...
.backedge.i:                                      ; preds = %464, %463, %462, %461, %460, %459, %458, %457, %449, %448, %447, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  %i.0.i = phi i32 [ undef, %strlen.exit ], [ %i.0.i, %.backedge.i ], [ %i.0.i, %464 ], [ %i.0.i, %463 ], [ %i.0.i, %462 ], [ %i.0.i, %461 ], [ %i.0.i, %459 ], [ %i.0.i, %458 ], [ %i.0.i, %457 ], [ %456, %449 ], [ %i.0.i, %448 ], [ %i.0.i, %447 ], [ %i.0
  %hash.0.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.i, %.backedge.i ], [ %hash.0.i, %464 ], [ %hash.0.i, %463 ], [ %hash.0.i, %462 ], [ %hash.0.i, %461 ], [ %hash.0.i, %459 ], [ %hash.0.i, %458 ], [ %hash.0.i, %457 ], [ %453, %449 ], [ %hash.0.i, %4
  %a.0.i = phi i32 [ undef, %strlen.exit ], [ %a.0.i, %.backedge.i ], [ %a.0.i, %464 ], [ %a.0.i, %463 ], [ %a.0.i, %462 ], [ %a.0.i, %461 ], [ %a.0.i, %459 ], [ %a.0.i, %458 ], [ %a.0.i, %457 ], [ %454, %449 ], [ %a.0.i, %448 ], [ %a.0.i, %447 ], [ %a.0
  %_1_RSHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_RSHash_next.0.i, %.backedge.i ], [ %_1_RSHash_next.0.i, %464 ], [ %_1_RSHash_next.0.i, %463 ], [ %_1_RSHash_next.0.i, %462 ], [ %_1_RSHash_next.0.i, %461 ], [ 5, %459 ], [ %_1_RSHash_next.0.i
  %_2_RSHash_next.0.i = phi i64 [ 2, %strlen.exit ], [ %_2_RSHash_next.0.i, %.backedge.i ], [ 0, %464 ], [ 17, %463 ], [ 14, %462 ], [ 9, %461 ], [ 0, %459 ], [ 5, %458 ], [ 0, %457 ], [ 8, %449 ], [ 0, %448 ], [ 0, %447 ], [ 13, %444 ], [ 0, %443 ], [ 1
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %.0.i, %.backedge.i ], [ %.0.i, %464 ], [ %.0.i, %463 ], [ %.0.i, %462 ], [ %.0.i, %461 ], [ %.0.i, %459 ], [ %.0.i, %458 ], [ %.0.i, %457 ], [ %455, %449 ], [ %.0.i, %448 ], [ %.0.i, %447 ], [ %.0.i, %444 ], [
  switch i64 %_2_RSHash_next.0.i, label %.backedge.i [
    i64 17, label %442
    i64 16, label %443
    i64 14, label %444
    i64 13, label %445
...
; <label>:444                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:445                                     ; preds = %.backedge.i
  %446 = icmp ult i32 %i.0.i, %441
  %..i = select i1 %446, i64 12, i64 11
  br label %.backedge.i

; <label>:447                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:448                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:449                                     ; preds = %.backedge.i
  %450 = mul i32 %a.0.i, %hash.0.i
  %451 = load i8* %.0.i, align 1
  %452 = sext i8 %451 to i32
  %453 = add i32 %452, %450
  %454 = mul i32 %a.0.i, 378551
  %455 = getelementptr inbounds i8* %.0.i, i64 1
  %456 = add i32 %i.0.i, 1
  br label %.backedge.i
...
; <label>:460                                     ; preds = %.backedge.i
  switch i64 %_1_RSHash_next.0.i, label %464 [
...
RSHash.exit:                                      ; preds = %.backedge.i
  %465 = icmp eq i32 %hash.0.i, 1294241610
  br i1 %465, label %466, label %467

; <label>:466                                     ; preds = %RSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %468

; <label>:467                                     ; preds = %RSHash.exit
