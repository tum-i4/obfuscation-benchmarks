; ModuleID = './rshash-addOpaque-updateOpaque1.bc'
...
; <label>:33                                      ; preds = %33, %91
  %p.0.i = phi i8* [ %94, %91 ], [ %36, %33 ]
...
strlen.exit:                                      ; preds = %33
  ...
  %38 = ptrtoint i8* %94 to i64, !dbg !2876
...
._crit_edge:                                      ; preds = %.lr.ph, %strlen.exit
  %hash.0.i.lcssa = phi i32 [ 0, %strlen.exit ], [ %55, %.lr.ph ]
  %43 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %44 = getelementptr inbounds %struct._1_main__opaque_Node_1* %43, i64 0, i32 1
  %45 = load %struct._1_main__opaque_Node_1** %44, align 8
  store %struct._1_main__opaque_Node_1* %45, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %46 = getelementptr inbounds %struct._1_main__opaque_Node_1* %92, i64 0, i32 1
  %47 = load %struct._1_main__opaque_Node_1** %46, align 8
  store %struct._1_main__opaque_Node_1* %47, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %48 = icmp eq %struct._1_main__opaque_Node_1* %47, null
  br i1 %48, label %49, label %RSHash.exit

; <label>:49                                      ; preds = %._crit_edge
  %50 = call fastcc i32 @__user_main(i32 8, i8** %1) #8
  br label %RSHash.exit

.lr.ph:                                           ; preds = %strlen.exit, %.lr.ph
  %51 = phi i8* [ %57, %.lr.ph ], [ %94, %strlen.exit ]
  %i.0.i4 = phi i32 [ %58, %.lr.ph ], [ 0, %strlen.exit ]
  %hash.0.i3 = phi i32 [ %55, %.lr.ph ], [ 0, %strlen.exit ]
  %a.0.i2 = phi i32 [ %56, %.lr.ph ], [ 63689, %strlen.exit ]
  %52 = mul i32 %hash.0.i3, %a.0.i2
  %53 = load i8* %51, align 1
  %54 = sext i8 %53 to i32
  %55 = add i32 %54, %52
  %56 = mul i32 %a.0.i2, 378551
  %57 = getelementptr inbounds i8* %51, i64 1
  store i8* %57, i8** %1, align 8
  %58 = add i32 %i.0.i4, 1
  %exitcond = icmp eq i32 %58, %40
  br i1 %exitcond, label %._crit_edge, label %.lr.ph

RSHash.exit:                                      ; preds = %._crit_edge, %49
  %59 = icmp eq i32 %hash.0.i.lcssa, 1294241610
  br i1 %59, label %60, label %61

; <label>:60                                      ; preds = %RSHash.exit
  %puts1 = call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %62

; <label>:61                                      ; preds = %RSHash.exit
...
; <label>:63                                      ; preds = %30, %22, %rand.exit
  %64 = load i32* %14, align 4, !dbg !2863
  %65 = load i32* %13, align 4, !dbg !2863
  %66 = add nsw i32 %65, %64, !dbg !2863
  store i32 %66, i32* %13, align 4, !dbg !2863
  %67 = lshr i32 %66, 1, !dbg !2864
  %68 = getelementptr inbounds i32* %13, i64 1, !dbg !2865
  %69 = icmp ult i32* %68, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !2866
  %70 = getelementptr inbounds i32* %14, i64 1, !dbg !2868
  br i1 %69, label %71, label %rand.exit.1, !dbg !2866

; <label>:71                                      ; preds = %63
  %72 = icmp ult i32* %70, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !2870
  %..i.i.i.1 = select i1 %72, i32* %70, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !2870
  br label %rand.exit.1, !dbg !2870

rand.exit.1:                                      ; preds = %63, %71
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %63 ], [ %68, %71 ]
  %rptr.0.i.i.i.1 = phi i32* [ %70, %63 ], [ %..i.i.i.1, %71 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !2872
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !2873
  %73 = call i8* @malloc(i64 16) #8
  %74 = bitcast i8* %73 to %struct._1_main__opaque_Node_1*
  %75 = icmp eq i8* %73, null
  br i1 %75, label %91, label %76

; <label>:76                                      ; preds = %rand.exit.1
...
; <label>:80                                      ; preds = %76
  %81 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %82 = getelementptr inbounds %struct._1_main__opaque_Node_1* %81, i64 0, i32 1
  %83 = load %struct._1_main__opaque_Node_1** %82, align 8
  %84 = getelementptr inbounds i8* %73, i64 8
  %85 = bitcast i8* %84 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %83, %struct._1_main__opaque_Node_1** %85, align 8
  %86 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %87 = getelementptr inbounds %struct._1_main__opaque_Node_1* %86, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %74, %struct._1_main__opaque_Node_1** %87, align 8
  br label %91

; <label>:88                                      ; preds = %76
  %89 = getelementptr inbounds i8* %73, i64 8
  %90 = bitcast i8* %89 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %74, %struct._1_main__opaque_Node_1** %90, align 8
  store %struct._1_main__opaque_Node_1* %74, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %91

; <label>:91                                      ; preds = %88, %80, %rand.exit.1
  ...
  %93 = getelementptr inbounds i8** %newArgv, i64 1
