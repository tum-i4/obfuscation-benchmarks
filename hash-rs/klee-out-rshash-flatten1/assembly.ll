...
.outer.outer.i:                                   ; preds = %.split8.i, %strlen.exit
  %hash.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %447, %.split8.i ]
  %a.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %448, %.split8.i ]
  %i.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %450, %.split8.i ]
  %_1_RSHash_next.0.ph.ph.i = phi i64 [ 5, %strlen.exit ], [ 3, %.split8.i ]
  %.0.ph.ph.i = phi i8* [ %433, %strlen.exit ], [ %449, %.split8.i ]
  br label %.outer.i

.outer.i:                                         ; preds = %.outer.i, %.outer.outer.i
  %hash.0.ph.i = phi i32 [ %hash.0.ph.ph.i, %.outer.outer.i ], [ 0, %.outer.i ]
  %a.0.ph.i = phi i32 [ %a.0.ph.ph.i, %.outer.outer.i ], [ 63689, %.outer.i ]
  %i.0.ph.i = phi i32 [ %i.0.ph.ph.i, %.outer.outer.i ], [ 0, %.outer.i ]
  %_1_RSHash_next.0.ph.i = phi i64 [ %_1_RSHash_next.0.ph.ph.i, %.outer.outer.i ], [ 3, %.outer.i ]
  %442 = icmp eq i64 %_1_RSHash_next.0.ph.i, 5
  br i1 %442, label %.outer.i, label %.outer1..outer1.split_crit_edge.lr.ph.i

.outer1..outer1.split_crit_edge.lr.ph.i:          ; preds = %.outer.i
  %443 = icmp ult i32 %i.0.ph.i, %441
  %..i = zext i1 %443 to i64
  br label %.outer1..outer1.split_crit_edge.i

.outer1..outer1.split_crit_edge.i:                ; preds = %.outer1..outer1.split_crit_edge.i, %.outer1..outer1.split_crit_edge.lr.ph.i
  %_1_RSHash_next.0.ph214.i = phi i64 [ %_1_RSHash_next.0.ph.i, %.outer1..outer1.split_crit_edge.lr.ph.i ], [ %..i, %.outer1..outer1.split_crit_edge.i ]
  switch i64 %_1_RSHash_next.0.ph214.i, label %infloop.i [
    i64 3, label %.outer1..outer1.split_crit_edge.i
    i64 1, label %.split8.i
    i64 0, label %RSHash.exit
  ]

.split8.i:                                        ; preds = %.outer1..outer1.split_crit_edge.i
  %444 = mul i32 %a.0.ph.i, %hash.0.ph.i
  %445 = load i8* %.0.ph.ph.i, align 1
  %446 = sext i8 %445 to i32
  %447 = add i32 %446, %444
  %448 = mul i32 %a.0.ph.i, 378551
  %449 = getelementptr inbounds i8* %.0.ph.ph.i, i64 1
  %450 = add i32 %i.0.ph.i, 1
  br label %.outer.outer.i

infloop.i:                                        ; preds = %.outer1..outer1.split_crit_edge.i, %infloop.i
  br label %infloop.i

RSHash.exit:                                      ; preds = %.outer1..outer1.split_crit_edge.i
  %451 = icmp eq i32 %hash.0.ph.i, 1294241610
  br i1 %451, label %452, label %453

; <label>:452                                     ; preds = %RSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %454

; <label>:453                                     ; preds = %RSHash.exit
