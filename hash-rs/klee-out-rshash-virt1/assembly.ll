...
@"_1_RSHash_$array" = internal unnamed_addr constant [1 x [199 x i8]] [[199 x i8] c"U\0C\00\00\00\EF\B7\C6\05\00\1FU\10\00\00\00\EF\C9\F8\00\00\1FU\14\00\00\00\EF\00\00\00\00\1FU\18\00\00\00\EF\00\00\00\00\1FU\18\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\B
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_RSHash_$locals.i" = alloca [28 x i8], align 16
  %"_1_RSHash_$stack.i" = alloca [1 x [32 x %"union._1_RSHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [28 x i8]* %"_1_RSHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_RSHash_$node"]]* %"_1_RSHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_RSHash_$node"]]* %"_1_RSHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %595, %588, %581, %573, %567, %560, %554, %546, %540, %537, %523, %521, %503, %496, %487, %478, %476, %468, %459, %451, %.backedge.i, %strlen.exit
  %"_1_RSHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [199 x i8]]* @"_1_RSHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_RSHash_$pc.0.0.i", %.backedge.i ], [ %603, %595 ], [ %589, %588 ], [ %587, %581 ], [ %574, %573 ], [ %572, %5
  %"_1_RSHash_$sp.0.0.i" = phi %"union._1_RSHash_$node"* [ %448, %strlen.exit ], [ %"_1_RSHash_$sp.0.0.i", %.backedge.i ], [ %602, %595 ], [ %"_1_RSHash_$sp.0.0.i", %588 ], [ %586, %581 ], [ %577, %573 ], [ %"_1_RSHash_$sp.0.0.i", %567 ], [ %564, %560 ],
  %449 = load i8* %"_1_RSHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %453 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  %454 = load i32* %453, align 4
  %455 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1
  %456 = bitcast %"union._1_RSHash_$node"* %455 to i32*
...
; <label>:459                                     ; preds = %.backedge.i
  %460 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %461 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  %462 = load i32* %461, align 4
  %463 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1
  %464 = bitcast %"union._1_RSHash_$node"* %463 to i32*
...
; <label>:468                                     ; preds = %.backedge.i
  %469 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %470 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  %471 = load i32* %470, align 4
  %472 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1, i32 0
  %473 = load i8** %472, align 8
  %474 = bitcast i8* %473 to i32*
  store i32 %471, i32* %474, align 4
  %475 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:476                                     ; preds = %.backedge.i
  %477 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:478                                     ; preds = %.backedge.i
  %479 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %480 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 0, i32 0
  %481 = load i8** %480, align 8
  %482 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1
  %483 = bitcast %"union._1_RSHash_$node"* %482 to i64*
  %484 = load i64* %483, align 8
  %485 = getelementptr i8* %481, i64 %484
  %486 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %485, i8** %486, align 8
  br label %.backedge.i

; <label>:487                                     ; preds = %.backedge.i
  %488 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %489 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i64*
  %490 = load i64* %489, align 8
  %491 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1
  %492 = bitcast %"union._1_RSHash_$node"* %491 to i64*
  %493 = load i64* %492, align 8
  %494 = mul i64 %493, %490
  %495 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1, i32 0
  %.c2.i = inttoptr i64 %494 to i8*
  store i8* %.c2.i, i8** %495, align 8
  br label %.backedge.i

; <label>:496                                     ; preds = %.backedge.i
  %497 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %498 = bitcast i8* %497 to i32*
  %499 = load i32* %498, align 4
  %500 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1
  %501 = bitcast %"union._1_RSHash_$node"* %500 to i32*
  store i32 %499, i32* %501, align 4
  %502 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:503                                     ; preds = %.backedge.i
  %504 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %505 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  %506 = load i32* %505, align 4
  %507 = sext i32 %506 to i64
  %508 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 0, i32 0
  %.c1.i = inttoptr i64 %507 to i8*
  store i8* %.c1.i, i8** %508, align 8
  br label %.backedge.i

; <label>:509                                     ; preds = %.backedge.i
  %510 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  %511 = load i32* %510, align 4
  %512 = icmp eq i32 %511, 0
  br i1 %512, label %519, label %513

; <label>:513                                     ; preds = %509
  %514 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %515 = bitcast i8* %514 to i32*
  %516 = load i32* %515, align 4
  %517 = sext i32 %516 to i64
  %.sum3.i = add i64 %517, 1
  %518 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 %.sum3.i
  br label %521

; <label>:519                                     ; preds = %509
  %520 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 5
  br label %521

; <label>:521                                     ; preds = %519, %513
  %"_1_RSHash_$pc.0.1.i" = phi i8* [ %520, %519 ], [ %518, %513 ]
  %522 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:523                                     ; preds = %.backedge.i
  %524 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %525 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i8*
  %526 = load i8* %525, align 1
  %527 = sext i8 %526 to i32
  %528 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  store i32 %527, i32* %528, align 4
  br label %.backedge.i

; <label>:529                                     ; preds = %.backedge.i
  %530 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
...
; <label>:533                                     ; preds = %529
  %534 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %534, align 8
  br label %537

; <label>:535                                     ; preds = %529
  %536 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %536, align 8
  br label %537

; <label>:537                                     ; preds = %535, %533, %529
  %538 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1
  %539 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:540                                     ; preds = %.backedge.i
  %541 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %542 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 0, i32 0
  %543 = load i8** %542, align 8
  %544 = load i8* %543, align 1
  %545 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i8*
  store i8 %544, i8* %545, align 1
  br label %.backedge.i

; <label>:546                                     ; preds = %.backedge.i
  %547 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %548 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1, i32 0
  %549 = load i8** %548, align 8
  %550 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 0, i32 0
  %551 = load i8** %550, align 8
  %552 = bitcast i8* %551 to i8**
  store i8* %549, i8** %552, align 8
  %553 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:554                                     ; preds = %.backedge.i
  %555 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %556 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 0, i32 0
  %557 = load i8** %556, align 8
  %558 = bitcast i8* %557 to i8**
  %559 = load i8** %558, align 8
  store i8* %559, i8** %556, align 8
  br label %.backedge.i

; <label>:560                                     ; preds = %.backedge.i
  %561 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %562 = bitcast i8* %561 to i32*
  %563 = load i32* %562, align 4
  %564 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1
  %565 = bitcast %"union._1_RSHash_$node"* %564 to i32*
  store i32 %563, i32* %565, align 4
  %566 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:567                                     ; preds = %.backedge.i
  %568 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %569 = bitcast i8* %568 to i32*
  %570 = load i32* %569, align 4
  %571 = sext i32 %570 to i64
  %.sum.i = add i64 %571, 1
  %572 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:573                                     ; preds = %.backedge.i
  %574 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %575 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  %576 = load i32* %575, align 4
  %577 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 -1
  %578 = bitcast %"union._1_RSHash_$node"* %577 to i32*
...
; <label>:581                                     ; preds = %.backedge.i
  %582 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %583 = bitcast i8* %582 to i64*
  %584 = load i64* %583, align 8
  %585 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1, i32 0
  %.c.i = inttoptr i64 %584 to i8*
  store i8* %.c.i, i8** %585, align 8
  %586 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1
  %587 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:588                                     ; preds = %.backedge.i
  %589 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %590 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 0, i32 0
  %591 = load i8** %590, align 8
  %592 = bitcast i8* %591 to i32*
  %593 = load i32* %592, align 4
  %594 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  store i32 %593, i32* %594, align 4
  br label %.backedge.i

; <label>:595                                     ; preds = %.backedge.i
  %596 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 1
  %597 = bitcast i8* %596 to i32*
  %598 = load i32* %597, align 4
  %599 = sext i32 %598 to i64
  %600 = getelementptr inbounds [28 x i8]* %"_1_RSHash_$locals.i", i64 0, i64 %599
  %601 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %600, i8** %601, align 8
  %602 = getelementptr inbounds %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i", i64 1
  %603 = getelementptr inbounds i8* %"_1_RSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

RSHash.exit:                                      ; preds = %.backedge.i
  %604 = bitcast %"union._1_RSHash_$node"* %"_1_RSHash_$sp.0.0.i" to i32*
  %605 = load i32* %604, align 4
  %606 = icmp eq i32 %605, 1294241610
  br i1 %606, label %607, label %608

; <label>:607                                     ; preds = %RSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %609

; <label>:608                                     ; preds = %RSHash.exit
