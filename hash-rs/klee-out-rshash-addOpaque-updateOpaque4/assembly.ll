; ModuleID = './rshash-addOpaque-updateOpaque4.bc'
...
; <label>:12                                      ; preds = %47, %0
  %13 = phi i8* [ %53, %47 ], [ %str, %0 ]
  %14 = phi %struct._1_main__opaque_Node_1* [ %.pr, %47 ], [ %9, %0 ]
  %hash.0 = phi i32 [ %51, %47 ], [ 0, %0 ]
  %a.0 = phi i32 [ %52, %47 ], [ 63689, %0 ]
  %i.0 = phi i32 [ %54, %47 ], [ 0, %0 ]
  %15 = icmp eq %struct._1_main__opaque_Node_1* %14, null
  br i1 %15, label %42, label %16

; <label>:16                                      ; preds = %12
  %17 = icmp ult i32 %i.0, %len
  br i1 %17, label %47, label %18

; <label>:18                                      ; preds = %16
  %19 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %20 = icmp eq %struct._1_main__opaque_Node_1* %19, null
  %21 = getelementptr inbounds %struct._1_main__opaque_Node_1* %19, i64 0, i32 1
...
; <label>:27                                      ; preds = %18
  %28 = getelementptr inbounds %struct._1_main__opaque_Node_1* %22, i64 -1
  ...
  %32 = getelementptr inbounds %struct._1_main__opaque_Node_1* %31, i64 1
  br label %33

; <label>:33                                      ; preds = %27, %23
  %34 = phi %struct._1_main__opaque_Node_1* [ %28, %27 ], [ %22, %23 ]
  %storemerge = phi %struct._1_main__opaque_Node_1* [ %32, %27 ], [ %26, %23 ]
  %35 = getelementptr inbounds %struct._1_main__opaque_Node_1* %34, i64 0, i32 1
  ...
  %37 = getelementptr inbounds %struct._1_main__opaque_Node_1* %storemerge, i64 0, i32 1
  ...
  %39 = icmp eq %struct._1_main__opaque_Node_1* %36, null
  br i1 %39, label %40, label %55

; <label>:40                                      ; preds = %33
  %41 = call fastcc i32 @RSHash(i8* null, i32 %hash.0)
  br label %55
...
; <label>:45                                      ; preds = %42
  %46 = call fastcc i32 @__user_main(i32 7, i8** %1)
  br label %47

; <label>:47                                      ; preds = %45, %42, %16
  %48 = mul i32 %a.0, %hash.0
  %49 = load i8* %13, align 1
  %50 = sext i8 %49 to i32
  %51 = add i32 %50, %48
  %52 = mul i32 %a.0, 378551
  %53 = getelementptr inbounds i8* %13, i64 1
  store i8* %53, i8** %1, align 8
  %54 = add i32 %i.0, 1
  %.pr = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %12

; <label>:55                                      ; preds = %33, %40
  ret i32 %hash.0
}
