...
__str_to_int.exit45.i:                            ; preds = %145
  ...
  br i1 %156, label %.lr.ph.i8, label %__streq.exit.thread.backedge.i, !dbg !2940

.lr.ph.i8:                                        ; preds = %__str_to_int.exit45.i
  %157 = sext i32 %23 to i64
  br label %158, !dbg !2940

; <label>:158                                     ; preds = %__add_arg.exit46.i, %.lr.ph.i8
  %indvars.iv.i = phi i64 [ %157, %.lr.ph.i8 ], [ %indvars.iv.next.i, %__add_arg.exit46.i ]
  %i.0151.i = phi i32 [ 0, %.lr.ph.i8 ], [ %169, %__add_arg.exit46.i ]
  %sym_arg_num.1150.i = phi i32 [ %sym_arg_num.0294.i, %.lr.ph.i8 ], [ %166, %__add_arg.exit46.i ]
  %159 = phi i32 [ %23, %.lr.ph.i8 ], [ %168, %__add_arg.exit46.i ]
...
; <label>:463                                     ; preds = %463, %513
  %p.0.i = phi i8* [ %517, %513 ], [ %466, %463 ]
...
.lr.ph.i:                                         ; preds = %strlen.exit
  ...
  %474 = icmp eq %struct._1_main__opaque_Node_1* %473, %514
  %475 = icmp eq i32 %470, 0
  br i1 %474, label %.lr.ph.split.us.i.preheader, label %.lr.ph..lr.ph.split_crit_edge.i

.lr.ph.split.us.i.preheader:                      ; preds = %.lr.ph.i
  br i1 %475, label %RSHash.exit.thread, label %.lr.ph.split.us.i

.lr.ph.split.us.i:                                ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph.split.us.i
  %a.02.us.i5 = phi i32 [ %480, %.lr.ph.split.us.i ], [ 63689, %.lr.ph.split.us.i.preheader ]
  %hash.03.us.i4 = phi i32 [ %479, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %i.04.us.i3 = phi i32 [ %482, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %.05.us.i2 = phi i8* [ %481, %.lr.ph.split.us.i ], [ %517, %.lr.ph.split.us.i.preheader ]
  %476 = mul i32 %a.02.us.i5, %hash.03.us.i4
  %477 = load i8* %.05.us.i2, align 1
  %478 = sext i8 %477 to i32
  %479 = add i32 %478, %476
  %480 = mul i32 %a.02.us.i5, 378551
  %481 = getelementptr inbounds i8* %.05.us.i2, i64 1
  %482 = add i32 %i.04.us.i3, 1
  %exitcond = icmp eq i32 %482, %470
  br i1 %exitcond, label %.lr.ph.split.us.i.RSHash.exit_crit_edge, label %.lr.ph.split.us.i

.preheader.i:                                     ; preds = %.lr.ph..lr.ph.split_crit_edge.i, %strlen.exit, %.preheader.i
  br label %.preheader.i

.lr.ph..lr.ph.split_crit_edge.i:                  ; preds = %.lr.ph.i
  br i1 %475, label %RSHash.exit.thread, label %.preheader.i

.lr.ph.split.us.i.RSHash.exit_crit_edge:          ; preds = %.lr.ph.split.us.i
  %phitmp = icmp eq i32 %479, 1294241610
  br i1 %phitmp, label %483, label %RSHash.exit.thread

; <label>:483                                     ; preds = %.lr.ph.split.us.i.RSHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %484

RSHash.exit.thread:                               ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph..lr.ph.split_crit_edge.i, %.lr.ph.split.us.i.RSHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %484

; <label>:484                                     ; preds = %RSHash.exit.thread, %483
  ret i32 0

; <label>:485                                     ; preds = %460, %452, %rand.exit
  %486 = load i32* %444, align 4, !dbg !3143
  %487 = load i32* %443, align 4, !dbg !3143
  %488 = add nsw i32 %487, %486, !dbg !3143
  store i32 %488, i32* %443, align 4, !dbg !3143
  %489 = lshr i32 %488, 1, !dbg !3144
  %490 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %491 = icmp ult i32* %490, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %492 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %491, label %493, label %rand.exit.1, !dbg !3146

; <label>:493                                     ; preds = %485
  %494 = icmp ult i32* %492, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %494, i32* %492, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %485, %493
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %485 ], [ %490, %493 ]
  %rptr.0.i.i.i.1 = phi i32* [ %492, %485 ], [ %..i.i.i.1, %493 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %495 = tail call i8* @malloc(i64 16) #7
  %496 = bitcast i8* %495 to %struct._1_main__opaque_Node_1*
  %497 = icmp eq i8* %495, null
  br i1 %497, label %513, label %498

; <label>:498                                     ; preds = %rand.exit.1
  %499 = bitcast i8* %495 to i32*
  store i32 %489, i32* %499, align 4
...
; <label>:502                                     ; preds = %498
  %503 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  ...
  %506 = getelementptr inbounds i8* %495, i64 8
  %507 = bitcast i8* %506 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %505, %struct._1_main__opaque_Node_1** %507, align 8
  %508 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %509 = getelementptr inbounds %struct._1_main__opaque_Node_1* %508, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %496, %struct._1_main__opaque_Node_1** %509, align 8
  br label %513

; <label>:510                                     ; preds = %498
  %511 = getelementptr inbounds i8* %495, i64 8
  %512 = bitcast i8* %511 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %496, %struct._1_main__opaque_Node_1** %512, align 8
  store %struct._1_main__opaque_Node_1* %496, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %513

; <label>:513                                     ; preds = %510, %502, %rand.exit.1
  %514 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %514, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %515 = getelementptr inbounds i8* %329, i64 8
  %516 = bitcast i8* %515 to i8**
  %517 = load i8** %516, align 8
