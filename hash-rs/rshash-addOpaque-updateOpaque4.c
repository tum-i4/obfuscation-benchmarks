  ...
  while (1) {
    if (_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) {
      ...
      if (_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) {
        ...
        randomVars_BogusReturn15 = main(7, & str);
      }
      if ((i < len) >= 6) {
        if ((_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) < 7) {
          while (1) {
            {  /* __blockattribute__(__ATOMIC__)*/ 
        ...
        if ((_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) >= 8) {
          b = RSHash(0 ^ 0, hash >> 9);
        } else {
