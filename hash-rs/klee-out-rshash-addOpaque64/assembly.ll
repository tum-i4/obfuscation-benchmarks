; ModuleID = './rshash-addOpaque64.bc'
...
define internal fastcc i32 @RSHash(i8* %str, i32 %len) #2 {
  %1 = alloca i8*, align 8
  store i8* %str, i8** %1, align 8
  %2 = getelementptr inbounds i8** %1, i64 1
  br label %thread-pre-split

thread-pre-split:                                 ; preds = %180, %185, %196, %204, %158, %.loopexit37, %0
  %3 = phi i8* [ %str, %0 ], [ %3, %204 ], [ %202, %196 ], [ %188, %185 ], [ %184, %180 ], [ %3, %158 ], [ %3, %.loopexit37 ]
  %i.0.ph = phi i32 [ 0, %0 ], [ %i.316, %204 ], [ %203, %196 ], [ 0, %185 ], [ %183, %180 ], [ %i.0, %158 ], [ %i.3.ph, %.loopexit37 ]
  %hash.0.ph = phi i32 [ 0, %0 ], [ %hash.217, %204 ], [ %200, %196 ], [ %179, %185 ], [ %181, %180 ], [ %hash.0, %158 ], [ %hash.2.ph, %.loopexit37 ]
  %a.0.ph = phi i32 [ 63689, %0 ], [ %a.618, %204 ], [ %201, %196 ], [ %187, %185 ], [ %183, %180 ], [ %a.0, %158 ], [ %a.6.ph, %.loopexit37 ]
  %.02.ph = phi i32 [ %len, %0 ], [ %.320, %204 ], [ %.320, %196 ], [ %.4, %185 ], [ %.4, %180 ], [ %.02, %158 ], [ %.3.ph, %.loopexit37 ]
  %.pr = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %4

; <label>:4                                       ; preds = %thread-pre-split, %192
  %5 = phi %struct._1_main__opaque_Node_1* [ %.pr, %thread-pre-split ], [ %193, %192 ]
  %i.0 = phi i32 [ %i.0.ph, %thread-pre-split ], [ %i.316, %192 ]
  %hash.0 = phi i32 [ %hash.0.ph, %thread-pre-split ], [ %hash.217, %192 ]
  %a.0 = phi i32 [ %a.0.ph, %thread-pre-split ], [ %a.618, %192 ]
  %.02 = phi i32 [ %.02.ph, %thread-pre-split ], [ %.320, %192 ]
  %6 = icmp eq %struct._1_main__opaque_Node_1* %5, null
  br i1 %6, label %7, label %8

; <label>:7                                       ; preds = %4
  call void asm sideeffect ".byte 0xcb,0x85,0xaf", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3157
  br label %.loopexit37
...
; <label>:8                                       ; preds = %4
  ...
  %12 = icmp eq %struct._1_main__opaque_Node_1* %9, null
...
; <label>:14                                      ; preds = %13
  %15 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %16
...
; <label>:20                                      ; preds = %16
  %21 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %22
...
; <label>:22                                      ; preds = %16, %20
  ...
  %25 = icmp eq %struct._1_main__opaque_Node_1* %23, %24
  br i1 %25, label %28, label %26

; <label>:26                                      ; preds = %22
  %27 = call fastcc i32 @RSHash(i8* null, i32 %.02)
...
; <label>:28                                      ; preds = %22, %26
  %29 = phi %struct._1_main__opaque_Node_1* [ %23, %22 ], [ %.pr4, %26 ]
  %30 = phi %struct._1_main__opaque_Node_1* [ %23, %22 ], [ %.pr3, %26 ]
  %31 = icmp ne %struct._1_main__opaque_Node_1* %30, null
  %32 = icmp eq %struct._1_main__opaque_Node_1* %29, null
  %or.cond = and i1 %31, %32
  br i1 %or.cond, label %33, label %thread-pre-split5

; <label>:33                                      ; preds = %28
  %34 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %35 = icmp eq %struct._1_main__opaque_Node_1* %34, null
  br i1 %35, label %36, label %37

; <label>:36                                      ; preds = %33
  call void asm sideeffect ".byte 0x0,0x48", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3158
  br label %thread-pre-split5

; <label>:37                                      ; preds = %33
  %38 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %thread-pre-split5

thread-pre-split5:                                ; preds = %28, %37, %36, %.us-lcssa27.us
  %.pr6 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %39 = icmp eq %struct._1_main__opaque_Node_1* %.pr6, null
  br i1 %39, label %.us-lcssa27.us, label %.outer..outer.split_crit_edge

.outer..outer.split_crit_edge:                    ; preds = %thread-pre-split5, %.outer..outer.split_crit_edge
  br label %.outer..outer.split_crit_edge

.us-lcssa27.us:                                   ; preds = %thread-pre-split5
  call void asm sideeffect ".byte 0x60,0x4c,0x8b,0x42", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3159
  br label %thread-pre-split5
...
; <label>:40                                      ; preds = %8
  ...
  br i1 %12, label %101, label %44

; <label>:44                                      ; preds = %40
  br i1 %43, label %47, label %45

; <label>:45                                      ; preds = %44
  %46 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %47
...
; <label>:50                                      ; preds = %47
  %51 = call fastcc i32 @RSHash(i8* null, i32 %i.0)
  br label %52

; <label>:52                                      ; preds = %47, %50
  %.2 = phi i32 [ %51, %50 ], [ %.02, %47 ]
...
; <label>:56                                      ; preds = %52
  %57 = icmp ult i32 %i.0, %.2
  br i1 %57, label %.loopexit37, label %58
...
; <label>:62                                      ; preds = %58
  %63 = icmp eq %struct._1_main__opaque_Node_1* %59, null
  br i1 %63, label %.loopexit37, label %64

; <label>:64                                      ; preds = %62
  %65 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %66 = icmp eq %struct._1_main__opaque_Node_1* %65, null
  br i1 %66, label %67, label %.loopexit83

; <label>:67                                      ; preds = %64
  call void asm sideeffect ".byte 0xfa,0xce,0x64,0x17,0xf9,0xd4,0x78,0xb4", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3160
  br label %.loopexit37

; <label>:68                                      ; preds = %52
  %69 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %70 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %71 = icmp eq %struct._1_main__opaque_Node_1* %69, %70
  br i1 %71, label %82, label %72

; <label>:72                                      ; preds = %68
  %73 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
...
; <label>:78                                      ; preds = %75
  %79 = call fastcc i32 @__user_main(i32 0, i8** %2)
  br label %82

; <label>:80                                      ; preds = %72
  %81 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %82

; <label>:82                                      ; preds = %75, %80, %78, %68
  ...
  %85 = icmp eq %struct._1_main__opaque_Node_1* %83, %84
...
; <label>:89                                      ; preds = %86
  %90 = call fastcc i32 @RSHash(i8* null, i32 %hash.0)
  br label %91

; <label>:91                                      ; preds = %86, %89
  %hash.1 = phi i32 [ %90, %89 ], [ %hash.0, %86 ]
...
; <label>:94                                      ; preds = %91
  %95 = call fastcc i32 @RSHash(i8* null, i32 %.2)
  br label %.loopexit37

; <label>:96                                      ; preds = %82
  %97 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %98 = icmp eq %struct._1_main__opaque_Node_1* %97, null
  br i1 %98, label %99, label %.preheader23.split

; <label>:99                                      ; preds = %96
  call void asm sideeffect ".byte 0xf9,0x44,0x89,0xe0,0xe9,0xbe,0xfe,0xff", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3161
  br label %.loopexit37

.preheader23.split:                               ; preds = %96, %.preheader23.split
  %100 = call fastcc i32 @RSHash(i8* null, i32 378551)
  br label %.preheader23.split

; <label>:101                                     ; preds = %40
  br i1 %43, label %102, label %162

; <label>:102                                     ; preds = %101
  %103 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %104 = icmp eq %struct._1_main__opaque_Node_1* %103, null
  br i1 %104, label %158, label %105

; <label>:105                                     ; preds = %102
  %106 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %107 = icmp eq %struct._1_main__opaque_Node_1* %106, null
  br i1 %107, label %.loopexit37, label %.outer39thread-pre-split

thread-pre-split7:                                ; preds = %145, %.thread
  %i.1.ph = phi i32 [ %i.1.ph41, %.thread ], [ %i.2, %145 ]
  %a.3.ph = phi i32 [ %a.3.ph42, %.thread ], [ %a.4, %145 ]
  %.pr8 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %.outer39thread-pre-split

.outer39thread-pre-split:                         ; preds = %105, %thread-pre-split7
  %.ph = phi %struct._1_main__opaque_Node_1* [ %.pr8, %thread-pre-split7 ], [ %106, %105 ]
  %i.1.ph41.ph = phi i32 [ %i.1.ph, %thread-pre-split7 ], [ %i.0, %105 ]
  %a.3.ph42.ph = phi i32 [ %a.3.ph, %thread-pre-split7 ], [ %a.0, %105 ]
  %.pr302 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %.outer39

.outer39:                                         ; preds = %.outer39thread-pre-split, %151
  %108 = phi %struct._1_main__opaque_Node_1* [ %.pr302, %.outer39thread-pre-split ], [ %153, %151 ]
  %109 = phi %struct._1_main__opaque_Node_1* [ %.ph, %.outer39thread-pre-split ], [ %152, %151 ]
  %i.1.ph41 = phi i32 [ %i.1.ph41.ph, %.outer39thread-pre-split ], [ %i.2, %151 ]
  %a.3.ph42 = phi i32 [ %a.3.ph42.ph, %.outer39thread-pre-split ], [ %a.5, %151 ]
  %110 = icmp eq %struct._1_main__opaque_Node_1* %109, null
  br i1 %110, label %.outer39.split.us.split.us.preheader, label %.outer39.split.split.us

.outer39.split.us.split.us.preheader:             ; preds = %.outer39
  %111 = icmp eq %struct._1_main__opaque_Node_1* %108, null
  br label %.outer39.split.us.split.us

.outer39.split.us.split.us:                       ; preds = %.outer39.split.us.split.us.preheader, %114
  %112 = phi %struct._1_main__opaque_Node_1* [ null, %114 ], [ %109, %.outer39.split.us.split.us.preheader ]
  %113 = icmp eq %struct._1_main__opaque_Node_1* %112, %108
  br i1 %113, label %114, label %.us-lcssa48.us

; <label>:114                                     ; preds = %.outer39.split.us.split.us
  br i1 %111, label %.us-lcssa49.us, label %.outer39.split.us.split.us

.outer39.split.split.us:                          ; preds = %.outer39
  %115 = icmp eq %struct._1_main__opaque_Node_1* %109, %108
  br i1 %115, label %116, label %.us-lcssa48.us

; <label>:116                                     ; preds = %.outer39.split.split.us
  %117 = icmp eq %struct._1_main__opaque_Node_1* %108, null
  br i1 %117, label %.us-lcssa49.us, label %.loopexit37

.us-lcssa49.us:                                   ; preds = %114, %116
  %118 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %119 = icmp eq %struct._1_main__opaque_Node_1* %118, null
  br i1 %119, label %120, label %.thread

; <label>:120                                     ; preds = %.us-lcssa49.us
  %121 = call fastcc i32 @__user_main(i32 0, i8** %1)
  %.pr9 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %122 = icmp eq %struct._1_main__opaque_Node_1* %.pr9, null
...
.thread:                                          ; preds = %.us-lcssa49.us, %120, %123
  call void asm sideeffect ".byte 0x85,0xc0,0x75,0x7", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3162
  br label %thread-pre-split7

.us-lcssa48.us:                                   ; preds = %.outer39.split.us.split.us, %.outer39.split.split.us
  %.lcssa44 = phi %struct._1_main__opaque_Node_1* [ %109, %.outer39.split.split.us ], [ %112, %.outer39.split.us.split.us ]
  %125 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %126 = icmp eq %struct._1_main__opaque_Node_1* %.lcssa44, %125
  br i1 %126, label %129, label %127

; <label>:127                                     ; preds = %.us-lcssa48.us
  %128 = call fastcc i32 @RSHash(i8* null, i32 %hash.0)
  %.pr10 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %129

; <label>:129                                     ; preds = %.us-lcssa48.us, %127
  %130 = phi %struct._1_main__opaque_Node_1* [ %.lcssa44, %.us-lcssa48.us ], [ %.pr10, %127 ]
  %a.4 = phi i32 [ %a.3.ph42, %.us-lcssa48.us ], [ %128, %127 ]
  %131 = icmp eq %struct._1_main__opaque_Node_1* %130, null
  ...
  br i1 %131, label %.preheader34, label %135

.preheader34:                                     ; preds = %129
  br i1 %134, label %.loopexit35, label %.preheader34..preheader34.split_crit_edge

.preheader34..preheader34.split_crit_edge:        ; preds = %.preheader34, %.preheader34..preheader34.split_crit_edge
  br label %.preheader34..preheader34.split_crit_edge

; <label>:135                                     ; preds = %129
  br i1 %134, label %.loopexit35, label %136

; <label>:136                                     ; preds = %135
  %137 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %138 = icmp eq %struct._1_main__opaque_Node_1* %137, null
  br i1 %138, label %139, label %141

; <label>:139                                     ; preds = %136
  %140 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %141

; <label>:141                                     ; preds = %136, %139
  %142 = call fastcc i32 @RSHash(i8* null, i32 378551)
  %.pr11 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %.loopexit35

.loopexit35:                                      ; preds = %.preheader34, %141, %135
  %143 = phi %struct._1_main__opaque_Node_1* [ %.pr11, %141 ], [ %132, %135 ], [ %132, %.preheader34 ]
  %i.2 = phi i32 [ %142, %141 ], [ %i.1.ph41, %135 ], [ %i.1.ph41, %.preheader34 ]
  %144 = icmp eq %struct._1_main__opaque_Node_1* %143, null
  br i1 %144, label %145, label %146

; <label>:145                                     ; preds = %.loopexit35
  call void asm sideeffect ".byte 0xff,0xff,0xff,0xff,0x7d,0x2", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3163
  br label %thread-pre-split7

; <label>:146                                     ; preds = %.loopexit35
...
; <label>:149                                     ; preds = %146
  %150 = call fastcc i32 @RSHash(i8* null, i32 %hash.0)
  br label %151

; <label>:151                                     ; preds = %149, %146
  %a.5 = phi i32 [ %150, %149 ], [ %a.4, %146 ]
  %152 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %153 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %154 = icmp eq %struct._1_main__opaque_Node_1* %152, %153
  br i1 %154, label %155, label %.outer39

; <label>:155                                     ; preds = %151
  %156 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %157 = icmp eq %struct._1_main__opaque_Node_1* %156, null
  %i.2. = select i1 %157, i32 %i.2, i32 378551
  br label %.loopexit83

; <label>:158                                     ; preds = %102
  %159 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %160 = icmp eq %struct._1_main__opaque_Node_1* %159, null
  br i1 %160, label %thread-pre-split, label %161

; <label>:161                                     ; preds = %158
  call void asm sideeffect ".byte 0x0", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3164
  br label %.loopexit37

; <label>:162                                     ; preds = %101
  call void asm sideeffect ".byte 0x5b", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3165
  br label %.loopexit37

.loopexit37:                                      ; preds = %116, %105, %162, %161, %62, %67, %56, %94, %99, %7
  %i.3.ph = phi i32 [ %i.0, %105 ], [ %i.0, %162 ], [ %i.0, %161 ], [ %i.0, %62 ], [ %i.0, %67 ], [ %i.0, %56 ], [ %i.0, %94 ], [ %i.0, %99 ], [ %i.0, %7 ], [ %i.1.ph41, %116 ]
  %hash.2.ph = phi i32 [ %hash.0, %105 ], [ %hash.0, %162 ], [ %hash.0, %161 ], [ %hash.0, %62 ], [ %hash.0, %67 ], [ %hash.0, %56 ], [ %95, %94 ], [ %hash.0, %99 ], [ %hash.0, %7 ], [ %hash.0, %116 ]
  %a.6.ph = phi i32 [ %a.0, %105 ], [ %a.0, %162 ], [ %a.0, %161 ], [ %a.0, %62 ], [ %a.0, %67 ], [ %a.0, %56 ], [ %a.0, %94 ], [ %a.0, %99 ], [ %a.0, %7 ], [ %a.3.ph42, %116 ]
  %.3.ph = phi i32 [ %.02, %105 ], [ %.02, %162 ], [ %.02, %161 ], [ %.2, %62 ], [ %.2, %67 ], [ %.2, %56 ], [ %.2, %94 ], [ %.2, %99 ], [ %.02, %7 ], [ %.02, %116 ]
  %.pr13 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %163 = icmp eq %struct._1_main__opaque_Node_1* %.pr13, null
  br i1 %163, label %thread-pre-split, label %.thread15

.thread15:                                        ; preds = %91, %.loopexit37
  %.320 = phi i32 [ %.3.ph, %.loopexit37 ], [ %.2, %91 ]
  %a.618 = phi i32 [ %a.6.ph, %.loopexit37 ], [ %a.0, %91 ]
  %hash.217 = phi i32 [ %hash.2.ph, %.loopexit37 ], [ %hash.1, %91 ]
  %i.316 = phi i32 [ %i.3.ph, %.loopexit37 ], [ %i.0, %91 ]
...
; <label>:169                                     ; preds = %166
  %170 = call fastcc i32 @RSHash(i8* null, i32 %i.316)
  %.pr21 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %171

; <label>:171                                     ; preds = %166, %169
  %172 = phi %struct._1_main__opaque_Node_1* [ %167, %166 ], [ %.pr21, %169 ]
  %.4 = phi i32 [ %.320, %166 ], [ %170, %169 ]
  %173 = icmp eq %struct._1_main__opaque_Node_1* %172, null
  %174 = mul i32 %hash.217, %a.618
  %175 = load i8* %3, align 1
  %176 = sext i8 %175 to i32
  %177 = add i32 %176, %174
  %178 = shl i32 %177, %a.618
  %179 = lshr i32 %178, %i.316
  br i1 %173, label %180, label %185

; <label>:180                                     ; preds = %171
  %181 = and i32 %179, %hash.217
  %182 = mul i32 %a.618, 1514204
  %183 = add i32 %182, 20
  %184 = getelementptr inbounds i8* %3, i64 2
  store i8* %184, i8** %1, align 8
  br label %thread-pre-split

; <label>:185                                     ; preds = %171
  %186 = mul i32 %a.618, 378551
  %187 = add i32 %186, 5
  %188 = getelementptr inbounds i8* %3, i64 1
  store i8* %188, i8** %1, align 8
  br label %thread-pre-split

; <label>:189                                     ; preds = %.thread15
  %190 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %191 = icmp eq %struct._1_main__opaque_Node_1* %164, %190
...
; <label>:192                                     ; preds = %189
  ...
  br i1 %195, label %196, label %4

; <label>:196                                     ; preds = %192
  %197 = mul i32 %hash.217, %a.618
  %198 = load i8* %3, align 1
  %199 = sext i8 %198 to i32
  %200 = add i32 %199, %197
  %201 = mul i32 %a.618, 378551
  %202 = getelementptr inbounds i8* %3, i64 1
  store i8* %202, i8** %1, align 8
  %203 = add i32 %i.316, 1
  br label %thread-pre-split

; <label>:204                                     ; preds = %189
  call void asm sideeffect ".byte 0xb5,0xff", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3166
  br label %thread-pre-split

; <label>:205                                     ; preds = %58
  %206 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %207 = icmp eq %struct._1_main__opaque_Node_1* %59, %206
  br i1 %207, label %208, label %225

; <label>:208                                     ; preds = %205
  %209 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %210 = icmp eq %struct._1_main__opaque_Node_1* %209, null
  br i1 %210, label %211, label %212

; <label>:211                                     ; preds = %208
  call void asm sideeffect ".byte 0x0,0x0,0xc7,0x85,0xa8,0xff", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3167
  br label %.loopexit83
...
; <label>:215                                     ; preds = %212
  %216 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %217 = icmp eq %struct._1_main__opaque_Node_1* %216, null
  br i1 %217, label %218, label %220

; <label>:218                                     ; preds = %215
  %219 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %220
...
; <label>:220                                     ; preds = %215, %218
  ...
  %.hash.0 = xor i32 %223, %hash.0
  ret i32 %.hash.0

; <label>:224                                     ; preds = %212
  call void asm sideeffect ".byte 0x41,0xbf,0x10,0x0,0x0,0x0", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3168
  br label %.loopexit83

; <label>:225                                     ; preds = %205
  %226 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %227 = icmp eq %struct._1_main__opaque_Node_1* %226, null
  %228 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %229 = icmp eq %struct._1_main__opaque_Node_1* %228, null
  br i1 %227, label %.preheader, label %230

.preheader:                                       ; preds = %225
  br i1 %229, label %.preheader..preheader.split_crit_edge, label %.split
...
.split:                                           ; preds = %.preheader
  %233 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %234 = icmp eq %struct._1_main__opaque_Node_1* %233, null
  br i1 %234, label %.loopexit83, label %235

; <label>:235                                     ; preds = %230, %.split, %231
  call void asm sideeffect ".byte 0x48", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3169
  br label %.loopexit83

.loopexit83:                                      ; preds = %64, %.split, %155, %211, %224, %235
  %.0 = phi i32 [ undef, %211 ], [ undef, %224 ], [ undef, %235 ], [ %i.2., %155 ], [ %.2, %.split ], [ %i.0, %64 ]
  ret i32 %.0
}
...
define internal fastcc void @__check_one_fd(i32 %fd, i32 %mode) #0 {
  ...
  %1 = icmp ult i32 %fd, 32, !dbg !3170
  br i1 %1, label %2, label %__get_file.exit.thread.i, !dbg !3170

; <label>:2                                       ; preds = %0
  %3 = sext i32 %fd to i64, !dbg !3174
  %4 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 1, !dbg !3175
  %5 = load i32* %4, align 4, !dbg !3175, !tbaa !3177
  %6 = and i32 %5, 1, !dbg !3175
  %7 = icmp eq i32 %6, 0, !dbg !3175
  br i1 %7, label %__get_file.exit.thread.i, label %__get_file.exit.i, !dbg !3175

__get_file.exit.i:                                ; preds = %2
  %8 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, !dbg !3174
  %9 = icmp eq %struct.exe_file_t* %8, null, !dbg !3178
  br i1 %9, label %__get_file.exit.thread.i, label %10, !dbg !3178

; <label>:10                                      ; preds = %__get_file.exit.i
  %11 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 3, !dbg !3180
  %12 = load %struct.exe_disk_file_t** %11, align 8, !dbg !3180, !tbaa !3092
  %13 = icmp eq %struct.exe_disk_file_t* %12, null, !dbg !3180
  br i1 %13, label %14, label %fcntl.exit.thread7, !dbg !3180

; <label>:14                                      ; preds = %10
  %15 = getelementptr inbounds %struct.exe_file_t* %8, i64 0, i32 0, !dbg !3181
  %16 = load i32* %15, align 8, !dbg !3181, !tbaa !3182
  %17 = call i64 (i64, ...)* @syscall(i64 72, i32 %16, i32 1, i32 0) #8, !dbg !3181
  %18 = trunc i64 %17 to i32, !dbg !3181
  %19 = icmp eq i32 %18, -1, !dbg !3183
  br i1 %19, label %20, label %fcntl.exit.thread7, !dbg !3183

; <label>:20                                      ; preds = %14
  %21 = call i32 @klee_get_errno() #8, !dbg !3185
  %phitmp = icmp eq i32 %21, 9, !dbg !3185
  br label %__get_file.exit.thread.i, !dbg !3185
...
__get_file.exit.thread.i:                         ; preds = %0, %2, %__get_file.exit.i, %20
  ...
  store i32 %storemerge, i32* @errno, align 4, !dbg !3185, !tbaa !3077
...
; <label>:26                                      ; preds = %fcntl.exit.thread7
  ...
  %28 = icmp eq i32 %27, %fd, !dbg !3186
  br i1 %28, label %29, label %108, !dbg !3186

; <label>:29                                      ; preds = %26
  %30 = bitcast %struct.stat64.647* %tmp.i to i8*, !dbg !3189
  br i1 %1, label %31, label %__get_file.exit.thread.i4, !dbg !3190

; <label>:31                                      ; preds = %29
  %32 = sext i32 %fd to i64, !dbg !3193
  %33 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %32, i32 1, !dbg !3194
  %34 = load i32* %33, align 4, !dbg !3194, !tbaa !3177
  %35 = and i32 %34, 1, !dbg !3194
  %36 = icmp eq i32 %35, 0, !dbg !3194
  br i1 %36, label %__get_file.exit.thread.i4, label %__get_file.exit.i3, !dbg !3194

__get_file.exit.i3:                               ; preds = %31
  %37 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %32, !dbg !3193
  %38 = icmp eq %struct.exe_file_t* %37, null, !dbg !3195
  br i1 %38, label %__get_file.exit.thread.i4, label %39, !dbg !3195

__get_file.exit.thread.i4:                        ; preds = %__get_file.exit.i3, %31, %29
  store i32 9, i32* @errno, align 4, !dbg !3197, !tbaa !3077
  br label %__fd_fstat.exit, !dbg !3199

; <label>:39                                      ; preds = %__get_file.exit.i3
  %40 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %32, i32 3, !dbg !3200
  %41 = load %struct.exe_disk_file_t** %40, align 8, !dbg !3200, !tbaa !3092
  %42 = icmp eq %struct.exe_disk_file_t* %41, null, !dbg !3200
  br i1 %42, label %43, label %51, !dbg !3200

; <label>:43                                      ; preds = %39
  %44 = getelementptr inbounds %struct.exe_file_t* %37, i64 0, i32 0, !dbg !3201
  %45 = load i32* %44, align 8, !dbg !3201, !tbaa !3182
  %46 = call i64 (i64, ...)* @syscall(i64 5, i32 %45, %struct.stat64.647* %tmp.i) #8, !dbg !3201
  %47 = trunc i64 %46 to i32, !dbg !3201
  %48 = icmp eq i32 %47, -1, !dbg !3202
  br i1 %48, label %49, label %__fd_fstat.exit, !dbg !3202

; <label>:49                                      ; preds = %43
  %50 = call i32 @klee_get_errno() #8, !dbg !3204
  store i32 %50, i32* @errno, align 4, !dbg !3204, !tbaa !3077
  br label %__fd_fstat.exit, !dbg !3204

; <label>:51                                      ; preds = %39
  %52 = getelementptr inbounds %struct.exe_disk_file_t* %41, i64 0, i32 2, !dbg !3205
  %53 = load %struct.stat64.647** %52, align 8, !dbg !3205, !tbaa !3041
  %54 = bitcast %struct.stat64.647* %53 to i8*, !dbg !3205
...
__fd_fstat.exit:                                  ; preds = %__get_file.exit.thread.i4, %43, %49, %51
  ...
  %56 = bitcast %struct.stat64.647* %tmp.i to <2 x i64>*, !dbg !3207
  %57 = load <2 x i64>* %56, align 16, !dbg !3207, !tbaa !3209
  %58 = bitcast %struct.stat.644* %st to <2 x i64>*, !dbg !3207
  store <2 x i64> %57, <2 x i64>* %58, align 16, !dbg !3207, !tbaa !3209
  %59 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 3, !dbg !3210
  %60 = bitcast i32* %59 to i64*, !dbg !3210
  %61 = load i64* %60, align 8, !dbg !3210
  %62 = trunc i64 %61 to i32, !dbg !3210
  %63 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 3, !dbg !3210
  store i32 %62, i32* %63, align 8, !dbg !3210, !tbaa !3211
  %64 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 2, !dbg !3213
  %65 = load i64* %64, align 16, !dbg !3213, !tbaa !3214
  %66 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 2, !dbg !3213
  store i64 %65, i64* %66, align 16, !dbg !3213, !tbaa !3215
  %67 = lshr i64 %61, 32
  %68 = trunc i64 %67 to i32
  %69 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 4, !dbg !3216
  store i32 %68, i32* %69, align 4, !dbg !3216, !tbaa !3217
  %70 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 5, !dbg !3218
  %71 = load i32* %70, align 16, !dbg !3218, !tbaa !3219
  %72 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 5, !dbg !3218
  store i32 %71, i32* %72, align 16, !dbg !3218, !tbaa !3220
  %73 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 7, !dbg !3221
  %74 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 7, !dbg !3221
  %75 = bitcast i64* %73 to <2 x i64>*, !dbg !3221
  %76 = load <2 x i64>* %75, align 8, !dbg !3221, !tbaa !3209
  %77 = bitcast i64* %74 to <2 x i64>*, !dbg !3221
  store <2 x i64> %76, <2 x i64>* %77, align 8, !dbg !3221, !tbaa !3209
  %78 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 11, i32 0, !dbg !3222
  %79 = load i64* %78, align 8, !dbg !3222, !tbaa !3223
  %80 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 11, !dbg !3222
  store i64 %79, i64* %80, align 8, !dbg !3222, !tbaa !3224
  %81 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 12, i32 0, !dbg !3225
  %82 = load i64* %81, align 8, !dbg !3225, !tbaa !3226
  %83 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 13, !dbg !3225
  store i64 %82, i64* %83, align 8, !dbg !3225, !tbaa !3227
  %84 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 13, i32 0, !dbg !3228
  %85 = load i64* %84, align 8, !dbg !3228, !tbaa !3229
  %86 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 15, !dbg !3228
  store i64 %85, i64* %86, align 8, !dbg !3228, !tbaa !3230
  %87 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 9, !dbg !3231
  %88 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 9, !dbg !3231
  %89 = bitcast i64* %87 to <2 x i64>*, !dbg !3231
  %90 = load <2 x i64>* %89, align 8, !dbg !3231, !tbaa !3209
  %91 = bitcast i64* %88 to <2 x i64>*, !dbg !3231
  store <2 x i64> %90, <2 x i64>* %91, align 8, !dbg !3231, !tbaa !3209
  %92 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 11, i32 1, !dbg !3232
  %93 = load i64* %92, align 8, !dbg !3232, !tbaa !3233
  %94 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 12, !dbg !3232
  store i64 %93, i64* %94, align 16, !dbg !3232, !tbaa !3234
  %95 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 12, i32 1, !dbg !3235
  %96 = load i64* %95, align 8, !dbg !3235, !tbaa !3236
  %97 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 14, !dbg !3235
  store i64 %96, i64* %97, align 16, !dbg !3235, !tbaa !3237
  %98 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 13, i32 1, !dbg !3238
  %99 = load i64* %98, align 8, !dbg !3238, !tbaa !3239
  %100 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 16, !dbg !3238
  store i64 %99, i64* %100, align 16, !dbg !3238, !tbaa !3240
  %101 = icmp eq i32 %.0.i5, 0, !dbg !3186
  br i1 %101, label %102, label %108, !dbg !3186

; <label>:102                                     ; preds = %__fd_fstat.exit
  %103 = load i32* %63, align 8, !dbg !3186
  %104 = and i32 %103, 61440, !dbg !3186
  %105 = icmp eq i32 %104, 8192, !dbg !3186
  %106 = load i64* %74, align 8, !dbg !3186
  %107 = icmp eq i64 %106, 259, !dbg !3241
  %or.cond = and i1 %105, %107, !dbg !3186
  br i1 %or.cond, label %109, label %108, !dbg !3186

; <label>:108                                     ; preds = %__fd_fstat.exit, %26, %102
  call void @abort() #14, !dbg !3242
...
entry:
  ...
  %2 = bitcast [15 x %struct.Elf64_auxv_t]* %auxvt.i to i8*, !dbg !3245
  %3 = add nsw i32 %0, 1, !dbg !3245
  %4 = sext i32 %3 to i64, !dbg !3245
  %5 = getelementptr inbounds i8** %1, i64 %4, !dbg !3245
  store i8** %5, i8*** @__environ, align 8, !dbg !3245
  %6 = bitcast i8** %5 to i8*, !dbg !3246
  %7 = load i8** %1, align 8, !dbg !3246
  %8 = icmp eq i8* %6, %7, !dbg !3246
  br i1 %8, label %9, label %12, !dbg !3246

; <label>:9                                       ; preds = %entry
  %10 = sext i32 %0 to i64, !dbg !3248
  %11 = getelementptr inbounds i8** %1, i64 %10, !dbg !3248
  store i8** %11, i8*** @__environ, align 8, !dbg !3248
  br label %12, !dbg !3250

; <label>:12                                      ; preds = %9, %entry
  %13 = phi i8** [ %11, %9 ], [ %5, %entry ]
  br label %14, !dbg !3251

; <label>:14                                      ; preds = %14, %12
  %p.02.i.i = phi i8* [ %2, %12 ], [ %15, %14 ]
  %.01.i.i = phi i64 [ 240, %12 ], [ %16, %14 ]
  %15 = getelementptr inbounds i8* %p.02.i.i, i64 1, !dbg !3253
  store i8 0, i8* %p.02.i.i, align 1, !dbg !3253
  %16 = add i64 %.01.i.i, -1, !dbg !3255
  %17 = icmp eq i64 %16, 0, !dbg !3251
  br i1 %17, label %memset.exit.i, label %14, !dbg !3251

memset.exit.i:                                    ; preds = %14
  %18 = bitcast i8** %13 to i64*, !dbg !3256
  br label %19, !dbg !3257

; <label>:19                                      ; preds = %19, %memset.exit.i
  %aux_dat.0.i = phi i64* [ %18, %memset.exit.i ], [ %22, %19 ]
  %20 = load i64* %aux_dat.0.i, align 8, !dbg !3257
  %21 = icmp eq i64 %20, 0, !dbg !3257
  %22 = getelementptr inbounds i64* %aux_dat.0.i, i64 1, !dbg !3258
  br i1 %21, label %.preheader.i, label %19, !dbg !3257

.preheader.i:                                     ; preds = %19
  %23 = load i64* %22, align 8, !dbg !3260
  %24 = icmp eq i64 %23, 0, !dbg !3260
  br i1 %24, label %._crit_edge.i, label %.lr.ph.i, !dbg !3260

.lr.ph.i:                                         ; preds = %.preheader.i, %memcpy.exit.i
  %aux_dat.12.i = phi i64* [ %79, %memcpy.exit.i ], [ %22, %.preheader.i ]
  %25 = load i64* %aux_dat.12.i, align 8, !dbg !3261
  %26 = icmp ult i64 %25, 15, !dbg !3261
  br i1 %26, label %.lr.ph.i.i, label %memcpy.exit.i, !dbg !3261

.lr.ph.i.i:                                       ; preds = %.lr.ph.i
  %27 = load i64* %aux_dat.12.i, align 8, !dbg !3264
  %28 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 %27, !dbg !3264
  %29 = bitcast %struct.Elf64_auxv_t* %28 to i8*, !dbg !3264
  %30 = bitcast i64* %aux_dat.12.i to i8*, !dbg !3264
  %31 = getelementptr inbounds i8* %30, i64 1, !dbg !3266
  %32 = load i8* %30, align 1, !dbg !3266
  %33 = getelementptr inbounds i8* %29, i64 1, !dbg !3266
  store i8 %32, i8* %29, align 16, !dbg !3266
  %34 = getelementptr inbounds i8* %30, i64 2, !dbg !3266
  %35 = load i8* %31, align 1, !dbg !3266
  %36 = getelementptr inbounds i8* %29, i64 2, !dbg !3266
  store i8 %35, i8* %33, align 1, !dbg !3266
  %37 = getelementptr inbounds i8* %30, i64 3, !dbg !3266
  %38 = load i8* %34, align 1, !dbg !3266
  %39 = getelementptr inbounds i8* %29, i64 3, !dbg !3266
  store i8 %38, i8* %36, align 2, !dbg !3266
  %40 = getelementptr inbounds i8* %30, i64 4, !dbg !3266
  %41 = load i8* %37, align 1, !dbg !3266
  %42 = getelementptr inbounds i8* %29, i64 4, !dbg !3266
  store i8 %41, i8* %39, align 1, !dbg !3266
  %43 = getelementptr inbounds i8* %30, i64 5, !dbg !3266
  %44 = load i8* %40, align 1, !dbg !3266
  %45 = getelementptr inbounds i8* %29, i64 5, !dbg !3266
  store i8 %44, i8* %42, align 4, !dbg !3266
  %46 = getelementptr inbounds i8* %30, i64 6, !dbg !3266
  %47 = load i8* %43, align 1, !dbg !3266
  %48 = getelementptr inbounds i8* %29, i64 6, !dbg !3266
  store i8 %47, i8* %45, align 1, !dbg !3266
  %49 = getelementptr inbounds i8* %30, i64 7, !dbg !3266
  %50 = load i8* %46, align 1, !dbg !3266
  %51 = getelementptr inbounds i8* %29, i64 7, !dbg !3266
  store i8 %50, i8* %48, align 2, !dbg !3266
  %52 = getelementptr inbounds i64* %aux_dat.12.i, i64 1, !dbg !3266
  %53 = bitcast i64* %52 to i8*, !dbg !3266
  %54 = load i8* %49, align 1, !dbg !3266
  %55 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 %27, i32 1, !dbg !3266
  %56 = bitcast %union.anon.645* %55 to i8*, !dbg !3266
  store i8 %54, i8* %51, align 1, !dbg !3266
  %57 = getelementptr inbounds i8* %53, i64 1, !dbg !3266
  %58 = load i8* %53, align 1, !dbg !3266
  %59 = getelementptr inbounds i8* %56, i64 1, !dbg !3266
  store i8 %58, i8* %56, align 8, !dbg !3266
  %60 = getelementptr inbounds i8* %53, i64 2, !dbg !3266
  %61 = load i8* %57, align 1, !dbg !3266
  %62 = getelementptr inbounds i8* %56, i64 2, !dbg !3266
  store i8 %61, i8* %59, align 1, !dbg !3266
  %63 = getelementptr inbounds i8* %53, i64 3, !dbg !3266
  %64 = load i8* %60, align 1, !dbg !3266
  %65 = getelementptr inbounds i8* %56, i64 3, !dbg !3266
  store i8 %64, i8* %62, align 2, !dbg !3266
  %66 = getelementptr inbounds i8* %53, i64 4, !dbg !3266
  %67 = load i8* %63, align 1, !dbg !3266
  %68 = getelementptr inbounds i8* %56, i64 4, !dbg !3266
  store i8 %67, i8* %65, align 1, !dbg !3266
  %69 = getelementptr inbounds i8* %53, i64 5, !dbg !3266
  %70 = load i8* %66, align 1, !dbg !3266
  %71 = getelementptr inbounds i8* %56, i64 5, !dbg !3266
  store i8 %70, i8* %68, align 4, !dbg !3266
  %72 = getelementptr inbounds i8* %53, i64 6, !dbg !3266
  %73 = load i8* %69, align 1, !dbg !3266
  %74 = getelementptr inbounds i8* %56, i64 6, !dbg !3266
  store i8 %73, i8* %71, align 1, !dbg !3266
  %75 = getelementptr inbounds i8* %53, i64 7, !dbg !3266
  %76 = load i8* %72, align 1, !dbg !3266
  %77 = getelementptr inbounds i8* %56, i64 7, !dbg !3266
  store i8 %76, i8* %74, align 2, !dbg !3266
  %78 = load i8* %75, align 1, !dbg !3266
  store i8 %78, i8* %77, align 1, !dbg !3266
  br label %memcpy.exit.i

memcpy.exit.i:                                    ; preds = %.lr.ph.i.i, %.lr.ph.i
  %79 = getelementptr inbounds i64* %aux_dat.12.i, i64 2, !dbg !3268
  %80 = load i64* %79, align 8, !dbg !3260
  %81 = icmp eq i64 %80, 0, !dbg !3260
  br i1 %81, label %._crit_edge.i, label %.lr.ph.i, !dbg !3260

._crit_edge.i:                                    ; preds = %.preheader.i, %memcpy.exit.i
  %82 = icmp eq i64 1, 0, !dbg !3269
  br i1 %82, label %__uClibc_init.exit.i, label %83, !dbg !3269

; <label>:83                                      ; preds = %._crit_edge.i
  %84 = load i32* @errno, align 4, !dbg !3272
  %85 = bitcast %struct.__kernel_termios* %k_termios.i.i.i.i.i to i8*, !dbg !3274
  %86 = call i32 (i32, i64, ...)* @ioctl(i32 0, i64 undef, %struct.__kernel_termios* %k_termios.i.i.i.i.i) #15, !dbg !3274
  %87 = icmp ne i32 %86, 0, !dbg !3275
  %88 = zext i1 %87 to i16, !dbg !3276
  %89 = shl nuw nsw i16 %88, 8, !dbg !3276
  %90 = load i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 0, i32 0), align 16, !dbg !3276
  %91 = xor i16 %89, %90, !dbg !3276
  store i16 %91, i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 0, i32 0), align 16, !dbg !3276
  %92 = bitcast %struct.__kernel_termios* %k_termios.i.i1.i.i.i to i8*, !dbg !3277
  %93 = call i32 (i32, i64, ...)* @ioctl(i32 1, i64 undef, %struct.__kernel_termios* %k_termios.i.i1.i.i.i) #15, !dbg !3277
  %94 = icmp ne i32 %93, 0, !dbg !3278
  %95 = zext i1 %94 to i16, !dbg !3279
  %96 = shl nuw nsw i16 %95, 8, !dbg !3279
  %97 = load i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 1, i32 0), align 16, !dbg !3279
  %98 = xor i16 %96, %97, !dbg !3279
  store i16 %98, i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 1, i32 0), align 16, !dbg !3279
  store i32 %84, i32* @errno, align 4, !dbg !3280
  br label %__uClibc_init.exit.i, !dbg !3273

__uClibc_init.exit.i:                             ; preds = %83, %._crit_edge.i
  %99 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 11, i32 1, i32 0, !dbg !3281
  %100 = load i64* %99, align 8, !dbg !3281
  %101 = icmp eq i64 %100, -1, !dbg !3281
  br i1 %101, label %102, label %.thread, !dbg !3281

; <label>:102                                     ; preds = %__uClibc_init.exit.i
  %103 = call i32 @getuid() #15, !dbg !3283
  %104 = call i32 @geteuid() #15, !dbg !3285
  %105 = call i32 @getgid() #15, !dbg !3286
  %106 = call i32 @getegid() #15, !dbg !3287
  %107 = icmp eq i32 %103, %104, !dbg !3288
  %108 = icmp eq i32 %105, %106, !dbg !3288
  %or.cond.i.i = and i1 %107, %108, !dbg !3288
  br i1 %or.cond.i.i, label %109, label %121, !dbg !3281

; <label>:109                                     ; preds = %102
  %.pr = load i64* %99, align 8, !dbg !3281
  %110 = icmp eq i64 %.pr, -1, !dbg !3281
  br i1 %110, label %122, label %.thread, !dbg !3281

.thread:                                          ; preds = %__uClibc_init.exit.i, %109
  %111 = load i64* %99, align 8, !dbg !3281
  %112 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 12, i32 1, i32 0, !dbg !3281
  %113 = load i64* %112, align 8, !dbg !3281
  %114 = icmp eq i64 %111, %113, !dbg !3281
  br i1 %114, label %115, label %121, !dbg !3281

; <label>:115                                     ; preds = %.thread
  %116 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 13, i32 1, i32 0, !dbg !3281
  %117 = load i64* %116, align 8, !dbg !3281
  %118 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 14, i32 1, i32 0, !dbg !3281
  %119 = load i64* %118, align 8, !dbg !3281
  %120 = icmp eq i64 %117, %119, !dbg !3281
  br i1 %120, label %122, label %121, !dbg !3281

; <label>:121                                     ; preds = %115, %.thread, %102
  call fastcc void @__check_one_fd(i32 0, i32 131072) #15, !dbg !3290
  call fastcc void @__check_one_fd(i32 1, i32 131074) #15, !dbg !3292
  call fastcc void @__check_one_fd(i32 2, i32 131074) #15, !dbg !3293
  br label %122, !dbg !3294

; <label>:122                                     ; preds = %121, %115, %109
  %123 = icmp eq i64 1, 0, !dbg !3295
  br i1 %123, label %125, label %124, !dbg !3295

; <label>:124                                     ; preds = %122
  store i32 0, i32* @errno, align 4, !dbg !3297
  br label %125, !dbg !3297

; <label>:125                                     ; preds = %124, %122
  %126 = call fastcc i32 @__user_main(i32 %0, i8** %1) #15, !dbg !3298
  call void @exit(i32 %126) #14, !dbg !3298
...
define internal i32 @ioctl(i32 %fd, i64 %request, ...) #10 {
  ...
  %1 = icmp ult i32 %fd, 32, !dbg !3299
  br i1 %1, label %2, label %__get_file.exit.thread, !dbg !3299

; <label>:2                                       ; preds = %0
  %3 = sext i32 %fd to i64, !dbg !3301
  %4 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 1, !dbg !3302
  %5 = load i32* %4, align 4, !dbg !3302, !tbaa !3177
  %6 = and i32 %5, 1, !dbg !3302
  %7 = icmp eq i32 %6, 0, !dbg !3302
  br i1 %7, label %__get_file.exit.thread, label %__get_file.exit, !dbg !3302

__get_file.exit:                                  ; preds = %2
  %8 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, !dbg !3301
  %9 = icmp eq %struct.exe_file_t* %8, null, !dbg !3303
  br i1 %9, label %__get_file.exit.thread, label %10, !dbg !3303

__get_file.exit.thread:                           ; preds = %__get_file.exit, %2, %0
  store i32 9, i32* @errno, align 4, !dbg !3305, !tbaa !3077
  br label %75, !dbg !3307

; <label>:10                                      ; preds = %__get_file.exit
  %11 = bitcast [1 x %struct.__va_list_tag.665]* %ap to i8*, !dbg !3308
  call void @llvm.va_start(i8* %11), !dbg !3308
  %12 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 0, !dbg !3309
  %13 = load i32* %12, align 16, !dbg !3309
  %14 = icmp ult i32 %13, 41, !dbg !3309
  br i1 %14, label %15, label %21, !dbg !3309

; <label>:15                                      ; preds = %10
  %16 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 3, !dbg !3309
  %17 = load i8** %16, align 16, !dbg !3309
  %18 = sext i32 %13 to i64, !dbg !3309
  %19 = getelementptr i8* %17, i64 %18, !dbg !3309
  %20 = add i32 %13, 8, !dbg !3309
  store i32 %20, i32* %12, align 16, !dbg !3309
  br label %25, !dbg !3309

; <label>:21                                      ; preds = %10
  %22 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 2, !dbg !3309
  %23 = load i8** %22, align 8, !dbg !3309
  %24 = getelementptr i8* %23, i64 8, !dbg !3309
  store i8* %24, i8** %22, align 8, !dbg !3309
  br label %25, !dbg !3309

; <label>:25                                      ; preds = %21, %15
  %.in = phi i8* [ %19, %15 ], [ %23, %21 ]
  %26 = bitcast i8* %.in to i8**, !dbg !3309
  %27 = load i8** %26, align 8, !dbg !3309
  call void @llvm.va_end(i8* %11), !dbg !3310
  %28 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 3, !dbg !3311
  %29 = load %struct.exe_disk_file_t** %28, align 8, !dbg !3311, !tbaa !3092
  %30 = icmp eq %struct.exe_disk_file_t* %29, null, !dbg !3311
  br i1 %30, label %67, label %31, !dbg !3311

; <label>:31                                      ; preds = %25
  %32 = getelementptr inbounds %struct.exe_disk_file_t* %29, i64 0, i32 2, !dbg !3312
  %33 = load %struct.stat64.647** %32, align 8, !dbg !3312, !tbaa !3041
  call void @klee_warning_once(i8* getelementptr inbounds ([41 x i8]* @.str13, i64 0, i64 0)) #8, !dbg !3313
  %34 = getelementptr inbounds %struct.stat64.647* %33, i64 0, i32 3, !dbg !3314
  %35 = load i32* %34, align 4, !dbg !3314, !tbaa !3211
  %36 = and i32 %35, 61440, !dbg !3314
  %37 = icmp eq i32 %36, 8192, !dbg !3314
  br i1 %37, label %38, label %66, !dbg !3314

; <label>:38                                      ; preds = %31
  %39 = bitcast i8* %27 to i32*, !dbg !3316
  store i32 27906, i32* %39, align 4, !dbg !3316, !tbaa !3318
  %40 = getelementptr inbounds i8* %27, i64 4, !dbg !3320
  %41 = bitcast i8* %40 to i32*, !dbg !3320
  store i32 5, i32* %41, align 4, !dbg !3320, !tbaa !3321
  %42 = getelementptr inbounds i8* %27, i64 8, !dbg !3322
  %43 = bitcast i8* %42 to i32*, !dbg !3322
  store i32 1215, i32* %43, align 4, !dbg !3322, !tbaa !3323
  %44 = getelementptr inbounds i8* %27, i64 12, !dbg !3324
  %45 = bitcast i8* %44 to i32*, !dbg !3324
  store i32 35287, i32* %45, align 4, !dbg !3324, !tbaa !3325
  %46 = getelementptr inbounds i8* %27, i64 16, !dbg !3326
  store i8 0, i8* %46, align 1, !dbg !3326, !tbaa !3327
  %47 = getelementptr inbounds i8* %27, i64 17, !dbg !3328
  store i8 3, i8* %47, align 1, !dbg !3328, !tbaa !2861
  %48 = getelementptr inbounds i8* %27, i64 18, !dbg !3329
  store i8 28, i8* %48, align 1, !dbg !3329, !tbaa !2861
  %49 = getelementptr inbounds i8* %27, i64 19, !dbg !3330
  store i8 127, i8* %49, align 1, !dbg !3330, !tbaa !2861
  %50 = getelementptr inbounds i8* %27, i64 20, !dbg !3331
  store i8 21, i8* %50, align 1, !dbg !3331, !tbaa !2861
  %51 = getelementptr inbounds i8* %27, i64 21, !dbg !3332
  store i8 4, i8* %51, align 1, !dbg !3332, !tbaa !2861
  %52 = getelementptr inbounds i8* %27, i64 22, !dbg !3333
  store i8 0, i8* %52, align 1, !dbg !3333, !tbaa !2861
  %53 = getelementptr inbounds i8* %27, i64 23, !dbg !3334
  store i8 1, i8* %53, align 1, !dbg !3334, !tbaa !2861
  %54 = getelementptr inbounds i8* %27, i64 24, !dbg !3335
  store i8 -1, i8* %54, align 1, !dbg !3335, !tbaa !2861
  %55 = getelementptr inbounds i8* %27, i64 25, !dbg !3336
  store i8 17, i8* %55, align 1, !dbg !3336, !tbaa !2861
  %56 = getelementptr inbounds i8* %27, i64 26, !dbg !3337
  store i8 19, i8* %56, align 1, !dbg !3337, !tbaa !2861
  %57 = getelementptr inbounds i8* %27, i64 27, !dbg !3338
  store i8 26, i8* %57, align 1, !dbg !3338, !tbaa !2861
  %58 = getelementptr inbounds i8* %27, i64 28, !dbg !3339
  store i8 -1, i8* %58, align 1, !dbg !3339, !tbaa !2861
  %59 = getelementptr inbounds i8* %27, i64 29, !dbg !3340
  store i8 18, i8* %59, align 1, !dbg !3340, !tbaa !2861
  %60 = getelementptr inbounds i8* %27, i64 30, !dbg !3341
  store i8 15, i8* %60, align 1, !dbg !3341, !tbaa !2861
  %61 = getelementptr inbounds i8* %27, i64 31, !dbg !3342
  store i8 23, i8* %61, align 1, !dbg !3342, !tbaa !2861
  %62 = getelementptr inbounds i8* %27, i64 32, !dbg !3343
  store i8 22, i8* %62, align 1, !dbg !3343, !tbaa !2861
  %63 = getelementptr inbounds i8* %27, i64 33, !dbg !3344
  store i8 -1, i8* %63, align 1, !dbg !3344, !tbaa !2861
  %64 = getelementptr inbounds i8* %27, i64 34, !dbg !3345
  store i8 0, i8* %64, align 1, !dbg !3345, !tbaa !2861
  %65 = getelementptr inbounds i8* %27, i64 35, !dbg !3346
  store i8 0, i8* %65, align 1, !dbg !3346, !tbaa !2861
  br label %75, !dbg !3347

; <label>:66                                      ; preds = %31
  store i32 25, i32* @errno, align 4, !dbg !3348, !tbaa !3077
  br label %75, !dbg !3350

; <label>:67                                      ; preds = %25
  %68 = getelementptr inbounds %struct.exe_file_t* %8, i64 0, i32 0, !dbg !3351
  %69 = load i32* %68, align 8, !dbg !3351, !tbaa !3182
  %70 = call i64 (i64, ...)* @syscall(i64 16, i32 %69, i64 21505, i8* %27) #8, !dbg !3351
  %71 = trunc i64 %70 to i32, !dbg !3351
  %72 = icmp eq i32 %71, -1, !dbg !3352
  br i1 %72, label %73, label %75, !dbg !3352

; <label>:73                                      ; preds = %67
  %74 = call i32 @klee_get_errno() #8, !dbg !3354
  store i32 %74, i32* @errno, align 4, !dbg !3354, !tbaa !3077
...
define internal i32 @open(i32 %flags, ...) #10 {
  %ap = alloca [1 x %struct.__va_list_tag.665], align 16
  %1 = and i32 %flags, 64, !dbg !3356
  %2 = icmp eq i32 %1, 0, !dbg !3356
  br i1 %2, label %21, label %3, !dbg !3356

; <label>:3                                       ; preds = %0
  %4 = bitcast [1 x %struct.__va_list_tag.665]* %ap to i8*, !dbg !3357
  call void @llvm.va_start(i8* %4), !dbg !3357
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 0, !dbg !3358
  %6 = load i32* %5, align 16, !dbg !3358
  %7 = icmp ult i32 %6, 41, !dbg !3358
  br i1 %7, label %8, label %14, !dbg !3358

; <label>:8                                       ; preds = %3
  %9 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 3, !dbg !3358
  %10 = load i8** %9, align 16, !dbg !3358
  %11 = sext i32 %6 to i64, !dbg !3358
  %12 = getelementptr i8* %10, i64 %11, !dbg !3358
  %13 = add i32 %6, 8, !dbg !3358
  store i32 %13, i32* %5, align 16, !dbg !3358
  br label %18, !dbg !3358

; <label>:14                                      ; preds = %3
  %15 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 2, !dbg !3358
  %16 = load i8** %15, align 8, !dbg !3358
  %17 = getelementptr i8* %16, i64 8, !dbg !3358
  store i8* %17, i8** %15, align 8, !dbg !3358
  br label %18, !dbg !3358

; <label>:18                                      ; preds = %14, %8
  %.in = phi i8* [ %12, %8 ], [ %16, %14 ]
  %19 = bitcast i8* %.in to i32*, !dbg !3358
  %20 = load i32* %19, align 4, !dbg !3358
  call void @llvm.va_end(i8* %4), !dbg !3359
  br label %21, !dbg !3360

; <label>:21                                      ; preds = %18, %0
  %mode.0 = phi i32 [ %20, %18 ], [ 0, %0 ]
  br label %25, !dbg !3361

; <label>:22                                      ; preds = %25
  %23 = trunc i64 %indvars.iv.next.i to i32, !dbg !3361
  %24 = icmp slt i32 %23, 32, !dbg !3361
  br i1 %24, label %25, label %31, !dbg !3361

; <label>:25                                      ; preds = %22, %21
  %indvars.iv.i = phi i64 [ 0, %21 ], [ %indvars.iv.next.i, %22 ]
  %fd.04.i = phi i32 [ 0, %21 ], [ %30, %22 ]
  %26 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %indvars.iv.i, i32 1, !dbg !3364
  %27 = load i32* %26, align 4, !dbg !3364, !tbaa !3177
  %28 = and i32 %27, 1, !dbg !3364
  %29 = icmp eq i32 %28, 0, !dbg !3364
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !3361
  %30 = add nsw i32 %fd.04.i, 1, !dbg !3361
  br i1 %29, label %31, label %22, !dbg !3364

; <label>:31                                      ; preds = %25, %22
  %fd.0.lcssa.i = phi i32 [ %fd.04.i, %25 ], [ %30, %22 ]
  %32 = icmp eq i32 %fd.0.lcssa.i, 32, !dbg !3366
  br i1 %32, label %33, label %34, !dbg !3366

; <label>:33                                      ; preds = %31
  store i32 24, i32* @errno, align 4, !dbg !3368, !tbaa !3077
  br label %__fd_open.exit, !dbg !3370

; <label>:34                                      ; preds = %31
  %35 = sext i32 %fd.0.lcssa.i to i64, !dbg !3371
  %36 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %35, !dbg !3371
  %37 = bitcast %struct.exe_file_t* %36 to i8*, !dbg !3372
  %38 = call i8* @memset(i8* %37, i32 0, i64 24)
  %39 = call i64 @klee_get_valuel(i64 ptrtoint ([10 x i8]* @.str130 to i64)) #8, !dbg !3373
  %40 = inttoptr i64 %39 to i8*, !dbg !3373
  %41 = icmp eq i8* %40, getelementptr inbounds ([10 x i8]* @.str130, i64 0, i64 0), !dbg !3376
  %42 = zext i1 %41 to i64, !dbg !3376
  call void @klee_assume(i64 %42) #8, !dbg !3376
  br label %43, !dbg !3377

; <label>:43                                      ; preds = %60, %34
  %i.0.i.i = phi i32 [ 0, %34 ], [ %61, %60 ]
  %sc.0.i.i = phi i8* [ %40, %34 ], [ %sc.1.i.i, %60 ]
  %44 = load i8* %sc.0.i.i, align 1, !dbg !3378, !tbaa !2861
  %45 = add i32 %i.0.i.i, -1, !dbg !3379
  %46 = and i32 %45, %i.0.i.i, !dbg !3379
  %47 = icmp eq i32 %46, 0, !dbg !3379
  br i1 %47, label %48, label %52, !dbg !3379
...
; <label>:49                                      ; preds = %48
  store i8 0, i8* %sc.0.i.i, align 1, !dbg !3381, !tbaa !2861
  br label %__concretize_string.exit.i, !dbg !3382

; <label>:50                                      ; preds = %48
  %51 = getelementptr inbounds i8* %sc.0.i.i, i64 1, !dbg !3383
  store i8 47, i8* %sc.0.i.i, align 1, !dbg !3383, !tbaa !2861
  br label %60, !dbg !3384

; <label>:52                                      ; preds = %43
  %53 = sext i8 %44 to i64, !dbg !3385
  %54 = call i64 @klee_get_valuel(i64 %53) #8, !dbg !3385
  %55 = trunc i64 %54 to i8, !dbg !3385
  %56 = icmp eq i8 %55, %44, !dbg !3386
  %57 = zext i1 %56 to i64, !dbg !3386
  call void @klee_assume(i64 %57) #8, !dbg !3386
  %58 = getelementptr inbounds i8* %sc.0.i.i, i64 1, !dbg !3387
  store i8 %55, i8* %sc.0.i.i, align 1, !dbg !3387, !tbaa !2861
  %59 = icmp eq i8 %55, 0, !dbg !3388
  br i1 %59, label %__concretize_string.exit.i, label %60, !dbg !3388

; <label>:60                                      ; preds = %52, %50, %48
  %sc.1.i.i = phi i8* [ %58, %52 ], [ %51, %50 ], [ %sc.0.i.i, %48 ]
  %61 = add i32 %i.0.i.i, 1, !dbg !3377
  br label %43, !dbg !3377

__concretize_string.exit.i:                       ; preds = %52, %49
  %62 = call i64 (i64, ...)* @syscall(i64 2, i8* getelementptr inbounds ([10 x i8]* @.str130, i64 0, i64 0), i32 %flags, i32 %mode.0) #8, !dbg !3375
  %63 = trunc i64 %62 to i32, !dbg !3375
  %64 = icmp eq i32 %63, -1, !dbg !3389
  br i1 %64, label %65, label %67, !dbg !3389

; <label>:65                                      ; preds = %__concretize_string.exit.i
  %66 = call i32 @klee_get_errno() #8, !dbg !3391
  store i32 %66, i32* @errno, align 4, !dbg !3391, !tbaa !3077
  br label %__fd_open.exit, !dbg !3393

; <label>:67                                      ; preds = %__concretize_string.exit.i
  %68 = getelementptr inbounds %struct.exe_file_t* %36, i64 0, i32 0, !dbg !3394
  store i32 %63, i32* %68, align 8, !dbg !3394, !tbaa !3182
  %.pre.i = and i32 %flags, 3, !dbg !3395
  %69 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %35, i32 1, !dbg !3397
  store i32 1, i32* %69, align 4, !dbg !3397, !tbaa !3177
...
; <label>:70                                      ; preds = %67
  store i32 5, i32* %69, align 4, !dbg !3398, !tbaa !3177
  br label %__fd_open.exit, !dbg !3400

; <label>:71                                      ; preds = %67
  store i32 9, i32* %69, align 4, !dbg !3401, !tbaa !3177
  br label %__fd_open.exit, !dbg !3404

; <label>:72                                      ; preds = %67
  store i32 13, i32* %69, align 4, !dbg !3405, !tbaa !3177
...
define internal fastcc void @__create_new_dfile(%struct.exe_disk_file_t* nocapture %dfile, i32 %size, i8* %name, %struct.stat64.647* nocapture readonly %defaults) #10 {
  ...
  %1 = call noalias i8* @malloc(i64 144) #8, !dbg !3407
  %2 = bitcast i8* %1 to %struct.stat64.647*, !dbg !3407
  %3 = getelementptr inbounds [64 x i8]* %sname, i64 0, i64 0, !dbg !3408
  %4 = load i8* %name, align 1, !dbg !3409, !tbaa !2861
  %5 = icmp eq i8 %4, 0, !dbg !3409
  %6 = ptrtoint i8* %name to i64, !dbg !3411
  br i1 %5, label %._crit_edge, label %.lr.ph, !dbg !3409

.lr.ph:                                           ; preds = %0, %.lr.ph
  %7 = phi i8* [ %14, %.lr.ph ], [ %3, %0 ]
  %8 = phi i8 [ %10, %.lr.ph ], [ %4, %0 ]
  %sp.01 = phi i8* [ %9, %.lr.ph ], [ %name, %0 ]
  store i8 %8, i8* %7, align 1, !dbg !3412, !tbaa !2861
  %9 = getelementptr inbounds i8* %sp.01, i64 1, !dbg !3409
  %10 = load i8* %9, align 1, !dbg !3409, !tbaa !2861
  %11 = icmp eq i8 %10, 0, !dbg !3409
  %12 = ptrtoint i8* %9 to i64, !dbg !3411
  %13 = sub i64 %12, %6, !dbg !3411
  %14 = getelementptr inbounds [64 x i8]* %sname, i64 0, i64 %13, !dbg !3411
  br i1 %11, label %._crit_edge, label %.lr.ph, !dbg !3409

._crit_edge:                                      ; preds = %.lr.ph, %0
  %.lcssa = phi i8* [ %3, %0 ], [ %14, %.lr.ph ]
  %15 = call i8* @memcpy(i8* %.lcssa, i8* getelementptr inbounds ([6 x i8]* @.str918, i64 0, i64 0), i64 6)
  %16 = icmp eq i32 %size, 0, !dbg !3413
  br i1 %16, label %17, label %18, !dbg !3413
...
; <label>:18                                      ; preds = %._crit_edge
  %19 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 0, !dbg !3414
  store i32 %size, i32* %19, align 4, !dbg !3414, !tbaa !3415
  %20 = zext i32 %size to i64, !dbg !3416
  %21 = call noalias i8* @malloc(i64 %20) #8, !dbg !3416
  %22 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 1, !dbg !3416
  store i8* %21, i8** %22, align 8, !dbg !3416, !tbaa !3417
  call void @klee_make_symbolic(i8* %21, i64 %20, i8* %name) #8, !dbg !3418
  call void @klee_make_symbolic(i8* %1, i64 144, i8* %3) #8, !dbg !3419
  %23 = getelementptr inbounds i8* %1, i64 8, !dbg !3420
  %24 = bitcast i8* %23 to i64*, !dbg !3420
  %25 = load i64* %24, align 8, !dbg !3420, !tbaa !3043
  %26 = call i32 @klee_is_symbolic(i64 %25) #8, !dbg !3420
  %27 = icmp eq i32 %26, 0, !dbg !3420
  %28 = load i64* %24, align 8, !dbg !3420, !tbaa !3043
  %29 = and i64 %28, 2147483647, !dbg !3420
  %30 = icmp eq i64 %29, 0, !dbg !3420
  %or.cond = and i1 %27, %30, !dbg !3420
  br i1 %or.cond, label %31, label %._crit_edge3, !dbg !3420

; <label>:31                                      ; preds = %18
  %32 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 1, !dbg !3422
  %33 = load i64* %32, align 8, !dbg !3422, !tbaa !3043
  store i64 %33, i64* %24, align 8, !dbg !3422, !tbaa !3043
  br label %._crit_edge3, !dbg !3422

._crit_edge3:                                     ; preds = %31, %18
  %34 = phi i64 [ %33, %31 ], [ %28, %18 ]
  %35 = and i64 %34, 2147483647, !dbg !3423
  %36 = icmp ne i64 %35, 0, !dbg !3423
  %37 = zext i1 %36 to i64, !dbg !3423
  call void @klee_assume(i64 %37) #8, !dbg !3423
  %38 = getelementptr inbounds i8* %1, i64 56, !dbg !3424
  %39 = bitcast i8* %38 to i64*, !dbg !3424
  %40 = load i64* %39, align 8, !dbg !3424, !tbaa !3425
  %41 = icmp ult i64 %40, 65536, !dbg !3424
  %42 = zext i1 %41 to i64, !dbg !3424
  call void @klee_assume(i64 %42) #8, !dbg !3424
  %43 = getelementptr inbounds i8* %1, i64 24, !dbg !3426
  %44 = bitcast i8* %43 to i32*, !dbg !3426
  %45 = load i32* %44, align 4, !dbg !3426, !tbaa !3427
  %46 = and i32 %45, -61952, !dbg !3426
  %47 = icmp eq i32 %46, 0, !dbg !3426
  %48 = zext i1 %47 to i64, !dbg !3426
  call void @klee_posix_prefer_cex(i8* %1, i64 %48) #8, !dbg !3426
  %49 = bitcast i8* %1 to i64*, !dbg !3428
  %50 = load i64* %49, align 8, !dbg !3428, !tbaa !3429
  %51 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 0, !dbg !3428
  %52 = load i64* %51, align 8, !dbg !3428, !tbaa !3429
  %53 = icmp eq i64 %50, %52, !dbg !3428
  %54 = zext i1 %53 to i64, !dbg !3428
  call void @klee_posix_prefer_cex(i8* %1, i64 %54) #8, !dbg !3428
  %55 = getelementptr inbounds i8* %1, i64 40, !dbg !3430
  %56 = bitcast i8* %55 to i64*, !dbg !3430
  %57 = load i64* %56, align 8, !dbg !3430, !tbaa !3431
  %58 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 7, !dbg !3430
  %59 = load i64* %58, align 8, !dbg !3430, !tbaa !3431
  %60 = icmp eq i64 %57, %59, !dbg !3430
  %61 = zext i1 %60 to i64, !dbg !3430
  call void @klee_posix_prefer_cex(i8* %1, i64 %61) #8, !dbg !3430
  %62 = load i32* %44, align 4, !dbg !3432, !tbaa !3427
  %63 = and i32 %62, 448, !dbg !3432
  %64 = icmp eq i32 %63, 384, !dbg !3432
  %65 = zext i1 %64 to i64, !dbg !3432
  call void @klee_posix_prefer_cex(i8* %1, i64 %65) #8, !dbg !3432
  %66 = load i32* %44, align 4, !dbg !3433, !tbaa !3427
  %67 = and i32 %66, 56, !dbg !3433
  %68 = icmp eq i32 %67, 16, !dbg !3433
  %69 = zext i1 %68 to i64, !dbg !3433
  call void @klee_posix_prefer_cex(i8* %1, i64 %69) #8, !dbg !3433
  %70 = load i32* %44, align 4, !dbg !3434, !tbaa !3427
  %71 = and i32 %70, 7, !dbg !3434
  %72 = icmp eq i32 %71, 2, !dbg !3434
  %73 = zext i1 %72 to i64, !dbg !3434
  call void @klee_posix_prefer_cex(i8* %1, i64 %73) #8, !dbg !3434
  %74 = load i32* %44, align 4, !dbg !3435, !tbaa !3427
  %75 = and i32 %74, 61440, !dbg !3435
  %76 = icmp eq i32 %75, 32768, !dbg !3435
  %77 = zext i1 %76 to i64, !dbg !3435
  call void @klee_posix_prefer_cex(i8* %1, i64 %77) #8, !dbg !3435
  %78 = getelementptr inbounds i8* %1, i64 16, !dbg !3436
  %79 = bitcast i8* %78 to i64*, !dbg !3436
  %80 = load i64* %79, align 8, !dbg !3436, !tbaa !3214
  %81 = icmp eq i64 %80, 1, !dbg !3436
  %82 = zext i1 %81 to i64, !dbg !3436
  call void @klee_posix_prefer_cex(i8* %1, i64 %82) #8, !dbg !3436
  %83 = getelementptr inbounds i8* %1, i64 28, !dbg !3437
  %84 = bitcast i8* %83 to i32*, !dbg !3437
  %85 = load i32* %84, align 4, !dbg !3437, !tbaa !3438
  %86 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 4, !dbg !3437
  %87 = load i32* %86, align 4, !dbg !3437, !tbaa !3438
  %88 = icmp eq i32 %85, %87, !dbg !3437
  %89 = zext i1 %88 to i64, !dbg !3437
  call void @klee_posix_prefer_cex(i8* %1, i64 %89) #8, !dbg !3437
  %90 = getelementptr inbounds i8* %1, i64 32, !dbg !3439
  %91 = bitcast i8* %90 to i32*, !dbg !3439
  %92 = load i32* %91, align 4, !dbg !3439, !tbaa !3219
  %93 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 5, !dbg !3439
  %94 = load i32* %93, align 4, !dbg !3439, !tbaa !3219
  %95 = icmp eq i32 %92, %94, !dbg !3439
  %96 = zext i1 %95 to i64, !dbg !3439
  call void @klee_posix_prefer_cex(i8* %1, i64 %96) #8, !dbg !3439
  %97 = load i64* %39, align 8, !dbg !3440, !tbaa !3425
  %98 = icmp eq i64 %97, 4096, !dbg !3440
  %99 = zext i1 %98 to i64, !dbg !3440
  call void @klee_posix_prefer_cex(i8* %1, i64 %99) #8, !dbg !3440
  %100 = getelementptr inbounds i8* %1, i64 72, !dbg !3441
  %101 = bitcast i8* %100 to i64*, !dbg !3441
  %102 = load i64* %101, align 8, !dbg !3441, !tbaa !3223
  %103 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 11, i32 0, !dbg !3441
  %104 = load i64* %103, align 8, !dbg !3441, !tbaa !3223
  %105 = icmp eq i64 %102, %104, !dbg !3441
  %106 = zext i1 %105 to i64, !dbg !3441
  call void @klee_posix_prefer_cex(i8* %1, i64 %106) #8, !dbg !3441
  %107 = getelementptr inbounds i8* %1, i64 88, !dbg !3442
  %108 = bitcast i8* %107 to i64*, !dbg !3442
  %109 = load i64* %108, align 8, !dbg !3442, !tbaa !3226
  %110 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 12, i32 0, !dbg !3442
  %111 = load i64* %110, align 8, !dbg !3442, !tbaa !3226
  %112 = icmp eq i64 %109, %111, !dbg !3442
  %113 = zext i1 %112 to i64, !dbg !3442
  call void @klee_posix_prefer_cex(i8* %1, i64 %113) #8, !dbg !3442
  %114 = getelementptr inbounds i8* %1, i64 104, !dbg !3443
  %115 = bitcast i8* %114 to i64*, !dbg !3443
  %116 = load i64* %115, align 8, !dbg !3443, !tbaa !3229
  %117 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 13, i32 0, !dbg !3443
  %118 = load i64* %117, align 8, !dbg !3443, !tbaa !3229
  %119 = icmp eq i64 %116, %118, !dbg !3443
  %120 = zext i1 %119 to i64, !dbg !3443
  call void @klee_posix_prefer_cex(i8* %1, i64 %120) #8, !dbg !3443
  %121 = load i32* %19, align 4, !dbg !3444, !tbaa !3415
  %122 = zext i32 %121 to i64, !dbg !3444
  %123 = getelementptr inbounds i8* %1, i64 48, !dbg !3444
  %124 = bitcast i8* %123 to i64*, !dbg !3444
  store i64 %122, i64* %124, align 8, !dbg !3444, !tbaa !3445
  %125 = getelementptr inbounds i8* %1, i64 64, !dbg !3446
  %126 = bitcast i8* %125 to i64*, !dbg !3446
  store i64 8, i64* %126, align 8, !dbg !3446, !tbaa !3447
  %127 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 2, !dbg !3448
  store %struct.stat64.647* %2, %struct.stat64.647** %127, align 8, !dbg !3448, !tbaa !3041
  ret void, !dbg !3449
}

; Function Attrs: noreturn nounwind ssp uwtable
define internal fastcc void @__emit_error(i8* %msg) #12 {
  tail call void @klee_report_error(i8* getelementptr inbounds ([16 x i8]* @.str2254, i64 0, i64 0), i32 24, i8* %msg, i8* getelementptr inbounds ([9 x i8]* @.str2355, i64 0, i64 0)) #5, !dbg !3450
  unreachable, !dbg !3450
}

; Function Attrs: nounwind ssp uwtable
define internal fastcc i8* @__get_sym_str(i32 %numChars, i8* %name) #10 {
  %1 = add nsw i32 %numChars, 1, !dbg !3451
  %2 = sext i32 %1 to i64, !dbg !3451
  %3 = tail call noalias i8* @malloc(i64 %2) #8, !dbg !3451
  tail call void @klee_mark_global(i8* %3) #8, !dbg !3452
  tail call void @klee_make_symbolic(i8* %3, i64 %2, i8* %name) #8, !dbg !3453
  %4 = icmp sgt i32 %numChars, 0, !dbg !3454
  br i1 %4, label %.lr.ph, label %._crit_edge, !dbg !3454

.lr.ph:                                           ; preds = %0, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ 0, %0 ]
  %5 = getelementptr inbounds i8* %3, i64 %indvars.iv, !dbg !3456
  %6 = load i8* %5, align 1, !dbg !3456, !tbaa !2861
  %7 = icmp sgt i8 %6, 31, !dbg !3457
  %8 = icmp ne i8 %6, 127, !dbg !3457
  %..i = and i1 %7, %8, !dbg !3457
  %9 = zext i1 %..i to i64, !dbg !3456
  tail call void @klee_posix_prefer_cex(i8* %3, i64 %9) #8, !dbg !3456
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !3454
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !3454
  %exitcond = icmp eq i32 %lftr.wideiv, %numChars, !dbg !3454
  br i1 %exitcond, label %._crit_edge, label %.lr.ph, !dbg !3454

._crit_edge:                                      ; preds = %.lr.ph, %0
  %10 = sext i32 %numChars to i64, !dbg !3458
  %11 = getelementptr inbounds i8* %3, i64 %10, !dbg !3458
  store i8 0, i8* %11, align 1, !dbg !3458, !tbaa !2861
  ret i8* %3, !dbg !3459
}
...
define void @klee_div_zero_check(i64 %z) #10 {
  %1 = icmp eq i64 %z, 0, !dbg !3460
  br i1 %1, label %2, label %3, !dbg !3460

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #14, !dbg !3462
...
define i32 @klee_int(i8* %name) #10 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !3464
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #15, !dbg !3464
  %2 = load i32* %x, align 4, !dbg !3465, !tbaa !3077
  ret i32 %2, !dbg !3465
}
...
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #10 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !3466
  br i1 %1, label %3, label %2, !dbg !3466

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #14, !dbg !3468
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #10 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !3471
  br i1 %1, label %3, label %2, !dbg !3471

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #14, !dbg !3473
  unreachable, !dbg !3473

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !3474
  %5 = icmp eq i32 %4, %end, !dbg !3474
  br i1 %5, label %21, label %6, !dbg !3474

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !3476
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #15, !dbg !3476
  %8 = icmp eq i32 %start, 0, !dbg !3478
  %9 = load i32* %x, align 4, !dbg !3480, !tbaa !3077
  br i1 %8, label %10, label %13, !dbg !3478

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !3480
  %12 = zext i1 %11 to i64, !dbg !3480
  call void @klee_assume(i64 %12) #15, !dbg !3480
  br label %19, !dbg !3482

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !3483
  %15 = zext i1 %14 to i64, !dbg !3483
  call void @klee_assume(i64 %15) #15, !dbg !3483
  %16 = load i32* %x, align 4, !dbg !3485, !tbaa !3077
  %17 = icmp slt i32 %16, %end, !dbg !3485
  %18 = zext i1 %17 to i64, !dbg !3485
  call void @klee_assume(i64 %18) #15, !dbg !3485
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !3486, !tbaa !3077
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #10 {
  %1 = icmp eq i64 %len, 0, !dbg !3488
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !3488
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3489
  %wide.load = load <16 x i8>* %3, align 1, !dbg !3489
  %next.gep.sum279 = or i64 %index, 16, !dbg !3489
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !3489
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !3489
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !3489
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !3489
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !3489
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !3489
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3489
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !3489
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !3490
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !3488
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !3489
  %12 = load i8* %src.03, align 1, !dbg !3489, !tbaa !2861
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !3489
  store i8 %12, i8* %dest.02, align 1, !dbg !3489, !tbaa !2861
  %14 = icmp eq i64 %10, 0, !dbg !3488
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !3488, !llvm.loop !3493

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !3494
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #10 {
  %1 = icmp eq i8* %src, %dst, !dbg !3495
  br i1 %1, label %.loopexit, label %2, !dbg !3495

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !3497
  br i1 %3, label %.preheader, label %18, !dbg !3497

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !3499
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !3499
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3499
  %wide.load = load <16 x i8>* %6, align 1, !dbg !3499
  %next.gep.sum586 = or i64 %index, 16, !dbg !3499
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !3499
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3499
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !3499
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !3499
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !3499
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !3499
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !3499
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !3499
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !3501
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !3499
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !3499
  %15 = load i8* %b.04, align 1, !dbg !3499, !tbaa !2861
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !3499
  store i8 %15, i8* %a.03, align 1, !dbg !3499, !tbaa !2861
  %17 = icmp eq i64 %13, 0, !dbg !3499
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !3499, !llvm.loop !3502

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !3503
  %20 = icmp eq i64 %count, 0, !dbg !3505
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !3505

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !3506
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !3503
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !3505
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !3505
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !3505
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !3505
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3505
  %.sum505 = add i64 %.sum440, -31, !dbg !3505
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !3505
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !3505
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !3505
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3505
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3505
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !3505
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !3505
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !3505
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3505
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !3505
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !3505
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !3505
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !3507
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !3505
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !3505
  %34 = load i8* %b.18, align 1, !dbg !3505, !tbaa !2861
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !3505
  store i8 %34, i8* %a.17, align 1, !dbg !3505, !tbaa !2861
  %36 = icmp eq i64 %32, 0, !dbg !3505
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !3505, !llvm.loop !3508
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #10 {
  %1 = icmp eq i64 %len, 0, !dbg !3510
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !3510
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3511
  %wide.load = load <16 x i8>* %3, align 1, !dbg !3511
  %next.gep.sum280 = or i64 %index, 16, !dbg !3511
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !3511
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !3511
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !3511
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !3511
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !3511
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !3511
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3511
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !3511
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !3512
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !3510
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !3511
  %12 = load i8* %src.03, align 1, !dbg !3511, !tbaa !2861
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !3511
  store i8 %12, i8* %dest.02, align 1, !dbg !3511, !tbaa !2861
  %14 = icmp eq i64 %10, 0, !dbg !3510
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !3510, !llvm.loop !3513
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !3514
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #10 {
  %1 = icmp eq i64 %count, 0, !dbg !3515
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !3515

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !3516
  br label %3, !dbg !3515

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !3515
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !3516
  store volatile i8 %2, i8* %a.02, align 1, !dbg !3516, !tbaa !2861
  %6 = icmp eq i64 %4, 0, !dbg !3515
  br i1 %6, label %._crit_edge, label %3, !dbg !3515
...
!3157 = metadata !{i32 3393}
!3158 = metadata !{i32 4225}
!3159 = metadata !{i32 5554}
!3160 = metadata !{i32 6641}
!3161 = metadata !{i32 7996}
!3162 = metadata !{i32 10149}
!3163 = metadata !{i32 11077}
!3164 = metadata !{i32 11938}
!3165 = metadata !{i32 12001}
!3166 = metadata !{i32 13362}
!3167 = metadata !{i32 13616}
!3168 = metadata !{i32 14104}
!3169 = metadata !{i32 14749}
!3170 = metadata !{i32 64, i32 0, metadata !1405, metadata !3171}
!3171 = metadata !{i32 1049, i32 0, metadata !1196, metadata !3172}
!3172 = metadata !{i32 139, i32 0, metadata !3173, null}
!3173 = metadata !{i32 786443, metadata !274, metadata !288, i32 139, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3174 = metadata !{i32 65, i32 0, metadata !1404, metadata !3171}
!3175 = metadata !{i32 66, i32 0, metadata !3176, metadata !3171}
!3176 = metadata !{i32 786443, metadata !801, metadata !1404, i32 66, i32 0, i32 374} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3177 = metadata !{metadata !3093, metadata !3035, i64 4}
!3178 = metadata !{i32 1053, i32 0, metadata !3179, metadata !3172}
!3179 = metadata !{i32 786443, metadata !801, metadata !1196, i32 1053, i32 0, i32 235} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3180 = metadata !{i32 1067, i32 0, metadata !1209, metadata !3172}
!3181 = metadata !{i32 1096, i32 0, metadata !1211, metadata !3172}
!3182 = metadata !{metadata !3093, metadata !3035, i64 0}
!3183 = metadata !{i32 1097, i32 0, metadata !3184, metadata !3172}
!3184 = metadata !{i32 786443, metadata !801, metadata !1211, i32 1097, i32 0, i32 249} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3185 = metadata !{i32 1098, i32 0, metadata !3184, metadata !3172}
!3186 = metadata !{i32 147, i32 0, metadata !3187, null}
!3187 = metadata !{i32 786443, metadata !274, metadata !3188, i32 147, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3188 = metadata !{i32 786443, metadata !274, metadata !3173, i32 140, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3189 = metadata !{i32 133, i32 0, metadata !1555, metadata !3186}
!3190 = metadata !{i32 64, i32 0, metadata !1405, metadata !3191}
!3191 = metadata !{i32 759, i32 0, metadata !1082, metadata !3192}
!3192 = metadata !{i32 134, i32 0, metadata !1555, metadata !3186}
!3193 = metadata !{i32 65, i32 0, metadata !1404, metadata !3191}
!3194 = metadata !{i32 66, i32 0, metadata !3176, metadata !3191}
!3195 = metadata !{i32 761, i32 0, metadata !3196, metadata !3192}
!3196 = metadata !{i32 786443, metadata !801, metadata !1082, i32 761, i32 0, i32 167} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3197 = metadata !{i32 762, i32 0, metadata !3198, metadata !3192}
!3198 = metadata !{i32 786443, metadata !801, metadata !3196, i32 761, i32 0, i32 168} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3199 = metadata !{i32 763, i32 0, metadata !3198, metadata !3192}
!3200 = metadata !{i32 766, i32 0, metadata !1091, metadata !3192}
!3201 = metadata !{i32 768, i32 0, metadata !1090, metadata !3192}
!3202 = metadata !{i32 772, i32 0, metadata !3203, metadata !3192}
!3203 = metadata !{i32 786443, metadata !801, metadata !1090, i32 772, i32 0, i32 171} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3204 = metadata !{i32 773, i32 0, metadata !3203, metadata !3192}
!3205 = metadata !{i32 777, i32 0, metadata !1082, metadata !3192}
!3206 = metadata !{i32 778, i32 0, metadata !1082, metadata !3192}
!3207 = metadata !{i32 42, i32 0, metadata !1637, metadata !3208}
!3208 = metadata !{i32 135, i32 0, metadata !1555, metadata !3186}
!3209 = metadata !{metadata !3045, metadata !3045, i64 0}
!3210 = metadata !{i32 44, i32 0, metadata !1637, metadata !3208}
!3211 = metadata !{metadata !3212, metadata !3035, i64 24}
!3212 = metadata !{metadata !"stat", metadata !3045, i64 0, metadata !3045, i64 8, metadata !3045, i64 16, metadata !3035, i64 24, metadata !3035, i64 28, metadata !3035, i64 32, metadata !3035, i64 36, metadata !3045, i64 40, metadata !3045, i64 48, met
!3213 = metadata !{i32 45, i32 0, metadata !1637, metadata !3208}
!3214 = metadata !{metadata !3044, metadata !3045, i64 16}
!3215 = metadata !{metadata !3212, metadata !3045, i64 16}
!3216 = metadata !{i32 46, i32 0, metadata !1637, metadata !3208}
!3217 = metadata !{metadata !3212, metadata !3035, i64 28}
!3218 = metadata !{i32 47, i32 0, metadata !1637, metadata !3208}
!3219 = metadata !{metadata !3044, metadata !3035, i64 32}
!3220 = metadata !{metadata !3212, metadata !3035, i64 32}
!3221 = metadata !{i32 48, i32 0, metadata !1637, metadata !3208}
!3222 = metadata !{i32 50, i32 0, metadata !1637, metadata !3208}
!3223 = metadata !{metadata !3044, metadata !3045, i64 72}
!3224 = metadata !{metadata !3212, metadata !3045, i64 72}
!3225 = metadata !{i32 51, i32 0, metadata !1637, metadata !3208}
!3226 = metadata !{metadata !3044, metadata !3045, i64 88}
!3227 = metadata !{metadata !3212, metadata !3045, i64 88}
!3228 = metadata !{i32 52, i32 0, metadata !1637, metadata !3208}
!3229 = metadata !{metadata !3044, metadata !3045, i64 104}
!3230 = metadata !{metadata !3212, metadata !3045, i64 104}
!3231 = metadata !{i32 53, i32 0, metadata !1637, metadata !3208}
!3232 = metadata !{i32 56, i32 0, metadata !1637, metadata !3208}
!3233 = metadata !{metadata !3044, metadata !3045, i64 80}
!3234 = metadata !{metadata !3212, metadata !3045, i64 80}
!3235 = metadata !{i32 57, i32 0, metadata !1637, metadata !3208}
!3236 = metadata !{metadata !3044, metadata !3045, i64 96}
!3237 = metadata !{metadata !3212, metadata !3045, i64 96}
!3238 = metadata !{i32 58, i32 0, metadata !1637, metadata !3208} ; [ DW_TAG_imported_module ]
!3239 = metadata !{metadata !3044, metadata !3045, i64 112}
!3240 = metadata !{metadata !3212, metadata !3045, i64 112}
!3241 = metadata !{i32 148, i32 18, metadata !3187, null}
!3242 = metadata !{i32 150, i32 0, metadata !3243, null}
!3243 = metadata !{i32 786443, metadata !274, metadata !3187, i32 149, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3244 = metadata !{i32 153, i32 0, metadata !288, null}
!3245 = metadata !{i32 294, i32 0, metadata !279, null}
!3246 = metadata !{i32 298, i32 0, metadata !3247, null}
!3247 = metadata !{i32 786443, metadata !274, metadata !279, i32 298, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3248 = metadata !{i32 300, i32 0, metadata !3249, null}
!3249 = metadata !{i32 786443, metadata !274, metadata !3247, i32 298, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3250 = metadata !{i32 301, i32 0, metadata !3249, null}
!3251 = metadata !{i32 27, i32 0, metadata !602, metadata !3252}
!3252 = metadata !{i32 305, i32 0, metadata !279, null}
!3253 = metadata !{i32 28, i32 0, metadata !3254, metadata !3252}
!3254 = metadata !{i32 786443, metadata !600, metadata !602, i32 27, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/string/memset.c]
!3255 = metadata !{i32 29, i32 0, metadata !3254, metadata !3252}
!3256 = metadata !{i32 306, i32 0, metadata !279, null}
!3257 = metadata !{i32 307, i32 0, metadata !279, null}
!3258 = metadata !{i32 308, i32 0, metadata !3259, null}
!3259 = metadata !{i32 786443, metadata !274, metadata !279, i32 307, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3260 = metadata !{i32 311, i32 0, metadata !279, null}
!3261 = metadata !{i32 313, i32 0, metadata !3262, null}
!3262 = metadata !{i32 786443, metadata !274, metadata !3263, i32 313, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3263 = metadata !{i32 786443, metadata !274, metadata !279, i32 311, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3264 = metadata !{i32 314, i32 0, metadata !3265, null}
!3265 = metadata !{i32 786443, metadata !274, metadata !3262, i32 313, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3266 = metadata !{i32 29, i32 0, metadata !3267, metadata !3264}
!3267 = metadata !{i32 786443, metadata !580, metadata !582, i32 28, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/string/memcpy.c]
!3268 = metadata !{i32 316, i32 0, metadata !3263, null}
!3269 = metadata !{i32 238, i32 0, metadata !3270, metadata !3271}
!3270 = metadata !{i32 786443, metadata !274, metadata !276, i32 238, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3271 = metadata !{i32 323, i32 0, metadata !279, null}
!3272 = metadata !{i32 280, i32 0, metadata !424, metadata !3273}
!3273 = metadata !{i32 239, i32 0, metadata !3270, metadata !3271}
!3274 = metadata !{i32 43, i32 0, metadata !626, metadata !3275}
!3275 = metadata !{i32 30, i32 0, metadata !619, metadata !3276}
!3276 = metadata !{i32 282, i32 0, metadata !424, metadata !3273}
!3277 = metadata !{i32 43, i32 0, metadata !626, metadata !3278}
!3278 = metadata !{i32 30, i32 0, metadata !619, metadata !3279}
!3279 = metadata !{i32 283, i32 0, metadata !424, metadata !3273}
!3280 = metadata !{i32 284, i32 0, metadata !424, metadata !3273}
!3281 = metadata !{i32 331, i32 0, metadata !3282, null}
!3282 = metadata !{i32 786443, metadata !274, metadata !279, i32 331, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3283 = metadata !{i32 160, i32 0, metadata !3284, metadata !3281}
!3284 = metadata !{i32 786443, metadata !274, metadata !297} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3285 = metadata !{i32 161, i32 0, metadata !3284, metadata !3281}
!3286 = metadata !{i32 162, i32 0, metadata !3284, metadata !3281}
!3287 = metadata !{i32 163, i32 0, metadata !3284, metadata !3281}
!3288 = metadata !{i32 165, i32 0, metadata !3289, metadata !3281}
!3289 = metadata !{i32 786443, metadata !274, metadata !3284, i32 165, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3290 = metadata !{i32 336, i32 0, metadata !3291, null}
!3291 = metadata !{i32 786443, metadata !274, metadata !3282, i32 335, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3292 = metadata !{i32 337, i32 0, metadata !3291, null}
!3293 = metadata !{i32 338, i32 0, metadata !3291, null}
!3294 = metadata !{i32 339, i32 0, metadata !3291, null}
!3295 = metadata !{i32 391, i32 0, metadata !3296, null}
!3296 = metadata !{i32 786443, metadata !274, metadata !279, i32 391, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3297 = metadata !{i32 392, i32 0, metadata !3296, null}
!3298 = metadata !{i32 401, i32 0, metadata !279, null}
!3299 = metadata !{i32 64, i32 0, metadata !1405, metadata !3300}
!3300 = metadata !{i32 902, i32 0, metadata !1138, null}
!3301 = metadata !{i32 65, i32 0, metadata !1404, metadata !3300}
!3302 = metadata !{i32 66, i32 0, metadata !3176, metadata !3300}
!3303 = metadata !{i32 910, i32 0, metadata !3304, null}
!3304 = metadata !{i32 786443, metadata !801, metadata !1138, i32 910, i32 0, i32 196} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3305 = metadata !{i32 911, i32 0, metadata !3306, null}
!3306 = metadata !{i32 786443, metadata !801, metadata !3304, i32 910, i32 0, i32 197} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3307 = metadata !{i32 912, i32 0, metadata !3306, null}
!3308 = metadata !{i32 915, i32 0, metadata !1138, null}
!3309 = metadata !{i32 916, i32 0, metadata !1138, null}
!3310 = metadata !{i32 917, i32 0, metadata !1138, null}
!3311 = metadata !{i32 919, i32 0, metadata !1162, null}
!3312 = metadata !{i32 920, i32 0, metadata !1161, null}
!3313 = metadata !{i32 926, i32 0, metadata !1164, null}
!3314 = metadata !{i32 929, i32 0, metadata !3315, null}
!3315 = metadata !{i32 786443, metadata !801, metadata !1164, i32 929, i32 0, i32 202} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3316 = metadata !{i32 932, i32 0, metadata !3317, null}
!3317 = metadata !{i32 786443, metadata !801, metadata !3315, i32 929, i32 0, i32 203} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3318 = metadata !{metadata !3319, metadata !3035, i64 0}
!3319 = metadata !{metadata !"termios", metadata !3035, i64 0, metadata !3035, i64 4, metadata !3035, i64 8, metadata !3035, i64 12, metadata !2862, i64 16, metadata !2862, i64 17, metadata !3035, i64 52, metadata !3035, i64 56}
!3320 = metadata !{i32 933, i32 0, metadata !3317, null}
!3321 = metadata !{metadata !3319, metadata !3035, i64 4}
!3322 = metadata !{i32 934, i32 0, metadata !3317, null}
!3323 = metadata !{metadata !3319, metadata !3035, i64 8}
!3324 = metadata !{i32 935, i32 0, metadata !3317, null}
!3325 = metadata !{metadata !3319, metadata !3035, i64 12}
!3326 = metadata !{i32 936, i32 0, metadata !3317, null}
!3327 = metadata !{metadata !3319, metadata !2862, i64 16}
!3328 = metadata !{i32 937, i32 0, metadata !3317, null}
!3329 = metadata !{i32 938, i32 0, metadata !3317, null}
!3330 = metadata !{i32 939, i32 0, metadata !3317, null}
!3331 = metadata !{i32 940, i32 0, metadata !3317, null}
!3332 = metadata !{i32 941, i32 0, metadata !3317, null}
!3333 = metadata !{i32 942, i32 0, metadata !3317, null}
!3334 = metadata !{i32 943, i32 0, metadata !3317, null}
!3335 = metadata !{i32 944, i32 0, metadata !3317, null}
!3336 = metadata !{i32 945, i32 0, metadata !3317, null}
!3337 = metadata !{i32 946, i32 0, metadata !3317, null}
!3338 = metadata !{i32 947, i32 0, metadata !3317, null}
!3339 = metadata !{i32 948, i32 0, metadata !3317, null}
!3340 = metadata !{i32 949, i32 0, metadata !3317, null}
!3341 = metadata !{i32 950, i32 0, metadata !3317, null}
!3342 = metadata !{i32 951, i32 0, metadata !3317, null}
!3343 = metadata !{i32 952, i32 0, metadata !3317, null}
!3344 = metadata !{i32 953, i32 0, metadata !3317, null}
!3345 = metadata !{i32 954, i32 0, metadata !3317, null}
!3346 = metadata !{i32 955, i32 0, metadata !3317, null}
!3347 = metadata !{i32 956, i32 0, metadata !3317, null}
!3348 = metadata !{i32 958, i32 0, metadata !3349, null}
!3349 = metadata !{i32 786443, metadata !801, metadata !3315, i32 957, i32 0, i32 204} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3350 = metadata !{i32 959, i32 0, metadata !3349, null}
!3351 = metadata !{i32 1041, i32 0, metadata !1195, null}
!3352 = metadata !{i32 1042, i32 0, metadata !3353, null}
!3353 = metadata !{i32 786443, metadata !801, metadata !1195, i32 1042, i32 0, i32 234} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3354 = metadata !{i32 1043, i32 0, metadata !3353, null}
!3355 = metadata !{i32 1046, i32 0, metadata !1138, null}
!3356 = metadata !{i32 68, i32 0, metadata !1447, null}
!3357 = metadata !{i32 71, i32 0, metadata !1446, null}
!3358 = metadata !{i32 72, i32 0, metadata !1446, null}
!3359 = metadata !{i32 73, i32 0, metadata !1446, null}
!3360 = metadata !{i32 74, i32 0, metadata !1446, null}
!3361 = metadata !{i32 133, i32 0, metadata !3362, metadata !3363}
!3362 = metadata !{i32 786443, metadata !801, metadata !862, i32 133, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3363 = metadata !{i32 76, i32 0, metadata !1436, null}
!3364 = metadata !{i32 134, i32 0, metadata !3365, metadata !3363}
!3365 = metadata !{i32 786443, metadata !801, metadata !3362, i32 134, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3366 = metadata !{i32 136, i32 0, metadata !3367, metadata !3363}
!3367 = metadata !{i32 786443, metadata !801, metadata !862, i32 136, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3368 = metadata !{i32 137, i32 0, metadata !3369, metadata !3363}
!3369 = metadata !{i32 786443, metadata !801, metadata !3367, i32 136, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3370 = metadata !{i32 138, i32 0, metadata !3369, metadata !3363}
!3371 = metadata !{i32 141, i32 0, metadata !862, metadata !3363}
!3372 = metadata !{i32 144, i32 0, metadata !862, metadata !3363}
!3373 = metadata !{i32 1417, i32 0, metadata !1379, metadata !3374}
!3374 = metadata !{i32 1429, i32 0, metadata !1360, metadata !3375}
!3375 = metadata !{i32 181, i32 0, metadata !883, metadata !3363}
!3376 = metadata !{i32 1418, i32 0, metadata !1379, metadata !3374}
!3377 = metadata !{i32 1432, i32 0, metadata !1369, metadata !3375}
!3378 = metadata !{i32 1433, i32 0, metadata !1368, metadata !3375}
!3379 = metadata !{i32 1434, i32 0, metadata !1372, metadata !3375}
!3380 = metadata !{i32 1435, i32 0, metadata !3060, metadata !3375}
!3381 = metadata !{i32 1436, i32 0, metadata !3063, metadata !3375}
!3382 = metadata !{i32 1437, i32 0, metadata !3063, metadata !3375}
!3383 = metadata !{i32 1439, i32 0, metadata !3066, metadata !3375}
!3384 = metadata !{i32 1440, i32 0, metadata !3066, metadata !3375}
!3385 = metadata !{i32 1442, i32 0, metadata !1371, metadata !3375}
!3386 = metadata !{i32 1443, i32 0, metadata !1371, metadata !3375}
!3387 = metadata !{i32 1444, i32 0, metadata !1371, metadata !3375}
!3388 = metadata !{i32 1445, i32 0, metadata !3073, metadata !3375}
!3389 = metadata !{i32 182, i32 0, metadata !3390, metadata !3363}
!3390 = metadata !{i32 786443, metadata !801, metadata !883, i32 182, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3391 = metadata !{i32 183, i32 0, metadata !3392, metadata !3363}
!3392 = metadata !{i32 786443, metadata !801, metadata !3390, i32 182, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3393 = metadata !{i32 184, i32 0, metadata !3392, metadata !3363}
!3394 = metadata !{i32 186, i32 0, metadata !883, metadata !3363}
!3395 = metadata !{i32 190, i32 0, metadata !3396, metadata !3363}
!3396 = metadata !{i32 786443, metadata !801, metadata !862, i32 190, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3397 = metadata !{i32 189, i32 0, metadata !862, metadata !3363}
!3398 = metadata !{i32 191, i32 0, metadata !3399, metadata !3363}
!3399 = metadata !{i32 786443, metadata !801, metadata !3396, i32 190, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3400 = metadata !{i32 192, i32 0, metadata !3399, metadata !3363}
!3401 = metadata !{i32 193, i32 0, metadata !3402, metadata !3363}
!3402 = metadata !{i32 786443, metadata !801, metadata !3403, i32 192, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3403 = metadata !{i32 786443, metadata !801, metadata !3396, i32 192, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3404 = metadata !{i32 194, i32 0, metadata !3402, metadata !3363}
!3405 = metadata !{i32 195, i32 0, metadata !3406, metadata !3363}
!3406 = metadata !{i32 786443, metadata !801, metadata !3403, i32 194, i32 0, i32 25} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3407 = metadata !{i32 48, i32 0, metadata !1841, null}
!3408 = metadata !{i32 50, i32 0, metadata !1841, null}
!3409 = metadata !{i32 51, i32 0, metadata !3410, null}
!3410 = metadata !{i32 786443, metadata !1798, metadata !1841, i32 51, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd_init.c]
!3411 = metadata !{i32 53, i32 0, metadata !1841, null}
!3412 = metadata !{i32 52, i32 0, metadata !3410, null}
!3413 = metadata !{i32 55, i32 0, metadata !1841, null}
!3414 = metadata !{i32 57, i32 0, metadata !1841, null}
!3415 = metadata !{metadata !3042, metadata !3035, i64 0}
!3416 = metadata !{i32 58, i32 0, metadata !1841, null} ; [ DW_TAG_imported_module ]
!3417 = metadata !{metadata !3042, metadata !2867, i64 8}
!3418 = metadata !{i32 59, i32 0, metadata !1841, null}
!3419 = metadata !{i32 61, i32 0, metadata !1841, null}
!3420 = metadata !{i32 64, i32 0, metadata !3421, null}
!3421 = metadata !{i32 786443, metadata !1798, metadata !1841, i32 64, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd_init.c]
!3422 = metadata !{i32 66, i32 0, metadata !3421, null}
!3423 = metadata !{i32 71, i32 0, metadata !1841, null}
!3424 = metadata !{i32 75, i32 0, metadata !1841, null}
!3425 = metadata !{metadata !3044, metadata !3045, i64 56}
!3426 = metadata !{i32 77, i32 0, metadata !1841, null}
!3427 = metadata !{metadata !3044, metadata !3035, i64 24}
!3428 = metadata !{i32 78, i32 0, metadata !1841, null}
!3429 = metadata !{metadata !3044, metadata !3045, i64 0}
!3430 = metadata !{i32 79, i32 0, metadata !1841, null}
!3431 = metadata !{metadata !3044, metadata !3045, i64 40}
!3432 = metadata !{i32 80, i32 0, metadata !1841, null}
!3433 = metadata !{i32 81, i32 0, metadata !1841, null}
!3434 = metadata !{i32 82, i32 0, metadata !1841, null}
!3435 = metadata !{i32 83, i32 0, metadata !1841, null}
!3436 = metadata !{i32 84, i32 0, metadata !1841, null}
!3437 = metadata !{i32 85, i32 0, metadata !1841, null}
!3438 = metadata !{metadata !3044, metadata !3035, i64 28}
!3439 = metadata !{i32 86, i32 0, metadata !1841, null}
!3440 = metadata !{i32 87, i32 0, metadata !1841, null}
!3441 = metadata !{i32 88, i32 0, metadata !1841, null}
!3442 = metadata !{i32 89, i32 0, metadata !1841, null}
!3443 = metadata !{i32 90, i32 0, metadata !1841, null}
!3444 = metadata !{i32 92, i32 0, metadata !1841, null}
!3445 = metadata !{metadata !3044, metadata !3045, i64 48}
!3446 = metadata !{i32 93, i32 0, metadata !1841, null}
!3447 = metadata !{metadata !3044, metadata !3045, i64 64}
!3448 = metadata !{i32 94, i32 0, metadata !1841, null}
!3449 = metadata !{i32 95, i32 0, metadata !1841, null}
!3450 = metadata !{i32 24, i32 0, metadata !2061, null}
!3451 = metadata !{i32 65, i32 0, metadata !2032, null}
!3452 = metadata !{i32 66, i32 0, metadata !2032, null}
!3453 = metadata !{i32 67, i32 0, metadata !2032, null}
!3454 = metadata !{i32 69, i32 0, metadata !3455, null}
!3455 = metadata !{i32 786443, metadata !1986, metadata !2032, i32 69, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/klee_init_env.c]
!3456 = metadata !{i32 70, i32 0, metadata !3455, null}
!3457 = metadata !{i32 50, i32 0, metadata !2040, metadata !3456}
!3458 = metadata !{i32 72, i32 0, metadata !2032, null}
!3459 = metadata !{i32 73, i32 0, metadata !2032, null}
!3460 = metadata !{i32 13, i32 0, metadata !3461, null}
!3461 = metadata !{i32 786443, metadata !2754, metadata !2753, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_div_zero_check.c]
!3462 = metadata !{i32 14, i32 0, metadata !3461, null}
!3463 = metadata !{i32 15, i32 0, metadata !2753, null}
!3464 = metadata !{i32 15, i32 0, metadata !2764, null}
!3465 = metadata !{i32 16, i32 0, metadata !2764, null}
!3466 = metadata !{i32 21, i32 0, metadata !3467, null}
!3467 = metadata !{i32 786443, metadata !2774, metadata !2773, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_overshift_check.c]
!3468 = metadata !{i32 27, i32 0, metadata !3469, null}
!3469 = metadata !{i32 786443, metadata !2774, metadata !3467, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_overshift_check.c]
!3470 = metadata !{i32 29, i32 0, metadata !2773, null}
!3471 = metadata !{i32 16, i32 0, metadata !3472, null}
!3472 = metadata !{i32 786443, metadata !2785, metadata !2784, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3473 = metadata !{i32 17, i32 0, metadata !3472, null}
!3474 = metadata !{i32 19, i32 0, metadata !3475, null}
!3475 = metadata !{i32 786443, metadata !2785, metadata !2784, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3476 = metadata !{i32 22, i32 0, metadata !3477, null}
!3477 = metadata !{i32 786443, metadata !2785, metadata !3475, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3478 = metadata !{i32 25, i32 0, metadata !3479, null}
!3479 = metadata !{i32 786443, metadata !2785, metadata !3477, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3480 = metadata !{i32 26, i32 0, metadata !3481, null}
!3481 = metadata !{i32 786443, metadata !2785, metadata !3479, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3482 = metadata !{i32 27, i32 0, metadata !3481, null}
!3483 = metadata !{i32 28, i32 0, metadata !3484, null}
!3484 = metadata !{i32 786443, metadata !2785, metadata !3479, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3485 = metadata !{i32 29, i32 0, metadata !3484, null}
!3486 = metadata !{i32 32, i32 0, metadata !3477, null}
!3487 = metadata !{i32 34, i32 0, metadata !2784, null}
!3488 = metadata !{i32 16, i32 0, metadata !2797, null}
!3489 = metadata !{i32 17, i32 0, metadata !2797, null}
!3490 = metadata !{metadata !3490, metadata !3491, metadata !3492}
!3491 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!3492 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!3493 = metadata !{metadata !3493, metadata !3491, metadata !3492}
!3494 = metadata !{i32 18, i32 0, metadata !2797, null}
!3495 = metadata !{i32 16, i32 0, metadata !3496, null}
!3496 = metadata !{i32 786443, metadata !2813, metadata !2812, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3497 = metadata !{i32 19, i32 0, metadata !3498, null}
!3498 = metadata !{i32 786443, metadata !2813, metadata !2812, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3499 = metadata !{i32 20, i32 0, metadata !3500, null}
!3500 = metadata !{i32 786443, metadata !2813, metadata !3498, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3501 = metadata !{metadata !3501, metadata !3491, metadata !3492}
!3502 = metadata !{metadata !3502, metadata !3491, metadata !3492}
!3503 = metadata !{i32 22, i32 0, metadata !3504, null}
!3504 = metadata !{i32 786443, metadata !2813, metadata !3498, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3505 = metadata !{i32 24, i32 0, metadata !3504, null}
!3506 = metadata !{i32 23, i32 0, metadata !3504, null}
!3507 = metadata !{metadata !3507, metadata !3491, metadata !3492}
!3508 = metadata !{metadata !3508, metadata !3491, metadata !3492}
!3509 = metadata !{i32 28, i32 0, metadata !2812, null}
!3510 = metadata !{i32 15, i32 0, metadata !2827, null}
!3511 = metadata !{i32 16, i32 0, metadata !2827, null}
!3512 = metadata !{metadata !3512, metadata !3491, metadata !3492}
!3513 = metadata !{metadata !3513, metadata !3491, metadata !3492}
!3514 = metadata !{i32 17, i32 0, metadata !2827, null}
!3515 = metadata !{i32 13, i32 0, metadata !2842, null}
!3516 = metadata !{i32 14, i32 0, metadata !2842, null}
!3517 = metadata !{i32 15, i32 0, metadata !2842, null}
