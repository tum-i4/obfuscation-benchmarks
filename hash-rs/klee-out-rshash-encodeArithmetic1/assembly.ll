; ModuleID = './rshash-encodeArithmetic1.bc'
...
__str_to_int.exit45.i:                            ; preds = %145
  ...
  br i1 %156, label %.lr.ph.i2, label %__streq.exit.thread.backedge.i, !dbg !2865

.lr.ph.i2:                                        ; preds = %__str_to_int.exit45.i
  %157 = sext i32 %23 to i64
  br label %158, !dbg !2865

; <label>:158                                     ; preds = %__add_arg.exit46.i, %.lr.ph.i2
  %indvars.iv.i = phi i64 [ %157, %.lr.ph.i2 ], [ %indvars.iv.next.i, %__add_arg.exit46.i ]
  %i.0151.i = phi i32 [ 0, %.lr.ph.i2 ], [ %169, %__add_arg.exit46.i ]
  %sym_arg_num.1150.i = phi i32 [ %sym_arg_num.0294.i, %.lr.ph.i2 ], [ %166, %__add_arg.exit46.i ]
  %159 = phi i32 [ %23, %.lr.ph.i2 ], [ %168, %__add_arg.exit46.i ]
...
strlen.exit:                                      ; preds = %434
  ...
  %442 = xor i32 %441, -2147483648
  %443 = sub i32 0, %441
  %444 = and i32 %442, %443
  %445 = or i32 %444, %441
  %446 = icmp slt i32 %445, 0
  br i1 %446, label %.lr.ph.i, label %RSHash.exit.thread

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.04.i = phi i8* [ %468, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.03.i = phi i32 [ %472, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.02.i = phi i32 [ %460, %.lr.ph.i ], [ 0, %strlen.exit ]
  %a.01.i = phi i32 [ %467, %.lr.ph.i ], [ 63689, %strlen.exit ]
  %447 = and i32 %a.01.i, %hash.02.i
  %448 = or i32 %a.01.i, %hash.02.i
  %449 = mul i32 %447, %448
  %450 = xor i32 %a.01.i, -1
  %451 = and i32 %hash.02.i, %450
  %452 = xor i32 %hash.02.i, -1
  %453 = and i32 %a.01.i, %452
  %454 = mul i32 %451, %453
  %455 = add i32 %449, %454
  %456 = load i8* %.04.i, align 1
  %457 = sext i8 %456 to i32
  %458 = or i32 %455, %457
  %459 = and i32 %455, %457
  %460 = add i32 %459, %458
  %461 = and i32 %a.01.i, 378551
  %462 = or i32 %a.01.i, 378551
  %463 = mul i32 %461, %462
  %464 = and i32 %a.01.i, -378552
  %465 = xor i32 %461, 378551
  %466 = mul i32 %465, %464
  %467 = add i32 %466, %463
  %468 = getelementptr inbounds i8* %.04.i, i64 1
  %469 = shl i32 %i.03.i, 1
  %470 = or i32 %469, 2
  %471 = xor i32 %i.03.i, 1
  %472 = sub i32 %470, %471
  %473 = xor i32 %472, -2147483648
  %474 = and i32 %473, %441
  %475 = xor i32 %472, %442
  %476 = sub i32 %472, %441
  %477 = and i32 %476, %475
  ...
  br i1 %479, label %.lr.ph.i, label %RSHash.exit

RSHash.exit:                                      ; preds = %.lr.ph.i
  %480 = icmp eq i32 %460, 1294241610
  br i1 %480, label %481, label %RSHash.exit.thread

; <label>:481                                     ; preds = %RSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %482

RSHash.exit.thread:                               ; preds = %strlen.exit, %RSHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %482

; <label>:482                                     ; preds = %RSHash.exit.thread, %481
  ret i32 0
}
