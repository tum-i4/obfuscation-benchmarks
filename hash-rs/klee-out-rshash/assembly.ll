...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %RSHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.04.i = phi i8* [ %448, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.03.i = phi i32 [ %449, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.02.i = phi i32 [ %446, %.lr.ph.i ], [ 0, %strlen.exit ]
  %a.01.i = phi i32 [ %447, %.lr.ph.i ], [ 63689, %strlen.exit ]
  %443 = mul i32 %a.01.i, %hash.02.i
  %444 = load i8* %.04.i, align 1
  %445 = sext i8 %444 to i32
  %446 = add i32 %445, %443
  %447 = mul i32 %a.01.i, 378551
  %448 = getelementptr inbounds i8* %.04.i, i64 1
  %449 = add i32 %i.03.i, 1
  %exitcond.i = icmp eq i32 %449, %441
  br i1 %exitcond.i, label %RSHash.exit, label %.lr.ph.i

RSHash.exit:                                      ; preds = %.lr.ph.i
  %450 = icmp eq i32 %446, 1294241610
  br i1 %450, label %451, label %RSHash.exit.thread

; <label>:451                                     ; preds = %RSHash.exit
...
; <label>:452                                     ; preds = %RSHash.exit.thread, %451
  ret i32 0
}
