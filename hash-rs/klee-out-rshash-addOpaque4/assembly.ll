...
define internal fastcc i32 @RSHash(i8* nocapture readonly %str, i32 %len) #2 {
  ...
  br i1 %3, label %.lr.ph, label %._crit_edge.us-lcssa
...
.lr.ph:                                           ; preds = %0
  ...
  %6 = icmp eq %struct._1_main__opaque_Node_1* %4, %5
  br i1 %6, label %.lr.ph.split.us, label %.lr.ph..lr.ph.split_crit_edge

.lr.ph.split.us:                                  ; preds = %.lr.ph, %10
  %7 = phi %struct._1_main__opaque_Node_1* [ %4, %10 ], [ %1, %.lr.ph ]
  %.018.us = phi i8* [ %16, %10 ], [ %str, %.lr.ph ]
  %i.07.us = phi i32 [ %17, %10 ], [ 0, %.lr.ph ]
  %a.06.us = phi i32 [ %15, %10 ], [ 63689, %.lr.ph ]
  %hash.05.us = phi i32 [ %14, %10 ], [ 0, %.lr.ph ]
  %8 = icmp eq %struct._1_main__opaque_Node_1* %7, null
  %9 = icmp ult i32 %i.07.us, %len
  %or.cond.us = or i1 %8, %9
  br i1 %or.cond.us, label %10, label %.us-lcssa.us

; <label>:10                                      ; preds = %.lr.ph.split.us
  %11 = mul i32 %a.06.us, %hash.05.us
  %12 = load i8* %.018.us, align 1
  %13 = sext i8 %12 to i32
  %14 = add i32 %13, %11
  %15 = mul i32 %a.06.us, 378551
  %16 = getelementptr inbounds i8* %.018.us, i64 1
  %17 = add i32 %i.07.us, 1
  br label %.lr.ph.split.us

._crit_edge.us-lcssa:                             ; preds = %.lr.ph..lr.ph.split_crit_edge, %0
  %.lcssa = phi %struct._1_main__opaque_Node_1* [ %1, %0 ], [ %4, %.lr.ph..lr.ph.split_crit_edge ]
  %18 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %19 = icmp eq %struct._1_main__opaque_Node_1* %.lcssa, %18
  br i1 %19, label %.preheader, label %20

; <label>:20                                      ; preds = %._crit_edge.us-lcssa
  %21 = tail call fastcc i32 @RSHash(i8* null, i32 %len)
  br label %.preheader

.preheader:                                       ; preds = %20, %._crit_edge.us-lcssa, %.preheader
  br label %.preheader

.lr.ph..lr.ph.split_crit_edge:                    ; preds = %.lr.ph
  %22 = icmp eq %struct._1_main__opaque_Node_1* %1, null
  %23 = icmp ne i32 %len, 0
  %or.cond = or i1 %22, %23
  br i1 %or.cond, label %._crit_edge.us-lcssa, label %.us-lcssa.us

.us-lcssa.us:                                     ; preds = %.lr.ph.split.us, %.lr.ph..lr.ph.split_crit_edge
  %hash.0.lcssa3 = phi i32 [ 0, %.lr.ph..lr.ph.split_crit_edge ], [ %hash.05.us, %.lr.ph.split.us ]
...
; <label>:27                                      ; preds = %.us-lcssa.us
  tail call void asm sideeffect ".byte 0x48", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3157
  br label %28

; <label>:28                                      ; preds = %.us-lcssa.us, %27
  ret i32 %hash.0.lcssa3
}
