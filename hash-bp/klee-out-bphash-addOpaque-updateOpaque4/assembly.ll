; ModuleID = './bphash-addOpaque-updateOpaque4.bc'
...
define internal fastcc i32 @BPHash(i8* %str, i32 %len) #0 {
  %1 = alloca i8*, align 8
...
; <label>:13                                      ; preds = %0
  %14 = call fastcc i32 @BPHash(i8* null, i32 %len)
  br label %.preheader

.preheader:                                       ; preds = %13, %0
  %hash.0.ph = phi i32 [ 0, %0 ], [ %14, %13 ]
  %15 = icmp eq i32 %len, 0
  br i1 %15, label %._crit_edge, label %.lr.ph

._crit_edge:                                      ; preds = %.lr.ph, %.preheader
  %hash.0.lcssa = phi i32 [ %hash.0.ph, %.preheader ], [ %50, %.lr.ph ]
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %46 = phi i8* [ %51, %.lr.ph ], [ %str, %.preheader ]
  %hash.02 = phi i32 [ %50, %.lr.ph ], [ %hash.0.ph, %.preheader ]
  %i.01 = phi i32 [ %52, %.lr.ph ], [ 0, %.preheader ]
  %47 = shl i32 %hash.02, 7
  %48 = load i8* %46, align 1
  %49 = sext i8 %48 to i32
  %50 = xor i32 %49, %47
  %51 = getelementptr inbounds i8* %46, i64 1
  store i8* %51, i8** %1, align 8
  %52 = add i32 %i.01, 1
  %exitcond = icmp eq i32 %52, %len
