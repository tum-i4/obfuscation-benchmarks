; ModuleID = './bphash-addOpaque16.bc'
...
.preheader17:                                     ; preds = %0, %5, %.loopexit16
  %6 = phi i8* [ %73, %.loopexit16 ], [ %str, %5 ], [ %str, %0 ]
  %i.0 = phi i32 [ %74, %.loopexit16 ], [ 0, %5 ], [ 0, %0 ]
  %hash.0 = phi i32 [ %72, %.loopexit16 ], [ 0, %5 ], [ 0, %0 ]
...
; <label>:24                                      ; preds = %.preheader.split.us
  %25 = call fastcc i32 @BPHash(i8* null, i32 %len)
  br label %26
...
; <label>:35                                      ; preds = %.preheader..preheader.split_crit_edge
  %36 = call fastcc i32 @BPHash(i8* null, i32 %len)
...
; <label>:40                                      ; preds = %.backedge8
  %41 = call fastcc i32 @BPHash(i8* null, i32 %len)
  br label %42
...
; <label>:48                                      ; preds = %47
  ...
  br i1 %51, label %75, label %.loopexit10
...
; <label>:60                                      ; preds = %56
  %61 = add i32 %i.1, -6
  %62 = call fastcc i32 @BPHash(i8* null, i32 %61)
...
; <label>:67                                      ; preds = %63
  %68 = call fastcc i32 @BPHash(i8* null, i32 %i.0)
  br label %.loopexit16

.loopexit16:                                      ; preds = %56, %63, %67
  %i.2 = phi i32 [ %68, %67 ], [ %i.0, %63 ], [ %i.1, %56 ]
  %69 = shl i32 %hash.0, 7
  %70 = load i8* %6, align 1
  %71 = sext i8 %70 to i32
  %72 = xor i32 %71, %69
  %73 = getelementptr inbounds i8* %6, i64 1
...
; <label>:78                                      ; preds = %75
  %79 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %80
...
!3157 = metadata !{i32 3347}
!3158 = metadata !{i32 4635}
!3159 = metadata !{i32 4530}
!3160 = metadata !{i32 3989}
!3161 = metadata !{i32 5424}
!3162 = metadata !{i32 7169}
!3163 = metadata !{i32 7291}
