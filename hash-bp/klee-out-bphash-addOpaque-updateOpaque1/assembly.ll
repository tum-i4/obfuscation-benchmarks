; ModuleID = './bphash-addOpaque-updateOpaque1.bc'
...
._crit_edge:                                      ; preds = %.lr.ph, %5
  %hash.0.lcssa = phi i32 [ 0, %5 ], [ %16, %.lr.ph ]
...
.lr.ph:                                           ; preds = %5, %.lr.ph
  %.04 = phi i8* [ %17, %.lr.ph ], [ %str, %5 ]
  %hash.03 = phi i32 [ %16, %.lr.ph ], [ 0, %5 ]
  %i.02 = phi i32 [ %18, %.lr.ph ], [ 0, %5 ]
  %13 = shl i32 %hash.03, 7
  %14 = load i8* %.04, align 1
  %15 = sext i8 %14 to i32
  %16 = xor i32 %15, %13
  %17 = getelementptr inbounds i8* %.04, i64 1
  %18 = add i32 %i.02, 1
  %exitcond = icmp eq i32 %18, %.01
