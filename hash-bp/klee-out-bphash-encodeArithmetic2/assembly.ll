; ModuleID = './bphash-encodeArithmetic2.bc'
...
; <label>:442                                     ; preds = %463, %strlen.exit
  %hash.0.i = phi i32 [ 0, %strlen.exit ], [ %488, %463 ]
  %i.0.i = phi i32 [ 0, %strlen.exit ], [ %500, %463 ]
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %489, %463 ]
  ...
  br i1 %462, label %463, label %BPHash.exit

; <label>:463                                     ; preds = %442
  %464 = shl i32 %hash.0.i, 7
  %465 = load i8* %.0.i, align 1
  %466 = sext i8 %465 to i32
  %.demorgan.i = and i32 %466, %464
  %467 = xor i32 %.demorgan.i, -1
  %468 = or i32 %464, 1
  %469 = add i32 %468, %466
  %470 = add i32 %469, %467
  %471 = xor i32 %464, -1
  ...
  %475 = sub i32 %474, %471
  %476 = xor i32 %475, %470
  %.demorgan1.i = and i32 %473, %464
  %477 = xor i32 %.demorgan1.i, 2147483647
  %478 = add i32 %468, %473
  %479 = add i32 %478, %477
  %480 = xor i32 %479, 2147483647
  %481 = xor i32 %464, 2147483647
  %482 = load i8* %.0.i, align 1
  ...
  %487 = shl i32 %486, 1
  %488 = sub i32 %476, %487
  %489 = getelementptr inbounds i8* %.0.i, i64 1
  %490 = shl i32 %i.0.i, 1
  %491 = or i32 %490, 2
  %492 = sub i32 %i.0.i, %491
  %493 = or i32 %490, %492
  %494 = or i32 %493, 2
  %495 = and i32 %492, %491
  %496 = add i32 %494, %495
...
BPHash.exit:                                      ; preds = %442
  %501 = icmp eq i32 %hash.0.i, 1543172857
  br i1 %501, label %502, label %503

; <label>:502                                     ; preds = %BPHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %504

; <label>:503                                     ; preds = %BPHash.exit
