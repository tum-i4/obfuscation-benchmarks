...
@"_2_BPHash_$array" = internal unnamed_addr constant [1 x [8684 x i8]] [[8684 x i8] c"\BD\10\00\00\00\03\00\00\00\00\00\00\00\00\81\00\00\00\00\00\00\00\00\81\08\00\00\00\00\00\00\005\05\0F\BD\18\00\00\00\03\00\00\00\00\00\00\00\00\81\00\00\00\00\00\00\0
@"_1_BPHash_$array" = internal global [1 x [157 x i8]] [[157 x i8] c"U\0C\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\10\00\00\00\07\D6l\0E\00\00\00:\04\00\00\00:X\00\00\00U\0C\
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_BPHash_$locals.i" = alloca [308 x i8], align 16
  %"_2_BPHash_$stack.i" = alloca [1 x [32 x %"union._2_BPHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [308 x i8]* %"_2_BPHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_BPHash_$node"]]* %"_2_BPHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_BPHash_$node"]]* %"_2_BPHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %714, %705, %699, %690, %684, %676, %667, %660, %652, %643, %640, %632, %615, %608, %600, %592, %586, %583, %574, %559, %550, %544, %535, %529, %523, %517, %509, %507, %505, %498, %496, %494, %4
  %"_2_BPHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [8684 x i8]]* @"_2_BPHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_BPHash_$pc.0.0.i", %.backedge.i ], [ %722, %714 ], [ %706, %705 ], [ %700, %699 ], [ %691, %690 ], [ %685, %
  %"_2_BPHash_$sp.0.0.i" = phi %"union._2_BPHash_$node"* [ %448, %strlen.exit ], [ %"_2_BPHash_$sp.0.0.i", %.backedge.i ], [ %721, %714 ], [ %709, %705 ], [ %"_2_BPHash_$sp.0.0.i", %699 ], [ %692, %690 ], [ %"_2_BPHash_$sp.0.0.i", %684 ], [ %678, %676 ],
  %449 = load i8* %"_2_BPHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %453 = bitcast i8* %452 to i32*
  %454 = load i32* %453, align 4
  %455 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1
  %456 = bitcast %"union._2_BPHash_$node"* %455 to i32*
  store i32 %454, i32* %456, align 4
  %457 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:458                                     ; preds = %.backedge.i
  %459 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %460 = bitcast i8* %459 to i8**
  %461 = load i8** %460, align 8
  %462 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* %461, i8** %462, align 8
  %463 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1
  %464 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:465                                     ; preds = %.backedge.i
  %466 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %467 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %468 = bitcast %"union._2_BPHash_$node"* %467 to i32*
  %469 = load i32* %468, align 4
  %470 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
...
; <label>:473                                     ; preds = %.backedge.i
  %474 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %475 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1, i32 0
  %476 = load i8** %475, align 8
  %477 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  %478 = load i32* %477, align 4
  %479 = sext i32 %478 to i64
  %480 = getelementptr i8* %476, i64 %479
  store i8* %480, i8** %475, align 8
  %481 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:482                                     ; preds = %.backedge.i
  %483 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  %484 = load i32* %483, align 4
  %485 = icmp eq i32 %484, 0
  br i1 %485, label %492, label %486

; <label>:486                                     ; preds = %482
  %487 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %488 = bitcast i8* %487 to i32*
  %489 = load i32* %488, align 4
  %490 = sext i32 %489 to i64
  %.sum9.i = add i64 %490, 1
  %491 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 %.sum9.i
  br label %494

; <label>:492                                     ; preds = %482
  %493 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 5
  br label %494

; <label>:494                                     ; preds = %492, %486
  %"_2_BPHash_$pc.0.1.i" = phi i8* [ %493, %492 ], [ %491, %486 ]
  %495 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:496                                     ; preds = %.backedge.i
  %497 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:498                                     ; preds = %.backedge.i
  %499 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %500 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %501 = load i8** %500, align 8
  %502 = bitcast i8* %501 to i32*
  %503 = load i32* %502, align 4
  %504 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  store i32 %503, i32* %504, align 4
  br label %.backedge.i

; <label>:505                                     ; preds = %.backedge.i
  %506 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:507                                     ; preds = %.backedge.i
  %508 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:509                                     ; preds = %.backedge.i
  %510 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %511 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %512 = bitcast %"union._2_BPHash_$node"* %511 to i32*
  %513 = load i32* %512, align 4
  %514 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
...
; <label>:517                                     ; preds = %.backedge.i
  %518 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %519 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  %520 = load i32* %519, align 4
  %521 = sext i32 %520 to i64
  %522 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %.c4.i = inttoptr i64 %521 to i8*
  store i8* %.c4.i, i8** %522, align 8
  br label %.backedge.i

; <label>:523                                     ; preds = %.backedge.i
  %524 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %525 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %526 = load i8** %525, align 8
  %527 = load i8* %526, align 1
  %528 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i8*
  store i8 %527, i8* %528, align 1
  br label %.backedge.i

; <label>:529                                     ; preds = %.backedge.i
  %530 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %531 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %532 = load i8** %531, align 8
  %533 = bitcast i8* %532 to i8**
  %534 = load i8** %533, align 8
  store i8* %534, i8** %531, align 8
  br label %.backedge.i

; <label>:535                                     ; preds = %.backedge.i
  %536 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %537 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %538 = bitcast %"union._2_BPHash_$node"* %537 to i32*
  %539 = load i32* %538, align 4
  %540 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %541 = load i8** %540, align 8
  %542 = bitcast i8* %541 to i32*
  store i32 %539, i32* %542, align 4
  %543 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:544                                     ; preds = %.backedge.i
  %545 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %546 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %547 = load i8** %546, align 8
  %548 = load i8* %547, align 1
  %549 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i8*
  store i8 %548, i8* %549, align 1
  br label %.backedge.i

; <label>:550                                     ; preds = %.backedge.i
  %551 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %552 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %553 = bitcast %"union._2_BPHash_$node"* %552 to i32*
  %554 = load i32* %553, align 4
  %555 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
...
; <label>:559                                     ; preds = %.backedge.i
  %560 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %561 = bitcast i8* %560 to i32*
  %562 = load i32* %561, align 4
  %563 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1
  %564 = bitcast %"union._2_BPHash_$node"* %563 to i32*
  store i32 %562, i32* %564, align 4
  %565 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:566                                     ; preds = %.backedge.i
  %567 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
...
; <label>:570                                     ; preds = %566
  %571 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %571, align 8
  br label %574

; <label>:572                                     ; preds = %566
  %573 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %573, align 8
  br label %574

; <label>:574                                     ; preds = %572, %570, %566
  %575 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1
  %576 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:577                                     ; preds = %.backedge.i
  %578 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %579 = bitcast i8* %578 to i32*
  %580 = load i32* %579, align 4
  %cond.i = icmp eq i32 %580, 0
  br i1 %cond.i, label %581, label %583

; <label>:581                                     ; preds = %577
  %582 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [157 x i8]]* @"_1_BPHash_$array", i64 0, i64 0, i64 0), i8** %582, align 8
  br label %583

; <label>:583                                     ; preds = %581, %577
  %584 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1
  %585 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:586                                     ; preds = %.backedge.i
  %587 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %588 = bitcast i8* %587 to i32*
  %589 = load i32* %588, align 4
  %590 = sext i32 %589 to i64
  %.sum3.i = add i64 %590, 1
  %591 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 %.sum3.i
  br label %.backedge.i

; <label>:592                                     ; preds = %.backedge.i
  %593 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %594 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %595 = load i8** %594, align 8
  %596 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1, i32 0
  %597 = load i8** %596, align 8
  %598 = bitcast i8* %597 to i8**
  store i8* %595, i8** %598, align 8
  %599 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:600                                     ; preds = %.backedge.i
  %601 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %602 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  %603 = load i32* %602, align 4
  %604 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1, i32 0
  %605 = load i8** %604, align 8
  %606 = bitcast i8* %605 to i32*
  store i32 %603, i32* %606, align 4
  %607 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:608                                     ; preds = %.backedge.i
  %609 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %610 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %611 = load i8** %610, align 8
  %612 = bitcast i8* %611 to i32*
  %613 = load i32* %612, align 4
  %614 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  store i32 %613, i32* %614, align 4
  br label %.backedge.i

; <label>:615                                     ; preds = %.backedge.i
  %616 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %617 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i8*
  %618 = load i8* %617, align 1
  %619 = sext i8 %618 to i32
  %620 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  store i32 %619, i32* %620, align 4
  br label %.backedge.i

; <label>:621                                     ; preds = %.backedge.i
  %622 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %623 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  %624 = load i32* %623, align 4
  %625 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %626 = bitcast i8* %622 to i32*
  %627 = load i32* %626, align 4
  %628 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 9
  %629 = bitcast i8* %628 to i32*
  %630 = load i32* %629, align 4
  %631 = icmp slt i32 %624, %627
  br i1 %631, label %632, label %635

; <label>:632                                     ; preds = %621
  %633 = sext i32 %630 to i64
  %.sum8.i = add i64 %633, 1
  %634 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:635                                     ; preds = %621
  %636 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 5
  %637 = bitcast i8* %636 to i32*
  %638 = load i32* %637, align 4
  %639 = icmp sgt i32 %624, %638
  br i1 %639, label %640, label %643

; <label>:640                                     ; preds = %635
  %641 = sext i32 %630 to i64
  %.sum7.i = add i64 %641, 1
  %642 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:643                                     ; preds = %635
  %644 = sub nsw i32 %624, %627
  %645 = shl nsw i32 %644, 2
  %646 = sext i32 %645 to i64
  %.sum5.i = add i64 %646, 13
  %647 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 %.sum5.i
  %648 = bitcast i8* %647 to i32*
  %649 = load i32* %648, align 4
  %650 = sext i32 %649 to i64
  %.sum6.i = add i64 %650, 1
  %651 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 %.sum6.i
  br label %.backedge.i

; <label>:652                                     ; preds = %.backedge.i
  %653 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %654 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %655 = bitcast %"union._2_BPHash_$node"* %654 to i8*
  %656 = load i8* %655, align 1
  %657 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %658 = load i8** %657, align 8
  store i8 %656, i8* %658, align 1
  %659 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:660                                     ; preds = %.backedge.i
  %661 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %662 = bitcast i8* %661 to i64*
  %663 = load i64* %662, align 8
  %664 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1, i32 0
  %.c2.i = inttoptr i64 %663 to i8*
  store i8* %.c2.i, i8** %664, align 8
  %665 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1
  %666 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:667                                     ; preds = %.backedge.i
  %668 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %669 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %670 = bitcast %"union._2_BPHash_$node"* %669 to i64*
  %671 = load i64* %670, align 8
  %672 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %673 = load i8** %672, align 8
  %674 = bitcast i8* %673 to i64*
  store i64 %671, i64* %674, align 8
  %675 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:676                                     ; preds = %.backedge.i
  %677 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %678 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %679 = bitcast %"union._2_BPHash_$node"* %678 to i32*
  %680 = load i32* %679, align 4
  %681 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
...
; <label>:684                                     ; preds = %.backedge.i
  %685 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %686 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %687 = load i8** %686, align 8
  %688 = bitcast i8* %687 to i64*
  %689 = load i64* %688, align 8
  %.c1.i = inttoptr i64 %689 to i8*
  store i8* %.c1.i, i8** %686, align 8
  br label %.backedge.i

; <label>:690                                     ; preds = %.backedge.i
  %691 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %692 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %693 = bitcast %"union._2_BPHash_$node"* %692 to i64*
  %694 = load i64* %693, align 8
  %695 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i64*
  %696 = load i64* %695, align 8
  %697 = mul i64 %696, %694
  %698 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1, i32 0
  %.c.i = inttoptr i64 %697 to i8*
  store i8* %.c.i, i8** %698, align 8
  br label %.backedge.i

; <label>:699                                     ; preds = %.backedge.i
  %700 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %701 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i8*
  %702 = load i8* %701, align 1
  %703 = zext i8 %702 to i32
  %704 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  store i32 %703, i32* %704, align 4
  br label %.backedge.i

; <label>:705                                     ; preds = %.backedge.i
  %706 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %707 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 0, i32 0
  %708 = load i8** %707, align 8
  %709 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1
  %710 = bitcast %"union._2_BPHash_$node"* %709 to i64*
  %711 = load i64* %710, align 8
  %712 = getelementptr i8* %708, i64 %711
  %713 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %712, i8** %713, align 8
  br label %.backedge.i

; <label>:714                                     ; preds = %.backedge.i
  %715 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 1
  %716 = bitcast i8* %715 to i32*
  %717 = load i32* %716, align 4
  %718 = sext i32 %717 to i64
  %719 = getelementptr inbounds [308 x i8]* %"_2_BPHash_$locals.i", i64 0, i64 %718
  %720 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* %719, i8** %720, align 8
  %721 = getelementptr inbounds %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i", i64 1
  %722 = getelementptr inbounds i8* %"_2_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

BPHash.exit:                                      ; preds = %.backedge.i
  %723 = bitcast %"union._2_BPHash_$node"* %"_2_BPHash_$sp.0.0.i" to i32*
  %724 = load i32* %723, align 4
  %725 = icmp eq i32 %724, 1543172857
  br i1 %725, label %726, label %727

; <label>:726                                     ; preds = %BPHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %728

; <label>:727                                     ; preds = %BPHash.exit
