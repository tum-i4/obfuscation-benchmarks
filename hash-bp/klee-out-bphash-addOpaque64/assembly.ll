; ModuleID = './bphash-addOpaque64.bc'
...
; <label>:4                                       ; preds = %0
  %5 = call fastcc i32 @BPHash(i8* null, i32 undef)
  br label %6
...
thread-pre-split:                                 ; preds = %.loopexit42, %10
  %11 = phi i8* [ %str, %10 ], [ %158, %.loopexit42 ]
  %i.0.ph = phi i32 [ undef, %10 ], [ %159, %.loopexit42 ]
  %hash.1.ph = phi i32 [ %hash.0, %10 ], [ %157, %.loopexit42 ]
...
; <label>:12                                      ; preds = %thread-pre-split, %6
  ...
  %hash.1 = phi i32 [ %hash.1.ph, %thread-pre-split ], [ 0, %6 ]
...
.thread:                                          ; preds = %.preheader97
  %50 = call fastcc i32 @BPHash(i8* null, i32 %len)
  br label %51
...
; <label>:54                                      ; preds = %.loopexit102
  %55 = call fastcc i32 @BPHash(i8* null, i32 %len)
  br label %.thread29
...
; <label>:70                                      ; preds = %67
  %71 = call fastcc i32 @BPHash(i8* null, i32 %len)
  br label %89
...
; <label>:86                                      ; preds = %83
  %87 = call fastcc i32 @BPHash(i8* null, i32 %len)
  br label %88
...
; <label>:94                                      ; preds = %.preheader120
  %95 = call fastcc i32 @BPHash(i8* null, i32 %hash.636)
  br label %96
...
; <label>:109                                     ; preds = %107
  ...
  br i1 %112, label %160, label %.loopexit94
...
; <label>:127                                     ; preds = %124
  %128 = call fastcc i32 @BPHash(i8* null, i32 7)
  br label %.loopexit42
...
.preheader86:                                     ; preds = %.split
  %134 = call fastcc i32 @BPHash(i8* null, i32 %len)
...
.lr.ph:                                           ; preds = %.split, %.preheader86, %.lr.ph
  ...
  %136 = add i32 %i.488, -6
  %137 = lshr i32 %136, 9
  %138 = call fastcc i32 @BPHash(i8* null, i32 %137)
...
thread-pre-split40.split.us.thread-pre-split40.split.us.split_crit_edge: ; preds = %thread-pre-split40.split.us
  ...
  %147 = call fastcc i32 @BPHash(i8* null, i32 %146)
...
; <label>:152                                     ; preds = %148
  %153 = call fastcc i32 @BPHash(i8* null, i32 %i.0)
  br label %.loopexit42

.loopexit42:                                      ; preds = %thread-pre-split40, %148, %152, %127
  %i.6 = phi i32 [ %128, %127 ], [ %153, %152 ], [ %i.0, %148 ], [ %i.5.ph, %thread-pre-split40 ]
  %154 = shl i32 %hash.1, 7
  %155 = load i8* %13, align 1
  %156 = sext i8 %155 to i32
  %157 = xor i32 %156, %154
  %158 = getelementptr inbounds i8* %13, i64 1
  store i8* %158, i8** %1, align 8
  %159 = add i32 %i.6, 1
  br label %thread-pre-split

; <label>:160                                     ; preds = %109
  %161 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %162 = icmp eq %struct._1_main__opaque_Node_1* %161, null
  br i1 %162, label %163, label %179

; <label>:163                                     ; preds = %160
  %164 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
...
; <label>:174                                     ; preds = %170
  %175 = getelementptr inbounds i8** %1, i64 -1
  %176 = call fastcc i32 @__user_main(i32 0, i8** %175)
  br label %179

; <label>:177                                     ; preds = %167
  %178 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %179

; <label>:179                                     ; preds = %160, %166, %173, %174, %177
...
; <label>:182                                     ; preds = %179
  %183 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %184 = icmp eq %struct._1_main__opaque_Node_1* %183, null
  br i1 %184, label %187, label %185

; <label>:185                                     ; preds = %182
  %186 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %190

; <label>:187                                     ; preds = %182
  %188 = getelementptr inbounds i8** %1, i64 -1
  %189 = call fastcc i32 @__user_main(i32 1, i8** %188)
  br label %190

; <label>:190                                     ; preds = %179, %185, %187
...
; <label>:196                                     ; preds = %193
  ...
  %199 = icmp eq %struct._1_main__opaque_Node_1* %197, %198
...
; <label>:201                                     ; preds = %193
  %202 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %203 = icmp eq %struct._1_main__opaque_Node_1* %202, null
  br i1 %203, label %210, label %204

; <label>:204                                     ; preds = %201
  %205 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %206 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %207 = icmp eq %struct._1_main__opaque_Node_1* %205, %206
...
; <label>:210                                     ; preds = %204, %196, %200, %201, %208, %209
  ret i32 %hash.1
}
...
!3157 = metadata !{i32 3429}
!3158 = metadata !{i32 4277}
!3159 = metadata !{i32 4890}
!3160 = metadata !{i32 6183}
!3161 = metadata !{i32 7821}
!3162 = metadata !{i32 9127}
!3163 = metadata !{i32 9598}
!3164 = metadata !{i32 9837}
!3165 = metadata !{i32 10853}
!3166 = metadata !{i32 12607}
!3167 = metadata !{i32 12959}
!3168 = metadata !{i32 15763}
!3169 = metadata !{i32 16053}
!3170 = metadata !{i32 16871}
!3171 = metadata !{i32 17146}
!3172 = metadata !{i32 17219}
