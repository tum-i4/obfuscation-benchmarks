...
.split.us.i:                                      ; preds = %.split.us.i.preheader, %.split.us.i
  ...
  br i1 %exitcond, label %.split.us.i.BPHash.exit_crit_edge, label %.split.us.i
...
.split.us.i.BPHash.exit_crit_edge:                ; preds = %.split.us.i
  %phitmp = icmp eq i32 %477, 1543172857
  br i1 %phitmp, label %482, label %.critedge

; <label>:482                                     ; preds = %.split.us.i.BPHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %483

.critedge:                                        ; preds = %.split.us.i.preheader, %.split.us.i.BPHash.exit_crit_edge
