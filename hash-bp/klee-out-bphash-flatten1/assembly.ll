...
.outer.outer.i:                                   ; preds = %.split8.i, %strlen.exit
  ...
  %_1_BPHash_next.0.ph.ph.i = phi i64 [ 5, %strlen.exit ], [ 3, %.split8.i ]
...
.outer.i:                                         ; preds = %.outer.i, %.outer.outer.i
  ...
  %_1_BPHash_next.0.ph.i = phi i64 [ %_1_BPHash_next.0.ph.ph.i, %.outer.outer.i ], [ 3, %.outer.i ]
  %442 = icmp eq i64 %_1_BPHash_next.0.ph.i, 5
...
.outer1..outer1.split_crit_edge.i:                ; preds = %.outer1..outer1.split_crit_edge.i, %.outer1..outer1.split_crit_edge.lr.ph.i
  %_1_BPHash_next.0.ph214.i = phi i64 [ %_1_BPHash_next.0.ph.i, %.outer1..outer1.split_crit_edge.lr.ph.i ], [ %..i, %.outer1..outer1.split_crit_edge.i ]
  switch i64 %_1_BPHash_next.0.ph214.i, label %infloop.i [
    i64 3, label %.outer1..outer1.split_crit_edge.i
    i64 1, label %.split8.i
    i64 0, label %BPHash.exit
  ]

.split8.i:                                        ; preds = %.outer1..outer1.split_crit_edge.i
  %444 = shl i32 %hash.0.ph.i, 7
...
BPHash.exit:                                      ; preds = %.outer1..outer1.split_crit_edge.i
  %450 = icmp eq i32 %hash.0.ph.i, 1543172857
  br i1 %450, label %451, label %452

; <label>:451                                     ; preds = %BPHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %453

; <label>:452                                     ; preds = %BPHash.exit
