...
; <label>:33                                      ; preds = %33, %101
  %p.0.i = phi i8* [ %104, %101 ], [ %36, %33 ]
...
strlen.exit:                                      ; preds = %33
  ...
  %38 = ptrtoint i8* %104 to i64, !dbg !2876
...
; <label>:42                                      ; preds = %.loopexit, %strlen.exit
  %43 = phi i8* [ %104, %strlen.exit ], [ %67, %.loopexit ]
  %44 = phi %struct._1_main__opaque_Node_1* [ %102, %strlen.exit ], [ %.pre, %.loopexit ]
  %hash.0.i = phi i32 [ 0, %strlen.exit ], [ %66, %.loopexit ]
  %i.0.i = phi i32 [ 0, %strlen.exit ], [ %68, %.loopexit ]
...
; <label>:58                                      ; preds = %56
  ...
  br i1 %61, label %BPHash.exit, label %.loopexit
...
; <label>:73                                      ; preds = %30, %22, %rand.exit
  %74 = load i32* %14, align 4, !dbg !2863
  %75 = load i32* %13, align 4, !dbg !2863
  %76 = add nsw i32 %75, %74, !dbg !2863
  store i32 %76, i32* %13, align 4, !dbg !2863
  %77 = lshr i32 %76, 1, !dbg !2864
  %78 = getelementptr inbounds i32* %13, i64 1, !dbg !2865
  %79 = icmp ult i32* %78, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !2866
  %80 = getelementptr inbounds i32* %14, i64 1, !dbg !2868
  br i1 %79, label %81, label %rand.exit.1, !dbg !2866

; <label>:81                                      ; preds = %73
  %82 = icmp ult i32* %80, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !2870
  %..i.i.i.1 = select i1 %82, i32* %80, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !2870
  br label %rand.exit.1, !dbg !2870

rand.exit.1:                                      ; preds = %73, %81
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %73 ], [ %78, %81 ]
  %rptr.0.i.i.i.1 = phi i32* [ %80, %73 ], [ %..i.i.i.1, %81 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !2872
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !2873
  %83 = call i8* @malloc(i64 16) #8
  %84 = bitcast i8* %83 to %struct._1_main__opaque_Node_1*
  %85 = icmp eq i8* %83, null
  br i1 %85, label %101, label %86

; <label>:86                                      ; preds = %rand.exit.1
...
; <label>:90                                      ; preds = %86
  %91 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %92 = getelementptr inbounds %struct._1_main__opaque_Node_1* %91, i64 0, i32 1
  %93 = load %struct._1_main__opaque_Node_1** %92, align 8
  %94 = getelementptr inbounds i8* %83, i64 8
  %95 = bitcast i8* %94 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %93, %struct._1_main__opaque_Node_1** %95, align 8
  %96 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %97 = getelementptr inbounds %struct._1_main__opaque_Node_1* %96, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %84, %struct._1_main__opaque_Node_1** %97, align 8
  br label %101

; <label>:98                                      ; preds = %86
  %99 = getelementptr inbounds i8* %83, i64 8
  %100 = bitcast i8* %99 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %84, %struct._1_main__opaque_Node_1** %100, align 8
  store %struct._1_main__opaque_Node_1* %84, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %101

; <label>:101                                     ; preds = %98, %90, %rand.exit.1
  %102 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %102, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %103 = getelementptr inbounds i8** %newArgv, i64 1
