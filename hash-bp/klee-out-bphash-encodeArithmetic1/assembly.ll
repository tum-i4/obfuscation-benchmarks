; ModuleID = './bphash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i, label %BPHash.exit.thread

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %453, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %458, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %452, %.lr.ph.i ], [ 0, %strlen.exit ]
  %447 = shl i32 %hash.01.i, 7
  ...
  %454 = xor i32 %i.02.i, -2
  %455 = shl i32 %i.02.i, 1
  %456 = or i32 %455, 2
  %457 = add i32 %454, 1
  %458 = add i32 %457, %456
  %459 = xor i32 %458, -2147483648
  %460 = and i32 %459, %441
  %461 = xor i32 %458, %442
  %462 = sub i32 %458, %441
  %463 = and i32 %462, %461
  ...
  br i1 %465, label %.lr.ph.i, label %BPHash.exit

BPHash.exit:                                      ; preds = %.lr.ph.i
  %466 = icmp eq i32 %452, 1543172857
  br i1 %466, label %467, label %BPHash.exit.thread

; <label>:467                                     ; preds = %BPHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %468

BPHash.exit.thread:                               ; preds = %strlen.exit, %BPHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %468

; <label>:468                                     ; preds = %BPHash.exit.thread, %467
  ret i32 0
}
