...
@"_1_BPHash_$array" = internal unnamed_addr constant [1 x [157 x i8]] [[157 x i8] c"U\0C\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\10\00\00\00\07\D6l\0E\00\00\00:\04\00\00\00:
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_BPHash_$locals.i" = alloca [20 x i8], align 16
  %"_1_BPHash_$stack.i" = alloca [1 x [32 x %"union._1_BPHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [20 x i8]* %"_1_BPHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_BPHash_$node"]]* %"_1_BPHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_BPHash_$node"]]* %"_1_BPHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %605, %597, %590, %584, %576, %574, %559, %545, %538, %530, %524, %518, %510, %501, %499, %490, %481, %473, %466, %460, %451, %.backedge.i, %strlen.exit
  %"_1_BPHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [157 x i8]]* @"_1_BPHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_BPHash_$pc.0.0.i", %.backedge.i ], [ %611, %605 ], [ %598, %597 ], [ %591, %590 ], [ %585, %584 ], [ %577, %5
  %"_1_BPHash_$sp.0.0.i" = phi %"union._1_BPHash_$node"* [ %448, %strlen.exit ], [ %"_1_BPHash_$sp.0.0.i", %.backedge.i ], [ %609, %605 ], [ %601, %597 ], [ %"_1_BPHash_$sp.0.0.i", %590 ], [ %"_1_BPHash_$sp.0.0.i", %584 ], [ %583, %576 ], [ %575, %574 ],
  %449 = load i8* %"_1_BPHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 0, i32 0
  %454 = load i8** %453, align 8
  %455 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1
  %456 = bitcast %"union._1_BPHash_$node"* %455 to i64*
  %457 = load i64* %456, align 8
  %458 = getelementptr i8* %454, i64 %457
  %459 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %458, i8** %459, align 8
  br label %.backedge.i

; <label>:460                                     ; preds = %.backedge.i
  %461 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %462 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  %463 = load i32* %462, align 4
  %464 = sext i32 %463 to i64
  %465 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 0, i32 0
  %.c2.i = inttoptr i64 %464 to i8*
  store i8* %.c2.i, i8** %465, align 8
  br label %.backedge.i

; <label>:466                                     ; preds = %.backedge.i
  %467 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %468 = bitcast i8* %467 to i32*
  %469 = load i32* %468, align 4
  %470 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1
  %471 = bitcast %"union._1_BPHash_$node"* %470 to i32*
  store i32 %469, i32* %471, align 4
  %472 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:473                                     ; preds = %.backedge.i
  %474 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %475 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1, i32 0
  %476 = load i8** %475, align 8
  %477 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 0, i32 0
  %478 = load i8** %477, align 8
  %479 = bitcast i8* %478 to i8**
  store i8* %476, i8** %479, align 8
  %480 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:481                                     ; preds = %.backedge.i
  %482 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %483 = bitcast i8* %482 to i32*
  %484 = load i32* %483, align 4
  %485 = sext i32 %484 to i64
  %486 = getelementptr inbounds [20 x i8]* %"_1_BPHash_$locals.i", i64 0, i64 %485
  %487 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* %486, i8** %487, align 8
  %488 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1
  %489 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:490                                     ; preds = %.backedge.i
  %491 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %492 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i64*
  %493 = load i64* %492, align 8
  %494 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1
  %495 = bitcast %"union._1_BPHash_$node"* %494 to i64*
  %496 = load i64* %495, align 8
  %497 = mul i64 %496, %493
  %498 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1, i32 0
  %.c1.i = inttoptr i64 %497 to i8*
  store i8* %.c1.i, i8** %498, align 8
  br label %.backedge.i

; <label>:499                                     ; preds = %.backedge.i
  %500 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:501                                     ; preds = %.backedge.i
  %502 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %503 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  %504 = load i32* %503, align 4
  %505 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1
  %506 = bitcast %"union._1_BPHash_$node"* %505 to i32*
  %507 = load i32* %506, align 4
  %508 = icmp ult i32 %504, %507
  %509 = zext i1 %508 to i32
  store i32 %509, i32* %506, align 4
  br label %.backedge.i

; <label>:510                                     ; preds = %.backedge.i
  %511 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %512 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  %513 = load i32* %512, align 4
  %514 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1
  %515 = bitcast %"union._1_BPHash_$node"* %514 to i32*
...
; <label>:518                                     ; preds = %.backedge.i
  %519 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %520 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 0, i32 0
  %521 = load i8** %520, align 8
  %522 = load i8* %521, align 1
  %523 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i8*
  store i8 %522, i8* %523, align 1
  br label %.backedge.i

; <label>:524                                     ; preds = %.backedge.i
  %525 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %526 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 0, i32 0
...
; <label>:530                                     ; preds = %.backedge.i
  %531 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %532 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1
  %533 = bitcast %"union._1_BPHash_$node"* %532 to i32*
  %534 = load i32* %533, align 4
  %535 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
...
; <label>:538                                     ; preds = %.backedge.i
  %539 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %540 = bitcast i8* %539 to i64*
  %541 = load i64* %540, align 8
  %542 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1, i32 0
  %.c.i = inttoptr i64 %541 to i8*
  store i8* %.c.i, i8** %542, align 8
  %543 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1
  %544 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:545                                     ; preds = %.backedge.i
  %546 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %547 = bitcast i8* %546 to i32*
  %548 = load i32* %547, align 4
  %549 = sext i32 %548 to i64
  %.sum.i = add i64 %549, 1
  %550 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:551                                     ; preds = %.backedge.i
  %552 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %553 = bitcast i8* %552 to i32*
  %554 = load i32* %553, align 4
  switch i32 %554, label %559 [
    i32 1, label %555
    i32 0, label %557
  ]

; <label>:555                                     ; preds = %551
  %556 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %556, align 8
  br label %559

; <label>:557                                     ; preds = %551
  %558 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %558, align 8
  br label %559

; <label>:559                                     ; preds = %557, %555, %551
  %560 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1
  %561 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:562                                     ; preds = %.backedge.i
  %563 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  %564 = load i32* %563, align 4
  %565 = icmp eq i32 %564, 0
  br i1 %565, label %572, label %566

; <label>:566                                     ; preds = %562
  %567 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %568 = bitcast i8* %567 to i32*
  %569 = load i32* %568, align 4
  %570 = sext i32 %569 to i64
  %.sum3.i = add i64 %570, 1
  %571 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 %.sum3.i
  br label %574

; <label>:572                                     ; preds = %562
  %573 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 5
  br label %574

; <label>:574                                     ; preds = %572, %566
  %"_1_BPHash_$pc.0.1.i" = phi i8* [ %573, %572 ], [ %571, %566 ]
  %575 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:576                                     ; preds = %.backedge.i
  %577 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %578 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  %579 = load i32* %578, align 4
  %580 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1, i32 0
  %581 = load i8** %580, align 8
  %582 = bitcast i8* %581 to i32*
  store i32 %579, i32* %582, align 4
  %583 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:584                                     ; preds = %.backedge.i
  %585 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %586 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i8*
  %587 = load i8* %586, align 1
  %588 = sext i8 %587 to i32
  %589 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  store i32 %588, i32* %589, align 4
  br label %.backedge.i

; <label>:590                                     ; preds = %.backedge.i
  %591 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %592 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 0, i32 0
  %593 = load i8** %592, align 8
  %594 = bitcast i8* %593 to i32*
  %595 = load i32* %594, align 4
  %596 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  store i32 %595, i32* %596, align 4
  br label %.backedge.i

; <label>:597                                     ; preds = %.backedge.i
  %598 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %599 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  %600 = load i32* %599, align 4
  %601 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 -1
  %602 = bitcast %"union._1_BPHash_$node"* %601 to i32*
...
; <label>:605                                     ; preds = %.backedge.i
  %606 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 1
  %607 = bitcast i8* %606 to i32*
  %608 = load i32* %607, align 4
  %609 = getelementptr inbounds %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i", i64 1
  %610 = bitcast %"union._1_BPHash_$node"* %609 to i32*
  store i32 %608, i32* %610, align 4
  %611 = getelementptr inbounds i8* %"_1_BPHash_$pc.0.0.i", i64 5
  br label %.backedge.i

BPHash.exit:                                      ; preds = %.backedge.i
  %612 = bitcast %"union._1_BPHash_$node"* %"_1_BPHash_$sp.0.0.i" to i32*
  %613 = load i32* %612, align 4
  %614 = icmp eq i32 %613, 1543172857
  br i1 %614, label %615, label %616

; <label>:615                                     ; preds = %BPHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %617

; <label>:616                                     ; preds = %BPHash.exit
