...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %BPHash.exit.thread, label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  ...
  br i1 %exitcond.i, label %BPHash.exit, label %.lr.ph.i

BPHash.exit:                                      ; preds = %.lr.ph.i
  %449 = icmp eq i32 %446, 1543172857
  br i1 %449, label %450, label %BPHash.exit.thread

; <label>:450                                     ; preds = %BPHash.exit
...
; <label>:451                                     ; preds = %BPHash.exit.thread, %450
  ret i32 0
}
