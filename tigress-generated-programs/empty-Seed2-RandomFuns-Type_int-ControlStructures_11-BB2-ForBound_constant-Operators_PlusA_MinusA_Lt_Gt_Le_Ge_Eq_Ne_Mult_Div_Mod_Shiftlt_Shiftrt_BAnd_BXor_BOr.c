...
{ 
  ...
  while (local1 < 1UL) {
    local2 = 0UL;
    while (local2 < 1UL) {
      state[0UL] |= (((state[local2] << (((state[0UL] >> 1U) & 15U) | 1UL)) | (state[local2] >> (32 - (((state[0UL] >> 1U) & 15U) | 1UL)))) & 31U) << 4UL;
      state[0UL] |= ((state[local2] ^ state[local1]) & 31U) << 4UL;
      local2 ++;
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] + 255873917UL) << 1U;
}
}
void megaInit(void) 
{ 
