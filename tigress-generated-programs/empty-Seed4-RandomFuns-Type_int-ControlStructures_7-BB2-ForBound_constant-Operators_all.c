...
{ 
  ...
  if (state[0UL] & 1U) {
    ...
    copy15 = *((unsigned short *)(& state[0UL]) + 0);
    *((unsigned short *)(& state[0UL]) + 0) = *((unsigned short *)(& state[0UL]) + 1);
    *((unsigned short *)(& state[0UL]) + 1) = copy15;
    copy15 = *((unsigned short *)(& state[0UL]) + 1);
    *((unsigned short *)(& state[0UL]) + 1) = *((unsigned short *)(& state[0UL]) + 0);
    *((unsigned short *)(& state[0UL]) + 0) = copy15;
  } else {
    state[0UL] |= (((state[0UL] >> (((state[0UL] >> 3U) & 15U) | 1UL)) | (state[0UL] << (32 - (((state[0UL] >> 3U) & 15U) | 1UL)))) & 7U) << 2UL;
  }
  output[0UL] = state[0UL] + 1930621409U;
}
}
void megaInit(void) 
{ 
