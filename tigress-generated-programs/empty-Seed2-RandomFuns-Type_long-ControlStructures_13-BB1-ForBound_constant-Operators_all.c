...
{ 
  ...
  while (local1 < 1UL) {
    ...
    if (state[0UL] < local1) {
      state[local1] |= ((state[local1] >> (((state[local1] >> 3UL) & 7UL) | 1UL)) & 63UL) << 4UL;
    } else {
      copy12 = *((unsigned short *)(& state[local1]) + 3);
      *((unsigned short *)(& state[local1]) + 3) = *((unsigned short *)(& state[local1]) + 2);
...
{ 
  ...
  if (output[0] == 8381198912031031296UL) {
    printf("You win!\n");
  } else {
