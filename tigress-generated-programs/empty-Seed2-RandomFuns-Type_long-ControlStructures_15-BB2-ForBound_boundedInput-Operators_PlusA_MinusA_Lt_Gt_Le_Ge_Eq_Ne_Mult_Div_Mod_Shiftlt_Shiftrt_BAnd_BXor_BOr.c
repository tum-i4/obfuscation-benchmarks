    ...
    while (local2 < 0UL) {
      if (state[0UL] <= (local2 | local1)) {
        ...
        *((unsigned short *)(& state[local1]) + 2) = copy11;
        state[local2] |= (((state[local1] << (((state[local2] >> 3UL) & 15UL) | 1UL)) | (state[local1] >> (64 - (((state[local2] >> 3UL) & 15UL) | 1UL)))) & 15UL) << 2UL;
      } else {
        state[local1] |= (state[0UL] & 63UL) << 4UL;
...
{ 
  ...
  if (output[0] == 1085460507765811860UL) {
    printf("You win!\n");
  } else {
