...
{ 
  ...
  if (state[0UL] & (unsigned short)1) {
    ...
    *((char *)(& state[0UL]) + 1) = copy11;
    ...
    state[0UL] |= ((state[0UL] << (((state[0UL] >> (unsigned short)4) & (unsigned short)7) | 1UL)) & (unsigned short)15) << 2UL;
    state[0UL] = (state[0UL] >> (((state[0UL] >> (unsigned short)2) & (unsigned short)15) | 1UL)) | (state[0UL] << (16 - (((state[0UL] >> (unsigned short)2) & (unsigned short)15) | 1UL)));
  }
  output[0UL] = state[0UL] + (unsigned short)63986;
}
}
int main(int argc , char *argv[] ) 
{ 
