...
{ 
  ...
  while (local1 < 1UL) {
    local2 = 0UL;
    while (local2 < 1UL) {
      if (state[0UL] > local2 << (((local1 >> 1UL) & 7UL) | 1UL)) {
        copy11 = *((char *)(& state[local2]) + 1);
        *((char *)(& state[local2]) + 1) = *((char *)(& state[local2]) + 7);
        *((char *)(& state[local2]) + 7) = copy11;
      } else {
        state[local2] = state[local1] >> (((state[local1] >> 3UL) & 7UL) | 1UL);
