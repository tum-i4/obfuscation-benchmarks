...
{ 
  ...
  if ((state[0UL] >> 4UL) & 1UL) {
    if ((state[0UL] >> 3UL) & 1UL) {
      ...
      *((char *)(& state[0UL]) + 5) = *((char *)(& state[0UL]) + 6);
      *((char *)(& state[0UL]) + 6) = copy12;
    } else {
      copy13 = *((char *)(& state[0UL]) + 1);
      *((char *)(& state[0UL]) + 1) = *((char *)(& state[0UL]) + 0);
      *((char *)(& state[0UL]) + 0) = copy13;
      copy13 = *((char *)(& state[0UL]) + 4);
      *((char *)(& state[0UL]) + 4) = *((char *)(& state[0UL]) + 7);
      *((char *)(& state[0UL]) + 7) = copy13;
    }
  } else {
    copy15 = *((char *)(& state[0UL]) + 6);
    *((char *)(& state[0UL]) + 6) = *((char *)(& state[0UL]) + 7);
    *((char *)(& state[0UL]) + 7) = copy15;
    state[0UL] += state[0UL];
  }
  output[0UL] = state[0UL] + 1044838405UL;
}
}
