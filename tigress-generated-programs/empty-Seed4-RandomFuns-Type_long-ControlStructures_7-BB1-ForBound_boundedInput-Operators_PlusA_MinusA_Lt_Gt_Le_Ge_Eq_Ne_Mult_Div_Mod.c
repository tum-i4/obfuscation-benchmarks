...
{ 
  ...
  if (state[0UL] & 1UL) {
    ...
    if ((state[0UL] >> 2UL) & 1UL) {
      copy13 = *((char *)(& state[0UL]) + 7);
      *((char *)(& state[0UL]) + 7) = *((char *)(& state[0UL]) + 2);
      *((char *)(& state[0UL]) + 2) = copy13;
      copy13 = *((char *)(& state[0UL]) + 3);
      *((char *)(& state[0UL]) + 3) = *((char *)(& state[0UL]) + 4);
      *((char *)(& state[0UL]) + 4) = copy13;
    } else {
  ...
  if ((state[0UL] >> 1UL) & 1UL) {
    copy15 = *((char *)(& state[0UL]) + 1);
    *((char *)(& state[0UL]) + 1) = *((char *)(& state[0UL]) + 7);
    *((char *)(& state[0UL]) + 7) = copy15;
  } else {
    copy16 = *((unsigned int *)(& state[0UL]) + 1);
    *((unsigned int *)(& state[0UL]) + 1) = *((unsigned int *)(& state[0UL]) + 0);
    *((unsigned int *)(& state[0UL]) + 0) = copy16;
    copy16 = *((unsigned int *)(& state[0UL]) + 0);
    *((unsigned int *)(& state[0UL]) + 0) = *((unsigned int *)(& state[0UL]) + 1);
    *((unsigned int *)(& state[0UL]) + 1) = copy16;
  }
  output[0UL] = state[0UL] + 886510463UL;
}
}
void megaInit(void) 
{ 
...
{ 
  ...
  if (output[0] == 399316920905171329UL) {
    printf("You win!\n");
  } else {
