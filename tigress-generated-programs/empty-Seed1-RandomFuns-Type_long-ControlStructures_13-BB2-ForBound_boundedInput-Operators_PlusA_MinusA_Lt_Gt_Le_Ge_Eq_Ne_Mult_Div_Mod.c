...
{ 
  ...
  while (local1 < 0UL) {
    if (state[0UL] < local1) {
      ...
      *((unsigned short *)(& state[local1]) + 1) = *((unsigned short *)(& state[local1]) + 2);
      ...
      *((unsigned short *)(& state[local1]) + 1) = copy12;
    }
    if (state[0UL] < local1) {
      copy13 = *((unsigned short *)(& state[local1]) + 1);
      *((unsigned short *)(& state[local1]) + 1) = *((unsigned short *)(& state[local1]) + 2);
      *((unsigned short *)(& state[local1]) + 2) = copy13;
      copy13 = *((unsigned short *)(& state[local1]) + 2);
      *((unsigned short *)(& state[local1]) + 2) = *((unsigned short *)(& state[local1]) + 0);
      ...
      *((unsigned short *)(& state[local1]) + 1) = *((unsigned short *)(& state[local1]) + 2);
      *((unsigned short *)(& state[local1]) + 2) = copy15;
  ...
  output[0UL] = (state[0UL] + 116928511UL) + 399227303UL;
}
}
int main(int argc , char *argv[] ) 
{ 
