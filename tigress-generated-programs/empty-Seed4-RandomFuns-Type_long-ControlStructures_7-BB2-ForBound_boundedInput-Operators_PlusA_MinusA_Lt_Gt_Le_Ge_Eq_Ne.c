...
{ 
  ...
  if (output[0] == 18446744073370852138UL) {
    printf("You win!\n");
  } else {
...
{ 
  ...
  if ((state[0UL] >> 2UL) & 1UL) {
    ...
    *((unsigned int *)(& state[0UL]) + 1) = copy17;
    copy18 = *((unsigned int *)(& state[0UL]) + 1);
    *((unsigned int *)(& state[0UL]) + 1) = *((unsigned int *)(& state[0UL]) + 0);
    *((unsigned int *)(& state[0UL]) + 0) = copy18;
  } else {
    copy19 = *((unsigned short *)(& state[0UL]) + 0);
    *((unsigned short *)(& state[0UL]) + 0) = *((unsigned short *)(& state[0UL]) + 2);
    *((unsigned short *)(& state[0UL]) + 2) = copy19;
    state[0UL] += state[0UL];
  }
  output[0UL] = (state[0UL] + 380867558UL) - 653123240UL;
}
}
