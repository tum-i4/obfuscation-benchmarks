...
{ 
  ...
  while (local1 < input[1UL]) {
    ...
    while (local2 < input[1UL]) {
      if (state[0UL] > local2 << (((local1 >> (unsigned short)1) & (unsigned short)7) | 1UL)) {
        state[local2] = state[0UL] >> (((state[0UL] >> (unsigned short)3) & (unsigned short)7) | 1UL);
      } else {
        state[local2] = state[local1] >> (((state[local1] >> (unsigned short)3) & (unsigned short)7) | 1UL);
  ...
  output[0UL] = (state[0UL] | 1059477100UL) >> (unsigned short)7;
}
}
void megaInit(void) 
{ 
