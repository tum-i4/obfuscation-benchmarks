...
{ 
  ...
  if (output[0] == 17188556437809464981UL) {
    printf("You win!\n");
  } else {
...
{ 
  ...
  if ((state[0UL] >> 3UL) & 1UL) {
    ...
    *((char *)(& state[0UL]) + 3) = copy15;
    copy15 = *((char *)(& state[0UL]) + 5);
    *((char *)(& state[0UL]) + 5) = *((char *)(& state[0UL]) + 7);
    *((char *)(& state[0UL]) + 7) = copy15;
  } else {
    copy16 = *((unsigned short *)(& state[0UL]) + 2);
  ...
  output[0UL] = (state[0UL] + 622214515UL) - 0xffffffffe852b961UL;
}
}
