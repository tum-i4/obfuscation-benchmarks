...
{ 
  ...
  while (local1 < 0UL) {
    ...
    if (state[0UL] > local1) {
      ...
      *((char *)(& state[0UL]) + 7) = *((char *)(& state[0UL]) + 1);
      ...
      *((unsigned short *)(& state[local1]) + 3) = copy14;
      copy15 = *((char *)(& state[local1]) + 2);
      *((char *)(& state[local1]) + 2) = *((char *)(& state[local1]) + 5);
      *((char *)(& state[local1]) + 5) = copy15;
      copy15 = *((char *)(& state[local1]) + 3);
      *((char *)(& state[local1]) + 3) = *((char *)(& state[local1]) + 2);
      *((char *)(& state[local1]) + 2) = copy15;
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] + 307931096UL) + 2436360533UL;
}
}
int main(int argc , char *argv[] ) 
{ 
  ...
  if (output[0] == 17188736333600101935UL) {
    printf("You win!\n");
  } else {
