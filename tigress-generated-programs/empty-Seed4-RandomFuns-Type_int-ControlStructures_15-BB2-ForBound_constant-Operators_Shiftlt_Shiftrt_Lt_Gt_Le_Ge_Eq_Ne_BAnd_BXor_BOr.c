...
{ 
  ...
  while (local1 < 1UL) {
    local2 = 0UL;
    while (local2 < 1UL) {
      if (state[0UL] > local2 << (((local1 >> 1U) & 7U) | 1UL)) {
        state[local2] = state[local1] >> (((state[local1] >> 4U) & 7U) | 1UL);
        ...
        *((unsigned short *)(& state[local1]) + 1) = copy11;
        ...
        copy12 = *((char *)(& state[local2]) + 3);
        *((char *)(& state[local2]) + 3) = *((char *)(& state[local2]) + 0);
        *((char *)(& state[local2]) + 0) = copy12;
        state[local2] = state[local1] >> (((state[local1] >> 3U) & 7U) | 1UL);
      }
      local2 += 2UL;
    }
    local1 ++;
