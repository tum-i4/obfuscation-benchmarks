...
{ 
  ...
  while (local1 < (unsigned short)0) {
    ...
    if (state[0UL] <= local1) {
      state[local1] |= (state[0UL] & (unsigned short)15) << 2UL;
      state[0UL] |= (((state[0UL] << (((state[0UL] >> (unsigned short)3) & (unsigned short)15) | 1UL)) | (state[0UL] >> (16 - (((state[0UL] >> (unsigned short)3) & (unsigned short)15) | 1UL)))) & (unsigned short)31) << 4UL;
    } else {
      state[0UL] |= ((state[local1] ^ state[0UL]) & (unsigned short)31) << 3UL;
      state[local1] |= (state[local1] & (unsigned short)15) << 2UL;
    }
    local1 ++;
  }
  output[0UL] = state[0UL] + (unsigned short)84;
}
}
int main(int argc , char *argv[] ) 
{ 
