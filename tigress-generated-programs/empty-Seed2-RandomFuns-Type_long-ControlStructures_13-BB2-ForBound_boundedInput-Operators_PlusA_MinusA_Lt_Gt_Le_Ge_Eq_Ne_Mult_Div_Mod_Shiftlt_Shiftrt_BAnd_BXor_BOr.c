  ...
  while (local1 < 0UL) {
    if (state[0UL] == local1) {
      ...
      *((char *)(& state[0UL]) + 4) = copy11;
      state[local1] = (state[local1] >> (((state[0UL] >> 2UL) & 15UL) | 1UL)) | (state[local1] << (64 - (((state[0UL] >> 2UL) & 15UL) | 1UL)));
    } else {
      ...
      *((unsigned int *)(& state[local1]) + 1) = copy12;
      state[0UL] |= (state[local1] & 15UL) << 3UL;
    }
    if (state[0UL] > local1) {
      state[0UL] *= state[0UL];
      state[0UL] |= ((state[local1] + state[0UL]) & 7UL) << 2UL;
    } else {
      state[0UL] = state[local1] | state[0UL];
      state[local1] = (state[local1] << (((state[local1] >> 4UL) & 15UL) | 1UL)) | (state[local1] >> (64 - (((state[local1] >> 4UL) & 15UL) | 1UL)));
    }
    local1 ++;
  }
  output[0UL] = state[0UL] | 6683440UL;
}
}
void megaInit(void) 
{ 
