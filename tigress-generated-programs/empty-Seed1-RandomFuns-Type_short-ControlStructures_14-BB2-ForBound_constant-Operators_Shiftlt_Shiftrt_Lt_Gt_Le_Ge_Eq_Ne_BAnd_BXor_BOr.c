...
{ 
  ...
  while (local1 < 1UL) {
    if (state[0UL] > local1) {
      if (state[0UL] > local1) {
        state[local1] = state[0UL] >> ((state[0UL] & (unsigned short)7) | 1UL);
      }
    } else
    if (state[0UL] <= local1) {
      ...
      *((char *)(& state[local1]) + 1) = copy14;
      state[local1] = state[0UL] >> (((state[0UL] >> (unsigned short)1) & (unsigned short)7) | 1UL);
    } else {
      state[local1] = state[0UL] >> (((state[0UL] >> (unsigned short)2) & (unsigned short)7) | 1UL);
    }
    local1 += 2UL;
  }
  output[0UL] = (state[0UL] & 237099718UL) >> (unsigned short)5;
}
}
int main(int argc , char *argv[] ) 
{ 
