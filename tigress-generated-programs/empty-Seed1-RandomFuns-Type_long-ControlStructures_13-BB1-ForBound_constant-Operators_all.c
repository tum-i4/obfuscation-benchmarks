...
{ 
  ...
  if (output[0] == 18446744048727012479UL) {
    printf("You win!\n");
  } else {
...
{ 
  ...
  while (local1 < 1UL) {
    ...
    if (state[0UL] == local1) {
      state[0UL] = (state[0UL] << (((state[0UL] >> 3UL) & 15UL) | 1UL)) | (state[0UL] >> (64 - (((state[0UL] >> 3UL) & 15UL) | 1UL)));
    } else {
      state[local1] = (state[0UL] << ((state[local1] & 15UL) | 1UL)) | (state[0UL] >> (64 - ((state[local1] & 15UL) | 1UL)));
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] << 5UL) | (state[0UL] >> 59UL);
}
}
void megaInit(void) 
{ 
