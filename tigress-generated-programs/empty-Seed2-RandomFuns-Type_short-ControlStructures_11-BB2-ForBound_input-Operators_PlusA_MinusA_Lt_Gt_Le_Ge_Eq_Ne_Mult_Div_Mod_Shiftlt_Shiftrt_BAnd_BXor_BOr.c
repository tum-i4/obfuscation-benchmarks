...
{ 
  ...
  while (local1 < input[1UL]) {
    ...
    while (local2 < input[1UL]) {
      state[0UL] |= (((state[local2] << (((state[0UL] >> (unsigned short)1) & (unsigned short)15) | 1UL)) | (state[local2] >> (16 - (((state[0UL] >> (unsigned short)1) & (unsigned short)15) | 1UL)))) & (unsigned short)31) << 4UL;
      state[0UL] |= ((state[local2] ^ state[local1]) & (unsigned short)31) << 4UL;
      local2 ++;
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] + 255873917UL) << (unsigned short)1;
}
}
void megaInit(void) 
{ 
