...
{ 
  ...
  if (output[0] == 18446545995213605245UL) {
    printf("You win!\n");
  } else {
...
{ 
  ...
  if ((state[0UL] >> 3UL) & 1UL) {
    ...
    *((unsigned short *)(& state[0UL]) + 2) = copy13;
    ...
    copy15 = *((char *)(& state[0UL]) + 4);
    *((char *)(& state[0UL]) + 4) = *((char *)(& state[0UL]) + 6);
    *((char *)(& state[0UL]) + 6) = copy15;
  }
  output[0UL] = (state[0UL] + 88679743UL) + 1144939583UL;
}
}
void megaInit(void) 
{ 
