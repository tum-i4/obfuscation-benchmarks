  ...
  if ((state[0UL] >> 4UL) & 1UL) {
    ...
    if ((state[0UL] >> 3UL) & 1UL) {
      ...
      *((unsigned int *)(& state[0UL]) + 1) = copy15;
      copy15 = *((unsigned int *)(& state[0UL]) + 1);
      *((unsigned int *)(& state[0UL]) + 1) = *((unsigned int *)(& state[0UL]) + 0);
      *((unsigned int *)(& state[0UL]) + 0) = copy15;
    } else {
      copy17 = *((char *)(& state[0UL]) + 4);
      *((char *)(& state[0UL]) + 4) = *((char *)(& state[0UL]) + 2);
