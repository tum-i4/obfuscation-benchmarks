...
{ 
  ...
  while (local1 < (unsigned char)0) {
    ...
    while (local2 < (unsigned char)0) {
      if (state[0UL] == local2 << (((local1 >> (unsigned char)4) & (unsigned char)7) | 1UL)) {
        state[local2] = state[0UL] << (((state[0UL] >> (unsigned char)1) & (unsigned char)7) | 1UL);
      } else {
  ...
  output[0UL] = (state[0UL] & 595841640UL) << (unsigned char)3;
}
}
int main(int argc , char *argv[] ) 
{ 
