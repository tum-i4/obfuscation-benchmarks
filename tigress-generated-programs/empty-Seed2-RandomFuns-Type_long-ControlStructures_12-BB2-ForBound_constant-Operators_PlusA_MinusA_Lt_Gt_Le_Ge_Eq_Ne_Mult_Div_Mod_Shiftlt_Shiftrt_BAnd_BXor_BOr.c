...
{ 
  ...
  while (local1 < 1UL) {
    if (state[0UL] == local1) {
      ...
      state[0UL] |= ((state[0UL] + state[local1]) & 7UL) << 2UL;
      state[0UL] |= (state[local1] & 7UL) << 2UL;
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] + 774950844UL) * 277251432775628160UL;
}
}
int main(int argc , char *argv[] ) 
{ 
  ...
  if (output[0] == 1843985957541214208UL) {
    printf("You win!\n");
  } else {
