...
{ 
  ...
  output[0UL] = (((state[0UL] << (unsigned short)9) | (state[0UL] >> (unsigned short)7)) << (unsigned short)1) | (((state[0UL] << (unsigned short)9) | (state[0UL] >> (unsigned short)7)) >> (unsigned short)15);
}
}
int main(int argc , char *argv[] ) 
{ 
