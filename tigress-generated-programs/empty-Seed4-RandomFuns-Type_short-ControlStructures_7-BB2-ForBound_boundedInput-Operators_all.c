...
{ 
  ...
  if (state[0UL] & (unsigned short)1) {
    state[0UL] |= (((state[0UL] << (((state[0UL] >> (unsigned short)4) & (unsigned short)15) | 1UL)) | (state[0UL] >> (16 - (((state[0UL] >> (unsigned short)4) & (unsigned short)15) | 1UL)))) & (unsigned short)63) << 4UL;
    ...
    *((char *)(& state[0UL]) + 0) = *((char *)(& state[0UL]) + 1);
    *((char *)(& state[0UL]) + 1) = copy16;
    copy17 = *((char *)(& state[0UL]) + 1);
    *((char *)(& state[0UL]) + 1) = *((char *)(& state[0UL]) + 0);
    *((char *)(& state[0UL]) + 0) = copy17;
  }
  output[0UL] = state[0UL] - (unsigned short)30421;
}
}
