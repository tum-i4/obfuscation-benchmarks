...
{ 
  ...
  if (output[0] == 2801324306713378572UL) {
    printf("You win!\n");
  } else {
...
{ 
  ...
  while (local1 < 1UL) {
    if (state[0UL] < local1) {
      ...
      *((char *)(& state[local1]) + 5) = *((char *)(& state[local1]) + 3);
      ...
      *((unsigned short *)(& state[local1]) + 3) = copy12;
    } else {
      copy13 = *((char *)(& state[local1]) + 7);
      *((char *)(& state[local1]) + 7) = *((char *)(& state[local1]) + 6);
      *((char *)(& state[local1]) + 6) = copy13;
  ...
  output[0UL] = (state[0UL] - 649632930UL) - 1861608530UL;
}
}
