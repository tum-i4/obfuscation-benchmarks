    ...
    if (state[0UL] & (unsigned short)1) {
      if (state[0UL] & (unsigned short)1) {
        ...
        *((char *)(& state[0UL]) + 1) = copy11;
        state[0UL] |= ((state[0UL] + state[0UL]) & (unsigned short)63) << 4UL;
      } else {
        state[0UL] |= (((state[0UL] << ((state[0UL] & (unsigned short)15) | 1UL)) | (state[0UL] >> (16 - ((state[0UL] & (unsigned short)15) | 1UL)))) & (unsigned short)31) << 3UL;
        state[0UL] |= (((state[0UL] << ((state[0UL] & (unsigned short)15) | 1UL)) | (state[0UL] >> (16 - ((state[0UL] & (unsigned short)15) | 1UL)))) & (unsigned short)31) << 4UL;
      }
    } else
    if ((state[0UL] >> (unsigned short)1) & (unsigned short)1) {
      state[0UL] = (state[0UL] << ((state[0UL] & (unsigned short)15) | 1UL)) | (state[0UL] >> (16 - ((state[0UL] & (unsigned short)15) | 1UL)));
    } else {
      copy13 = *((char *)(& state[0UL]) + 1);
      *((char *)(& state[0UL]) + 1) = *((char *)(& state[0UL]) + 0);
      *((char *)(& state[0UL]) + 0) = copy13;
      state[0UL] |= ((state[0UL] + state[0UL]) & (unsigned short)7) << 2UL;
    }
  } else
  if (! ((state[0UL] >> (unsigned short)1) & (unsigned short)1)) {
    state[0UL] <<= (state[0UL] & (unsigned short)7) | 1UL;
    state[0UL] = (state[0UL] << (((state[0UL] >> (unsigned short)4) & (unsigned short)15) | 1UL)) | (state[0UL] >> (16 - (((state[0UL] >> (unsigned short)4) & (unsigned short)15) | 1UL)));
  }
  output[0UL] = ((state[0UL] + 809619556UL) >> (unsigned short)15) | ((state[0UL] + 809619556UL) << (unsigned short)1);
}
}
