...
{ 
  ...
  if (output[0] == 18380937560208404646UL) {
    printf("You win!\n");
  } else {
...
{ 
  ...
  local1 = 0UL;
  while (local1 < 1UL) {
    state[local1] |= (state[local1] & 31UL) << 4UL;
    state[local1] |= (state[0UL] & 15UL) << 2UL;
    local1 ++;
  }
  local1 = 0UL;
  while (local1 < 1UL) {
    state[local1] |= (state[0UL] & 7UL) << 2UL;
    state[0UL] |= (state[local1] & 7UL) << 2UL;
    local1 ++;
  }
  output[0UL] = state[0UL] * 549183897UL + 534246206UL;
}
}
