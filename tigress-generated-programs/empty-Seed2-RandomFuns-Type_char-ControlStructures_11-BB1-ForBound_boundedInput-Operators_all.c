...
{ 
  ...
  while (local1 < (unsigned char)0) {
    ...
    while (local2 < (unsigned char)0) {
      state[0UL] = (state[local2] << (((state[0UL] >> (unsigned char)1) & (unsigned char)15) | 1UL)) | (state[local2] >> (8 - (((state[0UL] >> (unsigned char)1) & (unsigned char)15) | 1UL)));
      local2 ++;
    }
    local1 ++;
  }
  output[0UL] = ((state[0UL] << (unsigned char)13) | (state[0UL] >> (unsigned char)251)) + (unsigned char)94;
}
}
void megaInit(void) 
{ 
