...
{ 
  ...
  if (output[0] == 288229977467511430UL) {
    printf("You win!\n");
  } else {
...
{ 
  ...
  while (local1 < 1UL) {
    ...
    if (state[0UL] > local1) {
      state[local1] |= ((state[local1] >> (((state[local1] >> 4UL) & 7UL) | 1UL)) & 15UL) << 2UL;
      state[local1] >>= ((state[local1] >> 4UL) & 7UL) | 1UL;
    } else {
      state[local1] = state[0UL] | state[local1];
      state[local1] |= (((state[local1] >> ((state[0UL] & 15UL) | 1UL)) | (state[local1] << (64 - ((state[0UL] & 15UL) | 1UL)))) & 15UL) << 2UL;
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] + 518212932UL) << 1UL;
}
}
