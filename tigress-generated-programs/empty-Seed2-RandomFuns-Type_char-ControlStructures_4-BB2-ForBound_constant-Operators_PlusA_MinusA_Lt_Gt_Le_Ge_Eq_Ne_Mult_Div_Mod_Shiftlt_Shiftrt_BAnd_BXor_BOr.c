...
{ 
  ...
  if (state[0UL] & (unsigned char)1) {
    if ((state[0UL] >> (unsigned char)2) & (unsigned char)1) {
      ...
      state[0UL] |= (((state[0UL] >> (((state[0UL] >> (unsigned char)1) & (unsigned char)15) | 1UL)) | (state[0UL] << (8 - (((state[0UL] >> (unsigned char)1) & (unsigned char)15) | 1UL)))) & (unsigned char)15) << 3UL;
  ...
  if ((state[0UL] >> (unsigned char)4) & (unsigned char)1) {
    ...
    state[0UL] |= (state[0UL] * state[0UL] & (unsigned char)15) << 3UL;
    state[0UL] |= ((state[0UL] + state[0UL]) & (unsigned char)7) << 2UL;
  }
  output[0UL] = (state[0UL] + 576551744UL) - (unsigned char)69;
}
}
void megaInit(void) 
{ 
