...
{ 
  ...
  if ((state[0UL] >> (unsigned char)3) & (unsigned char)1) {
    state[0UL] |= (((state[0UL] >> (((state[0UL] >> (unsigned char)2) & (unsigned char)15) | 1UL)) | (state[0UL] << (8 - (((state[0UL] >> (unsigned char)2) & (unsigned char)15) | 1UL)))) & (unsigned char)31) << 3UL;
  } else {
    state[0UL] |= (state[0UL] & (unsigned char)31) << 3UL;
  }
  output[0UL] = (state[0UL] + 638614615UL) * (unsigned char)96;
}
}
int main(int argc , char *argv[] ) 
{ 
