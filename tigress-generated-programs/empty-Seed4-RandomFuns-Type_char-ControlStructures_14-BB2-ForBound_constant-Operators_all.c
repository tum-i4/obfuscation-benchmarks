  ...
  while (local1 < 1UL) {
    if (state[0UL] > local1) {
      if (state[0UL] == local1) {
        ...
        state[local1] |= ((state[0UL] + state[local1]) & (unsigned char)15) << 2UL;
    ...
    if (state[0UL] <= local1) {
      ...
      state[0UL] |= (state[local1] & (unsigned char)63) << 4UL;
      state[local1] |= ((state[0UL] + state[0UL]) & (unsigned char)15) << 3UL;
    }
    local1 ++;
  }
