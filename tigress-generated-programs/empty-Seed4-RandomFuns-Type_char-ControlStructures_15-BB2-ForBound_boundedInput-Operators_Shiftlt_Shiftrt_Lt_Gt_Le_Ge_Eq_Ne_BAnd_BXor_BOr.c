...
{ 
  ...
  while (local1 < (unsigned char)0) {
    ...
    while (local2 < (unsigned char)0) {
      if (state[0UL] > local2 << (((local1 >> (unsigned char)1) & (unsigned char)7) | 1UL)) {
        state[local2] = state[local1] >> (((state[local1] >> (unsigned char)4) & (unsigned char)7) | 1UL);
        state[local2] = state[0UL] >> (((state[0UL] >> (unsigned char)3) & (unsigned char)7) | 1UL);
      } else {
        state[local2] = state[0UL] >> (((state[0UL] >> (unsigned char)3) & (unsigned char)7) | 1UL);
  ...
  output[0UL] = (state[0UL] | 834686897UL) | (unsigned char)255;
}
}
void megaInit(void) 
{ 
