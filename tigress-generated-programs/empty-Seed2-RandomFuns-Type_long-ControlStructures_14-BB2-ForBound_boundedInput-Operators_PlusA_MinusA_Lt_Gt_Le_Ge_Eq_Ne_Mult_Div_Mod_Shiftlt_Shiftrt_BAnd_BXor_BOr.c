  ...
  while (local1 < 0UL) {
    if (state[0UL] == local1) {
      if (state[0UL] < local1) {
        ...
        state[local1] |= (state[local1] & 31UL) << 3UL;
      }
    } else
    if (state[0UL] == local1) {
      copy12 = *((char *)(& state[local1]) + 0);
      *((char *)(& state[local1]) + 0) = *((char *)(& state[local1]) + 5);
      *((char *)(& state[local1]) + 5) = copy12;
      state[local1] = state[0UL] ^ state[local1];
    } else {
      copy13 = *((char *)(& state[local1]) + 2);
      *((char *)(& state[local1]) + 2) = *((char *)(& state[local1]) + 4);
      *((char *)(& state[local1]) + 4) = copy13;
      state[0UL] = (state[local1] << (((state[0UL] >> 4UL) & 15UL) | 1UL)) | (state[local1] >> (64 - (((state[0UL] >> 4UL) & 15UL) | 1UL)));
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] << 7UL) | 0xf3fa00000000498dUL;
}
}
int main(int argc , char *argv[] ) 
{ 
  ...
  if (output[0] == 17580364271239220109UL) {
    printf("You win!\n");
  } else {
