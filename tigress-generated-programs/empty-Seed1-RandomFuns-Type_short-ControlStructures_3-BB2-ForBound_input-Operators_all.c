...
{ 
  ...
  output[0UL] = (((state[0UL] >> (unsigned short)1) | (state[0UL] << (unsigned short)15)) >> (unsigned short)15) | (((state[0UL] >> (unsigned short)1) | (state[0UL] << (unsigned short)15)) << (unsigned short)1);
}
}
int main(int argc , char *argv[] ) 
{ 
