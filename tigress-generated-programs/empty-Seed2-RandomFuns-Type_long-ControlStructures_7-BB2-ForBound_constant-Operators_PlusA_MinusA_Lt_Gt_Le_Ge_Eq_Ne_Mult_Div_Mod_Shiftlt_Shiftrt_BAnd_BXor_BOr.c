  ...
  if (state[0UL] & 1UL) {
    if ((state[0UL] >> 2UL) & 1UL) {
      if ((state[0UL] >> 3UL) & 1UL) {
        state[0UL] |= ((state[0UL] << (((state[0UL] >> 2UL) & 7UL) | 1UL)) & 15UL) << 2UL;
        state[0UL] += state[0UL];
      } else {
        copy11 = *((char *)(& state[0UL]) + 7);
        *((char *)(& state[0UL]) + 7) = *((char *)(& state[0UL]) + 5);
        *((char *)(& state[0UL]) + 5) = copy11;
        copy11 = *((char *)(& state[0UL]) + 4);
        *((char *)(& state[0UL]) + 4) = *((char *)(& state[0UL]) + 0);
        *((char *)(& state[0UL]) + 0) = copy11;
        copy12 = *((unsigned short *)(& state[0UL]) + 2);
        *((unsigned short *)(& state[0UL]) + 2) = *((unsigned short *)(& state[0UL]) + 0);
        *((unsigned short *)(& state[0UL]) + 0) = copy12;
      }
    } else
    if ((state[0UL] >> 4UL) & 1UL) {
      state[0UL] |= ((state[0UL] >> (((state[0UL] >> 4UL) & 7UL) | 1UL)) & 15UL) << 2UL;
      state[0UL] |= ((state[0UL] + state[0UL]) & 31UL) << 3UL;
    } else {
...
{ 
  ...
  if (output[0] == 4987877324802506775UL) {
    printf("You win!\n");
  } else {
