...
{ 
  ...
  if ((state[0UL] >> (unsigned char)2) & (unsigned char)1) {
    ...
    state[0UL] |= ((state[0UL] + state[0UL]) & (unsigned char)31) << 4UL;
    state[0UL] *= state[0UL];
  }
  output[0UL] = (state[0UL] + 745448133UL) << ((((9000184UL >> ((((480272593UL >> (unsigned char)255) >> (unsigned char)2) & (unsigned char)7) | 1UL)) >> (unsigned char)4) & (unsigned char)7) | 1UL);
}
}
int main(int argc , char *argv[] ) 
{ 
