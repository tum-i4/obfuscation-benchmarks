...
{ 
  ...
  while (local1 < input[1UL]) {
    ...
    if (state[0UL] > local1) {
      state[0UL] |= (state[local1] & (unsigned char)31) << 3UL;
      state[0UL] |= (state[0UL] & (unsigned char)63) << 4UL;
    } else {
      state[local1] = state[0UL] + state[local1];
      state[0UL] |= (((state[local1] >> (((state[local1] >> (unsigned char)4) & (unsigned char)15) | 1UL)) | (state[local1] << (8 - (((state[local1] >> (unsigned char)4) & (unsigned char)15) | 1UL)))) & (unsigned char)63) << 4UL;
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] - 628437510UL) & ((1070629817UL << ((((608010285UL >> (unsigned char)253) >> (unsigned char)1) & (unsigned char)15) | 1UL)) | (1070629817UL >> (8 - ((((608010285UL >> (unsigned char)253) >> (unsigned char)1) & (unsigned char)15) | 1UL))));
}
}
void megaInit(void) 
{ 
