  ...
  while (local1 < 1UL) {
    if (state[0UL] > local1) {
      ...
      *((char *)(& state[local1]) + 1) = copy11;
      state[local1] |= (((state[local1] << (((state[0UL] >> (unsigned short)2) & (unsigned short)15) | 1UL)) | (state[local1] >> (16 - (((state[0UL] >> (unsigned short)2) & (unsigned short)15) | 1UL)))) & (unsigned short)63) << 4UL;
    }
    if (state[0UL] == local1) {
      state[local1] |= ((state[local1] + state[local1]) & (unsigned short)15) << 2UL;
    } else {
