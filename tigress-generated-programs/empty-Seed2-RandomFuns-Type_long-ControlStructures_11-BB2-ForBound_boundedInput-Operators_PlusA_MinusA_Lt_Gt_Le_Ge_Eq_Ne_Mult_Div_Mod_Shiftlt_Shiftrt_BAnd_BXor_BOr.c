  ...
  while (local1 < 0UL) {
    ...
    while (local2 < 0UL) {
      ...
      *((char *)(& state[0UL]) + 4) = copy11;
      state[local2] = (state[local2] >> (((state[0UL] >> 2UL) & 15UL) | 1UL)) | (state[local2] << (64 - (((state[0UL] >> 2UL) & 15UL) | 1UL)));
      local2 ++;
    }
    local1 ++;
  }
  output[0UL] = (state[0UL] | 682246734UL) + 981331187UL;
}
}
