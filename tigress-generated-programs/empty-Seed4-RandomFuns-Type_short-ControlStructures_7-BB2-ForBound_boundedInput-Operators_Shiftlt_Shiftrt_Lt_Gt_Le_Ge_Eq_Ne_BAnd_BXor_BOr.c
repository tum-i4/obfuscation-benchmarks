...
{ 
  ...
  if ((state[0UL] >> (unsigned short)1) & (unsigned short)1) {
    ...
    if (state[0UL] & (unsigned short)1) {
      ...
      state[0UL] <<= ((state[0UL] >> (unsigned short)4) & (unsigned short)7) | 1UL;
      state[0UL] <<= ((state[0UL] >> (unsigned short)4) & (unsigned short)7) | 1UL;
    }
  } else
  if ((state[0UL] >> (unsigned short)1) & (unsigned short)1) {
    ...
    *((char *)(& state[0UL]) + 0) = copy15;
    state[0UL] <<= ((state[0UL] >> (unsigned short)2) & (unsigned short)7) | 1UL;
  } else {
    state[0UL] <<= ((state[0UL] >> (unsigned short)1) & (unsigned short)7) | 1UL;
  }
  output[0UL] = (state[0UL] | 415518632UL) >> (unsigned short)7;
}
}
