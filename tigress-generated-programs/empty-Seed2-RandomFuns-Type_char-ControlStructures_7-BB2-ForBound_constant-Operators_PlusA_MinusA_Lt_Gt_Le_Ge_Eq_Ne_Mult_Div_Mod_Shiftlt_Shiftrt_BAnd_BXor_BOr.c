...
{ 
  ...
  if ((state[0UL] >> (unsigned char)1) & (unsigned char)1) {
    state[0UL] |= (((state[0UL] >> (((state[0UL] >> (unsigned char)4) & (unsigned char)15) | 1UL)) | (state[0UL] << (8 - (((state[0UL] >> (unsigned char)4) & (unsigned char)15) | 1UL)))) & (unsigned char)31) << 4UL;
    state[0UL] |= ((state[0UL] << ((state[0UL] & (unsigned char)7) | 1UL)) & (unsigned char)31) << 3UL;
  } else {
    state[0UL] |= (state[0UL] & (unsigned char)15) << 3UL;
    state[0UL] |= (state[0UL] & (unsigned char)15) << 2UL;
  }
  output[0UL] = (state[0UL] | 855068995UL) | (unsigned char)128;
}
}
void megaInit(void) 
{ 
