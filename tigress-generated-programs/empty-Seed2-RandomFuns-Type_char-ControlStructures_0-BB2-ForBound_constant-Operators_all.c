...
{ 
  ...
  if (state[0UL] & (unsigned char)1) {
    state[0UL] |= (((state[0UL] << (((state[0UL] >> (unsigned char)3) & (unsigned char)15) | 1UL)) | (state[0UL] >> (8 - (((state[0UL] >> (unsigned char)3) & (unsigned char)15) | 1UL)))) & (unsigned char)15) << 3UL;
    state[0UL] |= (state[0UL] & (unsigned char)63) << 4UL;
  } else {
    state[0UL] |= ((state[0UL] + state[0UL]) & (unsigned char)15) << 2UL;
    state[0UL] |= ((state[0UL] + state[0UL]) & (unsigned char)15) << 2UL;
  }
  output[0UL] = state[0UL] ^ 95286627UL;
}
}
void megaInit(void) 
{ 
