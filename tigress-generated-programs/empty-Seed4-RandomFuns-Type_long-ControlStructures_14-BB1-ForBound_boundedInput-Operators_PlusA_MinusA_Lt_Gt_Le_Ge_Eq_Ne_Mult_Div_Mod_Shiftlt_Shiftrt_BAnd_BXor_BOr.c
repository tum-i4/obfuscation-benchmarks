...
{ 
  ...
  while (local1 < 0UL) {
    ...
    if (state[0UL] == local1) {
      state[local1] = (state[local1] >> (((state[local1] >> 2UL) & 15UL) | 1UL)) | (state[local1] << (64 - (((state[local1] >> 2UL) & 15UL) | 1UL)));
    } else {
      state[local1] |= ((state[local1] << (((state[local1] >> 2UL) & 7UL) | 1UL)) & 63UL) << 4UL;
    }
    local1 ++;
  }
