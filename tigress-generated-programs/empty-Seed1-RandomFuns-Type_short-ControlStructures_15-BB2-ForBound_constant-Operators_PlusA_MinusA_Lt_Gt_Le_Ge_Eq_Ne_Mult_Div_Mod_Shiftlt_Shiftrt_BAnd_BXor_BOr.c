...
{ 
  ...
  while (local1 < 1UL) {
    ...
    while (local2 < 1UL) {
      if (state[0UL] == local2 * local1) {
        ...
        copy11 = *((char *)(& state[local2]) + 1);
        *((char *)(& state[local2]) + 1) = *((char *)(& state[local2]) + 0);
        *((char *)(& state[local2]) + 0) = copy11;
  ...
  output[0UL] = (((state[0UL] >> (unsigned short)7) | (state[0UL] << (unsigned short)9)) >> (unsigned short)1) | (((state[0UL] >> (unsigned short)7) | (state[0UL] << (unsigned short)9)) << (unsigned short)15);
}
}
void megaInit(void) 
{ 
