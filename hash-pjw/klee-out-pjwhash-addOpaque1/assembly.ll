; ModuleID = './pjwhash-addOpaque1.bc'
...
__str_to_int.exit45.i:                            ; preds = %145
  ...
  br i1 %156, label %.lr.ph.i7, label %__streq.exit.thread.backedge.i, !dbg !2940

.lr.ph.i7:                                        ; preds = %__str_to_int.exit45.i
  %157 = sext i32 %23 to i64
  br label %158, !dbg !2940

; <label>:158                                     ; preds = %__add_arg.exit46.i, %.lr.ph.i7
  %indvars.iv.i = phi i64 [ %157, %.lr.ph.i7 ], [ %indvars.iv.next.i, %__add_arg.exit46.i ]
  %i.0151.i = phi i32 [ 0, %.lr.ph.i7 ], [ %169, %__add_arg.exit46.i ]
  %sym_arg_num.1150.i = phi i32 [ %sym_arg_num.0294.i, %.lr.ph.i7 ], [ %166, %__add_arg.exit46.i ]
  %159 = phi i32 [ %23, %.lr.ph.i7 ], [ %168, %__add_arg.exit46.i ]
...
; <label>:463                                     ; preds = %463, %520
  %p.0.i = phi i8* [ %524, %520 ], [ %466, %463 ]
...
strlen.exit:                                      ; preds = %463
  ...
  %468 = ptrtoint i8* %524 to i64, !dbg !3156
...
.lr.ph.i:                                         ; preds = %strlen.exit
  ...
  br i1 %476, label %.lr.ph.split.us.i.preheader, label %.lr.ph..lr.ph.split_crit_edge.i

.lr.ph.split.us.i.preheader:                      ; preds = %.lr.ph.i
  br i1 %477, label %PJWHash.exit.thread, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph.split.us.i
  %hash.03.us.i4 = phi i32 [ %hash.1.us.i, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %i.04.us.i3 = phi i32 [ %488, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %.05.us.i2 = phi i8* [ %487, %.lr.ph.split.us.i ], [ %524, %.lr.ph.split.us.i.preheader ]
  %478 = shl i32 %hash.03.us.i4, 4
  %479 = load i8* %.05.us.i2, align 1
  %480 = sext i8 %479 to i32
  %481 = add i32 %480, %478
  %482 = and i32 %481, -268435456
  %483 = icmp eq i32 %482, 0
  br i1 %483, label %.lr.ph.split.us.i, label %484

; <label>:484                                     ; preds = %.lr.ph
  %485 = lshr exact i32 %482, 24
  %.masked.us.i = and i32 %481, 268435455
  %486 = xor i32 %485, %.masked.us.i
  br label %.lr.ph.split.us.i

.lr.ph.split.us.i:                                ; preds = %484, %.lr.ph
  %hash.1.us.i = phi i32 [ %486, %484 ], [ %481, %.lr.ph ]
  %487 = getelementptr inbounds i8* %.05.us.i2, i64 1
  %488 = add i32 %i.04.us.i3, 1
  %exitcond = icmp eq i32 %488, %470
  br i1 %exitcond, label %PJWHash.exit, label %.lr.ph

.preheader.i:                                     ; preds = %.lr.ph..lr.ph.split_crit_edge.i, %strlen.exit, %.preheader.i
  br label %.preheader.i

.lr.ph..lr.ph.split_crit_edge.i:                  ; preds = %.lr.ph.i
  br i1 %477, label %PJWHash.exit.thread, label %.preheader.i

PJWHash.exit:                                     ; preds = %.lr.ph.split.us.i
  %489 = icmp eq i32 %hash.1.us.i, 184139465
  br i1 %489, label %490, label %PJWHash.exit.thread

; <label>:490                                     ; preds = %PJWHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %491

PJWHash.exit.thread:                              ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph..lr.ph.split_crit_edge.i, %PJWHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %491

; <label>:491                                     ; preds = %PJWHash.exit.thread, %490
  ret i32 0

; <label>:492                                     ; preds = %460, %452, %rand.exit
  %493 = load i32* %444, align 4, !dbg !3143
  %494 = load i32* %443, align 4, !dbg !3143
  %495 = add nsw i32 %494, %493, !dbg !3143
  store i32 %495, i32* %443, align 4, !dbg !3143
  %496 = lshr i32 %495, 1, !dbg !3144
  %497 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %498 = icmp ult i32* %497, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %499 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %498, label %500, label %rand.exit.1, !dbg !3146

; <label>:500                                     ; preds = %492
  %501 = icmp ult i32* %499, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %501, i32* %499, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %492, %500
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %492 ], [ %497, %500 ]
  %rptr.0.i.i.i.1 = phi i32* [ %499, %492 ], [ %..i.i.i.1, %500 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %502 = tail call i8* @malloc(i64 16) #7
  %503 = bitcast i8* %502 to %struct._1_main__opaque_Node_1*
  %504 = icmp eq i8* %502, null
  br i1 %504, label %520, label %505

; <label>:505                                     ; preds = %rand.exit.1
  %506 = bitcast i8* %502 to i32*
  store i32 %496, i32* %506, align 4
  %507 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %508 = icmp eq %struct._1_main__opaque_Node_1* %507, null
  br i1 %508, label %517, label %509

; <label>:509                                     ; preds = %505
  %510 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %511 = getelementptr inbounds %struct._1_main__opaque_Node_1* %510, i64 0, i32 1
  %512 = load %struct._1_main__opaque_Node_1** %511, align 8
  %513 = getelementptr inbounds i8* %502, i64 8
  %514 = bitcast i8* %513 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %512, %struct._1_main__opaque_Node_1** %514, align 8
  ...
  store %struct._1_main__opaque_Node_1* %503, %struct._1_main__opaque_Node_1** %516, align 8
  br label %520

; <label>:517                                     ; preds = %505
  %518 = getelementptr inbounds i8* %502, i64 8
  %519 = bitcast i8* %518 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %503, %struct._1_main__opaque_Node_1** %519, align 8
  store %struct._1_main__opaque_Node_1* %503, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %520

; <label>:520                                     ; preds = %517, %509, %rand.exit.1
  %521 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %521, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %522 = getelementptr inbounds i8* %329, i64 8
