...
.outer.i.outer:                                   ; preds = %.split19.i, %strlen.exit
  %test.0.ph.i.ph = phi i32 [ undef, %strlen.exit ], [ %450, %.split19.i ]
  %hash.0.ph.i.ph = phi i32 [ undef, %strlen.exit ], [ %449, %.split19.i ]
  %i.0.ph.i.ph = phi i32 [ undef, %strlen.exit ], [ %i.0.ph963.i, %.split19.i ]
  %_1_PJWHash_next.0.ph.i.ph = phi i64 [ 8, %strlen.exit ], [ 3, %.split19.i ]
  %.0.ph.i.ph = phi i8* [ %433, %strlen.exit ], [ %.0.ph1166.i, %.split19.i ]
  %442 = icmp eq i64 %_1_PJWHash_next.0.ph.i.ph, 8
  br i1 %442, label %.split.i.lr.ph, label %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i

.split.i.lr.ph:                                   ; preds = %.outer.i.outer
  tail call void @klee_div_zero_check(i64 4) #7
  tail call void @klee_div_zero_check(i64 8) #7
  br label %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i

.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i: ; preds = %.split.i.lr.ph, %.outer.i.outer
  %_1_PJWHash_next.0.ph.i.lcssa = phi i64 [ 6, %.split.i.lr.ph ], [ %_1_PJWHash_next.0.ph.i.ph, %.outer.i.outer ]
  %i.0.ph.i.lcssa = phi i32 [ 0, %.split.i.lr.ph ], [ %i.0.ph.i.ph, %.outer.i.outer ]
  %hash.0.ph.i.lcssa = phi i32 [ 0, %.split.i.lr.ph ], [ %hash.0.ph.i.ph, %.outer.i.outer ]
  %test.0.ph.i.lcssa = phi i32 [ 0, %.split.i.lr.ph ], [ %test.0.ph.i.ph, %.outer.i.outer ]
  %443 = icmp eq i32 %test.0.ph.i.lcssa, 0
  %.2.i = select i1 %443, i64 1, i64 2
  %444 = lshr i32 %test.0.ph.i.lcssa, 24
  br label %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.i

.outer12..outer12.split_crit_edge.lr.ph.lr.ph.i:  ; preds = %.split25.i, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i
  %.0.ph796.i = phi i8* [ %.0.ph.i.ph, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i ], [ %.0.ph1166.i, %.split25.i ]
  %_1_PJWHash_next.0.ph695.i = phi i64 [ %_1_PJWHash_next.0.ph.i.lcssa, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i ], [ 1, %.split25.i ]
  %i.0.ph594.i = phi i32 [ %i.0.ph.i.lcssa, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i ], [ %i.0.ph963.i, %.split25.i ]
  %hash.0.ph492.i = phi i32 [ %hash.0.ph.i.lcssa, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.lr.ph.i ], [ %451, %.split25.i ]
  br label %.outer12..outer12.split_crit_edge.lr.ph.i

.outer12..outer12.split_crit_edge.lr.ph.i:        ; preds = %.split28.i, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.i
  %.0.ph1166.i = phi i8* [ %.0.ph796.i, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.i ], [ %452, %.split28.i ]
  %_1_PJWHash_next.0.ph1065.i = phi i64 [ %_1_PJWHash_next.0.ph695.i, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.i ], [ 6, %.split28.i ]
  %i.0.ph963.i = phi i32 [ %i.0.ph594.i, %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.i ], [ %453, %.split28.i ]
  %445 = icmp ult i32 %i.0.ph963.i, %441
  %..i = select i1 %445, i64 4, i64 0
  br label %.outer12..outer12.split_crit_edge.i

.outer12..outer12.split_crit_edge.i:              ; preds = %.split22.i, %.outer12..outer12.split_crit_edge.i, %.outer12..outer12.split_crit_edge.lr.ph.i
  %_1_PJWHash_next.0.ph1334.i = phi i64 [ %_1_PJWHash_next.0.ph1065.i, %.outer12..outer12.split_crit_edge.lr.ph.i ], [ %.2.i, %.split22.i ], [ %..i, %.outer12..outer12.split_crit_edge.i ]
  switch i64 %_1_PJWHash_next.0.ph1334.i, label %infloop.i [
    i64 6, label %.outer12..outer12.split_crit_edge.i
    i64 4, label %.split19.i
    i64 3, label %.split22.i
    i64 2, label %.split25.i
    i64 1, label %.split28.i
    i64 0, label %PJWHash.exit
  ]

.split19.i:                                       ; preds = %.outer12..outer12.split_crit_edge.i
  %446 = shl i32 %hash.0.ph492.i, 4
  %447 = load i8* %.0.ph1166.i, align 1
  %448 = sext i8 %447 to i32
  %449 = add i32 %448, %446
  %450 = and i32 %449, -268435456
  br label %.outer.i.outer

.split22.i:                                       ; preds = %.outer12..outer12.split_crit_edge.i
  br label %.outer12..outer12.split_crit_edge.i

.split25.i:                                       ; preds = %.outer12..outer12.split_crit_edge.i
  %hash.0.masked.i = and i32 %hash.0.ph492.i, 268435455
  %451 = xor i32 %hash.0.masked.i, %444
  br label %.outer12..outer12.split_crit_edge.lr.ph.lr.ph.i

.split28.i:                                       ; preds = %.outer12..outer12.split_crit_edge.i
  %452 = getelementptr inbounds i8* %.0.ph1166.i, i64 1
  %453 = add i32 %i.0.ph963.i, 1
  br label %.outer12..outer12.split_crit_edge.lr.ph.i

infloop.i:                                        ; preds = %.outer12..outer12.split_crit_edge.i, %infloop.i
  br label %infloop.i

PJWHash.exit:                                     ; preds = %.outer12..outer12.split_crit_edge.i
  %454 = icmp eq i32 %hash.0.ph492.i, 184139465
  br i1 %454, label %455, label %456

; <label>:455                                     ; preds = %PJWHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %457

; <label>:456                                     ; preds = %PJWHash.exit
