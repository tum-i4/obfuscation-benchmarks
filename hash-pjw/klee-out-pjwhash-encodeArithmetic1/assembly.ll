; ModuleID = './pjwhash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %444, label %.lr.ph.i2, label %PJWHash.exit.thread

.lr.ph.i2:                                        ; preds = %strlen.exit, %466
  %.07.i = phi i8* [ %467, %466 ], [ %433, %strlen.exit ]
  %i.06.i = phi i32 [ %471, %466 ], [ 0, %strlen.exit ]
  %hash.05.i = phi i32 [ %hash.1.i, %466 ], [ 0, %strlen.exit ]
  %445 = shl i32 %hash.05.i, 4
  %446 = load i8* %.07.i, align 1
  %447 = sext i8 %446 to i32
  %448 = xor i32 %447, %445
  %449 = and i32 %447, %445
  %450 = shl i32 %449, 1
  %451 = add i32 %450, %448
  %452 = or i32 %451, -268435456
  %453 = xor i32 %452, 268435455
  %454 = add i32 %451, 1
  %455 = add i32 %454, %453
  %456 = icmp eq i32 %455, 0
  br i1 %456, label %466, label %457

; <label>:457                                     ; preds = %.lr.ph.i2
  %458 = lshr i32 %455, 24
  %459 = xor i32 %458, 268435455
  %460 = or i32 %459, %451
  %.neg4.i = add i32 %451, 268435454
  %461 = sub i32 %.neg4.i, %458
  %462 = sub i32 %461, %460
  %463 = sub i32 %462, %460
  %464 = or i32 %463, -268435456
  %465 = add i32 %464, 268435456
  br label %466

; <label>:466                                     ; preds = %457, %.lr.ph.i2
  %hash.1.i = phi i32 [ %465, %457 ], [ %451, %.lr.ph.i2 ]
  %467 = getelementptr inbounds i8* %.07.i, i64 1
  %468 = xor i32 %i.06.i, 1
  %469 = shl i32 %i.06.i, 1
  %470 = and i32 %469, 2
  %471 = add i32 %470, %468
  ...
  br i1 %478, label %.lr.ph.i2, label %PJWHash.exit

PJWHash.exit:                                     ; preds = %466
  %479 = icmp eq i32 %hash.1.i, 184139465
  br i1 %479, label %480, label %PJWHash.exit.thread
...
; <label>:481                                     ; preds = %PJWHash.exit.thread, %480
  ret i32 0
}
