...
.backedge.i:                                      ; preds = %478, %477, %474, %473, %470, %469, %468, %466, %465, %464, %458, %457, %456, %454, %453, %452, %451, %450, %449, %448, %447, %446, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  %i.0.i = phi i32 [ undef, %strlen.exit ], [ %i.0.i, %.backedge.i ], [ %i.0.i, %478 ], [ %i.0.i, %477 ], [ %476, %474 ], [ %i.0.i, %473 ], [ %i.0.i, %470 ], [ %i.0.i, %469 ], [ %i.0.i, %468 ], [ %i.0.i, %465 ], [ %i.0.i, %464 ], [ %i.0.i, %458 ], [ %i.0
  %test.0.i = phi i32 [ undef, %strlen.exit ], [ %test.0.i, %.backedge.i ], [ %test.0.i, %478 ], [ %test.0.i, %477 ], [ %test.0.i, %474 ], [ %test.0.i, %473 ], [ %test.0.i, %470 ], [ %test.0.i, %469 ], [ %test.0.i, %468 ], [ %test.0.i, %465 ], [ %test.0.
  %hash.0.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.i, %.backedge.i ], [ %hash.0.i, %478 ], [ %hash.0.i, %477 ], [ %hash.0.i, %474 ], [ %hash.0.i, %473 ], [ %472, %470 ], [ %hash.0.i, %469 ], [ %hash.0.i, %468 ], [ %hash.0.i, %465 ], [ %hash.0.i, %4
  %_1_PJWHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_PJWHash_next.0.i, %.backedge.i ], [ %_1_PJWHash_next.0.i, %478 ], [ 6, %477 ], [ %_1_PJWHash_next.0.i, %474 ], [ 1, %473 ], [ %_1_PJWHash_next.0.i, %470 ], [ 1, %469 ], [ 2, %468 ], [ %_1_PJ
  %_2_PJWHash_next.0.i = phi i64 [ 28, %strlen.exit ], [ %_2_PJWHash_next.0.i, %.backedge.i ], [ 2, %478 ], [ 26, %477 ], [ 5, %474 ], [ 26, %473 ], [ 8, %470 ], [ 26, %469 ], [ 26, %468 ], [ 13, %465 ], [ 26, %464 ], [ 16, %458 ], [ 26, %457 ], [ 26, %4
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %.0.i, %.backedge.i ], [ %.0.i, %478 ], [ %.0.i, %477 ], [ %475, %474 ], [ %.0.i, %473 ], [ %.0.i, %470 ], [ %.0.i, %469 ], [ %.0.i, %468 ], [ %.0.i, %465 ], [ %.0.i, %464 ], [ %.0.i, %458 ], [ %.0.i, %457 ], [
  switch i64 %_2_PJWHash_next.0.i, label %.backedge.i [
    i64 28, label %442
    i64 26, label %443
    i64 25, label %451
    i64 24, label %452
    ...
    i64 5, label %477
    i64 3, label %478
    i64 2, label %PJWHash.exit
  ]

; <label>:442                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:443                                     ; preds = %.backedge.i
  switch i64 %_1_PJWHash_next.0.i, label %450 [
...
; <label>:452                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:453                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:454                                     ; preds = %.backedge.i
  %455 = icmp ult i32 %i.0.i, %441
  %..i = select i1 %455, i64 20, i64 19
  br label %.backedge.i

; <label>:456                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:457                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:458                                     ; preds = %.backedge.i
  %459 = shl i32 %hash.0.i, 4
  %460 = load i8* %.0.i, align 1
  %461 = sext i8 %460 to i32
  %462 = add i32 %461, %459
  %463 = and i32 %462, -268435456
  br label %.backedge.i

; <label>:464                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:465                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:466                                     ; preds = %.backedge.i
  %467 = icmp eq i32 %test.0.i, 0
  %.2.i = select i1 %467, i64 11, i64 12
  br label %.backedge.i

; <label>:468                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:469                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:470                                     ; preds = %.backedge.i
  %471 = lshr i32 %test.0.i, 24
  %hash.0.masked.i = and i32 %hash.0.i, 268435455
  %472 = xor i32 %hash.0.masked.i, %471
  br label %.backedge.i

; <label>:473                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:474                                     ; preds = %.backedge.i
  %475 = getelementptr inbounds i8* %.0.i, i64 1
  %476 = add i32 %i.0.i, 1
  br label %.backedge.i

; <label>:477                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:478                                     ; preds = %.backedge.i
  br label %.backedge.i

PJWHash.exit:                                     ; preds = %.backedge.i
  %479 = icmp eq i32 %hash.0.i, 184139465
  br i1 %479, label %480, label %481

; <label>:480                                     ; preds = %PJWHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %482

; <label>:481                                     ; preds = %PJWHash.exit
