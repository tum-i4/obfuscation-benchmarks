; ModuleID = './pjwhash-addOpaque16.bc'
...
; <label>:464                                     ; preds = %464, %561
  %p.0.i = phi i8* [ %565, %561 ], [ %467, %464 ]
...
strlen.exit:                                      ; preds = %464
  ...
  %469 = ptrtoint i8* %565 to i64, !dbg !3156
  %470 = sub i64 %468, %469, !dbg !3156
  %471 = trunc i64 %470 to i32
  %472 = bitcast i8** %1 to i8*
  store i8* %565, i8** %1, align 8
  ...
  %474 = icmp eq %struct._1_main__opaque_Node_1* %473, null
  %475 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %476 = icmp eq %struct._1_main__opaque_Node_1* %475, %473
  br i1 %474, label %515, label %.preheader11.i

.preheader11.i:                                   ; preds = %strlen.exit
  br i1 %476, label %.lr.ph17.i, label %.preheader10.i

.preheader10.i:                                   ; preds = %.preheader11.i, %509, %.preheader10.i
  br label %.preheader10.i

.lr.ph17.i:                                       ; preds = %.preheader11.i, %509
  %477 = phi i8* [ %510, %509 ], [ %565, %.preheader11.i ]
  %i.016.i = phi i32 [ %511, %509 ], [ 0, %.preheader11.i ]
  %test.015.i = phi i32 [ %test.1.i, %509 ], [ 0, %.preheader11.i ]
  %hash.014.i = phi i32 [ %hash.2.i, %509 ], [ 0, %.preheader11.i ]
...
; <label>:481                                     ; preds = %.lr.ph17.i
  %482 = icmp ult i32 %i.016.i, %471
  br i1 %482, label %491, label %483

; <label>:483                                     ; preds = %481
  %484 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %485 = icmp eq %struct._1_main__opaque_Node_1* %484, null
  br i1 %485, label %486, label %487

; <label>:486                                     ; preds = %483
  call void asm sideeffect ".byte 0x6f", "~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !3157
  br label %491

; <label>:487                                     ; preds = %483
  %488 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %489 = icmp eq %struct._1_main__opaque_Node_1* %488, null
  br i1 %489, label %.thread.i, label %PJWHash.exit

; <label>:490                                     ; preds = %.lr.ph17.i
  call void asm sideeffect ".byte 0x0,0x0", "~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !3158
  br label %491

; <label>:491                                     ; preds = %490, %486, %481
  %.pr.i = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %492 = icmp eq %struct._1_main__opaque_Node_1* %.pr.i, null
  br i1 %492, label %.thread.i, label %493

; <label>:493                                     ; preds = %491
  %494 = shl i32 %hash.014.i, 4
  %495 = load i8* %477, align 1
  %496 = sext i8 %495 to i32
  %497 = add i32 %496, %494
  %498 = and i32 %497, -268435456
  br label %.thread.i

.thread.i:                                        ; preds = %493, %491, %487
  %hash.1.i = phi i32 [ %497, %493 ], [ %hash.014.i, %491 ], [ %hash.014.i, %487 ]
  %test.1.i = phi i32 [ %498, %493 ], [ %test.015.i, %491 ], [ %test.015.i, %487 ]
  ...
  %501 = icmp eq %struct._1_main__opaque_Node_1* %499, %500
  br i1 %501, label %504, label %502

; <label>:502                                     ; preds = %.thread.i
  %503 = call fastcc i32 @__user_main(i32 2, i8** %1) #7
  br label %504

; <label>:504                                     ; preds = %502, %.thread.i
  %505 = icmp eq i32 %test.1.i, 0
  br i1 %505, label %509, label %506

; <label>:506                                     ; preds = %504
  %507 = lshr i32 %test.1.i, 24
  %hash.1.masked.i = and i32 %hash.1.i, 268435455
  %508 = xor i32 %507, %hash.1.masked.i
  br label %509

; <label>:509                                     ; preds = %506, %504
  %hash.2.i = phi i32 [ %508, %506 ], [ %hash.1.i, %504 ]
  %510 = getelementptr inbounds i8* %477, i64 1
  store i8* %510, i8** %1, align 8
  %511 = add i32 %i.016.i, 1
  ...
  br i1 %514, label %.lr.ph17.i, label %.preheader10.i

; <label>:515                                     ; preds = %strlen.exit
  br i1 %476, label %._crit_edge.i, label %PJWHash.exit.thread

._crit_edge.i:                                    ; preds = %515
  call void asm sideeffect ".byte 0xf,0x45,0xf9,0x44,0x89", "~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !3159
  %516 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %517 = icmp eq %struct._1_main__opaque_Node_1* %516, null
  br i1 %517, label %.preheader.i, label %thread-pre-split.i

.preheader.i:                                     ; preds = %._crit_edge.i, %.preheader.i
  br label %.preheader.i

thread-pre-split.i:                               ; preds = %522, %._crit_edge.i
  %.pr4.i = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %518

; <label>:518                                     ; preds = %524, %thread-pre-split.i
  %519 = phi %struct._1_main__opaque_Node_1* [ %.pr4.i, %thread-pre-split.i ], [ %525, %524 ]
  %randomVars_BogusReturn10.0.i = phi i32 [ 1, %thread-pre-split.i ], [ %randomVars_BogusReturn10.16.i, %524 ]
  %520 = icmp eq %struct._1_main__opaque_Node_1* %519, null
  br i1 %520, label %.thread5.i, label %522

.thread5.i:                                       ; preds = %518
  %521 = call fastcc i32 @__user_main(i32 %randomVars_BogusReturn10.0.i, i8** %1) #7
  br label %524

; <label>:522                                     ; preds = %518
  %523 = icmp eq i32 %randomVars_BogusReturn10.0.i, 1
  br i1 %523, label %thread-pre-split.i, label %524

; <label>:524                                     ; preds = %522, %.thread5.i
  %randomVars_BogusReturn10.16.i = phi i32 [ 0, %.thread5.i ], [ %randomVars_BogusReturn10.0.i, %522 ]
  %525 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %526 = icmp ne %struct._1_main__opaque_Node_1* %525, null
  %527 = zext i1 %526 to i32
  %528 = icmp eq i32 %527, %randomVars_BogusReturn10.16.i
  br i1 %528, label %518, label %PJWHash.exit

PJWHash.exit.thread:                              ; preds = %515
  call void asm sideeffect ".byte 0xe1,0x52,0x1c,0x3a,0x62", "~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !3160
  br label %531

PJWHash.exit:                                     ; preds = %487, %524
  %.0.i = phi i32 [ %471, %524 ], [ %hash.014.i, %487 ]
  %529 = icmp eq i32 %.0.i, 184139465
  br i1 %529, label %530, label %531

; <label>:530                                     ; preds = %PJWHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %532

; <label>:531                                     ; preds = %PJWHash.exit.thread, %PJWHash.exit
...
; <label>:533                                     ; preds = %461, %453, %rand.exit
  %534 = load i32* %445, align 4, !dbg !3143
  %535 = load i32* %444, align 4, !dbg !3143
  %536 = add nsw i32 %535, %534, !dbg !3143
  store i32 %536, i32* %444, align 4, !dbg !3143
  %537 = lshr i32 %536, 1, !dbg !3144
  %538 = getelementptr inbounds i32* %444, i64 1, !dbg !3145
  %539 = icmp ult i32* %538, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %540 = getelementptr inbounds i32* %445, i64 1, !dbg !3148
  br i1 %539, label %541, label %rand.exit.1, !dbg !3146

; <label>:541                                     ; preds = %533
  %542 = icmp ult i32* %540, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %542, i32* %540, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %533, %541
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %533 ], [ %538, %541 ]
  %rptr.0.i.i.i.1 = phi i32* [ %540, %533 ], [ %..i.i.i.1, %541 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %543 = tail call i8* @malloc(i64 16) #7
  %544 = bitcast i8* %543 to %struct._1_main__opaque_Node_1*
  %545 = icmp eq i8* %543, null
  br i1 %545, label %561, label %546

; <label>:546                                     ; preds = %rand.exit.1
  %547 = bitcast i8* %543 to i32*
...
; <label>:550                                     ; preds = %546
  %551 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  ...
  %554 = getelementptr inbounds i8* %543, i64 8
  %555 = bitcast i8* %554 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %553, %struct._1_main__opaque_Node_1** %555, align 8
  %556 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %557 = getelementptr inbounds %struct._1_main__opaque_Node_1* %556, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %544, %struct._1_main__opaque_Node_1** %557, align 8
  br label %561

; <label>:558                                     ; preds = %546
  %559 = getelementptr inbounds i8* %543, i64 8
  %560 = bitcast i8* %559 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %544, %struct._1_main__opaque_Node_1** %560, align 8
  store %struct._1_main__opaque_Node_1* %544, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %561

; <label>:561                                     ; preds = %558, %550, %rand.exit.1
  %562 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %562, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %563 = getelementptr inbounds i8* %330, i64 8
  %564 = bitcast i8* %563 to i8**
  %565 = load i8** %564, align 8
...
!3157 = metadata !{i32 4200}
!3158 = metadata !{i32 4481}
!3159 = metadata !{i32 5405}
!3160 = metadata !{i32 7620}
