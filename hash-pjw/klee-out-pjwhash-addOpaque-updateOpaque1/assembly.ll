; ModuleID = './pjwhash-addOpaque-updateOpaque1.bc'
...
; <label>:464                                     ; preds = %464, %529
  %p.0.i = phi i8* [ %533, %529 ], [ %467, %464 ]
...
strlen.exit:                                      ; preds = %464
  ...
  %469 = ptrtoint i8* %533 to i64, !dbg !3156
  %470 = sub i64 %468, %469, !dbg !3156
  %471 = trunc i64 %470 to i32
  %472 = bitcast i8** %1 to i8*
  store i8* %533, i8** %1, align 8
  %473 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %474 = icmp eq %struct._1_main__opaque_Node_1* %473, %530
  br i1 %474, label %477, label %475

; <label>:475                                     ; preds = %strlen.exit
  %476 = call fastcc i32 @__user_main(i32 1, i8** %1) #7
  br label %477

; <label>:477                                     ; preds = %475, %strlen.exit
  call void @klee_div_zero_check(i64 4) #7
  call void @klee_div_zero_check(i64 8) #7
  %478 = icmp eq i32 %471, 0
  br i1 %478, label %PJWHash.exit.thread, label %.lr.ph.i3

.lr.ph.i3:                                        ; preds = %477, %495
  %479 = phi i8* [ %496, %495 ], [ %533, %477 ]
  %i.03.i = phi i32 [ %497, %495 ], [ 0, %477 ]
  %hash.02.i = phi i32 [ %hash.1.i, %495 ], [ 0, %477 ]
  %480 = shl i32 %hash.02.i, 4
  %481 = load i8* %479, align 1
  %482 = sext i8 %481 to i32
  %483 = add i32 %482, %480
  %484 = and i32 %483, -268435456
  %485 = icmp eq i32 %484, 0
  br i1 %485, label %495, label %486

; <label>:486                                     ; preds = %.lr.ph.i3
  %487 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %488 = getelementptr inbounds %struct._1_main__opaque_Node_1* %487, i64 0, i32 1
  %489 = load %struct._1_main__opaque_Node_1** %488, align 8
  store %struct._1_main__opaque_Node_1* %489, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %490 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %491 = getelementptr inbounds %struct._1_main__opaque_Node_1* %490, i64 0, i32 1
  ...
  %493 = lshr exact i32 %484, 24
  %.masked.i = and i32 %483, 268435455
  %494 = xor i32 %493, %.masked.i
  br label %495

; <label>:495                                     ; preds = %486, %.lr.ph.i3
  %hash.1.i = phi i32 [ %494, %486 ], [ %483, %.lr.ph.i3 ]
  %496 = getelementptr inbounds i8* %479, i64 1
  store i8* %496, i8** %1, align 8
  %497 = add i32 %i.03.i, 1
  %exitcond.i = icmp eq i32 %497, %471
  br i1 %exitcond.i, label %PJWHash.exit, label %.lr.ph.i3

PJWHash.exit:                                     ; preds = %495
  %498 = icmp eq i32 %hash.1.i, 184139465
  br i1 %498, label %499, label %PJWHash.exit.thread

; <label>:499                                     ; preds = %PJWHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %500

PJWHash.exit.thread:                              ; preds = %477, %PJWHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %500

; <label>:500                                     ; preds = %PJWHash.exit.thread, %499
  ret i32 0

; <label>:501                                     ; preds = %461, %453, %rand.exit
  %502 = load i32* %445, align 4, !dbg !3143
  %503 = load i32* %444, align 4, !dbg !3143
  %504 = add nsw i32 %503, %502, !dbg !3143
  store i32 %504, i32* %444, align 4, !dbg !3143
  %505 = lshr i32 %504, 1, !dbg !3144
  %506 = getelementptr inbounds i32* %444, i64 1, !dbg !3145
  %507 = icmp ult i32* %506, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %508 = getelementptr inbounds i32* %445, i64 1, !dbg !3148
  br i1 %507, label %509, label %rand.exit.1, !dbg !3146

; <label>:509                                     ; preds = %501
  %510 = icmp ult i32* %508, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %510, i32* %508, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %501, %509
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %501 ], [ %506, %509 ]
  %rptr.0.i.i.i.1 = phi i32* [ %508, %501 ], [ %..i.i.i.1, %509 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %511 = tail call i8* @malloc(i64 16) #7
  %512 = bitcast i8* %511 to %struct._1_main__opaque_Node_1*
  %513 = icmp eq i8* %511, null
  br i1 %513, label %529, label %514

; <label>:514                                     ; preds = %rand.exit.1
  %515 = bitcast i8* %511 to i32*
...
; <label>:518                                     ; preds = %514
  ...
  %522 = getelementptr inbounds i8* %511, i64 8
  %523 = bitcast i8* %522 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %521, %struct._1_main__opaque_Node_1** %523, align 8
  %524 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %525 = getelementptr inbounds %struct._1_main__opaque_Node_1* %524, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %512, %struct._1_main__opaque_Node_1** %525, align 8
  br label %529

; <label>:526                                     ; preds = %514
  %527 = getelementptr inbounds i8* %511, i64 8
  %528 = bitcast i8* %527 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %512, %struct._1_main__opaque_Node_1** %528, align 8
  store %struct._1_main__opaque_Node_1* %512, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %529

; <label>:529                                     ; preds = %526, %518, %rand.exit.1
  %530 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %530, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %531 = getelementptr inbounds i8* %330, i64 8
