...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %PJWHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %452
  %.03.i = phi i8* [ %453, %452 ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %454, %452 ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %hash.1.i, %452 ], [ 0, %strlen.exit ]
...
; <label>:449                                     ; preds = %.lr.ph.i
  ...
  %.masked.i = and i32 %446, 268435455
  %451 = xor i32 %450, %.masked.i
  br label %452

; <label>:452                                     ; preds = %449, %.lr.ph.i
  %hash.1.i = phi i32 [ %451, %449 ], [ %446, %.lr.ph.i ]
  %453 = getelementptr inbounds i8* %.03.i, i64 1
  %454 = add i32 %i.02.i, 1
  %exitcond.i = icmp eq i32 %454, %441
  br i1 %exitcond.i, label %PJWHash.exit, label %.lr.ph.i

PJWHash.exit:                                     ; preds = %452
  %455 = icmp eq i32 %hash.1.i, 184139465
  br i1 %455, label %456, label %PJWHash.exit.thread

; <label>:456                                     ; preds = %PJWHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %457

PJWHash.exit.thread:                              ; preds = %strlen.exit, %PJWHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %457

; <label>:457                                     ; preds = %PJWHash.exit.thread, %456
  ret i32 0
}
