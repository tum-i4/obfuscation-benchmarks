; ModuleID = './pjwhash-addOpaque4.bc'
...
__str_to_int.exit45.i:                            ; preds = %145
  ...
  br i1 %156, label %.lr.ph.i5, label %__streq.exit.thread.backedge.i, !dbg !2940

.lr.ph.i5:                                        ; preds = %__str_to_int.exit45.i
  %157 = sext i32 %23 to i64
  br label %158, !dbg !2940

; <label>:158                                     ; preds = %__add_arg.exit46.i, %.lr.ph.i5
  %indvars.iv.i = phi i64 [ %157, %.lr.ph.i5 ], [ %indvars.iv.next.i, %__add_arg.exit46.i ]
  %i.0151.i = phi i32 [ 0, %.lr.ph.i5 ], [ %169, %__add_arg.exit46.i ]
  %sym_arg_num.1150.i = phi i32 [ %sym_arg_num.0294.i, %.lr.ph.i5 ], [ %166, %__add_arg.exit46.i ]
  %159 = phi i32 [ %23, %.lr.ph.i5 ], [ %168, %__add_arg.exit46.i ]
...
; <label>:463                                     ; preds = %463, %532
  %p.0.i = phi i8* [ %536, %532 ], [ %466, %463 ]
...
strlen.exit:                                      ; preds = %463
  ...
  %468 = ptrtoint i8* %536 to i64, !dbg !3156
  %469 = sub i64 %467, %468, !dbg !3156
  %470 = trunc i64 %469 to i32
  tail call void @klee_div_zero_check(i64 4) #7
  tail call void @klee_div_zero_check(i64 8) #7
  %471 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %472 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %473 = icmp eq %struct._1_main__opaque_Node_1* %471, %472
  br i1 %473, label %.lr.ph.i, label %.preheader.i

.preheader.i:                                     ; preds = %strlen.exit, %494, %.preheader.i
  br label %.preheader.i

.lr.ph.i:                                         ; preds = %strlen.exit, %494
  %.06.i = phi i8* [ %495, %494 ], [ %536, %strlen.exit ]
  %i.05.i = phi i32 [ %496, %494 ], [ 0, %strlen.exit ]
  %hash.04.i = phi i32 [ %hash.1.i, %494 ], [ 0, %strlen.exit ]
  %474 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %475 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %476 = icmp eq %struct._1_main__opaque_Node_1* %474, %475
  br i1 %476, label %477, label %483

; <label>:477                                     ; preds = %.lr.ph.i
  %478 = icmp ult i32 %i.05.i, %470
  br i1 %478, label %484, label %479

; <label>:479                                     ; preds = %477
  %480 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %481 = icmp eq %struct._1_main__opaque_Node_1* %480, null
  br i1 %481, label %482, label %PJWHash.exit

; <label>:482                                     ; preds = %479
  tail call void asm sideeffect ".byte 0x6f", "~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !3157
  br label %484

; <label>:483                                     ; preds = %.lr.ph.i
  tail call void asm sideeffect ".byte 0x0,0x0", "~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !3158
  br label %484

; <label>:484                                     ; preds = %483, %482, %477
  %485 = shl i32 %hash.04.i, 4
  %486 = load i8* %.06.i, align 1
...
; <label>:491                                     ; preds = %484
  %492 = lshr exact i32 %489, 24
  %.masked.i = and i32 %488, 268435455
  %493 = xor i32 %492, %.masked.i
  br label %494

; <label>:494                                     ; preds = %491, %484
  %hash.1.i = phi i32 [ %493, %491 ], [ %488, %484 ]
  %495 = getelementptr inbounds i8* %.06.i, i64 1
  %496 = add i32 %i.05.i, 1
  %497 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %498 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %499 = icmp eq %struct._1_main__opaque_Node_1* %497, %498
  br i1 %499, label %.lr.ph.i, label %.preheader.i

PJWHash.exit:                                     ; preds = %479
  %500 = icmp eq i32 %hash.04.i, 184139465
  br i1 %500, label %501, label %502

; <label>:501                                     ; preds = %PJWHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %503

; <label>:502                                     ; preds = %PJWHash.exit
...
; <label>:504                                     ; preds = %460, %452, %rand.exit
  %505 = load i32* %444, align 4, !dbg !3143
  %506 = load i32* %443, align 4, !dbg !3143
  %507 = add nsw i32 %506, %505, !dbg !3143
  store i32 %507, i32* %443, align 4, !dbg !3143
  %508 = lshr i32 %507, 1, !dbg !3144
  %509 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %510 = icmp ult i32* %509, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %511 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %510, label %512, label %rand.exit.1, !dbg !3146

; <label>:512                                     ; preds = %504
  %513 = icmp ult i32* %511, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %513, i32* %511, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %504, %512
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %504 ], [ %509, %512 ]
  %rptr.0.i.i.i.1 = phi i32* [ %511, %504 ], [ %..i.i.i.1, %512 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %514 = tail call i8* @malloc(i64 16) #7
  %515 = bitcast i8* %514 to %struct._1_main__opaque_Node_1*
  %516 = icmp eq i8* %514, null
  br i1 %516, label %532, label %517

; <label>:517                                     ; preds = %rand.exit.1
  %518 = bitcast i8* %514 to i32*
...
; <label>:521                                     ; preds = %517
  %522 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  ...
  %525 = getelementptr inbounds i8* %514, i64 8
  %526 = bitcast i8* %525 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %524, %struct._1_main__opaque_Node_1** %526, align 8
  ...
  store %struct._1_main__opaque_Node_1* %515, %struct._1_main__opaque_Node_1** %528, align 8
  br label %532

; <label>:529                                     ; preds = %517
  %530 = getelementptr inbounds i8* %514, i64 8
  %531 = bitcast i8* %530 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %515, %struct._1_main__opaque_Node_1** %531, align 8
  store %struct._1_main__opaque_Node_1* %515, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %532

; <label>:532                                     ; preds = %529, %521, %rand.exit.1
  %533 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %533, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %534 = getelementptr inbounds i8* %329, i64 8
...
!3157 = metadata !{i32 2895}
!3158 = metadata !{i32 3003}
