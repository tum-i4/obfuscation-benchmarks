...
.backedge.i:                                      ; preds = %463, %462, %461, %460, %459, %458, %457, %456, %449, %448, %447, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  %_1_SDBMHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_SDBMHash_next.0.i, %.backedge.i ], [ %_1_SDBMHash_next.0.i, %463 ], [ %_1_SDBMHash_next.0.i, %462 ], [ %_1_SDBMHash_next.0.i, %461 ], [ %_1_SDBMHash_next.0.i, %460 ], [ 5, %458 ], [ %_1_SDB
  %i.0.i = phi i32 [ undef, %strlen.exit ], [ %i.0.i, %.backedge.i ], [ %i.0.i, %463 ], [ %i.0.i, %462 ], [ %i.0.i, %461 ], [ %i.0.i, %460 ], [ %i.0.i, %458 ], [ %i.0.i, %457 ], [ %i.0.i, %456 ], [ %455, %449 ], [ %i.0.i, %448 ], [ %i.0.i, %447 ], [ %i.0
  %hash.0.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.i, %.backedge.i ], [ %hash.0.i, %463 ], [ %hash.0.i, %462 ], [ %hash.0.i, %461 ], [ %hash.0.i, %460 ], [ %hash.0.i, %458 ], [ %hash.0.i, %457 ], [ %hash.0.i, %456 ], [ %453, %449 ], [ %hash.0.i, %4
  %_2_SDBMHash_next.0.i = phi i64 [ 2, %strlen.exit ], [ %_2_SDBMHash_next.0.i, %.backedge.i ], [ 0, %463 ], [ 17, %462 ], [ 14, %461 ], [ 9, %460 ], [ 0, %458 ], [ 5, %457 ], [ 0, %456 ], [ 8, %449 ], [ 0, %448 ], [ 0, %447 ], [ 13, %444 ], [ 0, %443 ],
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %.0.i, %.backedge.i ], [ %.0.i, %463 ], [ %.0.i, %462 ], [ %.0.i, %461 ], [ %.0.i, %460 ], [ %.0.i, %458 ], [ %.0.i, %457 ], [ %.0.i, %456 ], [ %454, %449 ], [ %.0.i, %448 ], [ %.0.i, %447 ], [ %.0.i, %444 ], [
  switch i64 %_2_SDBMHash_next.0.i, label %.backedge.i [
    i64 17, label %442
    i64 16, label %443
    i64 14, label %444
    i64 13, label %445
...
; <label>:449                                     ; preds = %.backedge.i
  %450 = load i8* %.0.i, align 1
  %451 = sext i8 %450 to i32
  %452 = mul i32 %hash.0.i, 65599
  %453 = add i32 %452, %451
  %454 = getelementptr inbounds i8* %.0.i, i64 1
  %455 = add i32 %i.0.i, 1
  br label %.backedge.i
...
; <label>:459                                     ; preds = %.backedge.i
  switch i64 %_1_SDBMHash_next.0.i, label %463 [
...
SDBMHash.exit:                                    ; preds = %.backedge.i
  %464 = icmp eq i32 %hash.0.i, -1982015890
  br i1 %464, label %465, label %466

; <label>:465                                     ; preds = %SDBMHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %467

; <label>:466                                     ; preds = %SDBMHash.exit
