; ModuleID = './sdbmhash-addOpaque-updateOpaque1.bc'
...
; <label>:33                                      ; preds = %33, %98
  %p.0.i = phi i8* [ %101, %98 ], [ %36, %33 ]
...
strlen.exit:                                      ; preds = %33
  ...
  %38 = ptrtoint i8* %101 to i64, !dbg !2876
...
; <label>:44                                      ; preds = %strlen.exit
  %45 = call fastcc i32 @__user_main(i32 5, i8** %1) #8
  br label %.preheader

.preheader:                                       ; preds = %strlen.exit, %44
  %46 = icmp eq i32 %40, 0
  br i1 %46, label %.critedge, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader
  %.pre = load i8** %1, align 8
  br label %47

; <label>:47                                      ; preds = %47, %.lr.ph
  %48 = phi i8* [ %.pre, %.lr.ph ], [ %53, %47 ]
  %i.0.i4 = phi i32 [ 0, %.lr.ph ], [ %54, %47 ]
  %hash.0.i3 = phi i32 [ 0, %.lr.ph ], [ %52, %47 ]
  %49 = load i8* %48, align 1
  %50 = sext i8 %49 to i32
  %tmp2 = mul i32 %hash.0.i3, 65600
  %51 = sub i32 %50, %hash.0.i3
  %52 = add i32 %51, %tmp2
  %53 = getelementptr inbounds i8* %48, i64 1
  store i8* %53, i8** %1, align 8
  %54 = add i32 %i.0.i4, 1
  %exitcond = icmp eq i32 %54, %40
  br i1 %exitcond, label %.SDBMHash.exit_crit_edge, label %47

.SDBMHash.exit_crit_edge:                         ; preds = %47
  %phitmp = icmp eq i32 %52, -1982015890
  %55 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %56 = getelementptr inbounds %struct._1_main__opaque_Node_1* %55, i64 0, i32 1
  %57 = load %struct._1_main__opaque_Node_1** %56, align 8
  store %struct._1_main__opaque_Node_1* %57, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %58 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %59 = getelementptr inbounds %struct._1_main__opaque_Node_1* %58, i64 0, i32 1
  %60 = load %struct._1_main__opaque_Node_1** %59, align 8
  store %struct._1_main__opaque_Node_1* %60, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br i1 %phitmp, label %61, label %68

; <label>:61                                      ; preds = %.SDBMHash.exit_crit_edge
...
.critedge:                                        ; preds = %.preheader
  ...
  %63 = getelementptr inbounds %struct._1_main__opaque_Node_1* %62, i64 0, i32 1
  ...
  %65 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %66 = getelementptr inbounds %struct._1_main__opaque_Node_1* %65, i64 0, i32 1
  %67 = load %struct._1_main__opaque_Node_1** %66, align 8
  store %struct._1_main__opaque_Node_1* %67, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %68

; <label>:68                                      ; preds = %.critedge, %.SDBMHash.exit_crit_edge
...
; <label>:70                                      ; preds = %30, %22, %rand.exit
  %71 = load i32* %14, align 4, !dbg !2863
  %72 = load i32* %13, align 4, !dbg !2863
  %73 = add nsw i32 %72, %71, !dbg !2863
  store i32 %73, i32* %13, align 4, !dbg !2863
  %74 = lshr i32 %73, 1, !dbg !2864
  %75 = getelementptr inbounds i32* %13, i64 1, !dbg !2865
  %76 = icmp ult i32* %75, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !2866
  %77 = getelementptr inbounds i32* %14, i64 1, !dbg !2868
  br i1 %76, label %78, label %rand.exit.1, !dbg !2866

; <label>:78                                      ; preds = %70
  %79 = icmp ult i32* %77, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !2870
  %..i.i.i.1 = select i1 %79, i32* %77, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !2870
  br label %rand.exit.1, !dbg !2870

rand.exit.1:                                      ; preds = %70, %78
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %70 ], [ %75, %78 ]
  %rptr.0.i.i.i.1 = phi i32* [ %77, %70 ], [ %..i.i.i.1, %78 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !2872
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !2873
  %80 = call i8* @malloc(i64 16) #8
  %81 = bitcast i8* %80 to %struct._1_main__opaque_Node_1*
  %82 = icmp eq i8* %80, null
  br i1 %82, label %98, label %83

; <label>:83                                      ; preds = %rand.exit.1
  %84 = bitcast i8* %80 to i32*
  store i32 %74, i32* %84, align 4
  %85 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %86 = icmp eq %struct._1_main__opaque_Node_1* %85, null
...
; <label>:87                                      ; preds = %83
  ...
  %90 = load %struct._1_main__opaque_Node_1** %89, align 8
  %91 = getelementptr inbounds i8* %80, i64 8
  %92 = bitcast i8* %91 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %90, %struct._1_main__opaque_Node_1** %92, align 8
  ...
  store %struct._1_main__opaque_Node_1* %81, %struct._1_main__opaque_Node_1** %94, align 8
  br label %98

; <label>:95                                      ; preds = %83
  %96 = getelementptr inbounds i8* %80, i64 8
  %97 = bitcast i8* %96 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %81, %struct._1_main__opaque_Node_1** %97, align 8
  store %struct._1_main__opaque_Node_1* %81, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %98

; <label>:98                                      ; preds = %95, %87, %rand.exit.1
  %99 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %99, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %100 = getelementptr inbounds i8** %newArgv, i64 1
