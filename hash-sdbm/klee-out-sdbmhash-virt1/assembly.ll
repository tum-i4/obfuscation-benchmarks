...
%"union._1_SDBMHash_$node" = type { i8* }
...
@"_1_SDBMHash_$array" = internal unnamed_addr constant [1 x [177 x i8]] [[177 x i8] c"U\0C\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00U\10\00\00\00\07\BF\01\00\00\00\07\D6l\0E\00\00\00:\04\00\00\0
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_SDBMHash_$locals.i" = alloca [20 x i8], align 16
  %"_1_SDBMHash_$stack.i" = alloca [1 x [32 x %"union._1_SDBMHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [20 x i8]* %"_1_SDBMHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_SDBMHash_$node"]]* %"_1_SDBMHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_SDBMHash_$node"]]* %"_1_SDBMHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %604, %596, %588, %582, %579, %563, %556, %549, %540, %531, %529, %511, %502, %493, %491, %485, %477, %470, %463, %457, %451, %.backedge.i, %strlen.exit
  %"_1_SDBMHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [177 x i8]]* @"_1_SDBMHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_SDBMHash_$pc.0.0.i", %.backedge.i ], [ %605, %604 ], [ %597, %596 ], [ %589, %588 ], [ %583, %582 ], [ %5
  %"_1_SDBMHash_$sp.0.0.i" = phi %"union._1_SDBMHash_$node"* [ %448, %strlen.exit ], [ %"_1_SDBMHash_$sp.0.0.i", %.backedge.i ], [ %608, %604 ], [ %600, %596 ], [ %592, %588 ], [ %"_1_SDBMHash_$sp.0.0.i", %582 ], [ %580, %579 ], [ %570, %563 ], [ %561, %
  %449 = load i8* %"_1_SDBMHash_$pc.0.0.i", align 1
  %450 = zext i8 %449 to i32
  switch i32 %450, label %.backedge.i [
    i32 34, label %SDBMHash.exit
    i32 150, label %451
    i32 58, label %457
    i32 233, label %463
    i32 7, label %470
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 0, i32 0
...
; <label>:457                                     ; preds = %.backedge.i
  %458 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %459 = bitcast i8* %458 to i32*
  %460 = load i32* %459, align 4
  %461 = sext i32 %460 to i64
  %.sum.i = add i64 %461, 1
  %462 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:463                                     ; preds = %.backedge.i
  %464 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %465 = bitcast i8* %464 to i32*
  %466 = load i32* %465, align 4
  %467 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1
  %468 = bitcast %"union._1_SDBMHash_$node"* %467 to i32*
  store i32 %466, i32* %468, align 4
  %469 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:470                                     ; preds = %.backedge.i
  %471 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %472 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %473 = load i8** %472, align 8
  %474 = bitcast i8* %473 to i32*
  %475 = load i32* %474, align 4
  %476 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  store i32 %475, i32* %476, align 4
  br label %.backedge.i

; <label>:477                                     ; preds = %.backedge.i
  %478 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %479 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %480 = load i32* %479, align 4
  %481 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %482 = load i8** %481, align 8
  %483 = bitcast i8* %482 to i32*
  store i32 %480, i32* %483, align 4
  %484 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:485                                     ; preds = %.backedge.i
  %486 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %487 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %488 = load i32* %487, align 4
  %489 = sext i32 %488 to i64
  %490 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %.c2.i = inttoptr i64 %489 to i8*
  store i8* %.c2.i, i8** %490, align 8
  br label %.backedge.i

; <label>:491                                     ; preds = %.backedge.i
  %492 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:493                                     ; preds = %.backedge.i
  %494 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %495 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1
  %496 = bitcast %"union._1_SDBMHash_$node"* %495 to i32*
  %497 = load i32* %496, align 4
  %498 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %499 = load i32* %498, align 4
  %500 = icmp ult i32 %497, %499
  %501 = zext i1 %500 to i32
  store i32 %501, i32* %496, align 4
  br label %.backedge.i

; <label>:502                                     ; preds = %.backedge.i
  %503 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %504 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %505 = load i8** %504, align 8
  %506 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1
  %507 = bitcast %"union._1_SDBMHash_$node"* %506 to i64*
  %508 = load i64* %507, align 8
  %509 = getelementptr i8* %505, i64 %508
  %510 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %509, i8** %510, align 8
  br label %.backedge.i

; <label>:511                                     ; preds = %.backedge.i
  %512 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %513 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %514 = load i8** %513, align 8
  %515 = load i8* %514, align 1
  %516 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i8*
  store i8 %515, i8* %516, align 1
  br label %.backedge.i

; <label>:517                                     ; preds = %.backedge.i
  %518 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %519 = load i32* %518, align 4
  %520 = icmp eq i32 %519, 0
  br i1 %520, label %527, label %521

; <label>:521                                     ; preds = %517
  %522 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %523 = bitcast i8* %522 to i32*
  %524 = load i32* %523, align 4
  %525 = sext i32 %524 to i64
  %.sum3.i = add i64 %525, 1
  %526 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 %.sum3.i
  br label %529

; <label>:527                                     ; preds = %517
  %528 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 5
  br label %529

; <label>:529                                     ; preds = %527, %521
  %"_1_SDBMHash_$pc.0.1.i" = phi i8* [ %528, %527 ], [ %526, %521 ]
  %530 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:531                                     ; preds = %.backedge.i
  %532 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %533 = bitcast i8* %532 to i32*
  %534 = load i32* %533, align 4
  %535 = sext i32 %534 to i64
  %536 = getelementptr inbounds [20 x i8]* %"_1_SDBMHash_$locals.i", i64 0, i64 %535
  %537 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* %536, i8** %537, align 8
  %538 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1
  %539 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:540                                     ; preds = %.backedge.i
  %541 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %542 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i64*
  %543 = load i64* %542, align 8
  %544 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1
  %545 = bitcast %"union._1_SDBMHash_$node"* %544 to i64*
  %546 = load i64* %545, align 8
  %547 = mul i64 %546, %543
  %548 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %.c1.i = inttoptr i64 %547 to i8*
  store i8* %.c1.i, i8** %548, align 8
  br label %.backedge.i

; <label>:549                                     ; preds = %.backedge.i
  %550 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %551 = bitcast i8* %550 to i32*
  %552 = load i32* %551, align 4
  %553 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1
  %554 = bitcast %"union._1_SDBMHash_$node"* %553 to i32*
  store i32 %552, i32* %554, align 4
  %555 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:556                                     ; preds = %.backedge.i
  %557 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %558 = bitcast i8* %557 to i64*
  %559 = load i64* %558, align 8
  %560 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1, i32 0
  %.c.i = inttoptr i64 %559 to i8*
  store i8* %.c.i, i8** %560, align 8
  %561 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1
  %562 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:563                                     ; preds = %.backedge.i
  %564 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %565 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %566 = load i8** %565, align 8
  %567 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %568 = load i8** %567, align 8
  %569 = bitcast i8* %568 to i8**
  store i8* %566, i8** %569, align 8
  %570 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:571                                     ; preds = %.backedge.i
  %572 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
...
; <label>:575                                     ; preds = %571
  %576 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %576, align 8
  br label %579

; <label>:577                                     ; preds = %571
  %578 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %578, align 8
  br label %579

; <label>:579                                     ; preds = %577, %575, %571
  %580 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 1
  %581 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:582                                     ; preds = %.backedge.i
  %583 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %584 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i8*
  %585 = load i8* %584, align 1
  %586 = sext i8 %585 to i32
  %587 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  store i32 %586, i32* %587, align 4
  br label %.backedge.i

; <label>:588                                     ; preds = %.backedge.i
  %589 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %590 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %591 = load i32* %590, align 4
  %592 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1
  %593 = bitcast %"union._1_SDBMHash_$node"* %592 to i32*
...
; <label>:596                                     ; preds = %.backedge.i
  %597 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %598 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %599 = load i32* %598, align 4
  %600 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1
  %601 = bitcast %"union._1_SDBMHash_$node"* %600 to i32*
...
; <label>:604                                     ; preds = %.backedge.i
  %605 = getelementptr inbounds i8* %"_1_SDBMHash_$pc.0.0.i", i64 1
  %606 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %607 = load i32* %606, align 4
  %608 = getelementptr inbounds %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i", i64 -1
  %609 = bitcast %"union._1_SDBMHash_$node"* %608 to i32*
...
SDBMHash.exit:                                    ; preds = %.backedge.i
  %612 = bitcast %"union._1_SDBMHash_$node"* %"_1_SDBMHash_$sp.0.0.i" to i32*
  %613 = load i32* %612, align 4
  %614 = icmp eq i32 %613, -1982015890
  br i1 %614, label %615, label %616

; <label>:615                                     ; preds = %SDBMHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %617

; <label>:616                                     ; preds = %SDBMHash.exit
