; ModuleID = './sdbmhash-addOpaque-updateOpaque4.bc'
...
; <label>:13                                      ; preds = %0
  %14 = call fastcc i32 @SDBMHash(i8* null, i32 %len)
  br label %.preheader
...
.outer..outer.split_crit_edge:                    ; preds = %.outer..outer.split_crit_edge.preheader, %.outer
  %17 = phi i8* [ %49, %.outer ], [ %str, %.outer..outer.split_crit_edge.preheader ]
  %hash.0.ph9 = phi i32 [ %48, %.outer ], [ 0, %.outer..outer.split_crit_edge.preheader ]
  %i.0.ph8 = phi i32 [ %50, %.outer ], [ 0, %.outer..outer.split_crit_edge.preheader ]
...
.split:                                           ; preds = %.outer, %.preheader
  %hash.0.ph.lcssa = phi i32 [ 0, %.preheader ], [ %48, %.outer ]
...
.outer:                                           ; preds = %.outer..outer.split_crit_edge
  %45 = load i8* %17, align 1
  %46 = sext i8 %45 to i32
  %tmp1 = mul i32 %hash.0.ph9, 65600
  %47 = sub i32 %46, %hash.0.ph9
  %48 = add i32 %47, %tmp1
  %49 = getelementptr inbounds i8* %17, i64 1
  store i8* %49, i8** %1, align 8
  %50 = add i32 %i.0.ph8, 1
  %51 = icmp ult i32 %50, %.0.ph
  br i1 %51, label %.outer..outer.split_crit_edge, label %.split
}
