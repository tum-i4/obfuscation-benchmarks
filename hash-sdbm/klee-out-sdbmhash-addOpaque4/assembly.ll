; ModuleID = './sdbmhash-addOpaque4.bc'
...
define internal fastcc i32 @SDBMHash(i8* nocapture readonly %str, i32 %len) #2 {
...
; <label>:7                                       ; preds = %4
  %8 = tail call fastcc i32 @SDBMHash(i8* null, i32 undef)
  br label %10

; <label>:9                                       ; preds = %0
  tail call void asm sideeffect ".byte 0x34,0x0,0x0,0x55", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3157
  br label %10

; <label>:10                                      ; preds = %7, %4, %9
  %.02 = phi i32 [ %8, %7 ], [ %len, %4 ], [ %len, %9 ]
  ...
  %13 = icmp eq %struct._1_main__opaque_Node_1* %11, %12
  br i1 %13, label %.split.us, label %.preheader

.split.us:                                        ; preds = %10, %15
  %i.0.us = phi i32 [ %21, %15 ], [ 0, %10 ]
  %hash.0.us = phi i32 [ %19, %15 ], [ 0, %10 ]
  %.01.us = phi i8* [ %20, %15 ], [ %str, %10 ]
  %14 = icmp ult i32 %i.0.us, %.02
  br i1 %14, label %15, label %.us-lcssa.us

; <label>:15                                      ; preds = %.split.us
  %16 = load i8* %.01.us, align 1
  %17 = sext i8 %16 to i32
  %tmp3.us = mul i32 %hash.0.us, 65600
  %18 = sub i32 %17, %hash.0.us
  %19 = add i32 %18, %tmp3.us
  %20 = getelementptr inbounds i8* %.01.us, i64 1
  %21 = add i32 %i.0.us, 1
  br label %.split.us

.preheader:                                       ; preds = %10, %.loopexit.split
  %i.0 = phi i32 [ %23, %.loopexit.split ], [ 0, %10 ]
  %22 = icmp ult i32 %i.0, %.02
  br i1 %22, label %.preheader..preheader.split_crit_edge, label %.loopexit.split
