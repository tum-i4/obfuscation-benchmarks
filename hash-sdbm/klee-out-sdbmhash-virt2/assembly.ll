...
%"union._2_SDBMHash_$node" = type { i8* }
...
@"_1_SDBMHash_$array" = internal global [1 x [177 x i8]] [[177 x i8] c"U\0C\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00U\10\00\00\00\07\BF\01\00\00\00\07\D6l\0E\00\00\00:\04\00\00\00:l\00\00\00U\0
@"_2_SDBMHash_$array" = internal unnamed_addr constant [1 x [8684 x i8]] [[8684 x i8] c"\88\18\00\00\00;\00\00\00\00\00\00\00\00R\00\00\00\00\00\00\00\00R\08\00\00\00\00\00\00\00\FDOR\00\00\00\00\00\00\00\00R\00\01\00\00\00\00\00\00\FDO\9E\88\10\00\00\00
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_SDBMHash_$locals.i" = alloca [308 x i8], align 16
  %"_2_SDBMHash_$stack.i" = alloca [1 x [32 x %"union._2_SDBMHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [308 x i8]* %"_2_SDBMHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_SDBMHash_$node"]]* %"_2_SDBMHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_SDBMHash_$node"]]* %"_2_SDBMHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %715, %707, %704, %691, %685, %677, %669, %662, %655, %646, %640, %631, %625, %619, %613, %611, %609, %603, %596, %587, %585, %566, %557, %548, %545, %537, %518, %516, %507, %504, %489, %483, %4
  %"_2_SDBMHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [8684 x i8]]* @"_2_SDBMHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_SDBMHash_$pc.0.0.i", %.backedge.i ], [ %721, %715 ], [ %708, %707 ], [ %706, %704 ], [ %697, %691 ], [ %
  %"_2_SDBMHash_$sp.0.0.i" = phi %"union._2_SDBMHash_$node"* [ %448, %strlen.exit ], [ %"_2_SDBMHash_$sp.0.0.i", %.backedge.i ], [ %720, %715 ], [ %711, %707 ], [ %705, %704 ], [ %695, %691 ], [ %"_2_SDBMHash_$sp.0.0.i", %685 ], [ %681, %677 ], [ %676, %
  %449 = load i8* %"_2_SDBMHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %454 = bitcast %"union._2_SDBMHash_$node"* %453 to i64*
  %455 = load i64* %454, align 8
  %456 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i64*
  %457 = load i64* %456, align 8
  %458 = mul i64 %457, %455
  %459 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %.c4.i = inttoptr i64 %458 to i8*
  store i8* %.c4.i, i8** %459, align 8
  br label %.backedge.i

; <label>:460                                     ; preds = %.backedge.i
  %461 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %462 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %463 = load i8** %462, align 8
  %464 = load i8* %463, align 1
  %465 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i8*
  store i8 %464, i8* %465, align 1
  br label %.backedge.i

; <label>:466                                     ; preds = %.backedge.i
  %467 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %468 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %469 = load i8** %468, align 8
  %470 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %471 = bitcast %"union._2_SDBMHash_$node"* %470 to i64*
  %472 = load i64* %471, align 8
  %473 = getelementptr i8* %469, i64 %472
  %474 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %473, i8** %474, align 8
  br label %.backedge.i

; <label>:475                                     ; preds = %.backedge.i
  %476 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %477 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %478 = load i32* %477, align 4
  %479 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %480 = bitcast %"union._2_SDBMHash_$node"* %479 to i32*
  %481 = load i32* %480, align 4
  %482 = sub i32 %478, %481
  store i32 %482, i32* %480, align 4
  br label %.backedge.i

; <label>:483                                     ; preds = %.backedge.i
  %484 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %485 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %486 = load i8** %485, align 8
  %487 = bitcast i8* %486 to i64*
  %488 = load i64* %487, align 8
  %.c3.i = inttoptr i64 %488 to i8*
  store i8* %.c3.i, i8** %485, align 8
  br label %.backedge.i

; <label>:489                                     ; preds = %.backedge.i
  %490 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %491 = bitcast i8* %490 to i8**
  %492 = load i8** %491, align 8
  %493 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* %492, i8** %493, align 8
  %494 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1
  %495 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:496                                     ; preds = %.backedge.i
  %497 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
...
; <label>:500                                     ; preds = %496
  %501 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %501, align 8
  br label %504

; <label>:502                                     ; preds = %496
  %503 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %503, align 8
  br label %504

; <label>:504                                     ; preds = %502, %500, %496
  %505 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1
  %506 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:507                                     ; preds = %.backedge.i
  %508 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %509 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %510 = bitcast %"union._2_SDBMHash_$node"* %509 to i32*
  %511 = load i32* %510, align 4
  %512 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
...
; <label>:516                                     ; preds = %.backedge.i
  %517 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:518                                     ; preds = %.backedge.i
  %519 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %520 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %521 = load i8** %520, align 8
  %522 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %523 = load i8** %522, align 8
  %524 = bitcast i8* %523 to i8**
  store i8* %521, i8** %524, align 8
  %525 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:526                                     ; preds = %.backedge.i
  %527 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %528 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %529 = load i32* %528, align 4
  %530 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %531 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 5
  %532 = bitcast i8* %531 to i32*
  %533 = load i32* %532, align 4
  %534 = bitcast i8* %527 to i32*
  %535 = load i32* %534, align 4
  %536 = icmp slt i32 %529, %533
  br i1 %536, label %537, label %540

; <label>:537                                     ; preds = %526
  %538 = sext i32 %535 to i64
  %.sum9.i = add i64 %538, 1
  %539 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 %.sum9.i
  br label %.backedge.i

; <label>:540                                     ; preds = %526
  %541 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 9
  %542 = bitcast i8* %541 to i32*
  %543 = load i32* %542, align 4
  %544 = icmp sgt i32 %529, %543
  br i1 %544, label %545, label %548

; <label>:545                                     ; preds = %540
  %546 = sext i32 %535 to i64
  %.sum8.i = add i64 %546, 1
  %547 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:548                                     ; preds = %540
  %549 = sub nsw i32 %529, %533
  %550 = shl nsw i32 %549, 2
  %551 = sext i32 %550 to i64
  %.sum6.i = add i64 %551, 13
  %552 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 %.sum6.i
  %553 = bitcast i8* %552 to i32*
  %554 = load i32* %553, align 4
  %555 = sext i32 %554 to i64
  %.sum7.i = add i64 %555, 1
  %556 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:557                                     ; preds = %.backedge.i
  %558 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %559 = bitcast i8* %558 to i32*
  %560 = load i32* %559, align 4
  %561 = sext i32 %560 to i64
  %562 = getelementptr inbounds [308 x i8]* %"_2_SDBMHash_$locals.i", i64 0, i64 %561
  %563 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* %562, i8** %563, align 8
  %564 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1
  %565 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:566                                     ; preds = %.backedge.i
  %567 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %568 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %569 = load i8** %568, align 8
  %570 = bitcast i8* %569 to i32*
  %571 = load i32* %570, align 4
  %572 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  store i32 %571, i32* %572, align 4
  br label %.backedge.i

; <label>:573                                     ; preds = %.backedge.i
  %574 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %575 = load i32* %574, align 4
  %576 = icmp eq i32 %575, 0
  br i1 %576, label %583, label %577

; <label>:577                                     ; preds = %573
  %578 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %579 = bitcast i8* %578 to i32*
  %580 = load i32* %579, align 4
  %581 = sext i32 %580 to i64
  %.sum5.i = add i64 %581, 1
  %582 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 %.sum5.i
  br label %585

; <label>:583                                     ; preds = %573
  %584 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 5
  br label %585

; <label>:585                                     ; preds = %583, %577
  %"_2_SDBMHash_$pc.0.1.i" = phi i8* [ %584, %583 ], [ %582, %577 ]
  %586 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:587                                     ; preds = %.backedge.i
  %588 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %589 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %590 = bitcast %"union._2_SDBMHash_$node"* %589 to i64*
  %591 = load i64* %590, align 8
  %592 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %593 = load i8** %592, align 8
  %594 = bitcast i8* %593 to i64*
  store i64 %591, i64* %594, align 8
  %595 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:596                                     ; preds = %.backedge.i
  %597 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %598 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %599 = load i8** %598, align 8
  %600 = bitcast i8* %599 to i32*
  %601 = load i32* %600, align 4
  %602 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  store i32 %601, i32* %602, align 4
  br label %.backedge.i

; <label>:603                                     ; preds = %.backedge.i
  %604 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %605 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %606 = load i8** %605, align 8
  %607 = bitcast i8* %606 to i8**
  %608 = load i8** %607, align 8
  store i8* %608, i8** %605, align 8
  br label %.backedge.i

; <label>:609                                     ; preds = %.backedge.i
  %610 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:611                                     ; preds = %.backedge.i
  %612 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:613                                     ; preds = %.backedge.i
  %614 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %615 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %616 = load i32* %615, align 4
  %617 = sext i32 %616 to i64
  %618 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %.c1.i = inttoptr i64 %617 to i8*
  store i8* %.c1.i, i8** %618, align 8
  br label %.backedge.i

; <label>:619                                     ; preds = %.backedge.i
  %620 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %621 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %622 = load i8** %621, align 8
  %623 = load i8* %622, align 1
  %624 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i8*
  store i8 %623, i8* %624, align 1
  br label %.backedge.i

; <label>:625                                     ; preds = %.backedge.i
  %626 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %627 = bitcast i8* %626 to i32*
  %628 = load i32* %627, align 4
  %629 = sext i32 %628 to i64
  %.sum.i = add i64 %629, 1
  %630 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:631                                     ; preds = %.backedge.i
  %632 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %633 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %634 = load i8** %633, align 8
  %635 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %636 = load i32* %635, align 4
  %637 = sext i32 %636 to i64
  %638 = getelementptr i8* %634, i64 %637
  store i8* %638, i8** %633, align 8
  %639 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:640                                     ; preds = %.backedge.i
  %641 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %642 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i8*
  %643 = load i8* %642, align 1
  %644 = zext i8 %643 to i32
  %645 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  store i32 %644, i32* %645, align 4
  br label %.backedge.i

; <label>:646                                     ; preds = %.backedge.i
  %647 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %648 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %649 = bitcast %"union._2_SDBMHash_$node"* %648 to i32*
  %650 = load i32* %649, align 4
  %651 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 0, i32 0
  %652 = load i8** %651, align 8
  %653 = bitcast i8* %652 to i32*
  store i32 %650, i32* %653, align 4
  %654 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:655                                     ; preds = %.backedge.i
  %656 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %657 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i8*
  %658 = load i8* %657, align 1
  %659 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %660 = load i8** %659, align 8
  store i8 %658, i8* %660, align 1
  %661 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:662                                     ; preds = %.backedge.i
  %663 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %664 = bitcast i8* %663 to i32*
  %665 = load i32* %664, align 4
  %666 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1
  %667 = bitcast %"union._2_SDBMHash_$node"* %666 to i32*
  store i32 %665, i32* %667, align 4
  %668 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:669                                     ; preds = %.backedge.i
  %670 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %671 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %672 = load i32* %671, align 4
  %673 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1, i32 0
  %674 = load i8** %673, align 8
  %675 = bitcast i8* %674 to i32*
  store i32 %672, i32* %675, align 4
  %676 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:677                                     ; preds = %.backedge.i
  %678 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %679 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %680 = load i32* %679, align 4
  %681 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %682 = bitcast %"union._2_SDBMHash_$node"* %681 to i32*
...
; <label>:685                                     ; preds = %.backedge.i
  %686 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %687 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i8*
  %688 = load i8* %687, align 1
  %689 = sext i8 %688 to i32
  %690 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  store i32 %689, i32* %690, align 4
  br label %.backedge.i

; <label>:691                                     ; preds = %.backedge.i
  %692 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %693 = bitcast i8* %692 to i32*
  %694 = load i32* %693, align 4
  %695 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1
  %696 = bitcast %"union._2_SDBMHash_$node"* %695 to i32*
  store i32 %694, i32* %696, align 4
  %697 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:698                                     ; preds = %.backedge.i
  %699 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %700 = bitcast i8* %699 to i32*
  %701 = load i32* %700, align 4
  %cond.i = icmp eq i32 %701, 0
  br i1 %cond.i, label %702, label %704

; <label>:702                                     ; preds = %698
  %703 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [177 x i8]]* @"_1_SDBMHash_$array", i64 0, i64 0, i64 0), i8** %703, align 8
  br label %704

; <label>:704                                     ; preds = %702, %698
  %705 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1
  %706 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:707                                     ; preds = %.backedge.i
  %708 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %709 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %710 = load i32* %709, align 4
  %711 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 -1
  %712 = bitcast %"union._2_SDBMHash_$node"* %711 to i32*
...
; <label>:715                                     ; preds = %.backedge.i
  %716 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 1
  %717 = bitcast i8* %716 to i64*
  %718 = load i64* %717, align 8
  %719 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1, i32 0
  %.c.i = inttoptr i64 %718 to i8*
  store i8* %.c.i, i8** %719, align 8
  %720 = getelementptr inbounds %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i", i64 1
  %721 = getelementptr inbounds i8* %"_2_SDBMHash_$pc.0.0.i", i64 9
  br label %.backedge.i

SDBMHash.exit:                                    ; preds = %.backedge.i
  %722 = bitcast %"union._2_SDBMHash_$node"* %"_2_SDBMHash_$sp.0.0.i" to i32*
  %723 = load i32* %722, align 4
  %724 = icmp eq i32 %723, -1982015890
  br i1 %724, label %725, label %726

; <label>:725                                     ; preds = %SDBMHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %727

; <label>:726                                     ; preds = %SDBMHash.exit
