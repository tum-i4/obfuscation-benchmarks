; ModuleID = './sdbmhash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i, label %SDBMHash.exit.thread

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %466, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %469, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %465, %.lr.ph.i ], [ 0, %strlen.exit ]
  %447 = load i8* %.03.i, align 1
  %448 = sext i8 %447 to i32
  %449 = shl i32 %hash.01.i, 6
  %450 = or i32 %448, %449
  %451 = and i32 %448, %449
  %452 = add i32 %450, %451
  %453 = shl i32 %hash.01.i, 16
  %454 = xor i32 %453, -1
  %455 = xor i32 %452, %454
  %456 = load i8* %.03.i, align 1
  ...
  %461 = or i32 %460, %453
  %462 = shl i32 %461, 1
  %463 = sub i32 1, %hash.01.i
  %464 = add i32 %463, %455
  %465 = add i32 %464, %462
  %466 = getelementptr inbounds i8* %.03.i, i64 1
  %467 = or i32 %i.02.i, 1
  %468 = and i32 %i.02.i, 1
  %469 = add i32 %467, %468
  %470 = xor i32 %469, -2147483648
  %471 = and i32 %470, %441
  %472 = xor i32 %469, %442
  %473 = sub i32 %469, %441
  %474 = and i32 %473, %472
  ...
  br i1 %476, label %.lr.ph.i, label %SDBMHash.exit

SDBMHash.exit:                                    ; preds = %.lr.ph.i
  %477 = icmp eq i32 %465, -1982015890
  br i1 %477, label %478, label %SDBMHash.exit.thread

; <label>:478                                     ; preds = %SDBMHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %479

SDBMHash.exit.thread:                             ; preds = %strlen.exit, %SDBMHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %479

; <label>:479                                     ; preds = %SDBMHash.exit.thread, %478
  ret i32 0
}
