; ModuleID = './sdbmhash-addOpaque16.bc'
...
; <label>:8                                       ; preds = %5
  %9 = call fastcc i32 @SDBMHash(i8* null, i32 undef)
  br label %11
...
; <label>:11                                      ; preds = %8, %5, %10
  %.01 = phi i32 [ %9, %8 ], [ %len, %5 ], [ %len, %10 ]
  br label %12

; <label>:12                                      ; preds = %11, %.loopexit5.split
  %13 = phi i8* [ %35, %.loopexit5.split ], [ %str, %11 ]
  %i.0 = phi i32 [ %36, %.loopexit5.split ], [ 0, %11 ]
  %hash.0 = phi i32 [ %34, %.loopexit5.split ], [ 0, %11 ]
...
; <label>:17                                      ; preds = %12
  %18 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %19 = icmp eq %struct._1_main__opaque_Node_1* %18, null
  br i1 %19, label %.loopexit5.split, label %20
...
; <label>:20                                      ; preds = %17
  ...
  br i1 %23, label %24, label %.loopexit5.split

; <label>:24                                      ; preds = %20
  %25 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %26 = icmp eq %struct._1_main__opaque_Node_1* %25, null
  br i1 %26, label %28, label %.preheader4

.preheader4:                                      ; preds = %24
  %27 = icmp ult i32 %i.0, %.01
  br i1 %27, label %.preheader4..preheader4.split_crit_edge, label %.loopexit5.split

.preheader4..preheader4.split_crit_edge:          ; preds = %.preheader4, %.preheader4..preheader4.split_crit_edge
  br label %.preheader4..preheader4.split_crit_edge

; <label>:28                                      ; preds = %24
  call void asm sideeffect ".byte 0x68,0x10,0xa0,0xc4,0x7e", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3158
  br label %.loopexit5.split

; <label>:29                                      ; preds = %12
  %30 = icmp ult i32 %i.0, %.01
  br i1 %30, label %.loopexit5.split, label %37

.loopexit5.split:                                 ; preds = %.preheader4, %17, %29, %28, %20
  %31 = load i8* %13, align 1
  %32 = sext i8 %31 to i32
  %tmp3 = mul i32 %hash.0, 65600
  %33 = sub i32 %32, %hash.0
  %34 = add i32 %33, %tmp3
  %35 = getelementptr inbounds i8* %13, i64 1
...
; <label>:40                                      ; preds = %37
  ...
  %42 = icmp eq %struct._1_main__opaque_Node_1* %41, null
  %43 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %44 = icmp eq %struct._1_main__opaque_Node_1* %41, %43
...
; <label>:46                                      ; preds = %.lr.ph, %46
  %47 = call fastcc i32 @__user_main(i32 0, i8** %45)
  ...
  br i1 %50, label %.loopexit, label %46

; <label>:51                                      ; preds = %40
  br i1 %44, label %.loopexit, label %52

; <label>:52                                      ; preds = %51
  %53 = call fastcc i32 @__user_main(i32 3, i8** %1)
  br label %.loopexit

.loopexit:                                        ; preds = %46, %.preheader, %37, %51, %52
  ret i32 %hash.0
}
...
!3157 = metadata !{i32 3402}
!3158 = metadata !{i32 4141}
