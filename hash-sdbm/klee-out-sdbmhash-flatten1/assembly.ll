...
.outer.outer.i:                                   ; preds = %.split9.i, %strlen.exit
  %i.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %449, %.split9.i ]
  %hash.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %447, %.split9.i ]
  %_1_SDBMHash_next.0.ph.ph.i = phi i64 [ 5, %strlen.exit ], [ 3, %.split9.i ]
  %.0.ph.ph.i = phi i8* [ %433, %strlen.exit ], [ %448, %.split9.i ]
  br label %.outer.i
...
.outer.i:                                         ; preds = %.outer.i, %.outer.outer.i
  ...
  %_1_SDBMHash_next.0.ph.i = phi i64 [ %_1_SDBMHash_next.0.ph.ph.i, %.outer.outer.i ], [ 3, %.outer.i ]
  %442 = icmp eq i64 %_1_SDBMHash_next.0.ph.i, 5
  br i1 %442, label %.outer.i, label %.outer2..outer2.split_crit_edge.lr.ph.i

.outer2..outer2.split_crit_edge.lr.ph.i:          ; preds = %.outer.i
  %443 = icmp ult i32 %i.0.ph.i, %441
  %..i = zext i1 %443 to i64
  br label %.outer2..outer2.split_crit_edge.i

.outer2..outer2.split_crit_edge.i:                ; preds = %.outer2..outer2.split_crit_edge.i, %.outer2..outer2.split_crit_edge.lr.ph.i
  %_1_SDBMHash_next.0.ph315.i = phi i64 [ %_1_SDBMHash_next.0.ph.i, %.outer2..outer2.split_crit_edge.lr.ph.i ], [ %..i, %.outer2..outer2.split_crit_edge.i ]
  switch i64 %_1_SDBMHash_next.0.ph315.i, label %infloop.i [
    i64 3, label %.outer2..outer2.split_crit_edge.i
    i64 1, label %.split9.i
    i64 0, label %SDBMHash.exit
  ]

.split9.i:                                        ; preds = %.outer2..outer2.split_crit_edge.i
  %444 = load i8* %.0.ph.ph.i, align 1
  %445 = sext i8 %444 to i32
  %446 = mul i32 %hash.0.ph.i, 65599
  %447 = add i32 %446, %445
  %448 = getelementptr inbounds i8* %.0.ph.ph.i, i64 1
  %449 = add i32 %i.0.ph.i, 1
  br label %.outer.outer.i

infloop.i:                                        ; preds = %.outer2..outer2.split_crit_edge.i, %infloop.i
  br label %infloop.i

SDBMHash.exit:                                    ; preds = %.outer2..outer2.split_crit_edge.i
  %450 = icmp eq i32 %hash.0.ph.i, -1982015890
  br i1 %450, label %451, label %452

; <label>:451                                     ; preds = %SDBMHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %453

; <label>:452                                     ; preds = %SDBMHash.exit
