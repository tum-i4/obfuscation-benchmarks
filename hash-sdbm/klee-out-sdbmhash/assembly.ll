...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %SDBMHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.04.i = phi i8* [ %447, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.03.i = phi i32 [ %448, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.02.i = phi i32 [ %446, %.lr.ph.i ], [ 0, %strlen.exit ]
  %443 = load i8* %.04.i, align 1
  %444 = sext i8 %443 to i32
  %tmp1.i = mul i32 %hash.02.i, 65600
  %445 = sub i32 %444, %hash.02.i
  %446 = add i32 %445, %tmp1.i
  %447 = getelementptr inbounds i8* %.04.i, i64 1
  %448 = add i32 %i.03.i, 1
  %exitcond.i = icmp eq i32 %448, %441
  br i1 %exitcond.i, label %SDBMHash.exit, label %.lr.ph.i

SDBMHash.exit:                                    ; preds = %.lr.ph.i
  %449 = icmp eq i32 %446, -1982015890
  br i1 %449, label %450, label %SDBMHash.exit.thread

; <label>:450                                     ; preds = %SDBMHash.exit
...
; <label>:451                                     ; preds = %SDBMHash.exit.thread, %450
  ret i32 0
}
