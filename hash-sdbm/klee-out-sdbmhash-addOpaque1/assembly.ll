; ModuleID = './sdbmhash-addOpaque1.bc'
...
.split.us.i:                                      ; preds = %.split.us.i.preheader, %.split.us.i
  %.0.us.i4 = phi i8* [ %478, %.split.us.i ], [ %516, %.split.us.i.preheader ]
  %i.0.us.i3 = phi i32 [ %479, %.split.us.i ], [ 0, %.split.us.i.preheader ]
  %hash.0.us.i2 = phi i32 [ %477, %.split.us.i ], [ 0, %.split.us.i.preheader ]
  %474 = load i8* %.0.us.i4, align 1
  %475 = sext i8 %474 to i32
  %476 = mul i32 %hash.0.us.i2, 65599
  %477 = add i32 %476, %475
  %478 = getelementptr inbounds i8* %.0.us.i4, i64 1
  %479 = add i32 %i.0.us.i3, 1
  %exitcond = icmp eq i32 %479, %470
  br i1 %exitcond, label %.split.us.i.SDBMHash.exit_crit_edge, label %.split.us.i

.preheader.i:                                     ; preds = %strlen.exit, %.preheader.i
  %i.0.i = phi i32 [ %481, %.preheader.i ], [ 0, %strlen.exit ]
  %480 = icmp ult i32 %i.0.i, %470
  %481 = add i32 %i.0.i, 1
  br i1 %480, label %.preheader..preheader.split_crit_edge.i, label %.preheader.i
...
.split.us.i.SDBMHash.exit_crit_edge:              ; preds = %.split.us.i
  %phitmp = icmp eq i32 %477, -1982015890
  br i1 %phitmp, label %482, label %.critedge

; <label>:482                                     ; preds = %.split.us.i.SDBMHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %483

.critedge:                                        ; preds = %.split.us.i.preheader, %.split.us.i.SDBMHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %483

; <label>:483                                     ; preds = %.critedge, %482
  ret i32 0
