; ModuleID = './djbhash-addOpaque1.bc'
...
.split.us.i:                                      ; preds = %.split.us.i.preheader, %.split.us.i
  ...
  %hash.0.us.i2 = phi i32 [ %477, %.split.us.i ], [ 5381, %.split.us.i.preheader ]
  %474 = mul i32 %hash.0.us.i2, 33
  %475 = load i8* %.0.us.i4, align 1
  %476 = sext i8 %475 to i32
  %477 = add i32 %476, %474
  %478 = getelementptr inbounds i8* %.0.us.i4, i64 1
  %479 = add i32 %i.0.us.i3, 1
  %exitcond = icmp eq i32 %479, %470
  br i1 %exitcond, label %.split.us.i.DJBHash.exit_crit_edge, label %.split.us.i
...
.split.us.i.DJBHash.exit_crit_edge:               ; preds = %.split.us.i
  %phitmp = icmp eq i32 %477, 1235568949
  br i1 %phitmp, label %482, label %.critedge

; <label>:482                                     ; preds = %.split.us.i.DJBHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %483

.critedge:                                        ; preds = %.split.us.i.preheader, %.split.us.i.DJBHash.exit_crit_edge
