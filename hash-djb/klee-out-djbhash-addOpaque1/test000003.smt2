...
(assert (and  (and  (and  (and  (=  (_ bv1 32) (concat  (select  model_version (_ bv3 32) ) (concat  (select  model_version (_ bv2 32) ) (concat  (select  model_version (_ bv1 32) ) (select  model_version (_ bv0 32) ) ) ) ) ) (=  false (=  (_ bv0 8) (select  arg0 (_ bv0 32) ) ) ) ) (=  false (=  (_ bv0 8) (select  arg0 (_ bv1 32) ) ) ) ) (=  false (=  (_ bv0 8) (select  arg0 (_ bv2 32) ) ) ) ) (=  (_ bv0 8) (select  arg0 (_ bv3 32) ) ) ) )
