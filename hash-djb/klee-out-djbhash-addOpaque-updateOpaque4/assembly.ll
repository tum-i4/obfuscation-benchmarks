; ModuleID = './djbhash-addOpaque-updateOpaque4.bc'
...
; <label>:13                                      ; preds = %0
  %14 = call fastcc i32 @DJBHash(i8* null, i32 %len)
  br label %.preheader
...
.outer..outer.split_crit_edge:                    ; preds = %.outer..outer.split_crit_edge.preheader, %.outer
  ...
  %hash.0.ph8 = phi i32 [ %48, %.outer ], [ 5381, %.outer..outer.split_crit_edge.preheader ]
  %i.0.ph7 = phi i32 [ %50, %.outer ], [ 0, %.outer..outer.split_crit_edge.preheader ]
...
.split:                                           ; preds = %.outer, %.preheader
  %hash.0.ph.lcssa = phi i32 [ 5381, %.preheader ], [ %48, %.outer ]
