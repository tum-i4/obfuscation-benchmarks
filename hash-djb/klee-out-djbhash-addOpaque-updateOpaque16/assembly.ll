; ModuleID = './djbhash-addOpaque-updateOpaque16.bc'
...
; <label>:5                                       ; preds = %0
  %6 = call fastcc i32 @DJBHash(i8* null, i32 undef)
  br label %7
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  %hash.0.lcssa = phi i32 [ 5381, %.preheader ], [ %120, %._crit_edge.loopexit ]
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  %hash.09 = phi i32 [ %120, %.lr.ph ], [ 5381, %.preheader ]
  %i.08 = phi i32 [ %122, %.lr.ph ], [ 0, %.preheader ]
  %117 = mul i32 %hash.09, 33
...
; <label>:134                                     ; preds = %131
  %135 = call fastcc i32 @DJBHash(i8* null, i32 %.06)
