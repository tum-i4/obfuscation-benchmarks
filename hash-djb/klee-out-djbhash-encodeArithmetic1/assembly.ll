; ModuleID = './djbhash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i, label %DJBHash.exit.thread

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %460, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %461, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %459, %.lr.ph.i ], [ 5381, %strlen.exit ]
  %447 = shl i32 %hash.01.i, 5
  %448 = or i32 %447, %hash.01.i
  %449 = shl i32 %448, 1
  %450 = xor i32 %447, %hash.01.i
  %451 = sub i32 %449, %450
  %452 = load i8* %.03.i, align 1
  ...
  %458 = add i32 %457, %456
  %459 = add i32 %458, %456
  %460 = getelementptr inbounds i8* %.03.i, i64 1
  %461 = add i32 %i.02.i, 1
  %462 = add i32 %i.02.i, -2147483647
  %463 = and i32 %462, %441
  %464 = xor i32 %461, %442
  %465 = sub i32 %461, %441
  %466 = and i32 %465, %464
  ...
  br i1 %468, label %.lr.ph.i, label %DJBHash.exit

DJBHash.exit:                                     ; preds = %.lr.ph.i
  %469 = icmp eq i32 %459, 1235568949
  br i1 %469, label %470, label %DJBHash.exit.thread

; <label>:470                                     ; preds = %DJBHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %471

DJBHash.exit.thread:                              ; preds = %strlen.exit, %DJBHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %471

; <label>:471                                     ; preds = %DJBHash.exit.thread, %470
  ret i32 0
}
