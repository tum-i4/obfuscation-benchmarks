; ModuleID = './djbhash-addOpaque-updateOpaque64.bc'
...
define internal fastcc i32 @DJBHash(i8* %str, i32 %len) #0 {
  %1 = alloca i8*, align 8
...
; <label>:17                                      ; preds = %0
  %18 = call fastcc i32 @DJBHash(i8* null, i32 undef)
...
; <label>:71                                      ; preds = %39
  %72 = call fastcc i32 @DJBHash(i8* null, i32 %len)
...
.outer:                                           ; preds = %414, %.preheader15
  %112 = phi i8* [ %str, %.preheader15 ], [ %419, %414 ]
  ...
  %i.0.ph16 = phi i32 [ 0, %.preheader15 ], [ %420, %414 ]
  %hash.0.ph17 = phi i32 [ 5381, %.preheader15 ], [ %418, %414 ]
...
; <label>:128                                     ; preds = %118
  %129 = call fastcc i32 @DJBHash(i8* null, i32 %i.0.ph16)
...
; <label>:137                                     ; preds = %133
  %138 = call fastcc i32 @DJBHash(i8* null, i32 %i.0.ph16)
...
; <label>:176                                     ; preds = %.thread69
  %177 = call fastcc i32 @DJBHash(i8* null, i32 %.01)
...
; <label>:226                                     ; preds = %.preheader13
  %227 = call fastcc i32 @DJBHash(i8* null, i32 %hash.5)
...
; <label>:396                                     ; preds = %384
  %397 = call fastcc i32 @DJBHash(i8* null, i32 %i.0.ph16)
...
strlen.exit:                                      ; preds = %463
  ...
  %471 = tail call fastcc i32 @DJBHash(i8* %508, i32 %470)
  %472 = icmp eq i32 %471, 1235568949
...
!2857 = metadata !{i32 3881}
!2858 = metadata !{i32 3949}
!2859 = metadata !{i32 15073}
!2860 = metadata !{i32 15204}
!2861 = metadata !{i32 15408}
!2862 = metadata !{i32 23602}
!2863 = metadata !{i32 24153}
!2864 = metadata !{i32 24483}
!2865 = metadata !{i32 25287}
!2866 = metadata !{i32 27355}
