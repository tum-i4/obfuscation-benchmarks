; ModuleID = './djbhash-addOpaque-updateOpaque1.bc'
...
; <label>:47                                      ; preds = %47, %.lr.ph
  ...
  %i.0.i3 = phi i32 [ 0, %.lr.ph ], [ %54, %47 ]
  %hash.0.i2 = phi i32 [ 5381, %.lr.ph ], [ %52, %47 ]
  %49 = mul i32 %hash.0.i2, 33
  ...
  br i1 %exitcond, label %.DJBHash.exit_crit_edge, label %47

.DJBHash.exit_crit_edge:                          ; preds = %47
  %phitmp = icmp eq i32 %52, 1235568949
...
; <label>:61                                      ; preds = %.DJBHash.exit_crit_edge
...
; <label>:68                                      ; preds = %.critedge, %.DJBHash.exit_crit_edge
