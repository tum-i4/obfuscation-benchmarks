...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %DJBHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %447, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %448, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %446, %.lr.ph.i ], [ 5381, %strlen.exit ]
  %443 = mul i32 %hash.01.i, 33
  ...
  br i1 %exitcond.i, label %DJBHash.exit, label %.lr.ph.i

DJBHash.exit:                                     ; preds = %.lr.ph.i
  %449 = icmp eq i32 %446, 1235568949
  br i1 %449, label %450, label %DJBHash.exit.thread

; <label>:450                                     ; preds = %DJBHash.exit
...
; <label>:451                                     ; preds = %DJBHash.exit.thread, %450
  ret i32 0
}
