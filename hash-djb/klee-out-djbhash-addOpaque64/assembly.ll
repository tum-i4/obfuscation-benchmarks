; ModuleID = './djbhash-addOpaque64.bc'
...
define internal fastcc i32 @DJBHash(i8* %str, i32 %len) #2 {
  %1 = alloca i8*, align 8
...
; <label>:4                                       ; preds = %0
  %5 = call fastcc i32 @DJBHash(i8* null, i32 undef)
  br label %6
...
; <label>:13                                      ; preds = %10
  %14 = call fastcc i32 @DJBHash(i8* null, i32 %i.0)
  br label %20
...
.backedge:                                        ; preds = %62, %.thread.thread, %20
  ...
  %hash.0 = phi i32 [ 5381, %20 ], [ 5, %62 ], [ %67, %.thread.thread ]
...
.thread10:                                        ; preds = %73
  %76 = call fastcc i32 @DJBHash(i8* null, i32 %i.1)
...
; <label>:87                                      ; preds = %83
  ...
  br i1 %88, label %.preheader27, label %99

.preheader27:                                     ; preds = %87
...
; <label>:92                                      ; preds = %.preheader27
  %93 = call fastcc i32 @DJBHash(i8* null, i32 %.08)
...
.lr.ph:                                           ; preds = %.lr.phthread-pre-split, %.preheader27
  %94 = phi %struct._1_main__opaque_Node_1* [ %.pr56, %.lr.phthread-pre-split ], [ %89, %.preheader27 ]
...
; <label>:111                                     ; preds = %108
  ...
  %113 = call fastcc i32 @DJBHash(i8* inttoptr (i64 9 to i8*), i32 %112)
  br label %116

; <label>:114                                     ; preds = %108
  %115 = call fastcc i32 @DJBHash(i8* null, i32 %hash.116)
  br label %116
...
.preheader30thread-pre-split:                     ; preds = %.critedge, %104, %119
...
; <label>:120                                     ; preds = %.preheader30thread-pre-split
...
.critedge:                                        ; preds = %99, %145, %123, %130, %150, %148, %149, %134, %124, %.preheader30thread-pre-split
...
; <label>:155                                     ; preds = %152
  %156 = call fastcc i32 @DJBHash(i8* null, i32 %i.1)
  br label %157
...
; <label>:160                                     ; preds = %157
  ...
  br i1 %162, label %thread-pre-split18, label %.preheader31

.preheader31:                                     ; preds = %160
  %163 = getelementptr inbounds i8** %1, i64 -1
  br label %164

; <label>:164                                     ; preds = %.preheader31, %182
...
; <label>:172                                     ; preds = %168
  ...
  br i1 %175, label %.loopexit32, label %182
...
.loopexit32:                                      ; preds = %172, %thread-pre-split18, %.thread14
...
!3157 = metadata !{i32 3618}
!3158 = metadata !{i32 5151}
!3159 = metadata !{i32 8298}
!3160 = metadata !{i32 8885}
!3161 = metadata !{i32 9378}
!3162 = metadata !{i32 9736}
!3163 = metadata !{i32 10001}
!3164 = metadata !{i32 10184}
!3165 = metadata !{i32 10920}
!3166 = metadata !{i32 11232}
!3167 = metadata !{i32 11362}
!3168 = metadata !{i32 12708}
!3169 = metadata !{i32 13946}
!3170 = metadata !{i32 14306}
!3171 = metadata !{i32 14754}
