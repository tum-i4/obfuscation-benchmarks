...
%"union._2_DJBHash_$node" = type { i8* }
...
@"_2_DJBHash_$array" = internal unnamed_addr constant [1 x [8280 x i8]] [[8280 x i8] c"\10\10\00\00\00\E9\08\00\00\00\00\00\00\00\E9\00\00\00\00\00\00\00\00\BC\D1\00\00\00\00\00\00\00\00\89\17\10\18\00\00\00\E9\00\01\00\00\00\00\00\00\E9\00\00\00\00\00\0
@"_1_DJBHash_$array" = internal global [1 x [164 x i8]] [[164 x i8] c"U\0C\00\00\00\EF\05\15\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00U\10\00\00\00\07\BF\01\00\00\00\07l<\0E\00\00\00:\04\00\00\00:_\00\00\00U\0C\0
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_DJBHash_$locals.i" = alloca [308 x i8], align 16
  %"_2_DJBHash_$stack.i" = alloca [1 x [32 x %"union._2_DJBHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [308 x i8]* %"_2_DJBHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_DJBHash_$node"]]* %"_2_DJBHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_DJBHash_$node"]]* %"_2_DJBHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %705, %696, %690, %681, %674, %667, %661, %655, %649, %642, %634, %631, %621, %600, %594, %592, %583, %576, %573, %559, %557, %549, %541, %535, %526, %524, %517, %511, %503, %497, %488, %485, %4
  %"_2_DJBHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [8280 x i8]]* @"_2_DJBHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_DJBHash_$pc.0.0.i", %.backedge.i ], [ %706, %705 ], [ %697, %696 ], [ %691, %690 ], [ %682, %681 ], [ %675
  %"_2_DJBHash_$sp.0.0.i" = phi %"union._2_DJBHash_$node"* [ %448, %strlen.exit ], [ %"_2_DJBHash_$sp.0.0.i", %.backedge.i ], [ %712, %705 ], [ %700, %696 ], [ %"_2_DJBHash_$sp.0.0.i", %690 ], [ %689, %681 ], [ %"_2_DJBHash_$sp.0.0.i", %674 ], [ %672, %6
  %449 = load i8* %"_2_DJBHash_$pc.0.0.i", align 1
  ...
  switch i32 %450, label %.backedge.i [
    ...
    i32 222, label %690
    i32 188, label %696
    i32 73, label %DJBHash.exit
    i32 79, label %705
  ]

; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  %454 = bitcast %"union._2_DJBHash_$node"* %453 to i8*
  %455 = load i8* %454, align 1
  %456 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %457 = load i8** %456, align 8
  store i8 %455, i8* %457, align 1
  %458 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:459                                     ; preds = %.backedge.i
  %460 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %461 = bitcast i8* %460 to i32*
  %462 = load i32* %461, align 4
  %463 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1
  %464 = bitcast %"union._2_DJBHash_$node"* %463 to i32*
  store i32 %462, i32* %464, align 4
  %465 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:466                                     ; preds = %.backedge.i
  %467 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %468 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %469 = load i32* %468, align 4
  %470 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  %471 = bitcast i8* %467 to i32*
  %472 = load i32* %471, align 4
  %473 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 5
  %474 = bitcast i8* %473 to i32*
  %475 = load i32* %474, align 4
  %476 = icmp slt i32 %469, %472
  br i1 %476, label %477, label %480

; <label>:477                                     ; preds = %466
  %478 = sext i32 %475 to i64
  %.sum9.i = add i64 %478, 1
  %479 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 %.sum9.i
  br label %.backedge.i

; <label>:480                                     ; preds = %466
  %481 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 9
...
; <label>:485                                     ; preds = %480
  ...
  %.sum8.i = add i64 %486, 1
  %487 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:488                                     ; preds = %480
  %489 = sub nsw i32 %469, %472
  %490 = shl nsw i32 %489, 2
  %491 = sext i32 %490 to i64
  %.sum6.i = add i64 %491, 13
  %492 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 %.sum6.i
  %493 = bitcast i8* %492 to i32*
  %494 = load i32* %493, align 4
  %495 = sext i32 %494 to i64
  %.sum7.i = add i64 %495, 1
  %496 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:497                                     ; preds = %.backedge.i
  %498 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %499 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %500 = load i8** %499, align 8
  %501 = load i8* %500, align 1
  %502 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i8*
  store i8 %501, i8* %502, align 1
  br label %.backedge.i

; <label>:503                                     ; preds = %.backedge.i
  %504 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %505 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  %506 = bitcast %"union._2_DJBHash_$node"* %505 to i32*
  %507 = load i32* %506, align 4
  %508 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %509 = load i32* %508, align 4
  %510 = add i32 %509, %507
  store i32 %510, i32* %506, align 4
  br label %.backedge.i

; <label>:511                                     ; preds = %.backedge.i
  %512 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %513 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %514 = load i8** %513, align 8
  %515 = bitcast i8* %514 to i64*
  %516 = load i64* %515, align 8
  %.c3.i = inttoptr i64 %516 to i8*
  store i8* %.c3.i, i8** %513, align 8
  br label %.backedge.i

; <label>:517                                     ; preds = %.backedge.i
  %518 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %519 = bitcast i8* %518 to i32*
  %520 = load i32* %519, align 4
  %521 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1
  %522 = bitcast %"union._2_DJBHash_$node"* %521 to i32*
  store i32 %520, i32* %522, align 4
  %523 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:524                                     ; preds = %.backedge.i
  %525 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:526                                     ; preds = %.backedge.i
  %527 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %528 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  %529 = bitcast %"union._2_DJBHash_$node"* %528 to i32*
  %530 = load i32* %529, align 4
  %531 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %532 = load i8** %531, align 8
  %533 = bitcast i8* %532 to i32*
  store i32 %530, i32* %533, align 4
  %534 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:535                                     ; preds = %.backedge.i
  %536 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %537 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %538 = load i8** %537, align 8
  %539 = load i8* %538, align 1
  %540 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i8*
  store i8 %539, i8* %540, align 1
  br label %.backedge.i

; <label>:541                                     ; preds = %.backedge.i
  %542 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %543 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %544 = load i8** %543, align 8
  %545 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %546 = load i8** %545, align 8
  %547 = bitcast i8* %546 to i8**
  store i8* %544, i8** %547, align 8
  %548 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:549                                     ; preds = %.backedge.i
  %550 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %551 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %552 = load i8** %551, align 8
  %553 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i64*
  %554 = load i64* %553, align 8
  %555 = getelementptr i8* %552, i64 %554
  store i8* %555, i8** %551, align 8
  %556 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:557                                     ; preds = %.backedge.i
  %558 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:559                                     ; preds = %.backedge.i
  %560 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %561 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %562 = load i32* %561, align 4
  %563 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  %564 = bitcast %"union._2_DJBHash_$node"* %563 to i32*
...
; <label>:567                                     ; preds = %.backedge.i
  %568 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %569 = bitcast i8* %568 to i32*
  %570 = load i32* %569, align 4
  %cond.i = icmp eq i32 %570, 0
  br i1 %cond.i, label %571, label %573

; <label>:571                                     ; preds = %567
  %572 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [164 x i8]]* @"_1_DJBHash_$array", i64 0, i64 0, i64 0), i8** %572, align 8
  br label %573

; <label>:573                                     ; preds = %571, %567
  %574 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1
  %575 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:576                                     ; preds = %.backedge.i
  %577 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %578 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %579 = load i8** %578, align 8
  %580 = bitcast i8* %579 to i32*
  %581 = load i32* %580, align 4
  %582 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  store i32 %581, i32* %582, align 4
  br label %.backedge.i

; <label>:583                                     ; preds = %.backedge.i
  %584 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %585 = bitcast i8* %584 to i32*
  %586 = load i32* %585, align 4
  %587 = sext i32 %586 to i64
  %588 = getelementptr inbounds [308 x i8]* %"_2_DJBHash_$locals.i", i64 0, i64 %587
  %589 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* %588, i8** %589, align 8
  %590 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1
  %591 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:592                                     ; preds = %.backedge.i
  %593 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:594                                     ; preds = %.backedge.i
  %595 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %596 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i8*
  %597 = load i8* %596, align 1
  %598 = sext i8 %597 to i32
  %599 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  store i32 %598, i32* %599, align 4
  br label %.backedge.i

; <label>:600                                     ; preds = %.backedge.i
  %601 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %602 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %603 = load i32* %602, align 4
  %604 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  %605 = bitcast %"union._2_DJBHash_$node"* %604 to i32*
...
; <label>:609                                     ; preds = %.backedge.i
  %610 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %611 = load i32* %610, align 4
  %612 = icmp eq i32 %611, 0
  br i1 %612, label %619, label %613

; <label>:613                                     ; preds = %609
  %614 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %615 = bitcast i8* %614 to i32*
  %616 = load i32* %615, align 4
  %617 = sext i32 %616 to i64
  %.sum5.i = add i64 %617, 1
  %618 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 %.sum5.i
  br label %621

; <label>:619                                     ; preds = %609
  %620 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 5
  br label %621

; <label>:621                                     ; preds = %619, %613
  %"_2_DJBHash_$pc.0.1.i" = phi i8* [ %620, %619 ], [ %618, %613 ]
  %622 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:623                                     ; preds = %.backedge.i
  %624 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %625 = bitcast i8* %624 to i32*
  %626 = load i32* %625, align 4
  switch i32 %626, label %631 [
    i32 1, label %627
    i32 0, label %629
  ]

; <label>:627                                     ; preds = %623
  %628 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %628, align 8
  br label %631

; <label>:629                                     ; preds = %623
  %630 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %630, align 8
  br label %631

; <label>:631                                     ; preds = %629, %627, %623
  %632 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1
  %633 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:634                                     ; preds = %.backedge.i
  %635 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %636 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %637 = load i32* %636, align 4
  %638 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %639 = load i8** %638, align 8
  %640 = bitcast i8* %639 to i32*
  store i32 %637, i32* %640, align 4
  %641 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:642                                     ; preds = %.backedge.i
  %643 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %644 = bitcast i8* %643 to i8**
  %645 = load i8** %644, align 8
  %646 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* %645, i8** %646, align 8
  %647 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1
  %648 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:649                                     ; preds = %.backedge.i
  %650 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %651 = bitcast i8* %650 to i32*
  %652 = load i32* %651, align 4
  %653 = sext i32 %652 to i64
  %.sum.i = add i64 %653, 1
  %654 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:655                                     ; preds = %.backedge.i
  %656 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %657 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %658 = load i8** %657, align 8
  %659 = bitcast i8* %658 to i8**
  %660 = load i8** %659, align 8
  store i8* %660, i8** %657, align 8
  br label %.backedge.i

; <label>:661                                     ; preds = %.backedge.i
  %662 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %663 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %664 = load i32* %663, align 4
  %665 = sext i32 %664 to i64
  %666 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %.c2.i = inttoptr i64 %665 to i8*
  store i8* %.c2.i, i8** %666, align 8
  br label %.backedge.i

; <label>:667                                     ; preds = %.backedge.i
  %668 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %669 = bitcast i8* %668 to i64*
  %670 = load i64* %669, align 8
  %671 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1, i32 0
  %.c1.i = inttoptr i64 %670 to i8*
  store i8* %.c1.i, i8** %671, align 8
  %672 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 1
  %673 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:674                                     ; preds = %.backedge.i
  %675 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %676 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 0, i32 0
  %677 = load i8** %676, align 8
  %678 = bitcast i8* %677 to i32*
  %679 = load i32* %678, align 4
  %680 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  store i32 %679, i32* %680, align 4
  br label %.backedge.i

; <label>:681                                     ; preds = %.backedge.i
  %682 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %683 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %684 = load i8** %683, align 8
  %685 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %686 = load i32* %685, align 4
  %687 = sext i32 %686 to i64
  %688 = getelementptr i8* %684, i64 %687
  store i8* %688, i8** %683, align 8
  %689 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:690                                     ; preds = %.backedge.i
  %691 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %692 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i8*
  %693 = load i8* %692, align 1
  %694 = zext i8 %693 to i32
  %695 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  store i32 %694, i32* %695, align 4
  br label %.backedge.i

; <label>:696                                     ; preds = %.backedge.i
  %697 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %698 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i64*
  %699 = load i64* %698, align 8
  %700 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1
  %701 = bitcast %"union._2_DJBHash_$node"* %700 to i64*
  %702 = load i64* %701, align 8
  %703 = mul i64 %702, %699
  %704 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %.c.i = inttoptr i64 %703 to i8*
  store i8* %.c.i, i8** %704, align 8
  br label %.backedge.i

; <label>:705                                     ; preds = %.backedge.i
  %706 = getelementptr inbounds i8* %"_2_DJBHash_$pc.0.0.i", i64 1
  %707 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i64*
  %708 = load i64* %707, align 8
  %709 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %710 = load i8** %709, align 8
  %711 = bitcast i8* %710 to i64*
  store i64 %708, i64* %711, align 8
  %712 = getelementptr inbounds %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

DJBHash.exit:                                     ; preds = %.backedge.i
  %713 = bitcast %"union._2_DJBHash_$node"* %"_2_DJBHash_$sp.0.0.i" to i32*
  %714 = load i32* %713, align 4
  %715 = icmp eq i32 %714, 1235568949
  br i1 %715, label %716, label %717

; <label>:716                                     ; preds = %DJBHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %718

; <label>:717                                     ; preds = %DJBHash.exit
