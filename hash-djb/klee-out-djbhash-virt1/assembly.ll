...
%"union._1_DJBHash_$node" = type { i8* }
...
@"_1_DJBHash_$array" = internal unnamed_addr constant [1 x [164 x i8]] [[164 x i8] c"U\0C\00\00\00\EF\05\15\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00U\10\00\00\00\07\BF\01\00\00\00\07l<\0E\00\00\00:\04\00\00\00:_
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_DJBHash_$locals.i" = alloca [20 x i8], align 16
  %"_1_DJBHash_$stack.i" = alloca [1 x [32 x %"union._1_DJBHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [20 x i8]* %"_1_DJBHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_DJBHash_$node"]]* %"_1_DJBHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_DJBHash_$node"]]* %"_1_DJBHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %597, %589, %583, %576, %570, %561, %555, %553, %539, %531, %524, %516, %510, %504, %501, %484, %476, %467, %460, %451, %.backedge.i, %strlen.exit
  %"_1_DJBHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [164 x i8]]* @"_1_DJBHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_DJBHash_$pc.0.0.i", %.backedge.i ], [ %598, %597 ], [ %590, %589 ], [ %584, %583 ], [ %582, %576 ], [ %575,
  %"_1_DJBHash_$sp.0.0.i" = phi %"union._1_DJBHash_$node"* [ %448, %strlen.exit ], [ %"_1_DJBHash_$sp.0.0.i", %.backedge.i ], [ %"_1_DJBHash_$sp.0.0.i", %597 ], [ %593, %589 ], [ %"_1_DJBHash_$sp.0.0.i", %583 ], [ %580, %576 ], [ %"_1_DJBHash_$sp.0.0.i",
  %449 = load i8* %"_1_DJBHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 0, i32 0
  %454 = load i8** %453, align 8
  %455 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1
  %456 = bitcast %"union._1_DJBHash_$node"* %455 to i64*
  %457 = load i64* %456, align 8
  %458 = getelementptr i8* %454, i64 %457
  %459 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %458, i8** %459, align 8
  br label %.backedge.i

; <label>:460                                     ; preds = %.backedge.i
  %461 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %462 = bitcast i8* %461 to i64*
  %463 = load i64* %462, align 8
  %464 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1, i32 0
  %.c2.i = inttoptr i64 %463 to i8*
  store i8* %.c2.i, i8** %464, align 8
  %465 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1
  %466 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:467                                     ; preds = %.backedge.i
  %468 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %469 = bitcast i8* %468 to i32*
  %470 = load i32* %469, align 4
  %471 = sext i32 %470 to i64
  %472 = getelementptr inbounds [20 x i8]* %"_1_DJBHash_$locals.i", i64 0, i64 %471
  %473 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* %472, i8** %473, align 8
  %474 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1
  %475 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:476                                     ; preds = %.backedge.i
  %477 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %478 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %479 = load i8** %478, align 8
  %480 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 0, i32 0
  %481 = load i8** %480, align 8
  %482 = bitcast i8* %481 to i8**
  store i8* %479, i8** %482, align 8
  %483 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:484                                     ; preds = %.backedge.i
  %485 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %486 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i64*
  %487 = load i64* %486, align 8
  %488 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1
  %489 = bitcast %"union._1_DJBHash_$node"* %488 to i64*
  %490 = load i64* %489, align 8
  %491 = mul i64 %490, %487
  %492 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %.c1.i = inttoptr i64 %491 to i8*
  store i8* %.c1.i, i8** %492, align 8
  br label %.backedge.i

; <label>:493                                     ; preds = %.backedge.i
  %494 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
...
; <label>:497                                     ; preds = %493
  %498 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %498, align 8
  br label %501

; <label>:499                                     ; preds = %493
  %500 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %500, align 8
  br label %501

; <label>:501                                     ; preds = %499, %497, %493
  %502 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1
  %503 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:504                                     ; preds = %.backedge.i
  %505 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %506 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 0, i32 0
  %507 = load i8** %506, align 8
  %508 = load i8* %507, align 1
  %509 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i8*
  store i8 %508, i8* %509, align 1
  br label %.backedge.i

; <label>:510                                     ; preds = %.backedge.i
  %511 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %512 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i8*
  %513 = load i8* %512, align 1
  %514 = sext i8 %513 to i32
  %515 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  store i32 %514, i32* %515, align 4
  br label %.backedge.i

; <label>:516                                     ; preds = %.backedge.i
  %517 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %518 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  %519 = load i32* %518, align 4
  %520 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1, i32 0
  %521 = load i8** %520, align 8
  %522 = bitcast i8* %521 to i32*
  store i32 %519, i32* %522, align 4
  %523 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:524                                     ; preds = %.backedge.i
  %525 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %526 = bitcast i8* %525 to i32*
  %527 = load i32* %526, align 4
  %528 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1
  %529 = bitcast %"union._1_DJBHash_$node"* %528 to i32*
  store i32 %527, i32* %529, align 4
  %530 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:531                                     ; preds = %.backedge.i
  %532 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %533 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  %534 = load i32* %533, align 4
  %535 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1
  %536 = bitcast %"union._1_DJBHash_$node"* %535 to i32*
...
; <label>:539                                     ; preds = %.backedge.i
  %540 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:541                                     ; preds = %.backedge.i
  %542 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  %543 = load i32* %542, align 4
  %544 = icmp eq i32 %543, 0
  br i1 %544, label %551, label %545

; <label>:545                                     ; preds = %541
  %546 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %547 = bitcast i8* %546 to i32*
  %548 = load i32* %547, align 4
  %549 = sext i32 %548 to i64
  %.sum3.i = add i64 %549, 1
  %550 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 %.sum3.i
  br label %553

; <label>:551                                     ; preds = %541
  %552 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 5
  br label %553

; <label>:553                                     ; preds = %551, %545
  %"_1_DJBHash_$pc.0.1.i" = phi i8* [ %552, %551 ], [ %550, %545 ]
  %554 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:555                                     ; preds = %.backedge.i
  %556 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %557 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 0, i32 0
...
; <label>:561                                     ; preds = %.backedge.i
  %562 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %563 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1
  %564 = bitcast %"union._1_DJBHash_$node"* %563 to i32*
  %565 = load i32* %564, align 4
  %566 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
...
; <label>:570                                     ; preds = %.backedge.i
  %571 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %572 = bitcast i8* %571 to i32*
  %573 = load i32* %572, align 4
  %574 = sext i32 %573 to i64
  %.sum.i = add i64 %574, 1
  %575 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:576                                     ; preds = %.backedge.i
  %577 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %578 = bitcast i8* %577 to i32*
  %579 = load i32* %578, align 4
  %580 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 1
  %581 = bitcast %"union._1_DJBHash_$node"* %580 to i32*
  store i32 %579, i32* %581, align 4
  %582 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:583                                     ; preds = %.backedge.i
  %584 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %585 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  %586 = load i32* %585, align 4
  %587 = sext i32 %586 to i64
  %588 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 0, i32 0
  %.c.i = inttoptr i64 %587 to i8*
  store i8* %.c.i, i8** %588, align 8
  br label %.backedge.i

; <label>:589                                     ; preds = %.backedge.i
  %590 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %591 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  %592 = load i32* %591, align 4
  %593 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 -1
  %594 = bitcast %"union._1_DJBHash_$node"* %593 to i32*
...
; <label>:597                                     ; preds = %.backedge.i
  %598 = getelementptr inbounds i8* %"_1_DJBHash_$pc.0.0.i", i64 1
  %599 = getelementptr inbounds %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i", i64 0, i32 0
  %600 = load i8** %599, align 8
  %601 = bitcast i8* %600 to i32*
  %602 = load i32* %601, align 4
  %603 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  store i32 %602, i32* %603, align 4
  br label %.backedge.i

DJBHash.exit:                                     ; preds = %.backedge.i
  %604 = bitcast %"union._1_DJBHash_$node"* %"_1_DJBHash_$sp.0.0.i" to i32*
  %605 = load i32* %604, align 4
  %606 = icmp eq i32 %605, 1235568949
  br i1 %606, label %607, label %608

; <label>:607                                     ; preds = %DJBHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %609

; <label>:608                                     ; preds = %DJBHash.exit
