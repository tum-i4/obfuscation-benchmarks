; ModuleID = './djbhash-addOpaque4.bc'
...
define internal fastcc i32 @DJBHash(i8* nocapture readonly %str, i32 %len) #2 {
...
; <label>:7                                       ; preds = %4
  %8 = tail call fastcc i32 @DJBHash(i8* null, i32 undef)
  br label %10
