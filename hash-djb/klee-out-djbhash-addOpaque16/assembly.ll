; ModuleID = './djbhash-addOpaque16.bc'
...
; <label>:8                                       ; preds = %5
  %9 = call fastcc i32 @DJBHash(i8* null, i32 undef)
  br label %11
...
; <label>:12                                      ; preds = %11, %.loopexit4.split
  %13 = phi i8* [ %35, %.loopexit4.split ], [ %str, %11 ]
  %i.0 = phi i32 [ %36, %.loopexit4.split ], [ 0, %11 ]
  %hash.0 = phi i32 [ %34, %.loopexit4.split ], [ 5381, %11 ]
...
; <label>:17                                      ; preds = %12
  ...
  br i1 %19, label %.loopexit4.split, label %20
...
; <label>:20                                      ; preds = %17
  ...
  br i1 %23, label %24, label %.loopexit4.split
...
.preheader3:                                      ; preds = %24
  ...
  br i1 %27, label %.preheader3..preheader3.split_crit_edge, label %.loopexit4.split

.preheader3..preheader3.split_crit_edge:          ; preds = %.preheader3, %.preheader3..preheader3.split_crit_edge
  br label %.preheader3..preheader3.split_crit_edge

; <label>:28                                      ; preds = %24
  call void asm sideeffect ".byte 0x68,0x10,0xa0,0xc4,0x7e", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3158
  br label %.loopexit4.split

; <label>:29                                      ; preds = %12
  %30 = icmp ult i32 %i.0, %.01
  br i1 %30, label %.loopexit4.split, label %37

.loopexit4.split:                                 ; preds = %.preheader3, %17, %29, %28, %20
  %31 = mul i32 %hash.0, 33
  %32 = load i8* %13, align 1
...
!3157 = metadata !{i32 3398}
!3158 = metadata !{i32 4140}
