...
@"_1_APHash_$array" = internal unnamed_addr constant [1 x [273 x i8]] [[273 x i8] c"U\0C\00\00\00\EF\AA\AA\AA\AA\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\10\00\00\00\07\F1\84\0E\00\00\00:\04\00\00\0
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_APHash_$locals.i" = alloca [24 x i8], align 16
  %"_1_APHash_$stack.i" = alloca [1 x [32 x %"union._1_APHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [24 x i8]* %"_1_APHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_APHash_$node"]]* %"_1_APHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_APHash_$node"]]* %"_1_APHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %638, %630, %624, %616, %608, %599, %592, %584, %576, %567, %559, %551, %544, %541, %531, %513, %504, %497, %491, %489, %481, %475, %466, %460, %451, %.backedge.i, %strlen.exit
  %"_1_APHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [273 x i8]]* @"_1_APHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_APHash_$pc.0.0.i", %.backedge.i ], [ %639, %638 ], [ %631, %630 ], [ %625, %624 ], [ %617, %616 ], [ %609, %6
  %"_1_APHash_$sp.0.0.i" = phi %"union._1_APHash_$node"* [ %448, %strlen.exit ], [ %"_1_APHash_$sp.0.0.i", %.backedge.i ], [ %"_1_APHash_$sp.0.0.i", %638 ], [ %634, %630 ], [ %"_1_APHash_$sp.0.0.i", %624 ], [ %620, %616 ], [ %610, %608 ], [ %603, %599 ],
  %449 = load i8* %"_1_APHash_$pc.0.0.i", align 1
  ...
  switch i32 %450, label %.backedge.i [
    ...
    i32 108, label %630
    i32 7, label %638
    i32 34, label %APHash.exit
  ]

; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %453 = bitcast i8* %452 to i32*
  %454 = load i32* %453, align 4
  %455 = sext i32 %454 to i64
  %456 = getelementptr inbounds [24 x i8]* %"_1_APHash_$locals.i", i64 0, i64 %455
  %457 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* %456, i8** %457, align 8
  %458 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1
  %459 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:460                                     ; preds = %.backedge.i
  %461 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %462 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %463 = load i32* %462, align 4
  %464 = sext i32 %463 to i64
  %465 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 0, i32 0
  %.c2.i = inttoptr i64 %464 to i8*
  store i8* %.c2.i, i8** %465, align 8
  br label %.backedge.i

; <label>:466                                     ; preds = %.backedge.i
  %467 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %468 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 0, i32 0
  %469 = load i8** %468, align 8
  %470 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %471 = bitcast %"union._1_APHash_$node"* %470 to i64*
  %472 = load i64* %471, align 8
  %473 = getelementptr i8* %469, i64 %472
  %474 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %473, i8** %474, align 8
  br label %.backedge.i

; <label>:475                                     ; preds = %.backedge.i
  %476 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %477 = bitcast i8* %476 to i32*
  %478 = load i32* %477, align 4
  %479 = sext i32 %478 to i64
  %.sum.i = add i64 %479, 1
  %480 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:481                                     ; preds = %.backedge.i
  %482 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %483 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %484 = load i32* %483, align 4
  %485 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %486 = bitcast %"union._1_APHash_$node"* %485 to i32*
...
; <label>:489                                     ; preds = %.backedge.i
  %490 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:491                                     ; preds = %.backedge.i
  %492 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %493 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 0, i32 0
  %494 = load i8** %493, align 8
...
; <label>:497                                     ; preds = %.backedge.i
  %498 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %499 = bitcast i8* %498 to i32*
  %500 = load i32* %499, align 4
  %501 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1
  %502 = bitcast %"union._1_APHash_$node"* %501 to i32*
  store i32 %500, i32* %502, align 4
  %503 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:504                                     ; preds = %.backedge.i
  %505 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %506 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %507 = load i32* %506, align 4
  %508 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %509 = bitcast %"union._1_APHash_$node"* %508 to i32*
...
; <label>:513                                     ; preds = %.backedge.i
  %514 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %515 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i8*
  %516 = load i8* %515, align 1
  %517 = sext i8 %516 to i32
  %518 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  store i32 %517, i32* %518, align 4
  br label %.backedge.i

; <label>:519                                     ; preds = %.backedge.i
  %520 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %521 = load i32* %520, align 4
  %522 = icmp eq i32 %521, 0
  br i1 %522, label %529, label %523

; <label>:523                                     ; preds = %519
  %524 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %525 = bitcast i8* %524 to i32*
  %526 = load i32* %525, align 4
  %527 = sext i32 %526 to i64
  %.sum3.i = add i64 %527, 1
  %528 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 %.sum3.i
  br label %531

; <label>:529                                     ; preds = %519
  %530 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 5
  br label %531

; <label>:531                                     ; preds = %529, %523
  %"_1_APHash_$pc.0.1.i" = phi i8* [ %530, %529 ], [ %528, %523 ]
  %532 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:533                                     ; preds = %.backedge.i
  %534 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %535 = bitcast i8* %534 to i32*
  %536 = load i32* %535, align 4
  switch i32 %536, label %541 [
    i32 1, label %537
    i32 0, label %539
  ]

; <label>:537                                     ; preds = %533
  %538 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %538, align 8
  br label %541

; <label>:539                                     ; preds = %533
  %540 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %540, align 8
  br label %541

; <label>:541                                     ; preds = %539, %537, %533
  %542 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1
  %543 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:544                                     ; preds = %.backedge.i
  %545 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %546 = bitcast i8* %545 to i64*
  %547 = load i64* %546, align 8
  %548 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1, i32 0
  %.c1.i = inttoptr i64 %547 to i8*
  store i8* %.c1.i, i8** %548, align 8
  %549 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1
  %550 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:551                                     ; preds = %.backedge.i
  %552 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %553 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %554 = load i32* %553, align 4
  %555 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %556 = bitcast %"union._1_APHash_$node"* %555 to i32*
...
; <label>:559                                     ; preds = %.backedge.i
  %560 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %561 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %562 = load i32* %561, align 4
  %563 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1, i32 0
  %564 = load i8** %563, align 8
  %565 = bitcast i8* %564 to i32*
  store i32 %562, i32* %565, align 4
  %566 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:567                                     ; preds = %.backedge.i
  %568 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %569 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i64*
  %570 = load i64* %569, align 8
  %571 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %572 = bitcast %"union._1_APHash_$node"* %571 to i64*
  %573 = load i64* %572, align 8
  %574 = mul i64 %573, %570
  %575 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1, i32 0
  %.c.i = inttoptr i64 %574 to i8*
  store i8* %.c.i, i8** %575, align 8
  br label %.backedge.i

; <label>:576                                     ; preds = %.backedge.i
  %577 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %578 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1, i32 0
  %579 = load i8** %578, align 8
  %580 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 0, i32 0
  %581 = load i8** %580, align 8
  %582 = bitcast i8* %581 to i8**
  store i8* %579, i8** %582, align 8
  %583 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:584                                     ; preds = %.backedge.i
  %585 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %586 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %587 = bitcast %"union._1_APHash_$node"* %586 to i32*
  %588 = load i32* %587, align 4
  %589 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
...
; <label>:592                                     ; preds = %.backedge.i
  %593 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %594 = bitcast i8* %593 to i32*
  %595 = load i32* %594, align 4
  %596 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 1
  %597 = bitcast %"union._1_APHash_$node"* %596 to i32*
  store i32 %595, i32* %597, align 4
  %598 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:599                                     ; preds = %.backedge.i
  %600 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %601 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %602 = load i32* %601, align 4
  %603 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %604 = bitcast %"union._1_APHash_$node"* %603 to i32*
...
; <label>:608                                     ; preds = %.backedge.i
  %609 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %610 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %611 = bitcast %"union._1_APHash_$node"* %610 to i32*
  %612 = load i32* %611, align 4
  %613 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
...
; <label>:616                                     ; preds = %.backedge.i
  %617 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %618 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %619 = load i32* %618, align 4
  %620 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %621 = bitcast %"union._1_APHash_$node"* %620 to i32*
...
; <label>:624                                     ; preds = %.backedge.i
  %625 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %626 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 0, i32 0
  %627 = load i8** %626, align 8
  %628 = load i8* %627, align 1
  %629 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i8*
  store i8 %628, i8* %629, align 1
  br label %.backedge.i

; <label>:630                                     ; preds = %.backedge.i
  %631 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %632 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %633 = load i32* %632, align 4
  %634 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 -1
  %635 = bitcast %"union._1_APHash_$node"* %634 to i32*
  %636 = load i32* %635, align 4
  %637 = lshr i32 %633, %636
  store i32 %637, i32* %635, align 4
  br label %.backedge.i

; <label>:638                                     ; preds = %.backedge.i
  %639 = getelementptr inbounds i8* %"_1_APHash_$pc.0.0.i", i64 1
  %640 = getelementptr inbounds %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i", i64 0, i32 0
  %641 = load i8** %640, align 8
  %642 = bitcast i8* %641 to i32*
  %643 = load i32* %642, align 4
  %644 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  store i32 %643, i32* %644, align 4
  br label %.backedge.i

APHash.exit:                                      ; preds = %.backedge.i
  %645 = bitcast %"union._1_APHash_$node"* %"_1_APHash_$sp.0.0.i" to i32*
  %646 = load i32* %645, align 4
  %647 = icmp eq i32 %646, 37524292
  br i1 %647, label %648, label %649

; <label>:648                                     ; preds = %APHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %650

; <label>:649                                     ; preds = %APHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %650

; <label>:650                                     ; preds = %649, %648
  ret i32 0
}
