...
.backedge.i:                                      ; preds = %487, %486, %482, %481, %473, %472, %465, %464, %463, %459, %458, %457, %456, %454, %453, %452, %451, %450, %449, %448, %447, %446, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  %_1_APHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_APHash_next.0.i, %.backedge.i ], [ %_1_APHash_next.0.i, %487 ], [ 6, %486 ], [ %_1_APHash_next.0.i, %482 ], [ 1, %481 ], [ %_1_APHash_next.0.i, %473 ], [ 1, %472 ], [ %_1_APHash_next.0.i, %46
  %tmp.0.i = phi i32 [ undef, %strlen.exit ], [ %tmp.0.i, %.backedge.i ], [ %tmp.0.i, %487 ], [ %tmp.0.i, %486 ], [ %tmp.0.i, %482 ], [ %tmp.0.i, %481 ], [ %480, %473 ], [ %tmp.0.i, %472 ], [ %471, %465 ], [ %tmp.0.i, %464 ], [ %tmp.0.i, %463 ], [ %tmp.0
  %i.0.i = phi i32 [ undef, %strlen.exit ], [ %i.0.i, %.backedge.i ], [ %i.0.i, %487 ], [ %i.0.i, %486 ], [ %485, %482 ], [ %i.0.i, %481 ], [ %i.0.i, %473 ], [ %i.0.i, %472 ], [ %i.0.i, %465 ], [ %i.0.i, %464 ], [ %i.0.i, %463 ], [ %i.0.i, %458 ], [ %i.0
  %hash.0.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.i, %.backedge.i ], [ %hash.0.i, %487 ], [ %hash.0.i, %486 ], [ %483, %482 ], [ %hash.0.i, %481 ], [ %hash.0.i, %473 ], [ %hash.0.i, %472 ], [ %hash.0.i, %465 ], [ %hash.0.i, %464 ], [ %hash.0.i, %4
  %_2_APHash_next.0.i = phi i64 [ 28, %strlen.exit ], [ %_2_APHash_next.0.i, %.backedge.i ], [ 2, %487 ], [ 26, %486 ], [ 5, %482 ], [ 26, %481 ], [ 8, %473 ], [ 26, %472 ], [ 11, %465 ], [ 26, %464 ], [ 26, %463 ], [ 16, %458 ], [ 26, %457 ], [ 26, %456
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %.0.i, %.backedge.i ], [ %.0.i, %487 ], [ %.0.i, %486 ], [ %484, %482 ], [ %.0.i, %481 ], [ %.0.i, %473 ], [ %.0.i, %472 ], [ %.0.i, %465 ], [ %.0.i, %464 ], [ %.0.i, %463 ], [ %.0.i, %458 ], [ %.0.i, %457 ], [
  switch i64 %_2_APHash_next.0.i, label %.backedge.i [
    i64 28, label %442
    i64 26, label %443
    i64 25, label %451
    i64 24, label %452
...
; <label>:443                                     ; preds = %.backedge.i
  switch i64 %_1_APHash_next.0.i, label %450 [
...
; <label>:465                                     ; preds = %.backedge.i
  %466 = shl i32 %hash.0.i, 7
  %467 = load i8* %.0.i, align 1
  %468 = sext i8 %467 to i32
  %469 = lshr i32 %hash.0.i, 3
  %470 = mul i32 %468, %469
  %471 = xor i32 %470, %466
  br label %.backedge.i

; <label>:472                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:473                                     ; preds = %.backedge.i
  %474 = shl i32 %hash.0.i, 11
  %475 = load i8* %.0.i, align 1
  %476 = sext i8 %475 to i32
  %477 = lshr i32 %hash.0.i, 5
  %478 = xor i32 %476, %477
  %479 = add i32 %478, %474
  %480 = xor i32 %479, -1
  br label %.backedge.i
...
; <label>:482                                     ; preds = %.backedge.i
  %483 = xor i32 %hash.0.i, %tmp.0.i
  %484 = getelementptr inbounds i8* %.0.i, i64 1
  %485 = add i32 %i.0.i, 1
  br label %.backedge.i

; <label>:486                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:487                                     ; preds = %.backedge.i
  br label %.backedge.i

APHash.exit:                                      ; preds = %.backedge.i
  %488 = icmp eq i32 %hash.0.i, 37524292
  br i1 %488, label %489, label %490

; <label>:489                                     ; preds = %APHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %491

; <label>:490                                     ; preds = %APHash.exit
