...
{ 
  ...
  if (_1_main__opaque_list1_1 == _1_main__opaque_list2_1) {
    if (_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) {
      while ((_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) == randomVars_BogusReturn38) {
  ...
  if ((_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) <= randomVars_BogusReturn38) {
    if ((_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) > randomVars_BogusReturn38) {
      while ((_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) < randomVars_BogusReturn38) {
        hash = i;
        i = 0U * len;
    ...
    while (1) {
      if (((_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) == randomVars_BogusReturn38) == randomVars_BogusReturn38) {
        return (i);
      } else {
  ...
  while (1) {
    if (! (i < len)) {
      ...
      if (_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) {
        randomVars_BogusReturn38 = main(9, & str);
      } else {
    ...
    if ((i & 1U) == 0U) {
      ...
      if (_1_main__opaque_list2_1 != (struct _1_main__opaque_Node_1 *)0UL) {
        ...
        if (_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) {
          while ((_1_main__opaque_list2_1 != (struct _1_main__opaque_Node_1 *)0UL) != randomVars_BogusReturn38) {
      ...
      if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
        while ((_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) >= randomVars_BogusReturn38) {
          tmp = ~ ((hash << 11) + ((unsigned int )*str ^ (hash >> 5))) >> tmp;
        }
      } else
      if (_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) {
