...
define internal fastcc i32 @APHash(i8* nocapture readonly %str, i32 %len) #0 {
  %1 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %2 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %3 = icmp eq %struct._1_main__opaque_Node_1* %1, %2
  br i1 %3, label %.preheader1, label %4

; <label>:4                                       ; preds = %0
  %5 = tail call fastcc i32 @APHash(i8* null, i32 0)
  br label %.preheader1

.preheader1:                                      ; preds = %4, %0
  %i.0.ph = phi i32 [ 0, %0 ], [ %5, %4 ]
  ...
  br i1 %8, label %.lr.ph.lr.ph, label %.preheader

.lr.ph.lr.ph:                                     ; preds = %.preheader1
...
.lr.ph:                                           ; preds = %.lr.ph.lr.ph, %.outer
  %.0.ph20 = phi i8* [ %str, %.lr.ph.lr.ph ], [ %50, %.outer ]
  %tmp.0.ph19 = phi i32 [ undef, %.lr.ph.lr.ph ], [ %tmp.1.lcssa, %.outer ]
  %hash.0.ph18 = phi i32 [ -1431655766, %.lr.ph.lr.ph ], [ %.lcssa, %.outer ]
  %i.0.ph217 = phi i32 [ %i.0.ph, %.lr.ph.lr.ph ], [ %51, %.outer ]
  br i1 %11, label %.lr.ph.split.us.split.us, label %.lr.ph.split..lr.ph.split.split_crit_edge

.lr.ph.split.us.split.us:                         ; preds = %.lr.ph, %33
  %hash.08.us.us = phi i32 [ %34, %33 ], [ %hash.0.ph18, %.lr.ph ]
  %i.07.us.us = phi i32 [ %36, %33 ], [ %i.0.ph217, %.lr.ph ]
  %13 = icmp ult i32 %i.07.us.us, %len
  br i1 %13, label %14, label %.us-lcssa.us

; <label>:14                                      ; preds = %.lr.ph.split.us.split.us
  %15 = and i32 %i.07.us.us, 1
  %16 = icmp eq i32 %15, 0
  br i1 %16, label %25, label %17

; <label>:17                                      ; preds = %14
  %18 = shl i32 %hash.08.us.us, 11
  %19 = load i8* %.0.ph20, align 1
  %20 = sext i8 %19 to i32
  %21 = lshr i32 %hash.08.us.us, 5
  %22 = xor i32 %20, %21
  %23 = add i32 %22, %18
  %24 = xor i32 %23, -1
...
; <label>:25                                      ; preds = %14
  %26 = shl i32 %hash.08.us.us, 7
  %27 = load i8* %.0.ph20, align 1
  %28 = sext i8 %27 to i32
  %29 = lshr i32 %hash.08.us.us, 3
  %30 = mul i32 %28, %29
  %31 = xor i32 %30, %26
  br label %thread-pre-split.us.us

thread-pre-split.us.us:                           ; preds = %17, %25
  %tmp.1.ph.us.us = phi i32 [ %31, %25 ], [ %24, %17 ]
  %32 = xor i32 %tmp.1.ph.us.us, %hash.08.us.us
  br i1 %12, label %33, label %.outer

; <label>:33                                      ; preds = %thread-pre-split.us.us
  %34 = shl i32 %32, 7
  %35 = add i32 %i.07.us.us, 1
  %36 = lshr i32 %35, %tmp.1.ph.us.us
  br label %.lr.ph.split.us.split.us

.preheader:                                       ; preds = %.preheader1, %48, %.outer, %.preheader
  br label %.preheader

.lr.ph.split..lr.ph.split.split_crit_edge:        ; preds = %.lr.ph
  %37 = icmp ult i32 %i.0.ph217, %len
  br i1 %37, label %38, label %.us-lcssa.us

; <label>:38                                      ; preds = %.lr.ph.split..lr.ph.split.split_crit_edge
  %39 = and i32 %i.0.ph217, 1
  %40 = icmp eq i32 %39, 0
  br i1 %40, label %48, label %thread-pre-split

thread-pre-split:                                 ; preds = %38
  %41 = shl i32 %hash.0.ph18, 11
  %42 = load i8* %.0.ph20, align 1
  %43 = sext i8 %42 to i32
  %44 = lshr i32 %hash.0.ph18, 5
  %45 = xor i32 %43, %44
  %46 = add i32 %45, %41
  %47 = xor i32 %46, -1
  br label %48

; <label>:48                                      ; preds = %38, %thread-pre-split
  %tmp.1 = phi i32 [ %47, %thread-pre-split ], [ %tmp.0.ph19, %38 ]
  br i1 %12, label %.preheader, label %.us-lcssa10.us-lcssa

.us-lcssa10.us-lcssa:                             ; preds = %48
  %49 = xor i32 %tmp.1, %hash.0.ph18
  br label %.outer

.outer:                                           ; preds = %thread-pre-split.us.us, %.us-lcssa10.us-lcssa
  %.lcssa = phi i32 [ %49, %.us-lcssa10.us-lcssa ], [ %32, %thread-pre-split.us.us ]
  %tmp.1.lcssa = phi i32 [ %tmp.1, %.us-lcssa10.us-lcssa ], [ %tmp.1.ph.us.us, %thread-pre-split.us.us ]
  %i.0.lcssa4 = phi i32 [ %i.0.ph217, %.us-lcssa10.us-lcssa ], [ %i.07.us.us, %thread-pre-split.us.us ]
  %50 = getelementptr inbounds i8* %.0.ph20, i64 1
  %51 = add i32 %i.0.lcssa4, 1
  br i1 %11, label %.lr.ph, label %.preheader

.us-lcssa.us:                                     ; preds = %.lr.ph.split..lr.ph.split.split_crit_edge, %.lr.ph.split.us.split.us
  %hash.0.lcssa5 = phi i32 [ %hash.08.us.us, %.lr.ph.split.us.split.us ], [ %hash.0.ph18, %.lr.ph.split..lr.ph.split.split_crit_edge ]
  ret i32 %hash.0.lcssa5
}
...
attributes #0 = { nounwind readonly uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-s
