...
@"_1_APHash_$array" = internal global [1 x [273 x i8]] [[273 x i8] c"U\0C\00\00\00\EF\AA\AA\AA\AA\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\10\00\00\00\07\F1\84\0E\00\00\00:\04\00\00\00:\CC\00\00\00\
@"_2_APHash_$array" = internal unnamed_addr constant [1 x [10300 x i8]] [[10300 x i8] c"?\00\00\00\00\00\00\00\00?\00\01\00\00\00\00\00\00@?\00\00\00\00\00\00\00\00?\08\00\00\00\00\00\00\00@,\00\00\00\00\00\00\00\00\C4\C4S\18\00\00\00\AE?\00\00\00\00\00\
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_APHash_$locals.i" = alloca [312 x i8], align 16
  %"_2_APHash_$stack.i" = alloca [1 x [32 x %"union._2_APHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [312 x i8]* %"_2_APHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_APHash_$node"]]* %"_2_APHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_APHash_$node"]]* %"_2_APHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %752, %737, %729, %721, %715, %707, %698, %692, %685, %679, %670, %662, %656, %646, %644, %637, %628, %626, %612, %606, %604, %597, %589, %581, %573, %566, %557, %554, %540, %533, %526, %517, %5
  %"_2_APHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [10300 x i8]]* @"_2_APHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_APHash_$pc.0.0.i", %.backedge.i ], [ %754, %752 ], [ %738, %737 ], [ %730, %729 ], [ %722, %721 ], [ %716, 
  %"_2_APHash_$sp.0.0.i" = phi %"union._2_APHash_$node"* [ %448, %strlen.exit ], [ %"_2_APHash_$sp.0.0.i", %.backedge.i ], [ %753, %752 ], [ %745, %737 ], [ %736, %729 ], [ %725, %721 ], [ %"_2_APHash_$sp.0.0.i", %715 ], [ %709, %707 ], [ %700, %698 ], [
  %449 = load i8* %"_2_APHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %454 = load i8** %453, align 8
  %455 = bitcast i8* %454 to i64*
  %456 = load i64* %455, align 8
  %.c4.i = inttoptr i64 %456 to i8*
  store i8* %.c4.i, i8** %453, align 8
  br label %.backedge.i

; <label>:457                                     ; preds = %.backedge.i
  %458 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %459 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i8*
  %460 = load i8* %459, align 1
  %461 = zext i8 %460 to i32
  %462 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  store i32 %461, i32* %462, align 4
  br label %.backedge.i

; <label>:463                                     ; preds = %.backedge.i
  %464 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %465 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %466 = bitcast %"union._2_APHash_$node"* %465 to i32*
  %467 = load i32* %466, align 4
  %468 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %469 = load i32* %468, align 4
  %470 = xor i32 %469, %467
  store i32 %470, i32* %466, align 4
  br label %.backedge.i

; <label>:471                                     ; preds = %.backedge.i
  %472 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %473 = bitcast i8* %472 to i8**
  %474 = load i8** %473, align 8
  %475 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* %474, i8** %475, align 8
  %476 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1
  %477 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:478                                     ; preds = %.backedge.i
  %479 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %480 = load i32* %479, align 4
  %481 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %482 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 9
  %483 = bitcast i8* %482 to i32*
  %484 = load i32* %483, align 4
  %485 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 5
  %486 = bitcast i8* %485 to i32*
  %487 = load i32* %486, align 4
  %488 = icmp slt i32 %480, %484
  br i1 %488, label %489, label %492

; <label>:489                                     ; preds = %478
  %490 = sext i32 %487 to i64
  %.sum9.i = add i64 %490, 1
  %491 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 %.sum9.i
  br label %.backedge.i

; <label>:492                                     ; preds = %478
  %493 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %494 = bitcast i8* %493 to i32*
  %495 = load i32* %494, align 4
  %496 = icmp sgt i32 %480, %495
  br i1 %496, label %497, label %500

; <label>:497                                     ; preds = %492
  %498 = sext i32 %487 to i64
  %.sum8.i = add i64 %498, 1
  %499 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:500                                     ; preds = %492
  %501 = sub nsw i32 %480, %484
  %502 = shl nsw i32 %501, 2
  %503 = sext i32 %502 to i64
  %.sum6.i = add i64 %503, 13
  %504 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 %.sum6.i
  %505 = bitcast i8* %504 to i32*
  %506 = load i32* %505, align 4
  %507 = sext i32 %506 to i64
  %.sum7.i = add i64 %507, 1
  %508 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:509                                     ; preds = %.backedge.i
  %510 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %511 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %512 = bitcast %"union._2_APHash_$node"* %511 to i32*
  %513 = load i32* %512, align 4
  %514 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %515 = load i32* %514, align 4
  %516 = add i32 %515, %513
  store i32 %516, i32* %512, align 4
  br label %.backedge.i

; <label>:517                                     ; preds = %.backedge.i
  %518 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %519 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %520 = bitcast %"union._2_APHash_$node"* %519 to i32*
  %521 = load i32* %520, align 4
  %522 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
...
; <label>:526                                     ; preds = %.backedge.i
  %527 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %528 = bitcast i8* %527 to i64*
  %529 = load i64* %528, align 8
  %530 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1, i32 0
  %.c2.i = inttoptr i64 %529 to i8*
  store i8* %.c2.i, i8** %530, align 8
  %531 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1
  %532 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:533                                     ; preds = %.backedge.i
  %534 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %535 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i8*
  %536 = load i8* %535, align 1
  %537 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1, i32 0
  %538 = load i8** %537, align 8
  store i8 %536, i8* %538, align 1
  %539 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:540                                     ; preds = %.backedge.i
  %541 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %542 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %543 = load i8** %542, align 8
  %544 = load i8* %543, align 1
  %545 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i8*
  store i8 %544, i8* %545, align 1
  br label %.backedge.i

; <label>:546                                     ; preds = %.backedge.i
  %547 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %548 = bitcast i8* %547 to i32*
  %549 = load i32* %548, align 4
  switch i32 %549, label %554 [
    i32 1, label %550
    i32 0, label %552
  ]

; <label>:550                                     ; preds = %546
  %551 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %551, align 8
  br label %554

; <label>:552                                     ; preds = %546
  %553 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %553, align 8
  br label %554

; <label>:554                                     ; preds = %552, %550, %546
  %555 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1
  %556 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:557                                     ; preds = %.backedge.i
  %558 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %559 = bitcast i8* %558 to i32*
  %560 = load i32* %559, align 4
  %561 = sext i32 %560 to i64
  %562 = getelementptr inbounds [312 x i8]* %"_2_APHash_$locals.i", i64 0, i64 %561
  %563 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* %562, i8** %563, align 8
  %564 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1
  %565 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:566                                     ; preds = %.backedge.i
  %567 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %568 = bitcast i8* %567 to i32*
  %569 = load i32* %568, align 4
  %570 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1
  %571 = bitcast %"union._2_APHash_$node"* %570 to i32*
  store i32 %569, i32* %571, align 4
  %572 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:573                                     ; preds = %.backedge.i
  %574 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %575 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %576 = load i32* %575, align 4
  %577 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1, i32 0
  %578 = load i8** %577, align 8
  %579 = bitcast i8* %578 to i32*
  store i32 %576, i32* %579, align 4
  %580 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:581                                     ; preds = %.backedge.i
  %582 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %583 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %584 = bitcast %"union._2_APHash_$node"* %583 to i32*
  %585 = load i32* %584, align 4
  %586 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %587 = load i32* %586, align 4
  %588 = shl i32 %585, %587
  store i32 %588, i32* %584, align 4
  br label %.backedge.i

; <label>:589                                     ; preds = %.backedge.i
  %590 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %591 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %592 = load i32* %591, align 4
  %593 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %594 = bitcast %"union._2_APHash_$node"* %593 to i32*
...
; <label>:597                                     ; preds = %.backedge.i
  %598 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %599 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %600 = load i8** %599, align 8
  %601 = bitcast i8* %600 to i32*
  %602 = load i32* %601, align 4
  %603 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  store i32 %602, i32* %603, align 4
  br label %.backedge.i

; <label>:604                                     ; preds = %.backedge.i
  %605 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:606                                     ; preds = %.backedge.i
  %607 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %608 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %609 = load i32* %608, align 4
  %610 = sext i32 %609 to i64
  %611 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %.c1.i = inttoptr i64 %610 to i8*
  store i8* %.c1.i, i8** %611, align 8
  br label %.backedge.i

; <label>:612                                     ; preds = %.backedge.i
  %613 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:614                                     ; preds = %.backedge.i
  %615 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %616 = load i32* %615, align 4
  %617 = icmp eq i32 %616, 0
  br i1 %617, label %624, label %618

; <label>:618                                     ; preds = %614
  %619 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %620 = bitcast i8* %619 to i32*
  %621 = load i32* %620, align 4
  %622 = sext i32 %621 to i64
  %.sum5.i = add i64 %622, 1
  %623 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 %.sum5.i
  br label %626

; <label>:624                                     ; preds = %614
  %625 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 5
  br label %626

; <label>:626                                     ; preds = %624, %618
  %"_2_APHash_$pc.0.1.i" = phi i8* [ %625, %624 ], [ %623, %618 ]
  %627 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:628                                     ; preds = %.backedge.i
  %629 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %630 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %631 = bitcast %"union._2_APHash_$node"* %630 to i32*
  %632 = load i32* %631, align 4
  %633 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
...
; <label>:637                                     ; preds = %.backedge.i
  %638 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %639 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %640 = load i8** %639, align 8
  %641 = bitcast i8* %640 to i32*
  %642 = load i32* %641, align 4
  %643 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  store i32 %642, i32* %643, align 4
  br label %.backedge.i

; <label>:644                                     ; preds = %.backedge.i
  %645 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:646                                     ; preds = %.backedge.i
  %647 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %648 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %649 = load i8** %648, align 8
  %650 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %651 = bitcast %"union._2_APHash_$node"* %650 to i32*
  %652 = load i32* %651, align 4
  %653 = sext i32 %652 to i64
  %654 = getelementptr i8* %649, i64 %653
  %655 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %654, i8** %655, align 8
  br label %.backedge.i

; <label>:656                                     ; preds = %.backedge.i
  %657 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %658 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i8*
  %659 = load i8* %658, align 1
  %660 = sext i8 %659 to i32
  %661 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  store i32 %660, i32* %661, align 4
  br label %.backedge.i

; <label>:662                                     ; preds = %.backedge.i
  %663 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %664 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1, i32 0
  %665 = load i8** %664, align 8
  %666 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %667 = load i8** %666, align 8
  %668 = bitcast i8* %667 to i8**
  store i8* %665, i8** %668, align 8
  %669 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:670                                     ; preds = %.backedge.i
  %671 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %672 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %673 = bitcast %"union._2_APHash_$node"* %672 to i64*
  %674 = load i64* %673, align 8
  %675 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %676 = load i8** %675, align 8
  %677 = bitcast i8* %676 to i64*
  store i64 %674, i64* %677, align 8
  %678 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:679                                     ; preds = %.backedge.i
  %680 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %681 = bitcast i8* %680 to i32*
  %682 = load i32* %681, align 4
  %683 = sext i32 %682 to i64
  %.sum.i = add i64 %683, 1
  %684 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:685                                     ; preds = %.backedge.i
  %686 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %687 = bitcast i8* %686 to i32*
  %688 = load i32* %687, align 4
  %689 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1
  %690 = bitcast %"union._2_APHash_$node"* %689 to i32*
  store i32 %688, i32* %690, align 4
  %691 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:692                                     ; preds = %.backedge.i
  %693 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %694 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %695 = load i8** %694, align 8
  %696 = load i8* %695, align 1
  %697 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i8*
  store i8 %696, i8* %697, align 1
  br label %.backedge.i

; <label>:698                                     ; preds = %.backedge.i
  %699 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %700 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %701 = bitcast %"union._2_APHash_$node"* %700 to i64*
  %702 = load i64* %701, align 8
  %703 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i64*
  %704 = load i64* %703, align 8
  %705 = mul i64 %704, %702
  %706 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1, i32 0
  %.c.i = inttoptr i64 %705 to i8*
  store i8* %.c.i, i8** %706, align 8
  br label %.backedge.i

; <label>:707                                     ; preds = %.backedge.i
  %708 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %709 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %710 = bitcast %"union._2_APHash_$node"* %709 to i32*
  %711 = load i32* %710, align 4
  %712 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %713 = load i32* %712, align 4
  %714 = mul i32 %713, %711
  store i32 %714, i32* %710, align 4
  br label %.backedge.i

; <label>:715                                     ; preds = %.backedge.i
  %716 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %717 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %718 = load i8** %717, align 8
  %719 = bitcast i8* %718 to i8**
  %720 = load i8** %719, align 8
  store i8* %720, i8** %717, align 8
  br label %.backedge.i

; <label>:721                                     ; preds = %.backedge.i
  %722 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %723 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %724 = load i32* %723, align 4
  %725 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %726 = bitcast %"union._2_APHash_$node"* %725 to i32*
...
; <label>:729                                     ; preds = %.backedge.i
  %730 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %731 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1, i32 0
  %732 = load i8** %731, align 8
  %733 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i64*
  %734 = load i64* %733, align 8
  %735 = getelementptr i8* %732, i64 %734
  store i8* %735, i8** %731, align 8
  %736 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:737                                     ; preds = %.backedge.i
  %738 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %739 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -1
  %740 = bitcast %"union._2_APHash_$node"* %739 to i32*
  %741 = load i32* %740, align 4
  %742 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 0, i32 0
  %743 = load i8** %742, align 8
  %744 = bitcast i8* %743 to i32*
  store i32 %741, i32* %744, align 4
  %745 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:746                                     ; preds = %.backedge.i
  %747 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 1
  %748 = bitcast i8* %747 to i32*
  %749 = load i32* %748, align 4
  %cond.i = icmp eq i32 %749, 0
  br i1 %cond.i, label %750, label %752

; <label>:750                                     ; preds = %746
  %751 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [273 x i8]]* @"_1_APHash_$array", i64 0, i64 0, i64 0), i8** %751, align 8
  br label %752

; <label>:752                                     ; preds = %750, %746
  %753 = getelementptr inbounds %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i", i64 1
  %754 = getelementptr inbounds i8* %"_2_APHash_$pc.0.0.i", i64 5
  br label %.backedge.i

APHash.exit:                                      ; preds = %.backedge.i
  %755 = bitcast %"union._2_APHash_$node"* %"_2_APHash_$sp.0.0.i" to i32*
  %756 = load i32* %755, align 4
  %757 = icmp eq i32 %756, 37524292
  br i1 %757, label %758, label %759

; <label>:758                                     ; preds = %APHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %760

; <label>:759                                     ; preds = %APHash.exit
