...
.outer.i:                                         ; preds = %.split20.i, %.split17.i, %strlen.exit
  %tmp.0.ph.i = phi i32 [ undef, %strlen.exit ], [ %459, %.split20.i ], [ %452, %.split17.i ]
  %i.0.ph.i = phi i32 [ undef, %strlen.exit ], [ %i.0.ph3.i, %.split20.i ], [ %i.0.ph3.i, %.split17.i ]
  %hash.0.ph.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.ph4.i, %.split20.i ], [ %hash.0.ph4.i, %.split17.i ]
  %_1_APHash_next.0.ph.i = phi i64 [ 8, %strlen.exit ], [ 1, %.split20.i ], [ 1, %.split17.i ]
  %.0.ph.i = phi i8* [ %433, %strlen.exit ], [ %.0.ph6.ph.i, %.split20.i ], [ %.0.ph6.ph.i, %.split17.i ]
  br label %.outer2.outer.i

.outer2.outer.i:                                  ; preds = %.split23.i, %.outer.i
  %i.0.ph3.ph.i = phi i32 [ %462, %.split23.i ], [ %i.0.ph.i, %.outer.i ]
  %hash.0.ph4.ph.i = phi i32 [ %460, %.split23.i ], [ %hash.0.ph.i, %.outer.i ]
  %_1_APHash_next.0.ph5.ph.i = phi i64 [ 6, %.split23.i ], [ %_1_APHash_next.0.ph.i, %.outer.i ]
  %.0.ph6.ph.i = phi i8* [ %461, %.split23.i ], [ %.0.ph.i, %.outer.i ]
  br label %.outer2.i

.outer2.i:                                        ; preds = %.outer2.i, %.outer2.outer.i
  %i.0.ph3.i = phi i32 [ %i.0.ph3.ph.i, %.outer2.outer.i ], [ 0, %.outer2.i ]
  %hash.0.ph4.i = phi i32 [ %hash.0.ph4.ph.i, %.outer2.outer.i ], [ -1431655766, %.outer2.i ]
  %_1_APHash_next.0.ph5.i = phi i64 [ %_1_APHash_next.0.ph5.ph.i, %.outer2.outer.i ], [ 6, %.outer2.i ]
  %442 = icmp eq i64 %_1_APHash_next.0.ph5.i, 8
  br i1 %442, label %.outer2.i, label %.outer7..outer7.split_crit_edge.lr.ph.i

.outer7..outer7.split_crit_edge.lr.ph.i:          ; preds = %.outer2.i
  %443 = icmp ult i32 %i.0.ph3.i, %441
  %..i = select i1 %443, i64 4, i64 0
  %444 = and i32 %i.0.ph3.i, 1
  %445 = zext i32 %444 to i64
  %446 = xor i64 %445, 3
  br label %.outer7..outer7.split_crit_edge.i

.outer7..outer7.split_crit_edge.i:                ; preds = %.outer7.backedge.i, %.outer7..outer7.split_crit_edge.i, %.outer7..outer7.split_crit_edge.lr.ph.i
  %_1_APHash_next.0.ph829.i = phi i64 [ %_1_APHash_next.0.ph5.i, %.outer7..outer7.split_crit_edge.lr.ph.i ], [ %446, %.outer7.backedge.i ], [ %..i, %.outer7..outer7.split_crit_edge.i ]
  switch i64 %_1_APHash_next.0.ph829.i, label %infloop.i [
    i64 6, label %.outer7..outer7.split_crit_edge.i
    i64 4, label %.outer7.backedge.i
    i64 3, label %.split17.i
    i64 2, label %.split20.i
    i64 1, label %.split23.i
    i64 0, label %APHash.exit
  ]

.outer7.backedge.i:                               ; preds = %.outer7..outer7.split_crit_edge.i
  br label %.outer7..outer7.split_crit_edge.i

.split17.i:                                       ; preds = %.outer7..outer7.split_crit_edge.i
  %447 = shl i32 %hash.0.ph4.i, 7
  %448 = load i8* %.0.ph6.ph.i, align 1
  %449 = sext i8 %448 to i32
  %450 = lshr i32 %hash.0.ph4.i, 3
  %451 = mul i32 %449, %450
  %452 = xor i32 %451, %447
  br label %.outer.i

.split20.i:                                       ; preds = %.outer7..outer7.split_crit_edge.i
  %453 = shl i32 %hash.0.ph4.i, 11
  %454 = load i8* %.0.ph6.ph.i, align 1
  %455 = sext i8 %454 to i32
  %456 = lshr i32 %hash.0.ph4.i, 5
  %457 = xor i32 %455, %456
  %458 = add i32 %457, %453
  %459 = xor i32 %458, -1
  br label %.outer.i

.split23.i:                                       ; preds = %.outer7..outer7.split_crit_edge.i
  %460 = xor i32 %hash.0.ph4.i, %tmp.0.ph.i
  %461 = getelementptr inbounds i8* %.0.ph6.ph.i, i64 1
  %462 = add i32 %i.0.ph3.i, 1
  br label %.outer2.outer.i

infloop.i:                                        ; preds = %.outer7..outer7.split_crit_edge.i, %infloop.i
  br label %infloop.i

APHash.exit:                                      ; preds = %.outer7..outer7.split_crit_edge.i
  %463 = icmp eq i32 %hash.0.ph4.i, 37524292
  br i1 %463, label %464, label %465

; <label>:464                                     ; preds = %APHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %466

; <label>:465                                     ; preds = %APHash.exit
