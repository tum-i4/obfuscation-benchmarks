...
define internal fastcc i32 @APHash(i8* nocapture readonly %str, i32 %len) #0 {
  tail call void @klee_div_zero_check(i64 2) #8
  tail call void @klee_div_zero_check(i64 2) #8
  br label %1

; <label>:1                                       ; preds = %0, %20
  %.024 = phi i32 [ -1431655766, %0 ], [ %22, %20 ]
  %.023 = phi i32 [ 0, %0 ], [ %24, %20 ]
  %.0 = phi i8* [ %str, %0 ], [ %23, %20 ]
  tail call void @klee_div_zero_check(i64 2) #8
  tail call void @klee_div_zero_check(i64 2) #8
  %2 = icmp ult i32 %.023, %len
...
; <label>:20                                      ; preds = %.loopexit, %6
  %21 = phi i32 [ %13, %6 ], [ %19, %.loopexit ]
  tail call void @klee_div_zero_check(i64 2) #8
  %22 = xor i32 %.024, %21
  tail call void @klee_div_zero_check(i64 2) #8
  %23 = getelementptr inbounds i8* %.0, i64 1
  %24 = add i32 %.023, 1
  br label %1
...
; <label>:21                                      ; preds = %.lr.ph.i.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([593 x i8]* @.str133, i64 0, i64 0)) #8, !dbg !2802
  unreachable
...
; <label>:47                                      ; preds = %__streq.exit8.thread108.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([48 x i8]* @.str436, i64 0, i64 0)) #8, !dbg !2811
  unreachable
...
; <label>:55                                      ; preds = %48
  call fastcc void @__emit_error(i8* getelementptr inbounds ([48 x i8]* @.str436, i64 0, i64 0)) #8, !dbg !2813
  unreachable
...
; <label>:66                                      ; preds = %.lr.ph.i18.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([48 x i8]* @.str436, i64 0, i64 0)) #8, !dbg !2823
  unreachable
...
__str_to_int.exit19.i:                            ; preds = %59
  ...
  %70 = call fastcc i8* @__get_sym_str(i32 %67, i8* %1) #8, !dbg !2825
  %71 = icmp eq i32 %23, 1024, !dbg !2826
  br i1 %71, label %72, label %__add_arg.exit20.i, !dbg !2826

; <label>:72                                      ; preds = %__str_to_int.exit19.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([37 x i8]* @.str2153, i64 0, i64 0)) #8, !dbg !2829
  unreachable
...
; <label>:95                                      ; preds = %__streq.exit25.thread110.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str739, i64 0, i64 0)) #8, !dbg !2842
  unreachable
...
; <label>:104                                     ; preds = %96
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str739, i64 0, i64 0)) #8, !dbg !2845
  unreachable
...
; <label>:115                                     ; preds = %.lr.ph.i34.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str739, i64 0, i64 0)) #8, !dbg !2850
  unreachable
...
; <label>:122                                     ; preds = %__str_to_int.exit35.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str739, i64 0, i64 0)) #8, !dbg !2852
  unreachable
...
; <label>:133                                     ; preds = %.lr.ph.i39.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str739, i64 0, i64 0)) #8, !dbg !2857
  unreachable
...
; <label>:141                                     ; preds = %__str_to_int.exit40.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str739, i64 0, i64 0)) #8, !dbg !2859
  unreachable
...
; <label>:152                                     ; preds = %.lr.ph.i44.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([77 x i8]* @.str739, i64 0, i64 0)) #8, !dbg !2864
  unreachable

__str_to_int.exit45.i:                            ; preds = %145
  %153 = trunc i64 %149 to i32, !dbg !2858
  %154 = add i32 %134, 1, !dbg !2865
  %155 = call i32 @klee_range(i32 %116, i32 %154, i8* getelementptr inbounds ([7 x i8]* @.str840, i64 0, i64 0)) #8, !dbg !2865
...
; <label>:158                                     ; preds = %__add_arg.exit46.i, %.lr.ph.i
  ...
  %162 = call fastcc i8* @__get_sym_str(i32 %153, i8* %1) #8, !dbg !2870
...
; <label>:165                                     ; preds = %158
  call fastcc void @__emit_error(i8* getelementptr inbounds ([37 x i8]* @.str2153, i64 0, i64 0)) #8, !dbg !2873
  unreachable
...
; <label>:189                                     ; preds = %__streq.exit51.thread112.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str1143, i64 0, i64 0)) #8, !dbg !2883
  unreachable
...
; <label>:197                                     ; preds = %190
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str1143, i64 0, i64 0)) #8, !dbg !2886
  unreachable
...
; <label>:208                                     ; preds = %.lr.ph.i60.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str1143, i64 0, i64 0)) #8, !dbg !2891
  unreachable
...
; <label>:216                                     ; preds = %__str_to_int.exit61.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str1143, i64 0, i64 0)) #8, !dbg !2893
  unreachable
...
; <label>:227                                     ; preds = %.lr.ph.i65.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([72 x i8]* @.str1143, i64 0, i64 0)) #8, !dbg !2898
  unreachable
...
; <label>:299                                     ; preds = %__streq.exit96.thread120.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([54 x i8]* @.str2052, i64 0, i64 0)) #8, !dbg !2931
  unreachable
...
; <label>:307                                     ; preds = %300
  call fastcc void @__emit_error(i8* getelementptr inbounds ([54 x i8]* @.str2052, i64 0, i64 0)) #8, !dbg !2933
  unreachable
...
; <label>:318                                     ; preds = %.lr.ph.i9.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([54 x i8]* @.str2052, i64 0, i64 0)) #8, !dbg !2938
  unreachable
...
; <label>:321                                     ; preds = %.loopexit141.i
  call fastcc void @__emit_error(i8* getelementptr inbounds ([37 x i8]* @.str2153, i64 0, i64 0)) #8, !dbg !2943
  unreachable
...
__streq.exit.thread._crit_edge.i:                 ; preds = %__streq.exit.thread.backedge.i, %__streq.exit.thread.preheader.i
  ...
  %329 = call noalias i8* @malloc(i64 %328) #8, !dbg !2946
  %330 = bitcast i8* %329 to i8**, !dbg !2946
  call void @klee_mark_global(i8* %329) #8, !dbg !2947
...
__get_sym_file.exit.thread.i.i.i:                 ; preds = %340, %344, %__streq.exit.thread._crit_edge.i
  %357 = call i64 @klee_get_valuel(i64 ptrtoint ([2 x i8]* @.str69 to i64)) #8, !dbg !2978
  ...
  call void @klee_assume(i64 %360) #8, !dbg !2981
...
__concretize_string.exit.i.i.i:                   ; preds = %370, %367
  %380 = call i64 (i64, ...)* @syscall(i64 4, i8* getelementptr inbounds ([2 x i8]* @.str69, i64 0, i64 0), %struct.stat64.647* %s.i.i) #8, !dbg !2980
...
; <label>:383                                     ; preds = %__concretize_string.exit.i.i.i
  %384 = call i32 @klee_get_errno() #8, !dbg !3002
...
__fd_stat.exit.i.i:                               ; preds = %383, %__concretize_string.exit.i.i.i, %354
  ...
  %387 = call noalias i8* @malloc(i64 %386) #8, !dbg !3005
...
.lr.ph.preheader.i.i:                             ; preds = %__fd_stat.exit.i.i
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %388, i32 %sym_file_len.0.lcssa.i, i8* %335, %struct.stat64.647* %s.i.i) #8, !dbg !3010
...
._crit_edge2.i.i:                                 ; preds = %.lr.ph.preheader.i.i, %._crit_edge2.i.i
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %392, i32 %sym_file_len.0.lcssa.i, i8* %335, %struct.stat64.647* %s.i.i) #8, !dbg !3010
...
; <label>:394                                     ; preds = %._crit_edge.i.i
  %395 = call noalias i8* @malloc(i64 24) #8, !dbg !3013
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %396, i32 %sym_file_len.0.lcssa.i, i8* getelementptr inbounds ([6 x i8]* @.str110, i64 0, i64 0), %struct.stat64.647* %s.i.i) #8, !dbg !3016
...
; <label>:422                                     ; preds = %420
  %423 = call noalias i8* @malloc(i64 24) #8, !dbg !3045
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %424, i32 1024, i8* getelementptr inbounds ([7 x i8]* @.str716, i64 0, i64 0), %struct.stat64.647* %s.i.i) #8, !dbg !3048
...
klee_init_env.exit:                               ; preds = %422, %426
  ...
  call void @klee_make_symbolic(i8* %427, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str817, i64 0, i64 0)) #8, !dbg !3059
  ...
  call void @klee_assume(i64 %430) #8, !dbg !3062
...
strlen.exit:                                      ; preds = %434
  ...
  %442 = tail call fastcc i32 @APHash(i8* %433, i32 %441)
  %443 = icmp eq i32 %442, 37524292
  br i1 %443, label %444, label %445

; <label>:444                                     ; preds = %strlen.exit
  tail call void @klee_div_zero_check(i64 2) #8
  %puts3 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  tail call void @klee_div_zero_check(i64 2) #8
  br label %446

; <label>:445                                     ; preds = %strlen.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %446

; <label>:446                                     ; preds = %444, %445
  ret i32 0
}
...
; <label>:43                                      ; preds = %39
  ...
  %46 = call i64 (i64, ...)* @syscall(i64 5, i32 %45, %struct.stat64.647* %tmp.i) #8, !dbg !3097
  %47 = trunc i64 %46 to i32, !dbg !3097
  %48 = icmp eq i32 %47, -1, !dbg !3098
  br i1 %48, label %49, label %__fd_fstat.exit, !dbg !3098

; <label>:49                                      ; preds = %43
  %50 = call i32 @klee_get_errno() #8, !dbg !3100
...
; <label>:83                                      ; preds = %._crit_edge.i
  ...
  %86 = call i32 (i32, i64, ...)* @ioctl(i32 0, i64 undef, %struct.__kernel_termios* %k_termios.i.i.i.i.i) #15, !dbg !3170
  ...
  %93 = call i32 (i32, i64, ...)* @ioctl(i32 1, i64 undef, %struct.__kernel_termios* %k_termios.i.i1.i.i.i) #15, !dbg !3173
...
; <label>:102                                     ; preds = %__uClibc_init.exit.i
  %103 = call i32 @getuid() #15, !dbg !3179
  %104 = call i32 @geteuid() #15, !dbg !3181
  %105 = call i32 @getgid() #15, !dbg !3182
  %106 = call i32 @getegid() #15, !dbg !3183
...
; <label>:121                                     ; preds = %115, %.thread, %102
  call fastcc void @__check_one_fd(i32 0, i32 131072) #15, !dbg !3186
  call fastcc void @__check_one_fd(i32 1, i32 131074) #15, !dbg !3188
  call fastcc void @__check_one_fd(i32 2, i32 131074) #15, !dbg !3189
...
; <label>:125                                     ; preds = %124, %122
  %126 = call fastcc i32 @__user_main(i32 %0, i8** %1) #15, !dbg !3194
  call void @exit(i32 %126) #14, !dbg !3194
...
; <label>:31                                      ; preds = %25
  ...
  call void @klee_warning_once(i8* getelementptr inbounds ([41 x i8]* @.str13, i64 0, i64 0)) #8, !dbg !3209
...
; <label>:67                                      ; preds = %25
  ...
  %70 = call i64 (i64, ...)* @syscall(i64 16, i32 %69, i64 21505, i8* %27) #8, !dbg !3247
  %71 = trunc i64 %70 to i32, !dbg !3247
  %72 = icmp eq i32 %71, -1, !dbg !3248
  br i1 %72, label %73, label %75, !dbg !3248

; <label>:73                                      ; preds = %67
  %74 = call i32 @klee_get_errno() #8, !dbg !3250
...
; <label>:34                                      ; preds = %31
  ...
  %39 = call i64 @klee_get_valuel(i64 ptrtoint ([10 x i8]* @.str118 to i64)) #8, !dbg !3269
  ...
  call void @klee_assume(i64 %42) #8, !dbg !3272
...
__concretize_string.exit.i:                       ; preds = %52, %49
  %62 = call i64 (i64, ...)* @syscall(i64 2, i8* getelementptr inbounds ([10 x i8]* @.str118, i64 0, i64 0), i32 %flags, i32 %mode.0) #8, !dbg !3271
...
; <label>:65                                      ; preds = %__concretize_string.exit.i
  %66 = call i32 @klee_get_errno() #8, !dbg !3287
...
define internal fastcc void @__create_new_dfile(%struct.exe_disk_file_t* nocapture %dfile, i32 %size, i8* %name, %struct.stat64.647* nocapture readonly %defaults) #10 {
  ...
  %1 = call noalias i8* @malloc(i64 144) #8, !dbg !3303
...
._crit_edge3:                                     ; preds = %31, %18
  ...
  call void @klee_assume(i64 %37) #8, !dbg !3319
  ...
  call void @klee_assume(i64 %42) #8, !dbg !3320
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %48) #8, !dbg !3322
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %54) #8, !dbg !3324
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %61) #8, !dbg !3326
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %65) #8, !dbg !3328
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %69) #8, !dbg !3329
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %73) #8, !dbg !3330
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %77) #8, !dbg !3331
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %82) #8, !dbg !3332
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %89) #8, !dbg !3333
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %96) #8, !dbg !3335
  %97 = load i64* %39, align 8, !dbg !3336, !tbaa !3321
  %98 = icmp eq i64 %97, 4096, !dbg !3336
  %99 = zext i1 %98 to i64, !dbg !3336
  call void @klee_posix_prefer_cex(i8* %1, i64 %99) #8, !dbg !3336
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %106) #8, !dbg !3337
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %113) #8, !dbg !3338
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %120) #8, !dbg !3339
...
define internal fastcc void @__emit_error(i8* %msg) #12 {
  tail call void @klee_report_error(i8* getelementptr inbounds ([16 x i8]* @.str2254, i64 0, i64 0), i32 24, i8* %msg, i8* getelementptr inbounds ([9 x i8]* @.str2355, i64 0, i64 0)) #5, !dbg !3346
...
define internal fastcc i8* @__get_sym_str(i32 %numChars, i8* %name) #10 {
  ...
  %3 = tail call noalias i8* @malloc(i64 %2) #8, !dbg !3347
  tail call void @klee_mark_global(i8* %3) #8, !dbg !3348
  tail call void @klee_make_symbolic(i8* %3, i64 %2, i8* %name) #8, !dbg !3349
...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  tail call void @klee_posix_prefer_cex(i8* %3, i64 %9) #8, !dbg !3352
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #14, !dbg !3358
...
define i32 @klee_int(i8* %name) #10 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #15, !dbg !3360
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #14, !dbg !3364
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #14, !dbg !3369
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #15, !dbg !3372
