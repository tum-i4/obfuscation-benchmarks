...
; <label>:463                                     ; preds = %463, %526
  %p.0.i = phi i8* [ %530, %526 ], [ %466, %463 ]
...
strlen.exit:                                      ; preds = %463
  ...
  %468 = ptrtoint i8* %530 to i64, !dbg !3156
  %469 = sub i64 %467, %468, !dbg !3156
  %470 = trunc i64 %469 to i32
  %471 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %472 = icmp eq %struct._1_main__opaque_Node_1* %471, %527
  br i1 %472, label %.lr.ph.i, label %.preheader.i

.lr.ph.i:                                         ; preds = %strlen.exit
  %473 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %474 = icmp eq %struct._1_main__opaque_Node_1* %473, %527
  %475 = icmp eq i32 %470, 0
  br i1 %474, label %.lr.ph.split.us.i.preheader, label %.lr.ph..lr.ph.split_crit_edge.i

.lr.ph.split.us.i.preheader:                      ; preds = %.lr.ph.i
  br i1 %475, label %APHash.exit.thread, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph.split.us.i
  %i.02.us.i4 = phi i32 [ %495, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %hash.03.us.i3 = phi i32 [ %493, %.lr.ph.split.us.i ], [ -1431655766, %.lr.ph.split.us.i.preheader ]
  %.04.us.i2 = phi i8* [ %494, %.lr.ph.split.us.i ], [ %530, %.lr.ph.split.us.i.preheader ]
  %476 = and i32 %i.02.us.i4, 1
  %477 = icmp eq i32 %476, 0
  br i1 %477, label %486, label %478

; <label>:478                                     ; preds = %.lr.ph
  %479 = shl i32 %hash.03.us.i3, 11
  %480 = load i8* %.04.us.i2, align 1
  %481 = sext i8 %480 to i32
  %482 = lshr i32 %hash.03.us.i3, 5
  %483 = xor i32 %481, %482
  %484 = add i32 %483, %479
  %485 = xor i32 %484, -1
  br label %.lr.ph.split.us.i

; <label>:486                                     ; preds = %.lr.ph
  %487 = shl i32 %hash.03.us.i3, 7
  %488 = load i8* %.04.us.i2, align 1
  %489 = sext i8 %488 to i32
  %490 = lshr i32 %hash.03.us.i3, 3
  %491 = mul i32 %489, %490
  %492 = xor i32 %491, %487
  br label %.lr.ph.split.us.i

.lr.ph.split.us.i:                                ; preds = %486, %478
  %tmp.0.us.i = phi i32 [ %492, %486 ], [ %485, %478 ]
  %493 = xor i32 %tmp.0.us.i, %hash.03.us.i3
  %494 = getelementptr inbounds i8* %.04.us.i2, i64 1
  %495 = add i32 %i.02.us.i4, 1
  %exitcond = icmp eq i32 %495, %470
  br i1 %exitcond, label %.lr.ph.split.us.i.APHash.exit_crit_edge, label %.lr.ph

.preheader.i:                                     ; preds = %.lr.ph..lr.ph.split_crit_edge.i, %strlen.exit, %.preheader.i
  br label %.preheader.i

.lr.ph..lr.ph.split_crit_edge.i:                  ; preds = %.lr.ph.i
  br i1 %475, label %APHash.exit.thread, label %.preheader.i

.lr.ph.split.us.i.APHash.exit_crit_edge:          ; preds = %.lr.ph.split.us.i
  %phitmp = icmp eq i32 %493, 37524292
  br i1 %phitmp, label %496, label %APHash.exit.thread

; <label>:496                                     ; preds = %.lr.ph.split.us.i.APHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %497

APHash.exit.thread:                               ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph..lr.ph.split_crit_edge.i, %.lr.ph.split.us.i.APHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %497

; <label>:497                                     ; preds = %APHash.exit.thread, %496
  ret i32 0

; <label>:498                                     ; preds = %460, %452, %rand.exit
  %499 = load i32* %444, align 4, !dbg !3143
  %500 = load i32* %443, align 4, !dbg !3143
  %501 = add nsw i32 %500, %499, !dbg !3143
  store i32 %501, i32* %443, align 4, !dbg !3143
  %502 = lshr i32 %501, 1, !dbg !3144
  %503 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %504 = icmp ult i32* %503, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %505 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %504, label %506, label %rand.exit.1, !dbg !3146

; <label>:506                                     ; preds = %498
  %507 = icmp ult i32* %505, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %507, i32* %505, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %498, %506
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %498 ], [ %503, %506 ]
  %rptr.0.i.i.i.1 = phi i32* [ %505, %498 ], [ %..i.i.i.1, %506 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %508 = tail call i8* @malloc(i64 16) #7
  %509 = bitcast i8* %508 to %struct._1_main__opaque_Node_1*
  %510 = icmp eq i8* %508, null
  br i1 %510, label %526, label %511

; <label>:511                                     ; preds = %rand.exit.1
  %512 = bitcast i8* %508 to i32*
  store i32 %502, i32* %512, align 4
  %513 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
...
; <label>:515                                     ; preds = %511
  ...
  %517 = getelementptr inbounds %struct._1_main__opaque_Node_1* %516, i64 0, i32 1
  %518 = load %struct._1_main__opaque_Node_1** %517, align 8
  %519 = getelementptr inbounds i8* %508, i64 8
  %520 = bitcast i8* %519 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %518, %struct._1_main__opaque_Node_1** %520, align 8
  %521 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %522 = getelementptr inbounds %struct._1_main__opaque_Node_1* %521, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %509, %struct._1_main__opaque_Node_1** %522, align 8
  br label %526

; <label>:523                                     ; preds = %511
  %524 = getelementptr inbounds i8* %508, i64 8
  %525 = bitcast i8* %524 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %509, %struct._1_main__opaque_Node_1** %525, align 8
  store %struct._1_main__opaque_Node_1* %509, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %526

; <label>:526                                     ; preds = %523, %515, %rand.exit.1
  %527 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %527, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %528 = getelementptr inbounds i8* %329, i64 8
