; ModuleID = './aphash-addOpaque16.bc'
...
define internal fastcc i32 @APHash(i8* nocapture readonly %str, i32 %len) #2 {
  %1 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %2 = icmp eq %struct._1_main__opaque_Node_1* %1, null
  %3 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br i1 %2, label %14, label %4

; <label>:4                                       ; preds = %0
  %5 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %6 = icmp eq %struct._1_main__opaque_Node_1* %3, %5
...
; <label>:7                                       ; preds = %4
  ...
  br i1 %10, label %.outer.outer, label %11

; <label>:11                                      ; preds = %7
  %12 = tail call fastcc i32 @APHash(i8* null, i32 0)
  br label %.outer.outer

.preheader8:                                      ; preds = %4, %.preheader8
  %13 = tail call fastcc i32 @APHash(i8* inttoptr (i64 4 to i8*), i32 %len)
  br label %.preheader8

; <label>:14                                      ; preds = %0
  %15 = icmp eq %struct._1_main__opaque_Node_1* %3, null
  br i1 %15, label %.preheader, label %.outer.outer

.preheader:                                       ; preds = %14, %.preheader
  br label %.preheader

; <label>:16                                      ; preds = %.outer, %91
  %tmp.0 = phi i32 [ %tmp.1, %91 ], [ %tmp.0.ph, %.outer ]
  %i.2 = phi i32 [ %i.3, %91 ], [ %i.2.ph5, %.outer ]
  %.01 = phi i32 [ %.2, %91 ], [ %.01.ph, %.outer ]
...
; <label>:24                                      ; preds = %20
  ...
  br i1 %27, label %.preheader3, label %30

.preheader3:                                      ; preds = %24, %.preheader3
  br label %.preheader3

; <label>:28                                      ; preds = %16
  %29 = icmp ult i32 %i.2, %.01
...
; <label>:33                                      ; preds = %30
  ...
  %35 = icmp ne %struct._1_main__opaque_Node_1* %34, null
  %36 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %37 = icmp eq %struct._1_main__opaque_Node_1* %34, %36
  %or.cond = and i1 %35, %37
  br i1 %or.cond, label %38, label %54

; <label>:38                                      ; preds = %33
  %39 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %40 = icmp eq %struct._1_main__opaque_Node_1* %39, null
  br i1 %40, label %41, label %43

; <label>:41                                      ; preds = %38
  %42 = tail call fastcc i32 @APHash(i8* null, i32 %hash.0.ph)
  br label %43

; <label>:43                                      ; preds = %38, %41
  %.1 = phi i32 [ %.01, %38 ], [ %42, %41 ]
  %44 = load i8* %.0.ph.ph, align 1
...
; <label>:54                                      ; preds = %33, %43, %48
  %tmp.1 = phi i32 [ %47, %43 ], [ %53, %48 ], [ %tmp.0, %33 ]
  %.2 = phi i32 [ %.1, %43 ], [ %.01, %48 ], [ %.01, %33 ]
  %55 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %56 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %57 = icmp eq %struct._1_main__opaque_Node_1* %55, %56
  br i1 %57, label %58, label %86

; <label>:58                                      ; preds = %54
  %59 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %60 = icmp eq %struct._1_main__opaque_Node_1* %59, null
  br i1 %60, label %61, label %69

; <label>:61                                      ; preds = %58
  %62 = getelementptr inbounds i8* %.0.ph.ph, i64 2
  %63 = add i32 %i.2, 1
  %64 = mul i32 %tmp.1, %63
  br label %.outer.outer

.outer.outer:                                     ; preds = %83, %61, %14, %7, %11
  %tmp.0.ph.ph = phi i32 [ undef, %11 ], [ undef, %7 ], [ undef, %14 ], [ %tmp.1, %61 ], [ %tmp.1, %83 ]
  %i.2.ph5.ph = phi i32 [ %12, %11 ], [ 0, %7 ], [ 0, %14 ], [ %64, %61 ], [ %85, %83 ]
  %hash.0.ph.ph = phi i32 [ -1431655766, %11 ], [ -1431655766, %7 ], [ -1431655766, %14 ], [ 1, %61 ], [ %78, %83 ]
  %.01.ph.ph = phi i32 [ %len, %11 ], [ %len, %7 ], [ %len, %14 ], [ %.2, %61 ], [ %.2, %83 ]
  %.0.ph.ph = phi i8* [ %str, %11 ], [ %str, %7 ], [ %str, %14 ], [ %62, %61 ], [ %84, %83 ]
  br label %.outer

.outer:                                           ; preds = %.outer.outer, %79
  %tmp.0.ph = phi i32 [ %tmp.1, %79 ], [ %tmp.0.ph.ph, %.outer.outer ]
  %i.2.ph5 = phi i32 [ %82, %79 ], [ %i.2.ph5.ph, %.outer.outer ]
  %hash.0.ph = phi i32 [ %80, %79 ], [ %hash.0.ph.ph, %.outer.outer ]
  %.01.ph = phi i32 [ %.2, %79 ], [ %.01.ph.ph, %.outer.outer ]
  %65 = shl i32 %hash.0.ph, 7
  %66 = lshr i32 %hash.0.ph, 3
  %67 = shl i32 %hash.0.ph, 11
  %68 = lshr i32 %hash.0.ph, 5
  br label %16
...
; <label>:73                                      ; preds = %69
  %74 = tail call fastcc i32 @APHash(i8* null, i32 %.2)
  %.pr = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %75

; <label>:75                                      ; preds = %69, %73
  %76 = phi %struct._1_main__opaque_Node_1* [ %70, %69 ], [ %.pr, %73 ]
  %hash.1 = phi i32 [ %hash.0.ph, %69 ], [ %74, %73 ]
  %77 = icmp eq %struct._1_main__opaque_Node_1* %76, null
  %78 = xor i32 %hash.1, %tmp.1
  br i1 %77, label %79, label %83

; <label>:79                                      ; preds = %75
  %80 = shl i32 %78, 7
  %81 = add i32 %i.2, 1
  %82 = lshr i32 %81, %tmp.1
  br label %.outer

; <label>:83                                      ; preds = %75
  %84 = getelementptr inbounds i8* %.0.ph.ph, i64 1
  %85 = add i32 %i.2, 1
  br label %.outer.outer
...
; <label>:89                                      ; preds = %86
  %90 = tail call fastcc i32 @APHash(i8* null, i32 %tmp.1)
  br label %91

; <label>:91                                      ; preds = %86, %89
  %i.3 = phi i32 [ %90, %89 ], [ %i.2, %86 ]
  tail call void asm sideeffect ".byte 0xa0,0x8d,0xf7,0xa6,0x9,0x59,0xf8", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3157
  br label %16
...
; <label>:43                                      ; preds = %39
  ...
  %46 = call i64 (i64, ...)* @syscall(i64 5, i32 %45, %struct.stat64.647* %tmp.i) #8, !dbg !3189
  %47 = trunc i64 %46 to i32, !dbg !3189
  %48 = icmp eq i32 %47, -1, !dbg !3190
  br i1 %48, label %49, label %__fd_fstat.exit, !dbg !3190

; <label>:49                                      ; preds = %43
  %50 = call i32 @klee_get_errno() #8, !dbg !3192
...
; <label>:83                                      ; preds = %._crit_edge.i
  ...
  %86 = call i32 (i32, i64, ...)* @ioctl(i32 0, i64 undef, %struct.__kernel_termios* %k_termios.i.i.i.i.i) #15, !dbg !3262
  ...
  %93 = call i32 (i32, i64, ...)* @ioctl(i32 1, i64 undef, %struct.__kernel_termios* %k_termios.i.i1.i.i.i) #15, !dbg !3265
...
; <label>:102                                     ; preds = %__uClibc_init.exit.i
  %103 = call i32 @getuid() #15, !dbg !3271
  %104 = call i32 @geteuid() #15, !dbg !3273
  %105 = call i32 @getgid() #15, !dbg !3274
  %106 = call i32 @getegid() #15, !dbg !3275
...
; <label>:121                                     ; preds = %115, %.thread, %102
  call fastcc void @__check_one_fd(i32 0, i32 131072) #15, !dbg !3278
  call fastcc void @__check_one_fd(i32 1, i32 131074) #15, !dbg !3280
  call fastcc void @__check_one_fd(i32 2, i32 131074) #15, !dbg !3281
...
; <label>:125                                     ; preds = %124, %122
  %126 = call fastcc i32 @__user_main(i32 %0, i8** %1) #15, !dbg !3286
  call void @exit(i32 %126) #14, !dbg !3286
...
; <label>:31                                      ; preds = %25
  ...
  call void @klee_warning_once(i8* getelementptr inbounds ([41 x i8]* @.str13, i64 0, i64 0)) #8, !dbg !3301
...
; <label>:67                                      ; preds = %25
  ...
  %70 = call i64 (i64, ...)* @syscall(i64 16, i32 %69, i64 21505, i8* %27) #8, !dbg !3339
  %71 = trunc i64 %70 to i32, !dbg !3339
  %72 = icmp eq i32 %71, -1, !dbg !3340
  br i1 %72, label %73, label %75, !dbg !3340

; <label>:73                                      ; preds = %67
  %74 = call i32 @klee_get_errno() #8, !dbg !3342
...
; <label>:34                                      ; preds = %31
  ...
  %39 = call i64 @klee_get_valuel(i64 ptrtoint ([10 x i8]* @.str130 to i64)) #8, !dbg !3361
  ...
  call void @klee_assume(i64 %42) #8, !dbg !3364
...
__concretize_string.exit.i:                       ; preds = %52, %49
  %62 = call i64 (i64, ...)* @syscall(i64 2, i8* getelementptr inbounds ([10 x i8]* @.str130, i64 0, i64 0), i32 %flags, i32 %mode.0) #8, !dbg !3363
...
; <label>:65                                      ; preds = %__concretize_string.exit.i
  %66 = call i32 @klee_get_errno() #8, !dbg !3379
...
define internal fastcc void @__create_new_dfile(%struct.exe_disk_file_t* nocapture %dfile, i32 %size, i8* %name, %struct.stat64.647* nocapture readonly %defaults) #10 {
  ...
  %1 = call noalias i8* @malloc(i64 144) #8, !dbg !3395
...
._crit_edge3:                                     ; preds = %31, %18
  ...
  call void @klee_assume(i64 %37) #8, !dbg !3411
  ...
  call void @klee_assume(i64 %42) #8, !dbg !3412
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %48) #8, !dbg !3414
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %54) #8, !dbg !3416
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %61) #8, !dbg !3418
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %65) #8, !dbg !3420
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %69) #8, !dbg !3421
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %73) #8, !dbg !3422
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %77) #8, !dbg !3423
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %82) #8, !dbg !3424
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %89) #8, !dbg !3425
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %96) #8, !dbg !3427
  %97 = load i64* %39, align 8, !dbg !3428, !tbaa !3413
  %98 = icmp eq i64 %97, 4096, !dbg !3428
  %99 = zext i1 %98 to i64, !dbg !3428
  call void @klee_posix_prefer_cex(i8* %1, i64 %99) #8, !dbg !3428
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %106) #8, !dbg !3429
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %113) #8, !dbg !3430
  ...
  call void @klee_posix_prefer_cex(i8* %1, i64 %120) #8, !dbg !3431
...
define internal fastcc void @__emit_error(i8* %msg) #12 {
  tail call void @klee_report_error(i8* getelementptr inbounds ([16 x i8]* @.str2254, i64 0, i64 0), i32 24, i8* %msg, i8* getelementptr inbounds ([9 x i8]* @.str2355, i64 0, i64 0)) #5, !dbg !3438
...
define internal fastcc i8* @__get_sym_str(i32 %numChars, i8* %name) #10 {
  ...
  %3 = tail call noalias i8* @malloc(i64 %2) #8, !dbg !3439
  tail call void @klee_mark_global(i8* %3) #8, !dbg !3440
  tail call void @klee_make_symbolic(i8* %3, i64 %2, i8* %name) #8, !dbg !3441
...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  tail call void @klee_posix_prefer_cex(i8* %3, i64 %9) #8, !dbg !3444
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #14, !dbg !3450
...
define i32 @klee_int(i8* %name) #10 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #15, !dbg !3452
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #14, !dbg !3456
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #14, !dbg !3461
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #15, !dbg !3464
