...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %APHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %460
  %.03.i = phi i8* [ %463, %460 ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %464, %460 ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %462, %460 ], [ -1431655766, %strlen.exit ]
  %443 = and i32 %i.02.i, 1
  %444 = icmp eq i32 %443, 0
  br i1 %444, label %445, label %452

; <label>:445                                     ; preds = %.lr.ph.i
  %446 = shl i32 %hash.01.i, 7
  %447 = load i8* %.03.i, align 1
  %448 = sext i8 %447 to i32
  %449 = lshr i32 %hash.01.i, 3
  %450 = mul i32 %448, %449
  %451 = xor i32 %450, %446
  br label %460

; <label>:452                                     ; preds = %.lr.ph.i
  %453 = shl i32 %hash.01.i, 11
  %454 = load i8* %.03.i, align 1
  %455 = sext i8 %454 to i32
  %456 = lshr i32 %hash.01.i, 5
  %457 = xor i32 %455, %456
  %458 = add i32 %457, %453
  %459 = xor i32 %458, -1
  br label %460

; <label>:460                                     ; preds = %452, %445
  %461 = phi i32 [ %451, %445 ], [ %459, %452 ]
  %462 = xor i32 %461, %hash.01.i
  %463 = getelementptr inbounds i8* %.03.i, i64 1
  %464 = add i32 %i.02.i, 1
  %exitcond.i = icmp eq i32 %464, %441
  br i1 %exitcond.i, label %APHash.exit, label %.lr.ph.i

APHash.exit:                                      ; preds = %460
  %465 = icmp eq i32 %462, 37524292
  br i1 %465, label %466, label %APHash.exit.thread

; <label>:466                                     ; preds = %APHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %467

APHash.exit.thread:                               ; preds = %strlen.exit, %APHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %467

; <label>:467                                     ; preds = %APHash.exit.thread, %466
  ret i32 0
}
