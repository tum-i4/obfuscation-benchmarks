; ModuleID = './aphash-addOpaque-updateOpaque1.bc'
...
._crit_edge:                                      ; preds = %29, %0
  %hash.0.lcssa = phi i32 [ -1431655766, %0 ], [ %30, %29 ]
  %i.0.lcssa = phi i32 [ 0, %0 ], [ %len, %29 ]
...
; <label>:4                                       ; preds = %._crit_edge
  %5 = tail call fastcc i32 @APHash(i8* null, i32 %i.0.lcssa)
  ret i32 %hash.0.lcssa

.lr.ph:                                           ; preds = %0, %29
  %.03 = phi i8* [ %31, %29 ], [ %str, %0 ]
  %hash.02 = phi i32 [ %30, %29 ], [ -1431655766, %0 ]
  %i.01 = phi i32 [ %32, %29 ], [ 0, %0 ]
  %6 = and i32 %i.01, 1
  %7 = icmp eq i32 %6, 0
...
; <label>:8                                       ; preds = %.lr.ph
  %9 = shl i32 %hash.02, 7
  %10 = load i8* %.03, align 1
  %11 = sext i8 %10 to i32
  %12 = lshr i32 %hash.02, 3
  %13 = mul i32 %11, %12
  %14 = xor i32 %13, %9
  br label %29
...
; <label>:15                                      ; preds = %.lr.ph
  ...
  %17 = getelementptr inbounds %struct._1_main__opaque_Node_1* %16, i64 0, i32 1
  %18 = load %struct._1_main__opaque_Node_1** %17, align 8
  store %struct._1_main__opaque_Node_1* %18, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %19 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %20 = getelementptr inbounds %struct._1_main__opaque_Node_1* %19, i64 0, i32 1
  %21 = load %struct._1_main__opaque_Node_1** %20, align 8
  store %struct._1_main__opaque_Node_1* %21, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %22 = shl i32 %hash.02, 11
  %23 = load i8* %.03, align 1
  %24 = sext i8 %23 to i32
  %25 = lshr i32 %hash.02, 5
  %26 = xor i32 %24, %25
  %27 = add i32 %26, %22
  %28 = xor i32 %27, -1
  br label %29
...
; <label>:29                                      ; preds = %15, %8
  %tmp.0 = phi i32 [ %14, %8 ], [ %28, %15 ]
  %30 = xor i32 %tmp.0, %hash.02
  %31 = getelementptr inbounds i8* %.03, i64 1
  %32 = add i32 %i.01, 1
  %exitcond = icmp eq i32 %32, %len
