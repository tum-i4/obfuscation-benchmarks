; ModuleID = './aphash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i2, label %APHash.exit.thread

.lr.ph.i2:                                        ; preds = %strlen.exit, %490
  %.06.i = phi i8* [ %497, %490 ], [ %433, %strlen.exit ]
  %hash.05.i = phi i32 [ %496, %490 ], [ -1431655766, %strlen.exit ]
  %i.04.i = phi i32 [ %500, %490 ], [ 0, %strlen.exit ]
  %447 = or i32 %i.04.i, 1
  %448 = xor i32 %447, -2
  %449 = add i32 %448, %i.04.i
  %450 = icmp eq i32 %449, -1
  br i1 %450, label %451, label %478

; <label>:451                                     ; preds = %.lr.ph.i2
  %452 = shl i32 %hash.05.i, 7
  %453 = load i8* %.06.i, align 1
  %454 = sext i8 %453 to i32
  %455 = lshr i32 %hash.05.i, 3
  %456 = and i32 %454, %455
  %457 = or i32 %454, %455
  %458 = mul i32 %456, %457
  %459 = xor i32 %455, -1
...
; <label>:478                                     ; preds = %.lr.ph.i2
  %479 = shl i32 %hash.05.i, 11
  %480 = load i8* %.06.i, align 1
  %481 = sext i8 %480 to i32
  %482 = lshr i32 %hash.05.i, 5
  %483 = xor i32 %482, 2147483647
  %484 = or i32 %481, %483
  %485 = shl i32 %484, 1
  %486 = add i32 %482, 1
  %487 = sub i32 %486, %479
...
; <label>:490                                     ; preds = %478, %451
  %tmp.0.i = phi i32 [ %477, %451 ], [ %489, %478 ]
  %491 = xor i32 %tmp.0.i, 2147483647
  %492 = or i32 %491, %hash.05.i
  %493 = shl i32 %492, 1
  %494 = add i32 %hash.05.i, -2
  %495 = sub i32 %494, %tmp.0.i
  %496 = sub i32 %495, %493
  %497 = getelementptr inbounds i8* %.06.i, i64 1
  %498 = shl i32 %447, 1
  %499 = xor i32 %i.04.i, 1
  %500 = sub i32 %498, %499
  %501 = xor i32 %500, -2147483648
  %502 = and i32 %501, %441
  %503 = xor i32 %442, %500
  %504 = sub i32 %500, %441
  %505 = and i32 %504, %503
  ...
  br i1 %507, label %.lr.ph.i2, label %APHash.exit

APHash.exit:                                      ; preds = %490
  %508 = icmp eq i32 %496, 37524292
  br i1 %508, label %509, label %APHash.exit.thread

; <label>:509                                     ; preds = %APHash.exit
...
; <label>:510                                     ; preds = %APHash.exit.thread, %509
  ret i32 0
}
