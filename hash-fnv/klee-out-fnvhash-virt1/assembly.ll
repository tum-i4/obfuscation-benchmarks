...
%"union._1_FNVHash_$node" = type { i8* }
...
@"_1_FNVHash_$array" = internal unnamed_addr constant [1 x [181 x i8]] [[181 x i8] c"U\0C\00\00\00\EF\C5\9D\1C\81\1FU\10\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\14\00\00\00\
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_FNVHash_$locals.i" = alloca [24 x i8], align 16
  %"_1_FNVHash_$stack.i" = alloca [1 x [32 x %"union._1_FNVHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [24 x i8]* %"_1_FNVHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_FNVHash_$node"]]* %"_1_FNVHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_FNVHash_$node"]]* %"_1_FNVHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %605, %596, %588, %582, %579, %563, %555, %548, %539, %530, %524, %518, %516, %497, %495, %489, %481, %474, %466, %460, %451, %.backedge.i, %strlen.exit
  %"_1_FNVHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [181 x i8]]* @"_1_FNVHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_FNVHash_$pc.0.0.i", %.backedge.i ], [ %611, %605 ], [ %597, %596 ], [ %589, %588 ], [ %583, %582 ], [ %581,
  %"_1_FNVHash_$sp.0.0.i" = phi %"union._1_FNVHash_$node"* [ %448, %strlen.exit ], [ %"_1_FNVHash_$sp.0.0.i", %.backedge.i ], [ %610, %605 ], [ %600, %596 ], [ %592, %588 ], [ %"_1_FNVHash_$sp.0.0.i", %582 ], [ %580, %579 ], [ %567, %563 ], [ %562, %555 
  %449 = load i8* %"_1_FNVHash_$pc.0.0.i", align 1
  %450 = zext i8 %449 to i32
  switch i32 %450, label %.backedge.i [
    i32 214, label %451
    i32 150, label %460
    i32 235, label %466
    i32 34, label %FNVHash.exit
    i32 7, label %474
    i32 60, label %481
    i32 89, label %489
    i32 55, label %495
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %453 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %454 = load i32* %453, align 4
  %455 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1
  %456 = bitcast %"union._1_FNVHash_$node"* %455 to i32*
...
; <label>:460                                     ; preds = %.backedge.i
  %461 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %462 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 0, i32 0
  %463 = load i8** %462, align 8
  %464 = bitcast i8* %463 to i8**
  %465 = load i8** %464, align 8
  store i8* %465, i8** %462, align 8
  br label %.backedge.i

; <label>:466                                     ; preds = %.backedge.i
  %467 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %468 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %469 = load i8** %468, align 8
  %470 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 0, i32 0
  %471 = load i8** %470, align 8
  %472 = bitcast i8* %471 to i8**
  store i8* %469, i8** %472, align 8
  %473 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:474                                     ; preds = %.backedge.i
  %475 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %476 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 0, i32 0
  %477 = load i8** %476, align 8
  %478 = bitcast i8* %477 to i32*
  %479 = load i32* %478, align 4
  %480 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  store i32 %479, i32* %480, align 4
  br label %.backedge.i

; <label>:481                                     ; preds = %.backedge.i
  %482 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %483 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %484 = load i32* %483, align 4
  %485 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1
  %486 = bitcast %"union._1_FNVHash_$node"* %485 to i32*
...
; <label>:489                                     ; preds = %.backedge.i
  %490 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %491 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %492 = load i32* %491, align 4
  %493 = sext i32 %492 to i64
  %494 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 0, i32 0
  %.c2.i = inttoptr i64 %493 to i8*
  store i8* %.c2.i, i8** %494, align 8
  br label %.backedge.i

; <label>:495                                     ; preds = %.backedge.i
  %496 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:497                                     ; preds = %.backedge.i
  %498 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %499 = bitcast i8* %498 to i32*
  %500 = load i32* %499, align 4
  %501 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1
  %502 = bitcast %"union._1_FNVHash_$node"* %501 to i32*
  store i32 %500, i32* %502, align 4
  %503 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:504                                     ; preds = %.backedge.i
  %505 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %506 = load i32* %505, align 4
  %507 = icmp eq i32 %506, 0
  br i1 %507, label %514, label %508

; <label>:508                                     ; preds = %504
  %509 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %510 = bitcast i8* %509 to i32*
  %511 = load i32* %510, align 4
  %512 = sext i32 %511 to i64
  %.sum3.i = add i64 %512, 1
  %513 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 %.sum3.i
  br label %516

; <label>:514                                     ; preds = %504
  %515 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 5
  br label %516

; <label>:516                                     ; preds = %514, %508
  %"_1_FNVHash_$pc.0.1.i" = phi i8* [ %515, %514 ], [ %513, %508 ]
  %517 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:518                                     ; preds = %.backedge.i
  %519 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %520 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 0, i32 0
  %521 = load i8** %520, align 8
  %522 = load i8* %521, align 1
  %523 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i8*
  store i8 %522, i8* %523, align 1
  br label %.backedge.i

; <label>:524                                     ; preds = %.backedge.i
  %525 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %526 = bitcast i8* %525 to i32*
  %527 = load i32* %526, align 4
  %528 = sext i32 %527 to i64
  %.sum.i = add i64 %528, 1
  %529 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:530                                     ; preds = %.backedge.i
  %531 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %532 = bitcast i8* %531 to i32*
  %533 = load i32* %532, align 4
  %534 = sext i32 %533 to i64
  %535 = getelementptr inbounds [24 x i8]* %"_1_FNVHash_$locals.i", i64 0, i64 %534
  %536 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* %535, i8** %536, align 8
  %537 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1
  %538 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:539                                     ; preds = %.backedge.i
  %540 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %541 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i64*
  %542 = load i64* %541, align 8
  %543 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1
  %544 = bitcast %"union._1_FNVHash_$node"* %543 to i64*
  %545 = load i64* %544, align 8
  %546 = mul i64 %545, %542
  %547 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %.c1.i = inttoptr i64 %546 to i8*
  store i8* %.c1.i, i8** %547, align 8
  br label %.backedge.i

; <label>:548                                     ; preds = %.backedge.i
  %549 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %550 = bitcast i8* %549 to i32*
  %551 = load i32* %550, align 4
  %552 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1
  %553 = bitcast %"union._1_FNVHash_$node"* %552 to i32*
  store i32 %551, i32* %553, align 4
  %554 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:555                                     ; preds = %.backedge.i
  %556 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %557 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %558 = load i32* %557, align 4
  %559 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %560 = load i8** %559, align 8
  %561 = bitcast i8* %560 to i32*
  store i32 %558, i32* %561, align 4
  %562 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:563                                     ; preds = %.backedge.i
  %564 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %565 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %566 = load i32* %565, align 4
  %567 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1
  %568 = bitcast %"union._1_FNVHash_$node"* %567 to i32*
...
; <label>:571                                     ; preds = %.backedge.i
  %572 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
...
; <label>:575                                     ; preds = %571
  %576 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %576, align 8
  br label %579

; <label>:577                                     ; preds = %571
  %578 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %578, align 8
  br label %579

; <label>:579                                     ; preds = %577, %575, %571
  %580 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1
  %581 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:582                                     ; preds = %.backedge.i
  %583 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %584 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i8*
  %585 = load i8* %584, align 1
  %586 = sext i8 %585 to i32
  %587 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  store i32 %586, i32* %587, align 4
  br label %.backedge.i

; <label>:588                                     ; preds = %.backedge.i
  %589 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %590 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %591 = load i32* %590, align 4
  %592 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1
  %593 = bitcast %"union._1_FNVHash_$node"* %592 to i32*
...
; <label>:596                                     ; preds = %.backedge.i
  %597 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %598 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 0, i32 0
  %599 = load i8** %598, align 8
  %600 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1
  %601 = bitcast %"union._1_FNVHash_$node"* %600 to i64*
  %602 = load i64* %601, align 8
  %603 = getelementptr i8* %599, i64 %602
  %604 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %603, i8** %604, align 8
  br label %.backedge.i

; <label>:605                                     ; preds = %.backedge.i
  %606 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 1
  %607 = bitcast i8* %606 to i64*
  %608 = load i64* %607, align 8
  %609 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1, i32 0
  %.c.i = inttoptr i64 %608 to i8*
  store i8* %.c.i, i8** %609, align 8
  %610 = getelementptr inbounds %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i", i64 1
  %611 = getelementptr inbounds i8* %"_1_FNVHash_$pc.0.0.i", i64 9
  br label %.backedge.i

FNVHash.exit:                                     ; preds = %.backedge.i
  %612 = bitcast %"union._1_FNVHash_$node"* %"_1_FNVHash_$sp.0.0.i" to i32*
  %613 = load i32* %612, align 4
  %614 = icmp eq i32 %613, -298024492
  br i1 %614, label %615, label %616

; <label>:615                                     ; preds = %FNVHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %617

; <label>:616                                     ; preds = %FNVHash.exit
