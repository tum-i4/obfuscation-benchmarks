...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %FNVHash.exit.thread, label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  ...
  %443 = mul i32 %hash.01.i, -2128831035
  ...
  br i1 %exitcond.i, label %FNVHash.exit, label %.lr.ph.i

FNVHash.exit:                                     ; preds = %.lr.ph.i
  %449 = icmp eq i32 %446, -298024492
  br i1 %449, label %450, label %FNVHash.exit.thread

; <label>:450                                     ; preds = %FNVHash.exit
...
; <label>:451                                     ; preds = %FNVHash.exit.thread, %450
  ret i32 0
}
