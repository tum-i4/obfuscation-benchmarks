; ModuleID = './fnvhash-addOpaque-updateOpaque4.bc'
...
; <label>:464                                     ; preds = %464, %557
  %p.0.i = phi i8* [ %561, %557 ], [ %467, %464 ]
...
strlen.exit:                                      ; preds = %464
  ...
  %469 = ptrtoint i8* %561 to i64, !dbg !3156
  %470 = sub i64 %468, %469, !dbg !3156
  %471 = trunc i64 %470 to i32
  %472 = bitcast i8** %1 to i8*
  store i8* %561, i8** %1, align 8
  ...
  %476 = getelementptr inbounds %struct._1_main__opaque_Node_1* %558, i64 0, i32 1
  ...
  %478 = icmp eq %struct._1_main__opaque_Node_1* %475, null
  br i1 %478, label %479, label %480

; <label>:479                                     ; preds = %strlen.exit
  call void @klee_div_zero_check(i64 2115367) #7
  %.pre = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %.pre10 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %480

; <label>:480                                     ; preds = %479, %strlen.exit
  %481 = phi %struct._1_main__opaque_Node_1* [ %.pre10, %479 ], [ %477, %strlen.exit ]
  %482 = phi %struct._1_main__opaque_Node_1* [ %.pre, %479 ], [ %475, %strlen.exit ]
  %hash.0.i = phi i32 [ 9, %479 ], [ 0, %strlen.exit ]
  %fnv_prime.0.i = phi i32 [ 2115367, %479 ], [ -2128831035, %strlen.exit ]
  %483 = getelementptr inbounds %struct._1_main__opaque_Node_1* %482, i64 0, i32 1
  %484 = load %struct._1_main__opaque_Node_1** %483, align 8
  store %struct._1_main__opaque_Node_1* %484, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %485 = getelementptr inbounds %struct._1_main__opaque_Node_1* %481, i64 0, i32 1
  %486 = load %struct._1_main__opaque_Node_1** %485, align 8
  store %struct._1_main__opaque_Node_1* %486, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %487

; <label>:487                                     ; preds = %512, %480
  %488 = phi i8* [ %517, %512 ], [ %561, %480 ]
  %489 = phi %struct._1_main__opaque_Node_1* [ %.pr.i, %512 ], [ %486, %480 ]
  %hash.1.i = phi i32 [ %516, %512 ], [ %hash.0.i, %480 ]
  %i.1.i = phi i32 [ %518, %512 ], [ %hash.0.i, %480 ]
  %490 = icmp eq %struct._1_main__opaque_Node_1* %489, null
  br i1 %490, label %491, label %493

; <label>:491                                     ; preds = %487
  %492 = call fastcc i32 @__user_main(i32 1, i8** %1) #7
  br label %493

; <label>:493                                     ; preds = %491, %487
  %494 = icmp ult i32 %i.1.i, %471
  br i1 %494, label %512, label %495

; <label>:495                                     ; preds = %493
  %496 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %497 = icmp eq %struct._1_main__opaque_Node_1* %496, null
  %.pre11 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br i1 %497, label %.FNVHash.exit_crit_edge, label %498

.FNVHash.exit_crit_edge:                          ; preds = %495
  %.pre12 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %FNVHash.exit

; <label>:498                                     ; preds = %495
  %499 = icmp eq %struct._1_main__opaque_Node_1* %.pre11, null
  %500 = getelementptr inbounds %struct._1_main__opaque_Node_1* %.pre11, i64 0, i32 1
...
; <label>:502                                     ; preds = %498
  ...
  %504 = getelementptr inbounds %struct._1_main__opaque_Node_1* %503, i64 0, i32 1
...
; <label>:506                                     ; preds = %498
  %507 = getelementptr inbounds %struct._1_main__opaque_Node_1* %501, i64 1
  store %struct._1_main__opaque_Node_1* %507, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %508 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %509 = getelementptr inbounds %struct._1_main__opaque_Node_1* %508, i64 0, i32 1
  %510 = load %struct._1_main__opaque_Node_1** %509, align 8
  %511 = getelementptr inbounds %struct._1_main__opaque_Node_1* %510, i64 1
  store %struct._1_main__opaque_Node_1* %511, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %FNVHash.exit

; <label>:512                                     ; preds = %493
  %513 = mul i32 %hash.1.i, %fnv_prime.0.i
  %514 = load i8* %488, align 1
  %515 = sext i8 %514 to i32
  %516 = xor i32 %515, %513
  %517 = getelementptr inbounds i8* %488, i64 1
  store i8* %517, i8** %1, align 8
  %518 = add i32 %i.1.i, 1
  %.pr.i = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %487

FNVHash.exit:                                     ; preds = %.FNVHash.exit_crit_edge, %502, %506
  %519 = phi %struct._1_main__opaque_Node_1* [ %.pre12, %.FNVHash.exit_crit_edge ], [ %505, %502 ], [ %511, %506 ]
  %520 = phi %struct._1_main__opaque_Node_1* [ %.pre11, %.FNVHash.exit_crit_edge ], [ %501, %502 ], [ %507, %506 ]
  %521 = getelementptr inbounds %struct._1_main__opaque_Node_1* %520, i64 0, i32 1
  %522 = load %struct._1_main__opaque_Node_1** %521, align 8
  store %struct._1_main__opaque_Node_1* %522, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %523 = getelementptr inbounds %struct._1_main__opaque_Node_1* %519, i64 0, i32 1
  ...
  %525 = icmp eq i32 %hash.1.i, -298024492
  br i1 %525, label %526, label %527

; <label>:526                                     ; preds = %FNVHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %528

; <label>:527                                     ; preds = %FNVHash.exit
...
; <label>:529                                     ; preds = %461, %453, %rand.exit
  %530 = load i32* %445, align 4, !dbg !3143
  %531 = load i32* %444, align 4, !dbg !3143
  %532 = add nsw i32 %531, %530, !dbg !3143
  store i32 %532, i32* %444, align 4, !dbg !3143
  %533 = lshr i32 %532, 1, !dbg !3144
  %534 = getelementptr inbounds i32* %444, i64 1, !dbg !3145
  %535 = icmp ult i32* %534, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %536 = getelementptr inbounds i32* %445, i64 1, !dbg !3148
  br i1 %535, label %537, label %rand.exit.1, !dbg !3146

; <label>:537                                     ; preds = %529
  %538 = icmp ult i32* %536, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %538, i32* %536, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %529, %537
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %529 ], [ %534, %537 ]
  %rptr.0.i.i.i.1 = phi i32* [ %536, %529 ], [ %..i.i.i.1, %537 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %539 = tail call i8* @malloc(i64 16) #7
  %540 = bitcast i8* %539 to %struct._1_main__opaque_Node_1*
  %541 = icmp eq i8* %539, null
  br i1 %541, label %557, label %542

; <label>:542                                     ; preds = %rand.exit.1
  %543 = bitcast i8* %539 to i32*
  store i32 %533, i32* %543, align 4
  %544 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %545 = icmp eq %struct._1_main__opaque_Node_1* %544, null
  br i1 %545, label %554, label %546

; <label>:546                                     ; preds = %542
  %547 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %548 = getelementptr inbounds %struct._1_main__opaque_Node_1* %547, i64 0, i32 1
  %549 = load %struct._1_main__opaque_Node_1** %548, align 8
  %550 = getelementptr inbounds i8* %539, i64 8
  %551 = bitcast i8* %550 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %549, %struct._1_main__opaque_Node_1** %551, align 8
  %552 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %553 = getelementptr inbounds %struct._1_main__opaque_Node_1* %552, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %540, %struct._1_main__opaque_Node_1** %553, align 8
  br label %557

; <label>:554                                     ; preds = %542
  %555 = getelementptr inbounds i8* %539, i64 8
  %556 = bitcast i8* %555 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %540, %struct._1_main__opaque_Node_1** %556, align 8
  store %struct._1_main__opaque_Node_1* %540, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %557

; <label>:557                                     ; preds = %554, %546, %rand.exit.1
  %558 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %558, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %559 = getelementptr inbounds i8* %330, i64 8
