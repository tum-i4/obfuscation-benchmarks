; ModuleID = './fnvhash-addOpaque1.bc'
...
.lr.ph.split.us.i.preheader:                      ; preds = %.lr.ph.i
  br i1 %475, label %FNVHash.exit.thread, label %.lr.ph.split.us.i
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph.split.us.i
  ...
  %476 = mul i32 %hash.02.us.i4, -2128831035
  ...
  br i1 %exitcond, label %.lr.ph.split.us.i.FNVHash.exit_crit_edge, label %.lr.ph.split.us.i

.preheader.i:                                     ; preds = %.lr.ph..lr.ph.split_crit_edge.i, %strlen.exit, %.preheader.i
  br label %.preheader.i

.lr.ph..lr.ph.split_crit_edge.i:                  ; preds = %.lr.ph.i
  br i1 %475, label %FNVHash.exit.thread, label %.preheader.i

.lr.ph.split.us.i.FNVHash.exit_crit_edge:         ; preds = %.lr.ph.split.us.i
  %phitmp = icmp eq i32 %479, -298024492
  br i1 %phitmp, label %482, label %FNVHash.exit.thread

; <label>:482                                     ; preds = %.lr.ph.split.us.i.FNVHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %483

FNVHash.exit.thread:                              ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph..lr.ph.split_crit_edge.i, %.lr.ph.split.us.i.FNVHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %483

; <label>:483                                     ; preds = %FNVHash.exit.thread, %482
  ret i32 0
