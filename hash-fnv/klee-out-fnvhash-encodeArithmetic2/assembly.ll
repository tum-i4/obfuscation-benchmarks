; ModuleID = './fnvhash-encodeArithmetic2.bc'
...
; <label>:442                                     ; preds = %461, %strlen.exit
  %hash.0.i = phi i32 [ 0, %strlen.exit ], [ %504, %461 ]
  %i.0.i = phi i32 [ 0, %strlen.exit ], [ %511, %461 ]
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %505, %461 ]
  ...
  %447 = add i32 %445, %446
  %448 = xor i32 %447, -1
  %449 = xor i32 %i.0.i, %441
  %450 = xor i32 %i.0.i, 2147483647
  %451 = and i32 %450, %441
  %452 = shl i32 %451, 1
  %453 = sub i32 %449, %452
  %454 = or i32 %453, %448
  %.neg3.i = add i32 %443, -1
  %.neg4.i = sub i32 %.neg3.i, %445
  %455 = sub i32 %.neg4.i, %454
  %456 = and i32 %455, %444
  %457 = sub i32 %445, %443
  %458 = add i32 %457, %454
  %459 = add i32 %458, %456
  %460 = icmp slt i32 %459, 0
  br i1 %460, label %461, label %FNVHash.exit

; <label>:461                                     ; preds = %442
  %462 = or i32 %hash.0.i, -2128831035
  %463 = xor i32 %462, 2128831034
  %464 = add i32 %hash.0.i, 1
  %465 = add i32 %464, %463
  %466 = add i32 %hash.0.i, -2128831034
  %467 = or i32 %hash.0.i, 2128831034
  %468 = xor i32 %467, -2128831035
  %469 = add i32 %466, %468
  %470 = and i32 %465, %469
  %471 = or i32 %465, %469
  %472 = mul i32 %470, %471
  %473 = xor i32 %469, -1
  %474 = and i32 %465, %473
  %.neg6.i = sub i32 -2, %hash.0.i
  %475 = sub i32 %.neg6.i, %463
  %476 = and i32 %475, %469
  %477 = mul i32 %474, %476
  %478 = add i32 %472, %477
  %479 = add i32 %462, 2128831035
  %480 = sub i32 %462, %hash.0.i
  %481 = and i32 %479, %480
  %482 = or i32 %479, %480
  %483 = mul i32 %481, %482
  %.neg9.i = add i32 %hash.0.i, -1
  %484 = sub i32 %.neg9.i, %462
  %485 = and i32 %479, %484
  %486 = sub i32 -2128831036, %462
  %487 = and i32 %486, %480
  %488 = mul i32 %485, %487
  %489 = add i32 %483, %488
  %490 = or i32 %478, %489
  ...
  %503 = and i32 %493, %496
  %504 = add i32 %503, %502
  %505 = getelementptr inbounds i8* %.0.i, i64 1
  %506 = shl i32 %i.0.i, 1
  %507 = or i32 %506, 2
  %508 = or i32 %i.0.i, 1
  %509 = and i32 %i.0.i, 1
...
FNVHash.exit:                                     ; preds = %442
  %512 = icmp eq i32 %hash.0.i, -298024492
  br i1 %512, label %513, label %514

; <label>:513                                     ; preds = %FNVHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %515

; <label>:514                                     ; preds = %FNVHash.exit
