; ModuleID = './fnvhash-encodeArithmetic1.bc'
...
__str_to_int.exit45.i:                            ; preds = %145
  ...
  br i1 %156, label %.lr.ph.i3, label %__streq.exit.thread.backedge.i, !dbg !2865

.lr.ph.i3:                                        ; preds = %__str_to_int.exit45.i
  %157 = sext i32 %23 to i64
  br label %158, !dbg !2865

; <label>:158                                     ; preds = %__add_arg.exit46.i, %.lr.ph.i3
  %indvars.iv.i = phi i64 [ %157, %.lr.ph.i3 ], [ %indvars.iv.next.i, %__add_arg.exit46.i ]
  %i.0151.i = phi i32 [ 0, %.lr.ph.i3 ], [ %169, %__add_arg.exit46.i ]
  %sym_arg_num.1150.i = phi i32 [ %sym_arg_num.0294.i, %.lr.ph.i3 ], [ %166, %__add_arg.exit46.i ]
  %159 = phi i32 [ %23, %.lr.ph.i3 ], [ %168, %__add_arg.exit46.i ]
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i, label %FNVHash.exit.thread

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.06.i = phi i8* [ %461, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.05.i = phi i32 [ %465, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.04.i = phi i32 [ %460, %.lr.ph.i ], [ 0, %strlen.exit ]
  %447 = and i32 %hash.04.i, -2128831035
  %448 = or i32 %hash.04.i, -2128831035
  %449 = mul i32 %447, %448
  %450 = and i32 %hash.04.i, 2128831034
  %451 = xor i32 %447, -2128831035
  %452 = mul i32 %451, %450
  %453 = add i32 %452, %449
  %454 = load i8* %.06.i, align 1
  %455 = sext i8 %454 to i32
  %456 = xor i32 %455, -1
  %457 = or i32 %453, %456
  %factor = mul i32 %457, -2
  %458 = sub i32 -2, %455
  %459 = add i32 %458, %453
  %460 = add i32 %459, %factor
  %461 = getelementptr inbounds i8* %.06.i, i64 1
  %462 = shl i32 %i.05.i, 1
  %463 = or i32 %462, 2
  %464 = xor i32 %i.05.i, 1
  %465 = sub i32 %463, %464
  %466 = xor i32 %465, -2147483648
  %467 = and i32 %466, %441
  %468 = xor i32 %465, %442
  %469 = sub i32 %465, %441
  %470 = and i32 %469, %468
  ...
  br i1 %472, label %.lr.ph.i, label %FNVHash.exit

FNVHash.exit:                                     ; preds = %.lr.ph.i
  %473 = icmp eq i32 %460, -298024492
  br i1 %473, label %474, label %FNVHash.exit.thread

; <label>:474                                     ; preds = %FNVHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %475

FNVHash.exit.thread:                              ; preds = %strlen.exit, %FNVHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %475

; <label>:475                                     ; preds = %FNVHash.exit.thread, %474
  ret i32 0
}
