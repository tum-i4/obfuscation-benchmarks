; ModuleID = './fnvhash-addOpaque-updateOpaque1.bc'
...
define internal fastcc i32 @FNVHash(i8* nocapture readonly %str, i32 %len) #2 {
  %1 = icmp eq i32 %len, 0
  %2 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br i1 %1, label %._crit_edge, label %.lr.ph

._crit_edge:                                      ; preds = %12, %0
  %.lcssa = phi %struct._1_main__opaque_Node_1* [ %2, %0 ], [ %20, %12 ]
  %hash.0.lcssa = phi i32 [ 0, %0 ], [ %16, %12 ]
  %3 = getelementptr inbounds %struct._1_main__opaque_Node_1* %.lcssa, i64 0, i32 1
...
.lr.ph:                                           ; preds = %0, %12
  %8 = phi %struct._1_main__opaque_Node_1* [ %20, %12 ], [ %2, %0 ]
  %.05 = phi i8* [ %17, %12 ], [ %str, %0 ]
  %.014 = phi i32 [ %.1, %12 ], [ %len, %0 ]
  %i.03 = phi i32 [ %18, %12 ], [ 0, %0 ]
  %hash.02 = phi i32 [ %16, %12 ], [ 0, %0 ]
  %9 = icmp eq %struct._1_main__opaque_Node_1* %8, null
  br i1 %9, label %10, label %12

; <label>:10                                      ; preds = %.lr.ph
  %11 = tail call fastcc i32 @FNVHash(i8* null, i32 %hash.02)
  br label %12

; <label>:12                                      ; preds = %.lr.ph, %10
  %.1 = phi i32 [ %.014, %.lr.ph ], [ %11, %10 ]
  %13 = mul i32 %hash.02, -2128831035
  %14 = load i8* %.05, align 1
  %15 = sext i8 %14 to i32
  %16 = xor i32 %15, %13
  %17 = getelementptr inbounds i8* %.05, i64 1
  %18 = add i32 %i.03, 1
