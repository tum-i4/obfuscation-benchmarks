...
%"union._2_FNVHash_$node" = type { i8* }
...
@"_1_FNVHash_$array" = internal global [1 x [181 x i8]] [[181 x i8] c"U\0C\00\00\00\EF\C5\9D\1C\81\1FU\10\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\14\00\00\00\07\D6l\0E\00\00
@"_2_FNVHash_$array" = internal unnamed_addr constant [1 x [8684 x i8]] [[8684 x i8] c"\88\18\00\00\00;\00\00\00\00\00\00\00\00R\00\00\00\00\00\00\00\00R\08\00\00\00\00\00\00\00\FDOR\00\00\00\00\00\00\00\00R\00\01\00\00\00\00\00\00\FDO\9E\88\10\00\00\00;
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_FNVHash_$locals.i" = alloca [312 x i8], align 16
  %"_2_FNVHash_$stack.i" = alloca [1 x [32 x %"union._2_FNVHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [312 x i8]* %"_2_FNVHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_FNVHash_$node"]]* %"_2_FNVHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_FNVHash_$node"]]* %"_2_FNVHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %713, %705, %698, %692, %685, %683, %664, %656, %653, %642, %634, %626, %620, %614, %612, %606, %598, %592, %583, %574, %571, %563, %546, %539, %532, %530, %522, %514, %507, %498, %492, %486, %4
  %"_2_FNVHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [8684 x i8]]* @"_2_FNVHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_FNVHash_$pc.0.0.i", %.backedge.i ], [ %714, %713 ], [ %706, %705 ], [ %704, %698 ], [ %693, %692 ], [ %686
  %"_2_FNVHash_$sp.0.0.i" = phi %"union._2_FNVHash_$node"* [ %448, %strlen.exit ], [ %"_2_FNVHash_$sp.0.0.i", %.backedge.i ], [ %717, %713 ], [ %712, %705 ], [ %703, %698 ], [ %"_2_FNVHash_$sp.0.0.i", %692 ], [ %"_2_FNVHash_$sp.0.0.i", %685 ], [ %684, %6
  %449 = load i8* %"_2_FNVHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %454 = bitcast %"union._2_FNVHash_$node"* %453 to i64*
  %455 = load i64* %454, align 8
  %456 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i64*
  %457 = load i64* %456, align 8
  %458 = mul i64 %457, %455
  %459 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %.c4.i = inttoptr i64 %458 to i8*
  store i8* %.c4.i, i8** %459, align 8
  br label %.backedge.i

; <label>:460                                     ; preds = %.backedge.i
  %461 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %462 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %463 = bitcast %"union._2_FNVHash_$node"* %462 to i32*
  %464 = load i32* %463, align 4
  %465 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
...
; <label>:468                                     ; preds = %.backedge.i
  %469 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %470 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %471 = load i8** %470, align 8
  %472 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %473 = bitcast %"union._2_FNVHash_$node"* %472 to i64*
  %474 = load i64* %473, align 8
  %475 = getelementptr i8* %471, i64 %474
  %476 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %475, i8** %476, align 8
  br label %.backedge.i

; <label>:477                                     ; preds = %.backedge.i
  %478 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %479 = bitcast i8* %478 to i32*
  %480 = load i32* %479, align 4
  %481 = sext i32 %480 to i64
  %482 = getelementptr inbounds [312 x i8]* %"_2_FNVHash_$locals.i", i64 0, i64 %481
  %483 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* %482, i8** %483, align 8
  %484 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1
  %485 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:486                                     ; preds = %.backedge.i
  %487 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %488 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %489 = load i8** %488, align 8
  %490 = bitcast i8* %489 to i64*
  %491 = load i64* %490, align 8
  %.c3.i = inttoptr i64 %491 to i8*
  store i8* %.c3.i, i8** %488, align 8
  br label %.backedge.i

; <label>:492                                     ; preds = %.backedge.i
  %493 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %494 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i8*
  %495 = load i8* %494, align 1
  %496 = sext i8 %495 to i32
  %497 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  store i32 %496, i32* %497, align 4
  br label %.backedge.i

; <label>:498                                     ; preds = %.backedge.i
  %499 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %500 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %501 = load i8** %500, align 8
  %502 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %503 = load i32* %502, align 4
  %504 = sext i32 %503 to i64
  %505 = getelementptr i8* %501, i64 %504
  store i8* %505, i8** %500, align 8
  %506 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:507                                     ; preds = %.backedge.i
  %508 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %509 = bitcast i8* %508 to i32*
  %510 = load i32* %509, align 4
  %511 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1
  %512 = bitcast %"union._2_FNVHash_$node"* %511 to i32*
  store i32 %510, i32* %512, align 4
  %513 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:514                                     ; preds = %.backedge.i
  %515 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %516 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i64*
  %517 = load i64* %516, align 8
  %518 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %519 = load i8** %518, align 8
  %520 = bitcast i8* %519 to i64*
  store i64 %517, i64* %520, align 8
  %521 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:522                                     ; preds = %.backedge.i
  %523 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %524 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %525 = load i32* %524, align 4
  %526 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %527 = bitcast %"union._2_FNVHash_$node"* %526 to i32*
...
; <label>:530                                     ; preds = %.backedge.i
  %531 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:532                                     ; preds = %.backedge.i
  %533 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %534 = bitcast i8* %533 to i64*
  %535 = load i64* %534, align 8
  %536 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1, i32 0
  %.c2.i = inttoptr i64 %535 to i8*
  store i8* %.c2.i, i8** %536, align 8
  %537 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1
  %538 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:539                                     ; preds = %.backedge.i
  %540 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %541 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %542 = load i8** %541, align 8
  %543 = bitcast i8* %542 to i32*
  %544 = load i32* %543, align 4
  %545 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  store i32 %544, i32* %545, align 4
  br label %.backedge.i

; <label>:546                                     ; preds = %.backedge.i
  %547 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %548 = bitcast i8* %547 to i32*
  %549 = load i32* %548, align 4
  %550 = sext i32 %549 to i64
  %.sum1.i = add i64 %550, 1
  %551 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 %.sum1.i
  br label %.backedge.i

; <label>:552                                     ; preds = %.backedge.i
  %553 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %554 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %555 = load i32* %554, align 4
  %556 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %557 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 5
  %558 = bitcast i8* %557 to i32*
  %559 = load i32* %558, align 4
  %560 = bitcast i8* %553 to i32*
...
; <label>:563                                     ; preds = %552
  ...
  %.sum9.i = add i64 %564, 1
  %565 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 %.sum9.i
  br label %.backedge.i

; <label>:566                                     ; preds = %552
  %567 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 9
  %568 = bitcast i8* %567 to i32*
  %569 = load i32* %568, align 4
  %570 = icmp sgt i32 %555, %569
  br i1 %570, label %571, label %574

; <label>:571                                     ; preds = %566
  %572 = sext i32 %561 to i64
  %.sum8.i = add i64 %572, 1
  %573 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:574                                     ; preds = %566
  %575 = sub nsw i32 %555, %559
  %576 = shl nsw i32 %575, 2
  %577 = sext i32 %576 to i64
  %.sum6.i = add i64 %577, 13
  %578 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 %.sum6.i
  %579 = bitcast i8* %578 to i32*
  %580 = load i32* %579, align 4
  %581 = sext i32 %580 to i64
  %.sum7.i = add i64 %581, 1
  %582 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:583                                     ; preds = %.backedge.i
  %584 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %585 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %586 = load i32* %585, align 4
  %587 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %588 = bitcast %"union._2_FNVHash_$node"* %587 to i32*
...
; <label>:592                                     ; preds = %.backedge.i
  %593 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %594 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %595 = load i32* %594, align 4
  %596 = sext i32 %595 to i64
  %597 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %.c.i = inttoptr i64 %596 to i8*
  store i8* %.c.i, i8** %597, align 8
  br label %.backedge.i

; <label>:598                                     ; preds = %.backedge.i
  %599 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %600 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %601 = bitcast %"union._2_FNVHash_$node"* %600 to i8*
  %602 = load i8* %601, align 1
  %603 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %604 = load i8** %603, align 8
  store i8 %602, i8* %604, align 1
  %605 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:606                                     ; preds = %.backedge.i
  %607 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %608 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i8*
  %609 = load i8* %608, align 1
  %610 = zext i8 %609 to i32
  %611 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  store i32 %610, i32* %611, align 4
  br label %.backedge.i

; <label>:612                                     ; preds = %.backedge.i
  %613 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:614                                     ; preds = %.backedge.i
  %615 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %616 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %617 = load i8** %616, align 8
  %618 = load i8* %617, align 1
  %619 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i8*
  store i8 %618, i8* %619, align 1
  br label %.backedge.i

; <label>:620                                     ; preds = %.backedge.i
  %621 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %622 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %623 = load i8** %622, align 8
  %624 = load i8* %623, align 1
  %625 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i8*
  store i8 %624, i8* %625, align 1
  br label %.backedge.i

; <label>:626                                     ; preds = %.backedge.i
  %627 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %628 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %629 = load i8** %628, align 8
  %630 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %631 = load i8** %630, align 8
  %632 = bitcast i8* %631 to i8**
  store i8* %629, i8** %632, align 8
  %633 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:634                                     ; preds = %.backedge.i
  %635 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:636                                     ; preds = %.backedge.i
  %637 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %638 = bitcast i8* %637 to i32*
  %639 = load i32* %638, align 4
  %cond.i = icmp eq i32 %639, 0
  br i1 %cond.i, label %640, label %642

; <label>:640                                     ; preds = %636
  %641 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [181 x i8]]* @"_1_FNVHash_$array", i64 0, i64 0, i64 0), i8** %641, align 8
  br label %642

; <label>:642                                     ; preds = %640, %636
  %643 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1
  %644 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:645                                     ; preds = %.backedge.i
  %646 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %647 = bitcast i8* %646 to i32*
  %648 = load i32* %647, align 4
  switch i32 %648, label %653 [
    i32 1, label %649
    i32 0, label %651
  ]

; <label>:649                                     ; preds = %645
  %650 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %650, align 8
  br label %653

; <label>:651                                     ; preds = %645
  %652 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %652, align 8
  br label %653

; <label>:653                                     ; preds = %651, %649, %645
  %654 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1
  %655 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:656                                     ; preds = %.backedge.i
  %657 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %658 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %659 = load i32* %658, align 4
  %660 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %661 = load i8** %660, align 8
  %662 = bitcast i8* %661 to i32*
  store i32 %659, i32* %662, align 4
  %663 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:664                                     ; preds = %.backedge.i
  %665 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %666 = bitcast i8* %665 to i32*
  %667 = load i32* %666, align 4
  %668 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1
  %669 = bitcast %"union._2_FNVHash_$node"* %668 to i32*
  store i32 %667, i32* %669, align 4
  %670 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:671                                     ; preds = %.backedge.i
  %672 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %673 = load i32* %672, align 4
  %674 = icmp eq i32 %673, 0
  br i1 %674, label %681, label %675

; <label>:675                                     ; preds = %671
  %676 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %677 = bitcast i8* %676 to i32*
  %678 = load i32* %677, align 4
  %679 = sext i32 %678 to i64
  %.sum5.i = add i64 %679, 1
  %680 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 %.sum5.i
  br label %683

; <label>:681                                     ; preds = %671
  %682 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 5
  br label %683

; <label>:683                                     ; preds = %681, %675
  %"_2_FNVHash_$pc.0.1.i" = phi i8* [ %682, %681 ], [ %680, %675 ]
  %684 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:685                                     ; preds = %.backedge.i
  %686 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %687 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
  %688 = load i8** %687, align 8
  %689 = bitcast i8* %688 to i32*
  %690 = load i32* %689, align 4
  %691 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  store i32 %690, i32* %691, align 4
  br label %.backedge.i

; <label>:692                                     ; preds = %.backedge.i
  %693 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %694 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 0, i32 0
...
; <label>:698                                     ; preds = %.backedge.i
  %699 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %700 = bitcast i8* %699 to i8**
  %701 = load i8** %700, align 8
  %702 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1, i32 0
  store i8* %701, i8** %702, align 8
  %703 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 1
  %704 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:705                                     ; preds = %.backedge.i
  %706 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %707 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %708 = load i32* %707, align 4
  %709 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1, i32 0
  %710 = load i8** %709, align 8
  %711 = bitcast i8* %710 to i32*
  store i32 %708, i32* %711, align 4
  %712 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:713                                     ; preds = %.backedge.i
  %714 = getelementptr inbounds i8* %"_2_FNVHash_$pc.0.0.i", i64 1
  %715 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %716 = load i32* %715, align 4
  %717 = getelementptr inbounds %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i", i64 -1
  %718 = bitcast %"union._2_FNVHash_$node"* %717 to i32*
...
FNVHash.exit:                                     ; preds = %.backedge.i
  %721 = bitcast %"union._2_FNVHash_$node"* %"_2_FNVHash_$sp.0.0.i" to i32*
  %722 = load i32* %721, align 4
  %723 = icmp eq i32 %722, -298024492
  br i1 %723, label %724, label %725

; <label>:724                                     ; preds = %FNVHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %726

; <label>:725                                     ; preds = %FNVHash.exit
