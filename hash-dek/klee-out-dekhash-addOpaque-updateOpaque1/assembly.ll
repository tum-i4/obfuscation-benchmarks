; ModuleID = './dekhash-addOpaque-updateOpaque1.bc'
...
define internal fastcc i32 @DEKHash(i8* nocapture readonly %str, i32 %len) #0 {
  %1 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %2 = icmp eq %struct._1_main__opaque_Node_1* %1, null
  br i1 %2, label %3, label %5

; <label>:3                                       ; preds = %0
  %4 = tail call fastcc i32 @DEKHash(i8* null, i32 undef)
  br label %5

; <label>:5                                       ; preds = %0, %3
  %.01 = phi i32 [ %4, %3 ], [ %len, %0 ]
  %6 = icmp eq i32 %.01, 0
  br i1 %6, label %._crit_edge, label %.lr.ph

._crit_edge:                                      ; preds = %.lr.ph, %5
  %hash.0.lcssa = phi i32 [ 0, %5 ], [ %18, %.lr.ph ]
  ...
  store %struct._1_main__opaque_Node_1* %12, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  ret i32 %hash.0.lcssa

.lr.ph:                                           ; preds = %5, %.lr.ph
  %.04 = phi i8* [ %19, %.lr.ph ], [ %str, %5 ]
  %hash.03 = phi i32 [ %18, %.lr.ph ], [ %.01, %5 ]
  %i.02 = phi i32 [ %20, %.lr.ph ], [ 0, %5 ]
  %13 = shl i32 %hash.03, 5
  %14 = lshr i32 %hash.03, 27
  %15 = or i32 %13, %14
  %16 = load i8* %.04, align 1
  %17 = sext i8 %16 to i32
  %18 = xor i32 %17, %15
  %19 = getelementptr inbounds i8* %.04, i64 1
  %20 = add i32 %i.02, 1
  %exitcond = icmp eq i32 %20, %.01
