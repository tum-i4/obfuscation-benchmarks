...
{ 
  ...
  if (_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) {
    ...
    while ((_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) >= randomVars_BogusReturn133) {
      i = DEKHash(0 & 6, len / len);
    }
  }
  {  /* __blockattribute__(__ATOMIC__)*/ 
  _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
  ...
  if (_1_main__opaque_list1_1 != _1_main__opaque_list2_1) {
    hash = DEKHash(0 >> randomVars_BogusReturn133, hash & hash);
  } else {
    hash = DEKHash(0, hash);
  }
  if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
  ...
  if (_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) {
    ...
    if (_1_main__opaque_list1_1 == _1_main__opaque_list2_1) {
      ...
      hash = DEKHash(10, hash + 10);
    }
    __asm__  volatile   (".byte 0xd3":);
  } else {
    {  /* __blockattribute__(__ATOMIC__)*/ 
    _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
    _1_main__opaque_list2_1 = _1_main__opaque_list2_1->next;
  ...
  while (1) {
    ...
    if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
      __asm__  volatile   (".byte 0xf3,0x8c,0xf6,0x84,0x35,0x30,0xa9":);
    } else
    if (_1_main__opaque_list1_1 == _1_main__opaque_list2_1) {
      {  /* __blockattribute__(__ATOMIC__)*/ 
      _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
    ...
    if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
      __asm__  volatile   (".byte 0xcf,0x20,0xc6,0x5,0x47,0x3e":);
    } else
    if (_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) {
      {  /* __blockattribute__(__ATOMIC__)*/ 
      _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
    ...
    if (! (i < len)) {
      ...
      if (_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) {
        if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
          __asm__  volatile   (".byte 0x40,0x0,0x0":);
        } else {
          hash = DEKHash(0, len);
        }
      } else {
    ...
    if (_1_main__opaque_list1_1 != _1_main__opaque_list2_1) {
      if ((_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) >= randomVars_BogusReturn133) {
        while (1) {
          if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
            if (((_1_main__opaque_list2_1 != (struct _1_main__opaque_Node_1 *)0UL) <= randomVars_BogusReturn133) < randomVars_BogusReturn133) {
              return (len);
            } else {
    ...
    if (_1_main__opaque_list1_1 == _1_main__opaque_list2_1) {
      ...
      while ((_1_main__opaque_list1_1 != _1_main__opaque_list2_1) != randomVars_BogusReturn133) {
        randomVars_BogusReturn133 = main(5 / randomVars_BogusReturn133, & str + -1);
      }
    }
    {  /* __blockattribute__(__ATOMIC__)*/ 
    _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
