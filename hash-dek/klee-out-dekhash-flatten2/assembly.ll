...
.backedge.i:                                      ; preds = %465, %464, %463, %462, %461, %460, %459, %458, %449, %448, %447, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  %_1_DEKHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_DEKHash_next.0.i, %.backedge.i ], [ %_1_DEKHash_next.0.i, %465 ], [ %_1_DEKHash_next.0.i, %464 ], [ %_1_DEKHash_next.0.i, %463 ], [ %_1_DEKHash_next.0.i, %462 ], [ 5, %460 ], [ %_1_DEKHash_n
  %i.0.i = phi i32 [ undef, %strlen.exit ], [ %i.0.i, %.backedge.i ], [ %i.0.i, %465 ], [ %i.0.i, %464 ], [ %i.0.i, %463 ], [ %i.0.i, %462 ], [ %i.0.i, %460 ], [ %i.0.i, %459 ], [ %i.0.i, %458 ], [ %457, %449 ], [ %i.0.i, %448 ], [ %i.0.i, %447 ], [ %i.0
  %hash.0.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.i, %.backedge.i ], [ %hash.0.i, %465 ], [ %hash.0.i, %464 ], [ %hash.0.i, %463 ], [ %hash.0.i, %462 ], [ %hash.0.i, %460 ], [ %hash.0.i, %459 ], [ %hash.0.i, %458 ], [ %455, %449 ], [ %hash.0.i, %4
  %_2_DEKHash_next.0.i = phi i64 [ 2, %strlen.exit ], [ %_2_DEKHash_next.0.i, %.backedge.i ], [ 0, %465 ], [ 17, %464 ], [ 14, %463 ], [ 9, %462 ], [ 0, %460 ], [ 5, %459 ], [ 0, %458 ], [ 8, %449 ], [ 0, %448 ], [ 0, %447 ], [ 13, %444 ], [ 0, %443 ], [
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %.0.i, %.backedge.i ], [ %.0.i, %465 ], [ %.0.i, %464 ], [ %.0.i, %463 ], [ %.0.i, %462 ], [ %.0.i, %460 ], [ %.0.i, %459 ], [ %.0.i, %458 ], [ %456, %449 ], [ %.0.i, %448 ], [ %.0.i, %447 ], [ %.0.i, %444 ], [
  switch i64 %_2_DEKHash_next.0.i, label %.backedge.i [
    i64 17, label %442
    i64 16, label %443
    i64 14, label %444
    i64 13, label %445
...
; <label>:449                                     ; preds = %.backedge.i
  ...
  %451 = lshr i32 %hash.0.i, 27
  %452 = or i32 %450, %451
  %453 = load i8* %.0.i, align 1
  %454 = sext i8 %453 to i32
  %455 = xor i32 %454, %452
  %456 = getelementptr inbounds i8* %.0.i, i64 1
  %457 = add i32 %i.0.i, 1
  br label %.backedge.i
...
; <label>:461                                     ; preds = %.backedge.i
  switch i64 %_1_DEKHash_next.0.i, label %465 [
...
DEKHash.exit:                                     ; preds = %.backedge.i
  %466 = icmp eq i32 %hash.0.i, -566008905
  br i1 %466, label %467, label %468

; <label>:467                                     ; preds = %DEKHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %469

; <label>:468                                     ; preds = %DEKHash.exit
