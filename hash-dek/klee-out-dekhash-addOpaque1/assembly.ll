; ModuleID = './dekhash-addOpaque1.bc'
...
; <label>:463                                     ; preds = %463, %514
  %p.0.i = phi i8* [ %518, %514 ], [ %466, %463 ]
...
strlen.exit:                                      ; preds = %463
  ...
  %468 = ptrtoint i8* %518 to i64, !dbg !3156
  %469 = sub i64 %467, %468, !dbg !3156
  %470 = trunc i64 %469 to i32
  %471 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %472 = icmp eq %struct._1_main__opaque_Node_1* %471, %515
  br i1 %472, label %.split.us.i.preheader, label %.preheader.i

.split.us.i.preheader:                            ; preds = %strlen.exit
  %473 = icmp eq i32 %470, 0
  br i1 %473, label %.critedge, label %.split.us.i

.split.us.i:                                      ; preds = %.split.us.i.preheader, %.split.us.i
  %.0.us.i4 = phi i8* [ %480, %.split.us.i ], [ %518, %.split.us.i.preheader ]
  %i.0.us.i3 = phi i32 [ %481, %.split.us.i ], [ 0, %.split.us.i.preheader ]
  %hash.0.us.i2 = phi i32 [ %479, %.split.us.i ], [ %470, %.split.us.i.preheader ]
  %474 = shl i32 %hash.0.us.i2, 5
  %475 = lshr i32 %hash.0.us.i2, 27
  %476 = or i32 %474, %475
  %477 = load i8* %.0.us.i4, align 1
  %478 = sext i8 %477 to i32
  %479 = xor i32 %478, %476
  %480 = getelementptr inbounds i8* %.0.us.i4, i64 1
  %481 = add i32 %i.0.us.i3, 1
  %exitcond = icmp eq i32 %481, %470
  br i1 %exitcond, label %.split.us.i.DEKHash.exit_crit_edge, label %.split.us.i

.preheader.i:                                     ; preds = %strlen.exit, %.preheader.i
  %i.0.i = phi i32 [ %483, %.preheader.i ], [ 0, %strlen.exit ]
  %482 = icmp ult i32 %i.0.i, %470
  %483 = add i32 %i.0.i, 1
  br i1 %482, label %.preheader..preheader.split_crit_edge.i, label %.preheader.i

.preheader..preheader.split_crit_edge.i:          ; preds = %.preheader.i, %.preheader..preheader.split_crit_edge.i
  br label %.preheader..preheader.split_crit_edge.i

.split.us.i.DEKHash.exit_crit_edge:               ; preds = %.split.us.i
  %phitmp = icmp eq i32 %479, -566008905
  br i1 %phitmp, label %484, label %.critedge

; <label>:484                                     ; preds = %.split.us.i.DEKHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %485

.critedge:                                        ; preds = %.split.us.i.preheader, %.split.us.i.DEKHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %485

; <label>:485                                     ; preds = %.critedge, %484
  ret i32 0

; <label>:486                                     ; preds = %460, %452, %rand.exit
  %487 = load i32* %444, align 4, !dbg !3143
  %488 = load i32* %443, align 4, !dbg !3143
  %489 = add nsw i32 %488, %487, !dbg !3143
  store i32 %489, i32* %443, align 4, !dbg !3143
  %490 = lshr i32 %489, 1, !dbg !3144
  %491 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %492 = icmp ult i32* %491, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %493 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %492, label %494, label %rand.exit.1, !dbg !3146

; <label>:494                                     ; preds = %486
  %495 = icmp ult i32* %493, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %495, i32* %493, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %486, %494
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %486 ], [ %491, %494 ]
  %rptr.0.i.i.i.1 = phi i32* [ %493, %486 ], [ %..i.i.i.1, %494 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %496 = tail call i8* @malloc(i64 16) #7
  %497 = bitcast i8* %496 to %struct._1_main__opaque_Node_1*
  %498 = icmp eq i8* %496, null
  br i1 %498, label %514, label %499

; <label>:499                                     ; preds = %rand.exit.1
  %500 = bitcast i8* %496 to i32*
  store i32 %490, i32* %500, align 4
  %501 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %502 = icmp eq %struct._1_main__opaque_Node_1* %501, null
  br i1 %502, label %511, label %503

; <label>:503                                     ; preds = %499
  %504 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %505 = getelementptr inbounds %struct._1_main__opaque_Node_1* %504, i64 0, i32 1
  %506 = load %struct._1_main__opaque_Node_1** %505, align 8
  %507 = getelementptr inbounds i8* %496, i64 8
  %508 = bitcast i8* %507 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %506, %struct._1_main__opaque_Node_1** %508, align 8
  ...
  store %struct._1_main__opaque_Node_1* %497, %struct._1_main__opaque_Node_1** %510, align 8
  br label %514

; <label>:511                                     ; preds = %499
  %512 = getelementptr inbounds i8* %496, i64 8
  %513 = bitcast i8* %512 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %497, %struct._1_main__opaque_Node_1** %513, align 8
  store %struct._1_main__opaque_Node_1* %497, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %514

; <label>:514                                     ; preds = %511, %503, %rand.exit.1
  %515 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %515, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %516 = getelementptr inbounds i8* %329, i64 8
  %517 = bitcast i8* %516 to i8**
  %518 = load i8** %517, align 8
