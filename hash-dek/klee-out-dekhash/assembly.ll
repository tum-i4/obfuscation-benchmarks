...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %DEKHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %449, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %450, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %448, %.lr.ph.i ], [ %441, %strlen.exit ]
  %443 = shl i32 %hash.01.i, 5
  %444 = lshr i32 %hash.01.i, 27
  %445 = or i32 %443, %444
  %446 = load i8* %.03.i, align 1
  %447 = sext i8 %446 to i32
  %448 = xor i32 %447, %445
  %449 = getelementptr inbounds i8* %.03.i, i64 1
  %450 = add i32 %i.02.i, 1
  %exitcond.i = icmp eq i32 %450, %441
  br i1 %exitcond.i, label %DEKHash.exit, label %.lr.ph.i

DEKHash.exit:                                     ; preds = %.lr.ph.i
  %451 = icmp eq i32 %448, -566008905
  br i1 %451, label %452, label %DEKHash.exit.thread

; <label>:452                                     ; preds = %DEKHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %453

DEKHash.exit.thread:                              ; preds = %strlen.exit, %DEKHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %453

; <label>:453                                     ; preds = %DEKHash.exit.thread, %452
  ret i32 0
}
