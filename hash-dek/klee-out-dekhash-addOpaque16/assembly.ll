; ModuleID = './dekhash-addOpaque16.bc'
...
define internal fastcc i32 @DEKHash(i8* %str, i32 %len) #2 {
  ...
  br i1 %4, label %.preheader17, label %5

; <label>:5                                       ; preds = %0
  call void asm sideeffect ".byte 0xa0,0x8d,0xf7,0xa6,0x9,0x59,0xf8", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3157
  br label %.preheader17

.preheader17:                                     ; preds = %0, %5, %.loopexit16
  %6 = phi i8* [ %75, %.loopexit16 ], [ %str, %5 ], [ %str, %0 ]
  %i.0 = phi i32 [ %76, %.loopexit16 ], [ 0, %5 ], [ 0, %0 ]
  %hash.0 = phi i32 [ %74, %.loopexit16 ], [ %len, %5 ], [ %len, %0 ]
...
; <label>:13                                      ; preds = %10
  %14 = call fastcc i32 @__user_main(i32 3, i8** %1)
  br label %15
...
; <label>:15                                      ; preds = %10, %13
  ...
  br i1 %18, label %19, label %.preheader7

; <label>:19                                      ; preds = %15
  %20 = icmp eq %struct._1_main__opaque_Node_1* %16, null
  %21 = icmp ult i32 %i.0, %len
  br i1 %20, label %.preheader, label %.preheader9

.preheader9:                                      ; preds = %19
  br i1 %21, label %.backedge11.us, label %.preheader9..preheader9.split_crit_edge

.backedge11.us:                                   ; preds = %.preheader9, %.backedge11.us
  br label %.backedge11.us

.preheader:                                       ; preds = %19
  br i1 %21, label %.preheader.split.us, label %.preheader..preheader.split_crit_edgethread-pre-split

.preheader.split.us:                              ; preds = %29, %30, %.preheader
...
; <label>:24                                      ; preds = %.preheader.split.us
  %25 = call fastcc i32 @DEKHash(i8* null, i32 %len)
  br label %26

; <label>:26                                      ; preds = %24, %.preheader.split.us
...
; <label>:29                                      ; preds = %26
  call void asm sideeffect ".byte 0x0,0x0,0x0,0x0,0x0", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3158
  br label %.preheader.split.us

; <label>:30                                      ; preds = %26
  call void asm sideeffect ".byte 0xe6,0x15,0xec,0xb6,0x70,0x8e", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3159
  br label %.preheader.split.us

.preheader9..preheader9.split_crit_edge:          ; preds = %.preheader9, %.backedge11
  ...
  br i1 %33, label %.loopexit10, label %.backedge11

.backedge11:                                      ; preds = %.preheader9..preheader9.split_crit_edge
  call void asm sideeffect ".byte 0x0,0x0,0x0,0x0,0x0", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3160
  br label %.preheader9..preheader9.split_crit_edge

.preheader..preheader.split_crit_edgethread-pre-split: ; preds = %.preheader, %35
  %.pr38 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %34 = icmp eq %struct._1_main__opaque_Node_1* %.pr38, null
  br label %.preheader..preheader.split_crit_edge

.preheader..preheader.split_crit_edge:            ; preds = %.preheader..preheader.split_crit_edgethread-pre-split, %.preheader..preheader.split_crit_edge
  br i1 %34, label %35, label %.preheader..preheader.split_crit_edge

; <label>:35                                      ; preds = %.preheader..preheader.split_crit_edge
  %36 = call fastcc i32 @DEKHash(i8* null, i32 %len)
  br label %.preheader..preheader.split_crit_edgethread-pre-split

.preheader7:                                      ; preds = %15
  %37 = icmp ult i32 %i.0, %len
  br label %.backedge8

.backedge8:                                       ; preds = %42, %.preheader7
...
; <label>:40                                      ; preds = %.backedge8
  %41 = call fastcc i32 @DEKHash(i8* null, i32 %len)
  br label %42

; <label>:42                                      ; preds = %.backedge8, %40
  br i1 %37, label %.backedge8, label %.lr.ph

.lr.ph:                                           ; preds = %42, %.lr.ph
  call void asm sideeffect ".byte 0x0,0x0,0x0,0x0,0x0", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3161
  br label %.lr.ph

; <label>:43                                      ; preds = %.preheader17
  %44 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %45 = icmp eq %struct._1_main__opaque_Node_1* %44, null
  %46 = icmp ult i32 %i.0, %len
  br i1 %45, label %.preheader12, label %47

.preheader12:                                     ; preds = %43
  br i1 %46, label %thread-pre-split, label %.preheader12..preheader12.split_crit_edge

.preheader12..preheader12.split_crit_edge:        ; preds = %.preheader12, %.preheader12..preheader12.split_crit_edge
  br label %.preheader12..preheader12.split_crit_edge

; <label>:47                                      ; preds = %43
  br i1 %46, label %thread-pre-split, label %48
...
; <label>:48                                      ; preds = %47
  ...
  %51 = icmp eq %struct._1_main__opaque_Node_1* %49, %50
  br i1 %51, label %77, label %.loopexit10

thread-pre-split:                                 ; preds = %.preheader12, %47
  %.pr = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %.loopexit10

.loopexit10:                                      ; preds = %.preheader9..preheader9.split_crit_edge, %thread-pre-split, %48
  %52 = phi %struct._1_main__opaque_Node_1* [ %.pr, %thread-pre-split ], [ %49, %48 ], [ %31, %.preheader9..preheader9.split_crit_edge ]
  %53 = icmp eq %struct._1_main__opaque_Node_1* %52, null
  br i1 %53, label %.preheader15, label %63

.preheader15:                                     ; preds = %.loopexit10, %60
  %i.1 = phi i32 [ %62, %60 ], [ %i.0, %.loopexit10 ]
  %54 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %55 = icmp eq %struct._1_main__opaque_Node_1* %54, null
  br i1 %55, label %.preheader13..preheader13.split_crit_edge, label %56
...
; <label>:56                                      ; preds = %.preheader15
  ...
  %59 = icmp eq %struct._1_main__opaque_Node_1* %57, %58
  br i1 %59, label %.loopexit16, label %60

.preheader13..preheader13.split_crit_edge:        ; preds = %.preheader15, %.preheader13..preheader13.split_crit_edge
  br label %.preheader13..preheader13.split_crit_edge

; <label>:60                                      ; preds = %56
  %61 = add i32 %i.1, -6
  %62 = call fastcc i32 @DEKHash(i8* null, i32 %61)
  br label %.preheader15

; <label>:63                                      ; preds = %.loopexit10
  ...
  %66 = icmp eq %struct._1_main__opaque_Node_1* %64, %65
  br i1 %66, label %.loopexit16, label %67

; <label>:67                                      ; preds = %63
  %68 = call fastcc i32 @DEKHash(i8* null, i32 %i.0)
  br label %.loopexit16

.loopexit16:                                      ; preds = %56, %63, %67
  %i.2 = phi i32 [ %68, %67 ], [ %i.0, %63 ], [ %i.1, %56 ]
  %69 = shl i32 %hash.0, 5
  %70 = lshr i32 %hash.0, 27
  %71 = or i32 %69, %70
  %72 = load i8* %6, align 1
  %73 = sext i8 %72 to i32
  %74 = xor i32 %73, %71
  %75 = getelementptr inbounds i8* %6, i64 1
...
; <label>:85                                      ; preds = %82
  ...
  %87 = icmp eq %struct._1_main__opaque_Node_1* %86, null
  br i1 %87, label %88, label %90

; <label>:88                                      ; preds = %85
  call void asm sideeffect ".byte 0xf7,0x48,0x1f,0xd3,0x7a,0x29,0x94", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3162
  br label %90

; <label>:89                                      ; preds = %82
  call void asm sideeffect ".byte 0x84,0x21,0x3,0x0,0x0,0x41,0x81,0xe7", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3163
  br label %90

; <label>:90                                      ; preds = %85, %89, %88
  ret i32 %hash.0
}
...
define internal fastcc void @__check_one_fd(i32 %fd, i32 %mode) #0 {
  ...
  %1 = icmp ult i32 %fd, 32, !dbg !3164
  br i1 %1, label %2, label %__get_file.exit.thread.i, !dbg !3164

; <label>:2                                       ; preds = %0
  %3 = sext i32 %fd to i64, !dbg !3168
  %4 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 1, !dbg !3169
  %5 = load i32* %4, align 4, !dbg !3169, !tbaa !3171
  %6 = and i32 %5, 1, !dbg !3169
  %7 = icmp eq i32 %6, 0, !dbg !3169
  br i1 %7, label %__get_file.exit.thread.i, label %__get_file.exit.i, !dbg !3169

__get_file.exit.i:                                ; preds = %2
  %8 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, !dbg !3168
  %9 = icmp eq %struct.exe_file_t* %8, null, !dbg !3172
  br i1 %9, label %__get_file.exit.thread.i, label %10, !dbg !3172

; <label>:10                                      ; preds = %__get_file.exit.i
  %11 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 3, !dbg !3174
  %12 = load %struct.exe_disk_file_t** %11, align 8, !dbg !3174, !tbaa !3092
  %13 = icmp eq %struct.exe_disk_file_t* %12, null, !dbg !3174
  br i1 %13, label %14, label %fcntl.exit.thread7, !dbg !3174

; <label>:14                                      ; preds = %10
  %15 = getelementptr inbounds %struct.exe_file_t* %8, i64 0, i32 0, !dbg !3175
  %16 = load i32* %15, align 8, !dbg !3175, !tbaa !3176
  %17 = call i64 (i64, ...)* @syscall(i64 72, i32 %16, i32 1, i32 0) #8, !dbg !3175
  %18 = trunc i64 %17 to i32, !dbg !3175
  %19 = icmp eq i32 %18, -1, !dbg !3177
  br i1 %19, label %20, label %fcntl.exit.thread7, !dbg !3177

; <label>:20                                      ; preds = %14
  %21 = call i32 @klee_get_errno() #8, !dbg !3179
  %phitmp = icmp eq i32 %21, 9, !dbg !3179
  br label %__get_file.exit.thread.i, !dbg !3179
...
__get_file.exit.thread.i:                         ; preds = %0, %2, %__get_file.exit.i, %20
  ...
  store i32 %storemerge, i32* @errno, align 4, !dbg !3179, !tbaa !3077
...
; <label>:26                                      ; preds = %fcntl.exit.thread7
  ...
  %28 = icmp eq i32 %27, %fd, !dbg !3180
  br i1 %28, label %29, label %108, !dbg !3180

; <label>:29                                      ; preds = %26
  %30 = bitcast %struct.stat64.647* %tmp.i to i8*, !dbg !3183
  br i1 %1, label %31, label %__get_file.exit.thread.i4, !dbg !3184

; <label>:31                                      ; preds = %29
  %32 = sext i32 %fd to i64, !dbg !3187
  %33 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %32, i32 1, !dbg !3188
  %34 = load i32* %33, align 4, !dbg !3188, !tbaa !3171
  %35 = and i32 %34, 1, !dbg !3188
  %36 = icmp eq i32 %35, 0, !dbg !3188
  br i1 %36, label %__get_file.exit.thread.i4, label %__get_file.exit.i3, !dbg !3188

__get_file.exit.i3:                               ; preds = %31
  %37 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %32, !dbg !3187
  %38 = icmp eq %struct.exe_file_t* %37, null, !dbg !3189
  br i1 %38, label %__get_file.exit.thread.i4, label %39, !dbg !3189

__get_file.exit.thread.i4:                        ; preds = %__get_file.exit.i3, %31, %29
  store i32 9, i32* @errno, align 4, !dbg !3191, !tbaa !3077
  br label %__fd_fstat.exit, !dbg !3193

; <label>:39                                      ; preds = %__get_file.exit.i3
  %40 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %32, i32 3, !dbg !3194
  %41 = load %struct.exe_disk_file_t** %40, align 8, !dbg !3194, !tbaa !3092
  %42 = icmp eq %struct.exe_disk_file_t* %41, null, !dbg !3194
  br i1 %42, label %43, label %51, !dbg !3194

; <label>:43                                      ; preds = %39
  %44 = getelementptr inbounds %struct.exe_file_t* %37, i64 0, i32 0, !dbg !3195
  %45 = load i32* %44, align 8, !dbg !3195, !tbaa !3176
  %46 = call i64 (i64, ...)* @syscall(i64 5, i32 %45, %struct.stat64.647* %tmp.i) #8, !dbg !3195
  %47 = trunc i64 %46 to i32, !dbg !3195
  %48 = icmp eq i32 %47, -1, !dbg !3196
  br i1 %48, label %49, label %__fd_fstat.exit, !dbg !3196

; <label>:49                                      ; preds = %43
  %50 = call i32 @klee_get_errno() #8, !dbg !3198
  store i32 %50, i32* @errno, align 4, !dbg !3198, !tbaa !3077
  br label %__fd_fstat.exit, !dbg !3198

; <label>:51                                      ; preds = %39
  %52 = getelementptr inbounds %struct.exe_disk_file_t* %41, i64 0, i32 2, !dbg !3199
  %53 = load %struct.stat64.647** %52, align 8, !dbg !3199, !tbaa !3041
  %54 = bitcast %struct.stat64.647* %53 to i8*, !dbg !3199
...
__fd_fstat.exit:                                  ; preds = %__get_file.exit.thread.i4, %43, %49, %51
  ...
  %56 = bitcast %struct.stat64.647* %tmp.i to <2 x i64>*, !dbg !3201
  %57 = load <2 x i64>* %56, align 16, !dbg !3201, !tbaa !3203
  %58 = bitcast %struct.stat.644* %st to <2 x i64>*, !dbg !3201
  store <2 x i64> %57, <2 x i64>* %58, align 16, !dbg !3201, !tbaa !3203
  %59 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 3, !dbg !3204
  %60 = bitcast i32* %59 to i64*, !dbg !3204
  %61 = load i64* %60, align 8, !dbg !3204
  %62 = trunc i64 %61 to i32, !dbg !3204
  %63 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 3, !dbg !3204
  store i32 %62, i32* %63, align 8, !dbg !3204, !tbaa !3205
  %64 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 2, !dbg !3207
  %65 = load i64* %64, align 16, !dbg !3207, !tbaa !3208
  %66 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 2, !dbg !3207
  store i64 %65, i64* %66, align 16, !dbg !3207, !tbaa !3209
  %67 = lshr i64 %61, 32
  %68 = trunc i64 %67 to i32
  %69 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 4, !dbg !3210
  store i32 %68, i32* %69, align 4, !dbg !3210, !tbaa !3211
  %70 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 5, !dbg !3212
  %71 = load i32* %70, align 16, !dbg !3212, !tbaa !3213
  %72 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 5, !dbg !3212
  store i32 %71, i32* %72, align 16, !dbg !3212, !tbaa !3214
  %73 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 7, !dbg !3215
  %74 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 7, !dbg !3215
  %75 = bitcast i64* %73 to <2 x i64>*, !dbg !3215
  %76 = load <2 x i64>* %75, align 8, !dbg !3215, !tbaa !3203
  %77 = bitcast i64* %74 to <2 x i64>*, !dbg !3215
  store <2 x i64> %76, <2 x i64>* %77, align 8, !dbg !3215, !tbaa !3203
  %78 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 11, i32 0, !dbg !3216
  %79 = load i64* %78, align 8, !dbg !3216, !tbaa !3217
  %80 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 11, !dbg !3216
  store i64 %79, i64* %80, align 8, !dbg !3216, !tbaa !3218
  %81 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 12, i32 0, !dbg !3219
  %82 = load i64* %81, align 8, !dbg !3219, !tbaa !3220
  %83 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 13, !dbg !3219
  store i64 %82, i64* %83, align 8, !dbg !3219, !tbaa !3221
  %84 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 13, i32 0, !dbg !3222
  %85 = load i64* %84, align 8, !dbg !3222, !tbaa !3223
  %86 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 15, !dbg !3222
  store i64 %85, i64* %86, align 8, !dbg !3222, !tbaa !3224
  %87 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 9, !dbg !3225
  %88 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 9, !dbg !3225
  %89 = bitcast i64* %87 to <2 x i64>*, !dbg !3225
  %90 = load <2 x i64>* %89, align 8, !dbg !3225, !tbaa !3203
  %91 = bitcast i64* %88 to <2 x i64>*, !dbg !3225
  store <2 x i64> %90, <2 x i64>* %91, align 8, !dbg !3225, !tbaa !3203
  %92 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 11, i32 1, !dbg !3226
  %93 = load i64* %92, align 8, !dbg !3226, !tbaa !3227
  %94 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 12, !dbg !3226
  store i64 %93, i64* %94, align 16, !dbg !3226, !tbaa !3228
  %95 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 12, i32 1, !dbg !3229
  %96 = load i64* %95, align 8, !dbg !3229, !tbaa !3230
  %97 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 14, !dbg !3229
  store i64 %96, i64* %97, align 16, !dbg !3229, !tbaa !3231
  %98 = getelementptr inbounds %struct.stat64.647* %tmp.i, i64 0, i32 13, i32 1, !dbg !3232
  %99 = load i64* %98, align 8, !dbg !3232, !tbaa !3233
  %100 = getelementptr inbounds %struct.stat.644* %st, i64 0, i32 16, !dbg !3232
  store i64 %99, i64* %100, align 16, !dbg !3232, !tbaa !3234
  %101 = icmp eq i32 %.0.i5, 0, !dbg !3180
  br i1 %101, label %102, label %108, !dbg !3180

; <label>:102                                     ; preds = %__fd_fstat.exit
  %103 = load i32* %63, align 8, !dbg !3180
  %104 = and i32 %103, 61440, !dbg !3180
  %105 = icmp eq i32 %104, 8192, !dbg !3180
  %106 = load i64* %74, align 8, !dbg !3180
  %107 = icmp eq i64 %106, 259, !dbg !3235
  %or.cond = and i1 %105, %107, !dbg !3180
  br i1 %or.cond, label %109, label %108, !dbg !3180

; <label>:108                                     ; preds = %__fd_fstat.exit, %26, %102
  call void @abort() #14, !dbg !3236
...
entry:
  ...
  %2 = bitcast [15 x %struct.Elf64_auxv_t]* %auxvt.i to i8*, !dbg !3239
  %3 = add nsw i32 %0, 1, !dbg !3239
  %4 = sext i32 %3 to i64, !dbg !3239
  %5 = getelementptr inbounds i8** %1, i64 %4, !dbg !3239
  store i8** %5, i8*** @__environ, align 8, !dbg !3239
  %6 = bitcast i8** %5 to i8*, !dbg !3240
  %7 = load i8** %1, align 8, !dbg !3240
  %8 = icmp eq i8* %6, %7, !dbg !3240
  br i1 %8, label %9, label %12, !dbg !3240

; <label>:9                                       ; preds = %entry
  %10 = sext i32 %0 to i64, !dbg !3242
  %11 = getelementptr inbounds i8** %1, i64 %10, !dbg !3242
  store i8** %11, i8*** @__environ, align 8, !dbg !3242
...
; <label>:14                                      ; preds = %14, %12
  ...
  %15 = getelementptr inbounds i8* %p.02.i.i, i64 1, !dbg !3247
  store i8 0, i8* %p.02.i.i, align 1, !dbg !3247
  %16 = add i64 %.01.i.i, -1, !dbg !3249
  %17 = icmp eq i64 %16, 0, !dbg !3245
  br i1 %17, label %memset.exit.i, label %14, !dbg !3245

memset.exit.i:                                    ; preds = %14
  %18 = bitcast i8** %13 to i64*, !dbg !3250
  br label %19, !dbg !3251

; <label>:19                                      ; preds = %19, %memset.exit.i
  %aux_dat.0.i = phi i64* [ %18, %memset.exit.i ], [ %22, %19 ]
  %20 = load i64* %aux_dat.0.i, align 8, !dbg !3251
  %21 = icmp eq i64 %20, 0, !dbg !3251
  %22 = getelementptr inbounds i64* %aux_dat.0.i, i64 1, !dbg !3252
  br i1 %21, label %.preheader.i, label %19, !dbg !3251

.preheader.i:                                     ; preds = %19
  %23 = load i64* %22, align 8, !dbg !3254
  %24 = icmp eq i64 %23, 0, !dbg !3254
  br i1 %24, label %._crit_edge.i, label %.lr.ph.i, !dbg !3254

.lr.ph.i:                                         ; preds = %.preheader.i, %memcpy.exit.i
  %aux_dat.12.i = phi i64* [ %79, %memcpy.exit.i ], [ %22, %.preheader.i ]
  %25 = load i64* %aux_dat.12.i, align 8, !dbg !3255
  %26 = icmp ult i64 %25, 15, !dbg !3255
  br i1 %26, label %.lr.ph.i.i, label %memcpy.exit.i, !dbg !3255

.lr.ph.i.i:                                       ; preds = %.lr.ph.i
  %27 = load i64* %aux_dat.12.i, align 8, !dbg !3258
  %28 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 %27, !dbg !3258
  %29 = bitcast %struct.Elf64_auxv_t* %28 to i8*, !dbg !3258
  %30 = bitcast i64* %aux_dat.12.i to i8*, !dbg !3258
  %31 = getelementptr inbounds i8* %30, i64 1, !dbg !3260
  %32 = load i8* %30, align 1, !dbg !3260
  %33 = getelementptr inbounds i8* %29, i64 1, !dbg !3260
  store i8 %32, i8* %29, align 16, !dbg !3260
  %34 = getelementptr inbounds i8* %30, i64 2, !dbg !3260
  %35 = load i8* %31, align 1, !dbg !3260
  %36 = getelementptr inbounds i8* %29, i64 2, !dbg !3260
  store i8 %35, i8* %33, align 1, !dbg !3260
  %37 = getelementptr inbounds i8* %30, i64 3, !dbg !3260
  %38 = load i8* %34, align 1, !dbg !3260
  %39 = getelementptr inbounds i8* %29, i64 3, !dbg !3260
  store i8 %38, i8* %36, align 2, !dbg !3260
  %40 = getelementptr inbounds i8* %30, i64 4, !dbg !3260
  %41 = load i8* %37, align 1, !dbg !3260
  %42 = getelementptr inbounds i8* %29, i64 4, !dbg !3260
  store i8 %41, i8* %39, align 1, !dbg !3260
  %43 = getelementptr inbounds i8* %30, i64 5, !dbg !3260
  %44 = load i8* %40, align 1, !dbg !3260
  %45 = getelementptr inbounds i8* %29, i64 5, !dbg !3260
  store i8 %44, i8* %42, align 4, !dbg !3260
  %46 = getelementptr inbounds i8* %30, i64 6, !dbg !3260
  %47 = load i8* %43, align 1, !dbg !3260
  %48 = getelementptr inbounds i8* %29, i64 6, !dbg !3260
  store i8 %47, i8* %45, align 1, !dbg !3260
  %49 = getelementptr inbounds i8* %30, i64 7, !dbg !3260
  %50 = load i8* %46, align 1, !dbg !3260
  %51 = getelementptr inbounds i8* %29, i64 7, !dbg !3260
  store i8 %50, i8* %48, align 2, !dbg !3260
  %52 = getelementptr inbounds i64* %aux_dat.12.i, i64 1, !dbg !3260
  %53 = bitcast i64* %52 to i8*, !dbg !3260
  %54 = load i8* %49, align 1, !dbg !3260
  %55 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 %27, i32 1, !dbg !3260
  %56 = bitcast %union.anon.645* %55 to i8*, !dbg !3260
  store i8 %54, i8* %51, align 1, !dbg !3260
  %57 = getelementptr inbounds i8* %53, i64 1, !dbg !3260
  %58 = load i8* %53, align 1, !dbg !3260
  %59 = getelementptr inbounds i8* %56, i64 1, !dbg !3260
  store i8 %58, i8* %56, align 8, !dbg !3260
  %60 = getelementptr inbounds i8* %53, i64 2, !dbg !3260
  %61 = load i8* %57, align 1, !dbg !3260
  %62 = getelementptr inbounds i8* %56, i64 2, !dbg !3260
  store i8 %61, i8* %59, align 1, !dbg !3260
  %63 = getelementptr inbounds i8* %53, i64 3, !dbg !3260
  %64 = load i8* %60, align 1, !dbg !3260
  %65 = getelementptr inbounds i8* %56, i64 3, !dbg !3260
  store i8 %64, i8* %62, align 2, !dbg !3260
  %66 = getelementptr inbounds i8* %53, i64 4, !dbg !3260
  %67 = load i8* %63, align 1, !dbg !3260
  %68 = getelementptr inbounds i8* %56, i64 4, !dbg !3260
  store i8 %67, i8* %65, align 1, !dbg !3260
  %69 = getelementptr inbounds i8* %53, i64 5, !dbg !3260
  %70 = load i8* %66, align 1, !dbg !3260
  %71 = getelementptr inbounds i8* %56, i64 5, !dbg !3260
  store i8 %70, i8* %68, align 4, !dbg !3260
  %72 = getelementptr inbounds i8* %53, i64 6, !dbg !3260
  %73 = load i8* %69, align 1, !dbg !3260
  %74 = getelementptr inbounds i8* %56, i64 6, !dbg !3260
  store i8 %73, i8* %71, align 1, !dbg !3260
  %75 = getelementptr inbounds i8* %53, i64 7, !dbg !3260
  %76 = load i8* %72, align 1, !dbg !3260
  %77 = getelementptr inbounds i8* %56, i64 7, !dbg !3260
  store i8 %76, i8* %74, align 2, !dbg !3260
  %78 = load i8* %75, align 1, !dbg !3260
  store i8 %78, i8* %77, align 1, !dbg !3260
  br label %memcpy.exit.i

memcpy.exit.i:                                    ; preds = %.lr.ph.i.i, %.lr.ph.i
  %79 = getelementptr inbounds i64* %aux_dat.12.i, i64 2, !dbg !3262
  %80 = load i64* %79, align 8, !dbg !3254
  %81 = icmp eq i64 %80, 0, !dbg !3254
  br i1 %81, label %._crit_edge.i, label %.lr.ph.i, !dbg !3254

._crit_edge.i:                                    ; preds = %.preheader.i, %memcpy.exit.i
  %82 = icmp eq i64 1, 0, !dbg !3263
  br i1 %82, label %__uClibc_init.exit.i, label %83, !dbg !3263

; <label>:83                                      ; preds = %._crit_edge.i
  %84 = load i32* @errno, align 4, !dbg !3266
  %85 = bitcast %struct.__kernel_termios* %k_termios.i.i.i.i.i to i8*, !dbg !3268
  %86 = call i32 (i32, i64, ...)* @ioctl(i32 0, i64 undef, %struct.__kernel_termios* %k_termios.i.i.i.i.i) #15, !dbg !3268
  %87 = icmp ne i32 %86, 0, !dbg !3269
  %88 = zext i1 %87 to i16, !dbg !3270
  %89 = shl nuw nsw i16 %88, 8, !dbg !3270
  %90 = load i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 0, i32 0), align 16, !dbg !3270
  %91 = xor i16 %89, %90, !dbg !3270
  store i16 %91, i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 0, i32 0), align 16, !dbg !3270
  %92 = bitcast %struct.__kernel_termios* %k_termios.i.i1.i.i.i to i8*, !dbg !3271
  %93 = call i32 (i32, i64, ...)* @ioctl(i32 1, i64 undef, %struct.__kernel_termios* %k_termios.i.i1.i.i.i) #15, !dbg !3271
  %94 = icmp ne i32 %93, 0, !dbg !3272
  %95 = zext i1 %94 to i16, !dbg !3273
  %96 = shl nuw nsw i16 %95, 8, !dbg !3273
  %97 = load i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 1, i32 0), align 16, !dbg !3273
  %98 = xor i16 %96, %97, !dbg !3273
  store i16 %98, i16* getelementptr inbounds ([3 x %struct.__STDIO_FILE_STRUCT.410]* @_stdio_streams, i64 0, i64 1, i32 0), align 16, !dbg !3273
  store i32 %84, i32* @errno, align 4, !dbg !3274
  br label %__uClibc_init.exit.i, !dbg !3267

__uClibc_init.exit.i:                             ; preds = %83, %._crit_edge.i
  %99 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 11, i32 1, i32 0, !dbg !3275
  %100 = load i64* %99, align 8, !dbg !3275
  %101 = icmp eq i64 %100, -1, !dbg !3275
  br i1 %101, label %102, label %.thread, !dbg !3275

; <label>:102                                     ; preds = %__uClibc_init.exit.i
  %103 = call i32 @getuid() #15, !dbg !3277
  %104 = call i32 @geteuid() #15, !dbg !3279
  %105 = call i32 @getgid() #15, !dbg !3280
  %106 = call i32 @getegid() #15, !dbg !3281
  %107 = icmp eq i32 %103, %104, !dbg !3282
  %108 = icmp eq i32 %105, %106, !dbg !3282
  %or.cond.i.i = and i1 %107, %108, !dbg !3282
  br i1 %or.cond.i.i, label %109, label %121, !dbg !3275

; <label>:109                                     ; preds = %102
  %.pr = load i64* %99, align 8, !dbg !3275
  %110 = icmp eq i64 %.pr, -1, !dbg !3275
  br i1 %110, label %122, label %.thread, !dbg !3275

.thread:                                          ; preds = %__uClibc_init.exit.i, %109
  %111 = load i64* %99, align 8, !dbg !3275
  %112 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 12, i32 1, i32 0, !dbg !3275
  %113 = load i64* %112, align 8, !dbg !3275
  %114 = icmp eq i64 %111, %113, !dbg !3275
  br i1 %114, label %115, label %121, !dbg !3275

; <label>:115                                     ; preds = %.thread
  %116 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 13, i32 1, i32 0, !dbg !3275
  %117 = load i64* %116, align 8, !dbg !3275
  %118 = getelementptr inbounds [15 x %struct.Elf64_auxv_t]* %auxvt.i, i64 0, i64 14, i32 1, i32 0, !dbg !3275
  %119 = load i64* %118, align 8, !dbg !3275
  %120 = icmp eq i64 %117, %119, !dbg !3275
  br i1 %120, label %122, label %121, !dbg !3275

; <label>:121                                     ; preds = %115, %.thread, %102
  call fastcc void @__check_one_fd(i32 0, i32 131072) #15, !dbg !3284
  call fastcc void @__check_one_fd(i32 1, i32 131074) #15, !dbg !3286
  call fastcc void @__check_one_fd(i32 2, i32 131074) #15, !dbg !3287
  br label %122, !dbg !3288

; <label>:122                                     ; preds = %121, %115, %109
  %123 = icmp eq i64 1, 0, !dbg !3289
  br i1 %123, label %125, label %124, !dbg !3289

; <label>:124                                     ; preds = %122
  store i32 0, i32* @errno, align 4, !dbg !3291
  br label %125, !dbg !3291

; <label>:125                                     ; preds = %124, %122
  %126 = call fastcc i32 @__user_main(i32 %0, i8** %1) #15, !dbg !3292
  call void @exit(i32 %126) #14, !dbg !3292
...
define internal i32 @ioctl(i32 %fd, i64 %request, ...) #10 {
  ...
  %1 = icmp ult i32 %fd, 32, !dbg !3293
  br i1 %1, label %2, label %__get_file.exit.thread, !dbg !3293

; <label>:2                                       ; preds = %0
  %3 = sext i32 %fd to i64, !dbg !3295
  %4 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 1, !dbg !3296
  %5 = load i32* %4, align 4, !dbg !3296, !tbaa !3171
  %6 = and i32 %5, 1, !dbg !3296
  %7 = icmp eq i32 %6, 0, !dbg !3296
  br i1 %7, label %__get_file.exit.thread, label %__get_file.exit, !dbg !3296

__get_file.exit:                                  ; preds = %2
  %8 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, !dbg !3295
  %9 = icmp eq %struct.exe_file_t* %8, null, !dbg !3297
  br i1 %9, label %__get_file.exit.thread, label %10, !dbg !3297

__get_file.exit.thread:                           ; preds = %__get_file.exit, %2, %0
  store i32 9, i32* @errno, align 4, !dbg !3299, !tbaa !3077
  br label %75, !dbg !3301

; <label>:10                                      ; preds = %__get_file.exit
  %11 = bitcast [1 x %struct.__va_list_tag.665]* %ap to i8*, !dbg !3302
  call void @llvm.va_start(i8* %11), !dbg !3302
  %12 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 0, !dbg !3303
  %13 = load i32* %12, align 16, !dbg !3303
  %14 = icmp ult i32 %13, 41, !dbg !3303
  br i1 %14, label %15, label %21, !dbg !3303

; <label>:15                                      ; preds = %10
  %16 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 3, !dbg !3303
  %17 = load i8** %16, align 16, !dbg !3303
  %18 = sext i32 %13 to i64, !dbg !3303
  %19 = getelementptr i8* %17, i64 %18, !dbg !3303
  %20 = add i32 %13, 8, !dbg !3303
  store i32 %20, i32* %12, align 16, !dbg !3303
  br label %25, !dbg !3303

; <label>:21                                      ; preds = %10
  %22 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 2, !dbg !3303
  %23 = load i8** %22, align 8, !dbg !3303
  %24 = getelementptr i8* %23, i64 8, !dbg !3303
  store i8* %24, i8** %22, align 8, !dbg !3303
  br label %25, !dbg !3303

; <label>:25                                      ; preds = %21, %15
  %.in = phi i8* [ %19, %15 ], [ %23, %21 ]
  %26 = bitcast i8* %.in to i8**, !dbg !3303
  %27 = load i8** %26, align 8, !dbg !3303
  call void @llvm.va_end(i8* %11), !dbg !3304
  %28 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %3, i32 3, !dbg !3305
  %29 = load %struct.exe_disk_file_t** %28, align 8, !dbg !3305, !tbaa !3092
  %30 = icmp eq %struct.exe_disk_file_t* %29, null, !dbg !3305
  br i1 %30, label %67, label %31, !dbg !3305

; <label>:31                                      ; preds = %25
  %32 = getelementptr inbounds %struct.exe_disk_file_t* %29, i64 0, i32 2, !dbg !3306
  %33 = load %struct.stat64.647** %32, align 8, !dbg !3306, !tbaa !3041
  call void @klee_warning_once(i8* getelementptr inbounds ([41 x i8]* @.str13, i64 0, i64 0)) #8, !dbg !3307
  %34 = getelementptr inbounds %struct.stat64.647* %33, i64 0, i32 3, !dbg !3308
  %35 = load i32* %34, align 4, !dbg !3308, !tbaa !3205
  %36 = and i32 %35, 61440, !dbg !3308
  %37 = icmp eq i32 %36, 8192, !dbg !3308
  br i1 %37, label %38, label %66, !dbg !3308

; <label>:38                                      ; preds = %31
  %39 = bitcast i8* %27 to i32*, !dbg !3310
  store i32 27906, i32* %39, align 4, !dbg !3310, !tbaa !3312
  %40 = getelementptr inbounds i8* %27, i64 4, !dbg !3314
  %41 = bitcast i8* %40 to i32*, !dbg !3314
  store i32 5, i32* %41, align 4, !dbg !3314, !tbaa !3315
  %42 = getelementptr inbounds i8* %27, i64 8, !dbg !3316
  %43 = bitcast i8* %42 to i32*, !dbg !3316
  store i32 1215, i32* %43, align 4, !dbg !3316, !tbaa !3317
  %44 = getelementptr inbounds i8* %27, i64 12, !dbg !3318
  %45 = bitcast i8* %44 to i32*, !dbg !3318
  store i32 35287, i32* %45, align 4, !dbg !3318, !tbaa !3319
  %46 = getelementptr inbounds i8* %27, i64 16, !dbg !3320
  store i8 0, i8* %46, align 1, !dbg !3320, !tbaa !3321
  %47 = getelementptr inbounds i8* %27, i64 17, !dbg !3322
  store i8 3, i8* %47, align 1, !dbg !3322, !tbaa !2861
  %48 = getelementptr inbounds i8* %27, i64 18, !dbg !3323
  store i8 28, i8* %48, align 1, !dbg !3323, !tbaa !2861
  %49 = getelementptr inbounds i8* %27, i64 19, !dbg !3324
  store i8 127, i8* %49, align 1, !dbg !3324, !tbaa !2861
  %50 = getelementptr inbounds i8* %27, i64 20, !dbg !3325
  store i8 21, i8* %50, align 1, !dbg !3325, !tbaa !2861
  %51 = getelementptr inbounds i8* %27, i64 21, !dbg !3326
  store i8 4, i8* %51, align 1, !dbg !3326, !tbaa !2861
  %52 = getelementptr inbounds i8* %27, i64 22, !dbg !3327
  store i8 0, i8* %52, align 1, !dbg !3327, !tbaa !2861
  %53 = getelementptr inbounds i8* %27, i64 23, !dbg !3328
  store i8 1, i8* %53, align 1, !dbg !3328, !tbaa !2861
  %54 = getelementptr inbounds i8* %27, i64 24, !dbg !3329
  store i8 -1, i8* %54, align 1, !dbg !3329, !tbaa !2861
  %55 = getelementptr inbounds i8* %27, i64 25, !dbg !3330
  store i8 17, i8* %55, align 1, !dbg !3330, !tbaa !2861
  %56 = getelementptr inbounds i8* %27, i64 26, !dbg !3331
  store i8 19, i8* %56, align 1, !dbg !3331, !tbaa !2861
  %57 = getelementptr inbounds i8* %27, i64 27, !dbg !3332
  store i8 26, i8* %57, align 1, !dbg !3332, !tbaa !2861
  %58 = getelementptr inbounds i8* %27, i64 28, !dbg !3333
  store i8 -1, i8* %58, align 1, !dbg !3333, !tbaa !2861
  %59 = getelementptr inbounds i8* %27, i64 29, !dbg !3334
  store i8 18, i8* %59, align 1, !dbg !3334, !tbaa !2861
  %60 = getelementptr inbounds i8* %27, i64 30, !dbg !3335
  store i8 15, i8* %60, align 1, !dbg !3335, !tbaa !2861
  %61 = getelementptr inbounds i8* %27, i64 31, !dbg !3336
  store i8 23, i8* %61, align 1, !dbg !3336, !tbaa !2861
  %62 = getelementptr inbounds i8* %27, i64 32, !dbg !3337
  store i8 22, i8* %62, align 1, !dbg !3337, !tbaa !2861
  %63 = getelementptr inbounds i8* %27, i64 33, !dbg !3338
  store i8 -1, i8* %63, align 1, !dbg !3338, !tbaa !2861
  %64 = getelementptr inbounds i8* %27, i64 34, !dbg !3339
  store i8 0, i8* %64, align 1, !dbg !3339, !tbaa !2861
  %65 = getelementptr inbounds i8* %27, i64 35, !dbg !3340
  store i8 0, i8* %65, align 1, !dbg !3340, !tbaa !2861
  br label %75, !dbg !3341

; <label>:66                                      ; preds = %31
  store i32 25, i32* @errno, align 4, !dbg !3342, !tbaa !3077
  br label %75, !dbg !3344

; <label>:67                                      ; preds = %25
  %68 = getelementptr inbounds %struct.exe_file_t* %8, i64 0, i32 0, !dbg !3345
  %69 = load i32* %68, align 8, !dbg !3345, !tbaa !3176
  %70 = call i64 (i64, ...)* @syscall(i64 16, i32 %69, i64 21505, i8* %27) #8, !dbg !3345
  %71 = trunc i64 %70 to i32, !dbg !3345
  %72 = icmp eq i32 %71, -1, !dbg !3346
  br i1 %72, label %73, label %75, !dbg !3346

; <label>:73                                      ; preds = %67
  %74 = call i32 @klee_get_errno() #8, !dbg !3348
  store i32 %74, i32* @errno, align 4, !dbg !3348, !tbaa !3077
...
define internal i32 @open(i32 %flags, ...) #10 {
  %ap = alloca [1 x %struct.__va_list_tag.665], align 16
  %1 = and i32 %flags, 64, !dbg !3350
  %2 = icmp eq i32 %1, 0, !dbg !3350
  br i1 %2, label %21, label %3, !dbg !3350

; <label>:3                                       ; preds = %0
  %4 = bitcast [1 x %struct.__va_list_tag.665]* %ap to i8*, !dbg !3351
  call void @llvm.va_start(i8* %4), !dbg !3351
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 0, !dbg !3352
  %6 = load i32* %5, align 16, !dbg !3352
  %7 = icmp ult i32 %6, 41, !dbg !3352
  br i1 %7, label %8, label %14, !dbg !3352

; <label>:8                                       ; preds = %3
  %9 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 3, !dbg !3352
  %10 = load i8** %9, align 16, !dbg !3352
  %11 = sext i32 %6 to i64, !dbg !3352
  %12 = getelementptr i8* %10, i64 %11, !dbg !3352
  %13 = add i32 %6, 8, !dbg !3352
  store i32 %13, i32* %5, align 16, !dbg !3352
  br label %18, !dbg !3352

; <label>:14                                      ; preds = %3
  %15 = getelementptr inbounds [1 x %struct.__va_list_tag.665]* %ap, i64 0, i64 0, i32 2, !dbg !3352
  %16 = load i8** %15, align 8, !dbg !3352
  %17 = getelementptr i8* %16, i64 8, !dbg !3352
  store i8* %17, i8** %15, align 8, !dbg !3352
  br label %18, !dbg !3352

; <label>:18                                      ; preds = %14, %8
  %.in = phi i8* [ %12, %8 ], [ %16, %14 ]
  %19 = bitcast i8* %.in to i32*, !dbg !3352
  %20 = load i32* %19, align 4, !dbg !3352
  call void @llvm.va_end(i8* %4), !dbg !3353
  br label %21, !dbg !3354

; <label>:21                                      ; preds = %18, %0
  %mode.0 = phi i32 [ %20, %18 ], [ 0, %0 ]
  br label %25, !dbg !3355

; <label>:22                                      ; preds = %25
  %23 = trunc i64 %indvars.iv.next.i to i32, !dbg !3355
  %24 = icmp slt i32 %23, 32, !dbg !3355
  br i1 %24, label %25, label %31, !dbg !3355

; <label>:25                                      ; preds = %22, %21
  %indvars.iv.i = phi i64 [ 0, %21 ], [ %indvars.iv.next.i, %22 ]
  %fd.04.i = phi i32 [ 0, %21 ], [ %30, %22 ]
  %26 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %indvars.iv.i, i32 1, !dbg !3358
  %27 = load i32* %26, align 4, !dbg !3358, !tbaa !3171
  %28 = and i32 %27, 1, !dbg !3358
  %29 = icmp eq i32 %28, 0, !dbg !3358
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !3355
  %30 = add nsw i32 %fd.04.i, 1, !dbg !3355
  br i1 %29, label %31, label %22, !dbg !3358

; <label>:31                                      ; preds = %25, %22
  %fd.0.lcssa.i = phi i32 [ %fd.04.i, %25 ], [ %30, %22 ]
  %32 = icmp eq i32 %fd.0.lcssa.i, 32, !dbg !3360
  br i1 %32, label %33, label %34, !dbg !3360

; <label>:33                                      ; preds = %31
  store i32 24, i32* @errno, align 4, !dbg !3362, !tbaa !3077
  br label %__fd_open.exit, !dbg !3364

; <label>:34                                      ; preds = %31
  %35 = sext i32 %fd.0.lcssa.i to i64, !dbg !3365
  %36 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %35, !dbg !3365
  %37 = bitcast %struct.exe_file_t* %36 to i8*, !dbg !3366
  %38 = call i8* @memset(i8* %37, i32 0, i64 24)
  %39 = call i64 @klee_get_valuel(i64 ptrtoint ([10 x i8]* @.str130 to i64)) #8, !dbg !3367
  %40 = inttoptr i64 %39 to i8*, !dbg !3367
  %41 = icmp eq i8* %40, getelementptr inbounds ([10 x i8]* @.str130, i64 0, i64 0), !dbg !3370
  %42 = zext i1 %41 to i64, !dbg !3370
  call void @klee_assume(i64 %42) #8, !dbg !3370
  br label %43, !dbg !3371

; <label>:43                                      ; preds = %60, %34
  %i.0.i.i = phi i32 [ 0, %34 ], [ %61, %60 ]
  %sc.0.i.i = phi i8* [ %40, %34 ], [ %sc.1.i.i, %60 ]
  %44 = load i8* %sc.0.i.i, align 1, !dbg !3372, !tbaa !2861
  %45 = add i32 %i.0.i.i, -1, !dbg !3373
  %46 = and i32 %45, %i.0.i.i, !dbg !3373
  %47 = icmp eq i32 %46, 0, !dbg !3373
  br i1 %47, label %48, label %52, !dbg !3373
...
; <label>:49                                      ; preds = %48
  store i8 0, i8* %sc.0.i.i, align 1, !dbg !3375, !tbaa !2861
  br label %__concretize_string.exit.i, !dbg !3376

; <label>:50                                      ; preds = %48
  %51 = getelementptr inbounds i8* %sc.0.i.i, i64 1, !dbg !3377
  store i8 47, i8* %sc.0.i.i, align 1, !dbg !3377, !tbaa !2861
  br label %60, !dbg !3378

; <label>:52                                      ; preds = %43
  %53 = sext i8 %44 to i64, !dbg !3379
  %54 = call i64 @klee_get_valuel(i64 %53) #8, !dbg !3379
  %55 = trunc i64 %54 to i8, !dbg !3379
  %56 = icmp eq i8 %55, %44, !dbg !3380
  %57 = zext i1 %56 to i64, !dbg !3380
  call void @klee_assume(i64 %57) #8, !dbg !3380
  %58 = getelementptr inbounds i8* %sc.0.i.i, i64 1, !dbg !3381
  store i8 %55, i8* %sc.0.i.i, align 1, !dbg !3381, !tbaa !2861
  %59 = icmp eq i8 %55, 0, !dbg !3382
  br i1 %59, label %__concretize_string.exit.i, label %60, !dbg !3382

; <label>:60                                      ; preds = %52, %50, %48
  %sc.1.i.i = phi i8* [ %58, %52 ], [ %51, %50 ], [ %sc.0.i.i, %48 ]
  %61 = add i32 %i.0.i.i, 1, !dbg !3371
  br label %43, !dbg !3371

__concretize_string.exit.i:                       ; preds = %52, %49
  %62 = call i64 (i64, ...)* @syscall(i64 2, i8* getelementptr inbounds ([10 x i8]* @.str130, i64 0, i64 0), i32 %flags, i32 %mode.0) #8, !dbg !3369
  %63 = trunc i64 %62 to i32, !dbg !3369
  %64 = icmp eq i32 %63, -1, !dbg !3383
  br i1 %64, label %65, label %67, !dbg !3383

; <label>:65                                      ; preds = %__concretize_string.exit.i
  %66 = call i32 @klee_get_errno() #8, !dbg !3385
  store i32 %66, i32* @errno, align 4, !dbg !3385, !tbaa !3077
  br label %__fd_open.exit, !dbg !3387

; <label>:67                                      ; preds = %__concretize_string.exit.i
  %68 = getelementptr inbounds %struct.exe_file_t* %36, i64 0, i32 0, !dbg !3388
  store i32 %63, i32* %68, align 8, !dbg !3388, !tbaa !3176
  %.pre.i = and i32 %flags, 3, !dbg !3389
  %69 = getelementptr inbounds %struct.exe_sym_env_t* bitcast ({ [32 x %struct.exe_file_t], i32, i32, i32, [4 x i8] }* @__exe_env to %struct.exe_sym_env_t*), i64 0, i32 0, i64 %35, i32 1, !dbg !3391
  store i32 1, i32* %69, align 4, !dbg !3391, !tbaa !3171
...
; <label>:70                                      ; preds = %67
  store i32 5, i32* %69, align 4, !dbg !3392, !tbaa !3171
  br label %__fd_open.exit, !dbg !3394

; <label>:71                                      ; preds = %67
  store i32 9, i32* %69, align 4, !dbg !3395, !tbaa !3171
  br label %__fd_open.exit, !dbg !3398

; <label>:72                                      ; preds = %67
  store i32 13, i32* %69, align 4, !dbg !3399, !tbaa !3171
...
define internal fastcc void @__create_new_dfile(%struct.exe_disk_file_t* nocapture %dfile, i32 %size, i8* %name, %struct.stat64.647* nocapture readonly %defaults) #10 {
  ...
  %1 = call noalias i8* @malloc(i64 144) #8, !dbg !3401
  %2 = bitcast i8* %1 to %struct.stat64.647*, !dbg !3401
  %3 = getelementptr inbounds [64 x i8]* %sname, i64 0, i64 0, !dbg !3402
  %4 = load i8* %name, align 1, !dbg !3403, !tbaa !2861
  %5 = icmp eq i8 %4, 0, !dbg !3403
  %6 = ptrtoint i8* %name to i64, !dbg !3405
  br i1 %5, label %._crit_edge, label %.lr.ph, !dbg !3403

.lr.ph:                                           ; preds = %0, %.lr.ph
  %7 = phi i8* [ %14, %.lr.ph ], [ %3, %0 ]
  %8 = phi i8 [ %10, %.lr.ph ], [ %4, %0 ]
  %sp.01 = phi i8* [ %9, %.lr.ph ], [ %name, %0 ]
  store i8 %8, i8* %7, align 1, !dbg !3406, !tbaa !2861
  %9 = getelementptr inbounds i8* %sp.01, i64 1, !dbg !3403
  %10 = load i8* %9, align 1, !dbg !3403, !tbaa !2861
  %11 = icmp eq i8 %10, 0, !dbg !3403
  %12 = ptrtoint i8* %9 to i64, !dbg !3405
  %13 = sub i64 %12, %6, !dbg !3405
  %14 = getelementptr inbounds [64 x i8]* %sname, i64 0, i64 %13, !dbg !3405
  br i1 %11, label %._crit_edge, label %.lr.ph, !dbg !3403

._crit_edge:                                      ; preds = %.lr.ph, %0
  %.lcssa = phi i8* [ %3, %0 ], [ %14, %.lr.ph ]
  %15 = call i8* @memcpy(i8* %.lcssa, i8* getelementptr inbounds ([6 x i8]* @.str918, i64 0, i64 0), i64 6)
  %16 = icmp eq i32 %size, 0, !dbg !3407
  br i1 %16, label %17, label %18, !dbg !3407
...
; <label>:18                                      ; preds = %._crit_edge
  %19 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 0, !dbg !3408
  store i32 %size, i32* %19, align 4, !dbg !3408, !tbaa !3409
  %20 = zext i32 %size to i64, !dbg !3410
  %21 = call noalias i8* @malloc(i64 %20) #8, !dbg !3410
  %22 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 1, !dbg !3410
  store i8* %21, i8** %22, align 8, !dbg !3410, !tbaa !3411
  call void @klee_make_symbolic(i8* %21, i64 %20, i8* %name) #8, !dbg !3412
  call void @klee_make_symbolic(i8* %1, i64 144, i8* %3) #8, !dbg !3413
  %23 = getelementptr inbounds i8* %1, i64 8, !dbg !3414
  %24 = bitcast i8* %23 to i64*, !dbg !3414
  %25 = load i64* %24, align 8, !dbg !3414, !tbaa !3043
  %26 = call i32 @klee_is_symbolic(i64 %25) #8, !dbg !3414
  %27 = icmp eq i32 %26, 0, !dbg !3414
  %28 = load i64* %24, align 8, !dbg !3414, !tbaa !3043
  %29 = and i64 %28, 2147483647, !dbg !3414
  %30 = icmp eq i64 %29, 0, !dbg !3414
  %or.cond = and i1 %27, %30, !dbg !3414
  br i1 %or.cond, label %31, label %._crit_edge3, !dbg !3414

; <label>:31                                      ; preds = %18
  %32 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 1, !dbg !3416
  %33 = load i64* %32, align 8, !dbg !3416, !tbaa !3043
  store i64 %33, i64* %24, align 8, !dbg !3416, !tbaa !3043
  br label %._crit_edge3, !dbg !3416

._crit_edge3:                                     ; preds = %31, %18
  %34 = phi i64 [ %33, %31 ], [ %28, %18 ]
  %35 = and i64 %34, 2147483647, !dbg !3417
  %36 = icmp ne i64 %35, 0, !dbg !3417
  %37 = zext i1 %36 to i64, !dbg !3417
  call void @klee_assume(i64 %37) #8, !dbg !3417
  %38 = getelementptr inbounds i8* %1, i64 56, !dbg !3418
  %39 = bitcast i8* %38 to i64*, !dbg !3418
  %40 = load i64* %39, align 8, !dbg !3418, !tbaa !3419
  %41 = icmp ult i64 %40, 65536, !dbg !3418
  %42 = zext i1 %41 to i64, !dbg !3418
  call void @klee_assume(i64 %42) #8, !dbg !3418
  %43 = getelementptr inbounds i8* %1, i64 24, !dbg !3420
  %44 = bitcast i8* %43 to i32*, !dbg !3420
  %45 = load i32* %44, align 4, !dbg !3420, !tbaa !3421
  %46 = and i32 %45, -61952, !dbg !3420
  %47 = icmp eq i32 %46, 0, !dbg !3420
  %48 = zext i1 %47 to i64, !dbg !3420
  call void @klee_posix_prefer_cex(i8* %1, i64 %48) #8, !dbg !3420
  %49 = bitcast i8* %1 to i64*, !dbg !3422
  %50 = load i64* %49, align 8, !dbg !3422, !tbaa !3423
  %51 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 0, !dbg !3422
  %52 = load i64* %51, align 8, !dbg !3422, !tbaa !3423
  %53 = icmp eq i64 %50, %52, !dbg !3422
  %54 = zext i1 %53 to i64, !dbg !3422
  call void @klee_posix_prefer_cex(i8* %1, i64 %54) #8, !dbg !3422
  %55 = getelementptr inbounds i8* %1, i64 40, !dbg !3424
  %56 = bitcast i8* %55 to i64*, !dbg !3424
  %57 = load i64* %56, align 8, !dbg !3424, !tbaa !3425
  %58 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 7, !dbg !3424
  %59 = load i64* %58, align 8, !dbg !3424, !tbaa !3425
  %60 = icmp eq i64 %57, %59, !dbg !3424
  %61 = zext i1 %60 to i64, !dbg !3424
  call void @klee_posix_prefer_cex(i8* %1, i64 %61) #8, !dbg !3424
  %62 = load i32* %44, align 4, !dbg !3426, !tbaa !3421
  %63 = and i32 %62, 448, !dbg !3426
  %64 = icmp eq i32 %63, 384, !dbg !3426
  %65 = zext i1 %64 to i64, !dbg !3426
  call void @klee_posix_prefer_cex(i8* %1, i64 %65) #8, !dbg !3426
  %66 = load i32* %44, align 4, !dbg !3427, !tbaa !3421
  %67 = and i32 %66, 56, !dbg !3427
  %68 = icmp eq i32 %67, 16, !dbg !3427
  %69 = zext i1 %68 to i64, !dbg !3427
  call void @klee_posix_prefer_cex(i8* %1, i64 %69) #8, !dbg !3427
  %70 = load i32* %44, align 4, !dbg !3428, !tbaa !3421
  %71 = and i32 %70, 7, !dbg !3428
  %72 = icmp eq i32 %71, 2, !dbg !3428
  %73 = zext i1 %72 to i64, !dbg !3428
  call void @klee_posix_prefer_cex(i8* %1, i64 %73) #8, !dbg !3428
  %74 = load i32* %44, align 4, !dbg !3429, !tbaa !3421
  %75 = and i32 %74, 61440, !dbg !3429
  %76 = icmp eq i32 %75, 32768, !dbg !3429
  %77 = zext i1 %76 to i64, !dbg !3429
  call void @klee_posix_prefer_cex(i8* %1, i64 %77) #8, !dbg !3429
  %78 = getelementptr inbounds i8* %1, i64 16, !dbg !3430
  %79 = bitcast i8* %78 to i64*, !dbg !3430
  %80 = load i64* %79, align 8, !dbg !3430, !tbaa !3208
  %81 = icmp eq i64 %80, 1, !dbg !3430
  %82 = zext i1 %81 to i64, !dbg !3430
  call void @klee_posix_prefer_cex(i8* %1, i64 %82) #8, !dbg !3430
  %83 = getelementptr inbounds i8* %1, i64 28, !dbg !3431
  %84 = bitcast i8* %83 to i32*, !dbg !3431
  %85 = load i32* %84, align 4, !dbg !3431, !tbaa !3432
  %86 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 4, !dbg !3431
  %87 = load i32* %86, align 4, !dbg !3431, !tbaa !3432
  %88 = icmp eq i32 %85, %87, !dbg !3431
  %89 = zext i1 %88 to i64, !dbg !3431
  call void @klee_posix_prefer_cex(i8* %1, i64 %89) #8, !dbg !3431
  %90 = getelementptr inbounds i8* %1, i64 32, !dbg !3433
  %91 = bitcast i8* %90 to i32*, !dbg !3433
  %92 = load i32* %91, align 4, !dbg !3433, !tbaa !3213
  %93 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 5, !dbg !3433
  %94 = load i32* %93, align 4, !dbg !3433, !tbaa !3213
  %95 = icmp eq i32 %92, %94, !dbg !3433
  %96 = zext i1 %95 to i64, !dbg !3433
  call void @klee_posix_prefer_cex(i8* %1, i64 %96) #8, !dbg !3433
  %97 = load i64* %39, align 8, !dbg !3434, !tbaa !3419
  %98 = icmp eq i64 %97, 4096, !dbg !3434
  %99 = zext i1 %98 to i64, !dbg !3434
  call void @klee_posix_prefer_cex(i8* %1, i64 %99) #8, !dbg !3434
  %100 = getelementptr inbounds i8* %1, i64 72, !dbg !3435
  %101 = bitcast i8* %100 to i64*, !dbg !3435
  %102 = load i64* %101, align 8, !dbg !3435, !tbaa !3217
  %103 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 11, i32 0, !dbg !3435
  %104 = load i64* %103, align 8, !dbg !3435, !tbaa !3217
  %105 = icmp eq i64 %102, %104, !dbg !3435
  %106 = zext i1 %105 to i64, !dbg !3435
  call void @klee_posix_prefer_cex(i8* %1, i64 %106) #8, !dbg !3435
  %107 = getelementptr inbounds i8* %1, i64 88, !dbg !3436
  %108 = bitcast i8* %107 to i64*, !dbg !3436
  %109 = load i64* %108, align 8, !dbg !3436, !tbaa !3220
  %110 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 12, i32 0, !dbg !3436
  %111 = load i64* %110, align 8, !dbg !3436, !tbaa !3220
  %112 = icmp eq i64 %109, %111, !dbg !3436
  %113 = zext i1 %112 to i64, !dbg !3436
  call void @klee_posix_prefer_cex(i8* %1, i64 %113) #8, !dbg !3436
  %114 = getelementptr inbounds i8* %1, i64 104, !dbg !3437
  %115 = bitcast i8* %114 to i64*, !dbg !3437
  %116 = load i64* %115, align 8, !dbg !3437, !tbaa !3223
  %117 = getelementptr inbounds %struct.stat64.647* %defaults, i64 0, i32 13, i32 0, !dbg !3437
  %118 = load i64* %117, align 8, !dbg !3437, !tbaa !3223
  %119 = icmp eq i64 %116, %118, !dbg !3437
  %120 = zext i1 %119 to i64, !dbg !3437
  call void @klee_posix_prefer_cex(i8* %1, i64 %120) #8, !dbg !3437
  %121 = load i32* %19, align 4, !dbg !3438, !tbaa !3409
  %122 = zext i32 %121 to i64, !dbg !3438
  %123 = getelementptr inbounds i8* %1, i64 48, !dbg !3438
  %124 = bitcast i8* %123 to i64*, !dbg !3438
  store i64 %122, i64* %124, align 8, !dbg !3438, !tbaa !3439
  %125 = getelementptr inbounds i8* %1, i64 64, !dbg !3440
  %126 = bitcast i8* %125 to i64*, !dbg !3440
  store i64 8, i64* %126, align 8, !dbg !3440, !tbaa !3441
  %127 = getelementptr inbounds %struct.exe_disk_file_t* %dfile, i64 0, i32 2, !dbg !3442
  store %struct.stat64.647* %2, %struct.stat64.647** %127, align 8, !dbg !3442, !tbaa !3041
  ret void, !dbg !3443
}

; Function Attrs: noreturn nounwind ssp uwtable
define internal fastcc void @__emit_error(i8* %msg) #12 {
  tail call void @klee_report_error(i8* getelementptr inbounds ([16 x i8]* @.str2254, i64 0, i64 0), i32 24, i8* %msg, i8* getelementptr inbounds ([9 x i8]* @.str2355, i64 0, i64 0)) #5, !dbg !3444
  unreachable, !dbg !3444
}

; Function Attrs: nounwind ssp uwtable
define internal fastcc i8* @__get_sym_str(i32 %numChars, i8* %name) #10 {
  %1 = add nsw i32 %numChars, 1, !dbg !3445
  %2 = sext i32 %1 to i64, !dbg !3445
  %3 = tail call noalias i8* @malloc(i64 %2) #8, !dbg !3445
  tail call void @klee_mark_global(i8* %3) #8, !dbg !3446
  tail call void @klee_make_symbolic(i8* %3, i64 %2, i8* %name) #8, !dbg !3447
  %4 = icmp sgt i32 %numChars, 0, !dbg !3448
  br i1 %4, label %.lr.ph, label %._crit_edge, !dbg !3448

.lr.ph:                                           ; preds = %0, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ 0, %0 ]
  %5 = getelementptr inbounds i8* %3, i64 %indvars.iv, !dbg !3450
  %6 = load i8* %5, align 1, !dbg !3450, !tbaa !2861
  %7 = icmp sgt i8 %6, 31, !dbg !3451
  %8 = icmp ne i8 %6, 127, !dbg !3451
  %..i = and i1 %7, %8, !dbg !3451
  %9 = zext i1 %..i to i64, !dbg !3450
  tail call void @klee_posix_prefer_cex(i8* %3, i64 %9) #8, !dbg !3450
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !3448
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !3448
  %exitcond = icmp eq i32 %lftr.wideiv, %numChars, !dbg !3448
  br i1 %exitcond, label %._crit_edge, label %.lr.ph, !dbg !3448

._crit_edge:                                      ; preds = %.lr.ph, %0
  %10 = sext i32 %numChars to i64, !dbg !3452
  %11 = getelementptr inbounds i8* %3, i64 %10, !dbg !3452
  store i8 0, i8* %11, align 1, !dbg !3452, !tbaa !2861
  ret i8* %3, !dbg !3453
}
...
define void @klee_div_zero_check(i64 %z) #10 {
  %1 = icmp eq i64 %z, 0, !dbg !3454
  br i1 %1, label %2, label %3, !dbg !3454

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #14, !dbg !3456
...
define i32 @klee_int(i8* %name) #10 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !3458
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #15, !dbg !3458
  %2 = load i32* %x, align 4, !dbg !3459, !tbaa !3077
  ret i32 %2, !dbg !3459
}
...
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #10 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !3460
  br i1 %1, label %3, label %2, !dbg !3460

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #14, !dbg !3462
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #10 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !3465
  br i1 %1, label %3, label %2, !dbg !3465

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #14, !dbg !3467
  unreachable, !dbg !3467

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !3468
  %5 = icmp eq i32 %4, %end, !dbg !3468
  br i1 %5, label %21, label %6, !dbg !3468

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !3470
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #15, !dbg !3470
  %8 = icmp eq i32 %start, 0, !dbg !3472
  %9 = load i32* %x, align 4, !dbg !3474, !tbaa !3077
  br i1 %8, label %10, label %13, !dbg !3472

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !3474
  %12 = zext i1 %11 to i64, !dbg !3474
  call void @klee_assume(i64 %12) #15, !dbg !3474
  br label %19, !dbg !3476

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !3477
  %15 = zext i1 %14 to i64, !dbg !3477
  call void @klee_assume(i64 %15) #15, !dbg !3477
  %16 = load i32* %x, align 4, !dbg !3479, !tbaa !3077
  %17 = icmp slt i32 %16, %end, !dbg !3479
  %18 = zext i1 %17 to i64, !dbg !3479
  call void @klee_assume(i64 %18) #15, !dbg !3479
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !3480, !tbaa !3077
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #10 {
  %1 = icmp eq i64 %len, 0, !dbg !3482
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !3482
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3483
  %wide.load = load <16 x i8>* %3, align 1, !dbg !3483
  %next.gep.sum279 = or i64 %index, 16, !dbg !3483
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !3483
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !3483
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !3483
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !3483
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !3483
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !3483
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3483
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !3483
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !3484
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !3482
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !3483
  %12 = load i8* %src.03, align 1, !dbg !3483, !tbaa !2861
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !3483
  store i8 %12, i8* %dest.02, align 1, !dbg !3483, !tbaa !2861
  %14 = icmp eq i64 %10, 0, !dbg !3482
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !3482, !llvm.loop !3487

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !3488
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #10 {
  %1 = icmp eq i8* %src, %dst, !dbg !3489
  br i1 %1, label %.loopexit, label %2, !dbg !3489

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !3491
  br i1 %3, label %.preheader, label %18, !dbg !3491

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !3493
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !3493
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3493
  %wide.load = load <16 x i8>* %6, align 1, !dbg !3493
  %next.gep.sum586 = or i64 %index, 16, !dbg !3493
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !3493
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3493
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !3493
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !3493
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !3493
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !3493
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !3493
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !3493
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !3495
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !3493
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !3493
  %15 = load i8* %b.04, align 1, !dbg !3493, !tbaa !2861
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !3493
  store i8 %15, i8* %a.03, align 1, !dbg !3493, !tbaa !2861
  %17 = icmp eq i64 %13, 0, !dbg !3493
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !3493, !llvm.loop !3496

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !3497
  %20 = icmp eq i64 %count, 0, !dbg !3499
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !3499

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !3500
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !3497
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !3499
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !3499
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !3499
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !3499
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3499
  %.sum505 = add i64 %.sum440, -31, !dbg !3499
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !3499
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !3499
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !3499
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3499
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3499
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !3499
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !3499
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !3499
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !3499
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !3499
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !3499
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !3499
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !3501
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !3499
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !3499
  %34 = load i8* %b.18, align 1, !dbg !3499, !tbaa !2861
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !3499
  store i8 %34, i8* %a.17, align 1, !dbg !3499, !tbaa !2861
  %36 = icmp eq i64 %32, 0, !dbg !3499
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !3499, !llvm.loop !3502
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #10 {
  %1 = icmp eq i64 %len, 0, !dbg !3504
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !3504
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !3505
  %wide.load = load <16 x i8>* %3, align 1, !dbg !3505
  %next.gep.sum280 = or i64 %index, 16, !dbg !3505
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !3505
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !3505
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !3505
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !3505
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !3505
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !3505
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !3505
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !3505
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !3506
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !3504
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !3505
  %12 = load i8* %src.03, align 1, !dbg !3505, !tbaa !2861
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !3505
  store i8 %12, i8* %dest.02, align 1, !dbg !3505, !tbaa !2861
  %14 = icmp eq i64 %10, 0, !dbg !3504
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !3504, !llvm.loop !3507
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !3508
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #10 {
  %1 = icmp eq i64 %count, 0, !dbg !3509
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !3509

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !3510
  br label %3, !dbg !3509

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !3509
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !3510
  store volatile i8 %2, i8* %a.02, align 1, !dbg !3510, !tbaa !2861
  %6 = icmp eq i64 %4, 0, !dbg !3509
  br i1 %6, label %._crit_edge, label %3, !dbg !3509
...
!3157 = metadata !{i32 3351}
!3158 = metadata !{i32 4640}
!3159 = metadata !{i32 4535}
!3160 = metadata !{i32 3993}
!3161 = metadata !{i32 5430}
!3162 = metadata !{i32 7194}
!3163 = metadata !{i32 7316}
!3164 = metadata !{i32 64, i32 0, metadata !1405, metadata !3165}
!3165 = metadata !{i32 1049, i32 0, metadata !1196, metadata !3166}
!3166 = metadata !{i32 139, i32 0, metadata !3167, null}
!3167 = metadata !{i32 786443, metadata !274, metadata !288, i32 139, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3168 = metadata !{i32 65, i32 0, metadata !1404, metadata !3165}
!3169 = metadata !{i32 66, i32 0, metadata !3170, metadata !3165}
!3170 = metadata !{i32 786443, metadata !801, metadata !1404, i32 66, i32 0, i32 374} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3171 = metadata !{metadata !3093, metadata !3035, i64 4}
!3172 = metadata !{i32 1053, i32 0, metadata !3173, metadata !3166}
!3173 = metadata !{i32 786443, metadata !801, metadata !1196, i32 1053, i32 0, i32 235} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3174 = metadata !{i32 1067, i32 0, metadata !1209, metadata !3166}
!3175 = metadata !{i32 1096, i32 0, metadata !1211, metadata !3166}
!3176 = metadata !{metadata !3093, metadata !3035, i64 0}
!3177 = metadata !{i32 1097, i32 0, metadata !3178, metadata !3166}
!3178 = metadata !{i32 786443, metadata !801, metadata !1211, i32 1097, i32 0, i32 249} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3179 = metadata !{i32 1098, i32 0, metadata !3178, metadata !3166}
!3180 = metadata !{i32 147, i32 0, metadata !3181, null}
!3181 = metadata !{i32 786443, metadata !274, metadata !3182, i32 147, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3182 = metadata !{i32 786443, metadata !274, metadata !3167, i32 140, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3183 = metadata !{i32 133, i32 0, metadata !1555, metadata !3180}
!3184 = metadata !{i32 64, i32 0, metadata !1405, metadata !3185}
!3185 = metadata !{i32 759, i32 0, metadata !1082, metadata !3186}
!3186 = metadata !{i32 134, i32 0, metadata !1555, metadata !3180}
!3187 = metadata !{i32 65, i32 0, metadata !1404, metadata !3185}
!3188 = metadata !{i32 66, i32 0, metadata !3170, metadata !3185}
!3189 = metadata !{i32 761, i32 0, metadata !3190, metadata !3186}
!3190 = metadata !{i32 786443, metadata !801, metadata !1082, i32 761, i32 0, i32 167} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3191 = metadata !{i32 762, i32 0, metadata !3192, metadata !3186}
!3192 = metadata !{i32 786443, metadata !801, metadata !3190, i32 761, i32 0, i32 168} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3193 = metadata !{i32 763, i32 0, metadata !3192, metadata !3186}
!3194 = metadata !{i32 766, i32 0, metadata !1091, metadata !3186}
!3195 = metadata !{i32 768, i32 0, metadata !1090, metadata !3186}
!3196 = metadata !{i32 772, i32 0, metadata !3197, metadata !3186}
!3197 = metadata !{i32 786443, metadata !801, metadata !1090, i32 772, i32 0, i32 171} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3198 = metadata !{i32 773, i32 0, metadata !3197, metadata !3186}
!3199 = metadata !{i32 777, i32 0, metadata !1082, metadata !3186}
!3200 = metadata !{i32 778, i32 0, metadata !1082, metadata !3186}
!3201 = metadata !{i32 42, i32 0, metadata !1637, metadata !3202}
!3202 = metadata !{i32 135, i32 0, metadata !1555, metadata !3180}
!3203 = metadata !{metadata !3045, metadata !3045, i64 0}
!3204 = metadata !{i32 44, i32 0, metadata !1637, metadata !3202}
!3205 = metadata !{metadata !3206, metadata !3035, i64 24}
!3206 = metadata !{metadata !"stat", metadata !3045, i64 0, metadata !3045, i64 8, metadata !3045, i64 16, metadata !3035, i64 24, metadata !3035, i64 28, metadata !3035, i64 32, metadata !3035, i64 36, metadata !3045, i64 40, metadata !3045, i64 48, met
!3207 = metadata !{i32 45, i32 0, metadata !1637, metadata !3202}
!3208 = metadata !{metadata !3044, metadata !3045, i64 16}
!3209 = metadata !{metadata !3206, metadata !3045, i64 16}
!3210 = metadata !{i32 46, i32 0, metadata !1637, metadata !3202}
!3211 = metadata !{metadata !3206, metadata !3035, i64 28}
!3212 = metadata !{i32 47, i32 0, metadata !1637, metadata !3202}
!3213 = metadata !{metadata !3044, metadata !3035, i64 32}
!3214 = metadata !{metadata !3206, metadata !3035, i64 32}
!3215 = metadata !{i32 48, i32 0, metadata !1637, metadata !3202}
!3216 = metadata !{i32 50, i32 0, metadata !1637, metadata !3202}
!3217 = metadata !{metadata !3044, metadata !3045, i64 72}
!3218 = metadata !{metadata !3206, metadata !3045, i64 72}
!3219 = metadata !{i32 51, i32 0, metadata !1637, metadata !3202}
!3220 = metadata !{metadata !3044, metadata !3045, i64 88}
!3221 = metadata !{metadata !3206, metadata !3045, i64 88}
!3222 = metadata !{i32 52, i32 0, metadata !1637, metadata !3202}
!3223 = metadata !{metadata !3044, metadata !3045, i64 104}
!3224 = metadata !{metadata !3206, metadata !3045, i64 104}
!3225 = metadata !{i32 53, i32 0, metadata !1637, metadata !3202}
!3226 = metadata !{i32 56, i32 0, metadata !1637, metadata !3202}
!3227 = metadata !{metadata !3044, metadata !3045, i64 80}
!3228 = metadata !{metadata !3206, metadata !3045, i64 80}
!3229 = metadata !{i32 57, i32 0, metadata !1637, metadata !3202}
!3230 = metadata !{metadata !3044, metadata !3045, i64 96}
!3231 = metadata !{metadata !3206, metadata !3045, i64 96}
!3232 = metadata !{i32 58, i32 0, metadata !1637, metadata !3202} ; [ DW_TAG_imported_module ]
!3233 = metadata !{metadata !3044, metadata !3045, i64 112}
!3234 = metadata !{metadata !3206, metadata !3045, i64 112}
!3235 = metadata !{i32 148, i32 18, metadata !3181, null}
!3236 = metadata !{i32 150, i32 0, metadata !3237, null}
!3237 = metadata !{i32 786443, metadata !274, metadata !3181, i32 149, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3238 = metadata !{i32 153, i32 0, metadata !288, null}
!3239 = metadata !{i32 294, i32 0, metadata !279, null}
!3240 = metadata !{i32 298, i32 0, metadata !3241, null}
!3241 = metadata !{i32 786443, metadata !274, metadata !279, i32 298, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3242 = metadata !{i32 300, i32 0, metadata !3243, null}
!3243 = metadata !{i32 786443, metadata !274, metadata !3241, i32 298, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3244 = metadata !{i32 301, i32 0, metadata !3243, null}
!3245 = metadata !{i32 27, i32 0, metadata !602, metadata !3246}
!3246 = metadata !{i32 305, i32 0, metadata !279, null}
!3247 = metadata !{i32 28, i32 0, metadata !3248, metadata !3246}
!3248 = metadata !{i32 786443, metadata !600, metadata !602, i32 27, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/string/memset.c]
!3249 = metadata !{i32 29, i32 0, metadata !3248, metadata !3246}
!3250 = metadata !{i32 306, i32 0, metadata !279, null}
!3251 = metadata !{i32 307, i32 0, metadata !279, null}
!3252 = metadata !{i32 308, i32 0, metadata !3253, null}
!3253 = metadata !{i32 786443, metadata !274, metadata !279, i32 307, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3254 = metadata !{i32 311, i32 0, metadata !279, null}
!3255 = metadata !{i32 313, i32 0, metadata !3256, null}
!3256 = metadata !{i32 786443, metadata !274, metadata !3257, i32 313, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3257 = metadata !{i32 786443, metadata !274, metadata !279, i32 311, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3258 = metadata !{i32 314, i32 0, metadata !3259, null}
!3259 = metadata !{i32 786443, metadata !274, metadata !3256, i32 313, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3260 = metadata !{i32 29, i32 0, metadata !3261, metadata !3258}
!3261 = metadata !{i32 786443, metadata !580, metadata !582, i32 28, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/string/memcpy.c]
!3262 = metadata !{i32 316, i32 0, metadata !3257, null}
!3263 = metadata !{i32 238, i32 0, metadata !3264, metadata !3265}
!3264 = metadata !{i32 786443, metadata !274, metadata !276, i32 238, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3265 = metadata !{i32 323, i32 0, metadata !279, null}
!3266 = metadata !{i32 280, i32 0, metadata !424, metadata !3267}
!3267 = metadata !{i32 239, i32 0, metadata !3264, metadata !3265}
!3268 = metadata !{i32 43, i32 0, metadata !626, metadata !3269}
!3269 = metadata !{i32 30, i32 0, metadata !619, metadata !3270}
!3270 = metadata !{i32 282, i32 0, metadata !424, metadata !3267}
!3271 = metadata !{i32 43, i32 0, metadata !626, metadata !3272}
!3272 = metadata !{i32 30, i32 0, metadata !619, metadata !3273}
!3273 = metadata !{i32 283, i32 0, metadata !424, metadata !3267}
!3274 = metadata !{i32 284, i32 0, metadata !424, metadata !3267}
!3275 = metadata !{i32 331, i32 0, metadata !3276, null}
!3276 = metadata !{i32 786443, metadata !274, metadata !279, i32 331, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3277 = metadata !{i32 160, i32 0, metadata !3278, metadata !3275}
!3278 = metadata !{i32 786443, metadata !274, metadata !297} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3279 = metadata !{i32 161, i32 0, metadata !3278, metadata !3275}
!3280 = metadata !{i32 162, i32 0, metadata !3278, metadata !3275}
!3281 = metadata !{i32 163, i32 0, metadata !3278, metadata !3275}
!3282 = metadata !{i32 165, i32 0, metadata !3283, metadata !3275}
!3283 = metadata !{i32 786443, metadata !274, metadata !3278, i32 165, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3284 = metadata !{i32 336, i32 0, metadata !3285, null}
!3285 = metadata !{i32 786443, metadata !274, metadata !3276, i32 335, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3286 = metadata !{i32 337, i32 0, metadata !3285, null}
!3287 = metadata !{i32 338, i32 0, metadata !3285, null}
!3288 = metadata !{i32 339, i32 0, metadata !3285, null}
!3289 = metadata !{i32 391, i32 0, metadata !3290, null}
!3290 = metadata !{i32 786443, metadata !274, metadata !279, i32 391, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee-uclibc/libc/misc/internals/__uClibc_main.c]
!3291 = metadata !{i32 392, i32 0, metadata !3290, null}
!3292 = metadata !{i32 401, i32 0, metadata !279, null}
!3293 = metadata !{i32 64, i32 0, metadata !1405, metadata !3294}
!3294 = metadata !{i32 902, i32 0, metadata !1138, null}
!3295 = metadata !{i32 65, i32 0, metadata !1404, metadata !3294}
!3296 = metadata !{i32 66, i32 0, metadata !3170, metadata !3294}
!3297 = metadata !{i32 910, i32 0, metadata !3298, null}
!3298 = metadata !{i32 786443, metadata !801, metadata !1138, i32 910, i32 0, i32 196} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3299 = metadata !{i32 911, i32 0, metadata !3300, null}
!3300 = metadata !{i32 786443, metadata !801, metadata !3298, i32 910, i32 0, i32 197} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3301 = metadata !{i32 912, i32 0, metadata !3300, null}
!3302 = metadata !{i32 915, i32 0, metadata !1138, null}
!3303 = metadata !{i32 916, i32 0, metadata !1138, null}
!3304 = metadata !{i32 917, i32 0, metadata !1138, null}
!3305 = metadata !{i32 919, i32 0, metadata !1162, null}
!3306 = metadata !{i32 920, i32 0, metadata !1161, null}
!3307 = metadata !{i32 926, i32 0, metadata !1164, null}
!3308 = metadata !{i32 929, i32 0, metadata !3309, null}
!3309 = metadata !{i32 786443, metadata !801, metadata !1164, i32 929, i32 0, i32 202} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3310 = metadata !{i32 932, i32 0, metadata !3311, null}
!3311 = metadata !{i32 786443, metadata !801, metadata !3309, i32 929, i32 0, i32 203} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3312 = metadata !{metadata !3313, metadata !3035, i64 0}
!3313 = metadata !{metadata !"termios", metadata !3035, i64 0, metadata !3035, i64 4, metadata !3035, i64 8, metadata !3035, i64 12, metadata !2862, i64 16, metadata !2862, i64 17, metadata !3035, i64 52, metadata !3035, i64 56}
!3314 = metadata !{i32 933, i32 0, metadata !3311, null}
!3315 = metadata !{metadata !3313, metadata !3035, i64 4}
!3316 = metadata !{i32 934, i32 0, metadata !3311, null}
!3317 = metadata !{metadata !3313, metadata !3035, i64 8}
!3318 = metadata !{i32 935, i32 0, metadata !3311, null}
!3319 = metadata !{metadata !3313, metadata !3035, i64 12}
!3320 = metadata !{i32 936, i32 0, metadata !3311, null}
!3321 = metadata !{metadata !3313, metadata !2862, i64 16}
!3322 = metadata !{i32 937, i32 0, metadata !3311, null}
!3323 = metadata !{i32 938, i32 0, metadata !3311, null}
!3324 = metadata !{i32 939, i32 0, metadata !3311, null}
!3325 = metadata !{i32 940, i32 0, metadata !3311, null}
!3326 = metadata !{i32 941, i32 0, metadata !3311, null}
!3327 = metadata !{i32 942, i32 0, metadata !3311, null}
!3328 = metadata !{i32 943, i32 0, metadata !3311, null}
!3329 = metadata !{i32 944, i32 0, metadata !3311, null}
!3330 = metadata !{i32 945, i32 0, metadata !3311, null}
!3331 = metadata !{i32 946, i32 0, metadata !3311, null}
!3332 = metadata !{i32 947, i32 0, metadata !3311, null}
!3333 = metadata !{i32 948, i32 0, metadata !3311, null}
!3334 = metadata !{i32 949, i32 0, metadata !3311, null}
!3335 = metadata !{i32 950, i32 0, metadata !3311, null}
!3336 = metadata !{i32 951, i32 0, metadata !3311, null}
!3337 = metadata !{i32 952, i32 0, metadata !3311, null}
!3338 = metadata !{i32 953, i32 0, metadata !3311, null}
!3339 = metadata !{i32 954, i32 0, metadata !3311, null}
!3340 = metadata !{i32 955, i32 0, metadata !3311, null}
!3341 = metadata !{i32 956, i32 0, metadata !3311, null}
!3342 = metadata !{i32 958, i32 0, metadata !3343, null}
!3343 = metadata !{i32 786443, metadata !801, metadata !3309, i32 957, i32 0, i32 204} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3344 = metadata !{i32 959, i32 0, metadata !3343, null}
!3345 = metadata !{i32 1041, i32 0, metadata !1195, null}
!3346 = metadata !{i32 1042, i32 0, metadata !3347, null}
!3347 = metadata !{i32 786443, metadata !801, metadata !1195, i32 1042, i32 0, i32 234} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3348 = metadata !{i32 1043, i32 0, metadata !3347, null}
!3349 = metadata !{i32 1046, i32 0, metadata !1138, null}
!3350 = metadata !{i32 68, i32 0, metadata !1447, null}
!3351 = metadata !{i32 71, i32 0, metadata !1446, null}
!3352 = metadata !{i32 72, i32 0, metadata !1446, null}
!3353 = metadata !{i32 73, i32 0, metadata !1446, null}
!3354 = metadata !{i32 74, i32 0, metadata !1446, null}
!3355 = metadata !{i32 133, i32 0, metadata !3356, metadata !3357}
!3356 = metadata !{i32 786443, metadata !801, metadata !862, i32 133, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3357 = metadata !{i32 76, i32 0, metadata !1436, null}
!3358 = metadata !{i32 134, i32 0, metadata !3359, metadata !3357}
!3359 = metadata !{i32 786443, metadata !801, metadata !3356, i32 134, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3360 = metadata !{i32 136, i32 0, metadata !3361, metadata !3357}
!3361 = metadata !{i32 786443, metadata !801, metadata !862, i32 136, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3362 = metadata !{i32 137, i32 0, metadata !3363, metadata !3357}
!3363 = metadata !{i32 786443, metadata !801, metadata !3361, i32 136, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3364 = metadata !{i32 138, i32 0, metadata !3363, metadata !3357}
!3365 = metadata !{i32 141, i32 0, metadata !862, metadata !3357}
!3366 = metadata !{i32 144, i32 0, metadata !862, metadata !3357}
!3367 = metadata !{i32 1417, i32 0, metadata !1379, metadata !3368}
!3368 = metadata !{i32 1429, i32 0, metadata !1360, metadata !3369}
!3369 = metadata !{i32 181, i32 0, metadata !883, metadata !3357}
!3370 = metadata !{i32 1418, i32 0, metadata !1379, metadata !3368}
!3371 = metadata !{i32 1432, i32 0, metadata !1369, metadata !3369}
!3372 = metadata !{i32 1433, i32 0, metadata !1368, metadata !3369}
!3373 = metadata !{i32 1434, i32 0, metadata !1372, metadata !3369}
!3374 = metadata !{i32 1435, i32 0, metadata !3060, metadata !3369}
!3375 = metadata !{i32 1436, i32 0, metadata !3063, metadata !3369}
!3376 = metadata !{i32 1437, i32 0, metadata !3063, metadata !3369}
!3377 = metadata !{i32 1439, i32 0, metadata !3066, metadata !3369}
!3378 = metadata !{i32 1440, i32 0, metadata !3066, metadata !3369}
!3379 = metadata !{i32 1442, i32 0, metadata !1371, metadata !3369}
!3380 = metadata !{i32 1443, i32 0, metadata !1371, metadata !3369}
!3381 = metadata !{i32 1444, i32 0, metadata !1371, metadata !3369}
!3382 = metadata !{i32 1445, i32 0, metadata !3073, metadata !3369}
!3383 = metadata !{i32 182, i32 0, metadata !3384, metadata !3357}
!3384 = metadata !{i32 786443, metadata !801, metadata !883, i32 182, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3385 = metadata !{i32 183, i32 0, metadata !3386, metadata !3357}
!3386 = metadata !{i32 786443, metadata !801, metadata !3384, i32 182, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3387 = metadata !{i32 184, i32 0, metadata !3386, metadata !3357}
!3388 = metadata !{i32 186, i32 0, metadata !883, metadata !3357}
!3389 = metadata !{i32 190, i32 0, metadata !3390, metadata !3357}
!3390 = metadata !{i32 786443, metadata !801, metadata !862, i32 190, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3391 = metadata !{i32 189, i32 0, metadata !862, metadata !3357}
!3392 = metadata !{i32 191, i32 0, metadata !3393, metadata !3357}
!3393 = metadata !{i32 786443, metadata !801, metadata !3390, i32 190, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3394 = metadata !{i32 192, i32 0, metadata !3393, metadata !3357}
!3395 = metadata !{i32 193, i32 0, metadata !3396, metadata !3357}
!3396 = metadata !{i32 786443, metadata !801, metadata !3397, i32 192, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3397 = metadata !{i32 786443, metadata !801, metadata !3390, i32 192, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3398 = metadata !{i32 194, i32 0, metadata !3396, metadata !3357}
!3399 = metadata !{i32 195, i32 0, metadata !3400, metadata !3357}
!3400 = metadata !{i32 786443, metadata !801, metadata !3397, i32 194, i32 0, i32 25} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd.c]
!3401 = metadata !{i32 48, i32 0, metadata !1841, null}
!3402 = metadata !{i32 50, i32 0, metadata !1841, null}
!3403 = metadata !{i32 51, i32 0, metadata !3404, null}
!3404 = metadata !{i32 786443, metadata !1798, metadata !1841, i32 51, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd_init.c]
!3405 = metadata !{i32 53, i32 0, metadata !1841, null}
!3406 = metadata !{i32 52, i32 0, metadata !3404, null}
!3407 = metadata !{i32 55, i32 0, metadata !1841, null}
!3408 = metadata !{i32 57, i32 0, metadata !1841, null}
!3409 = metadata !{metadata !3042, metadata !3035, i64 0}
!3410 = metadata !{i32 58, i32 0, metadata !1841, null} ; [ DW_TAG_imported_module ]
!3411 = metadata !{metadata !3042, metadata !2867, i64 8}
!3412 = metadata !{i32 59, i32 0, metadata !1841, null}
!3413 = metadata !{i32 61, i32 0, metadata !1841, null}
!3414 = metadata !{i32 64, i32 0, metadata !3415, null}
!3415 = metadata !{i32 786443, metadata !1798, metadata !1841, i32 64, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/fd_init.c]
!3416 = metadata !{i32 66, i32 0, metadata !3415, null}
!3417 = metadata !{i32 71, i32 0, metadata !1841, null}
!3418 = metadata !{i32 75, i32 0, metadata !1841, null}
!3419 = metadata !{metadata !3044, metadata !3045, i64 56}
!3420 = metadata !{i32 77, i32 0, metadata !1841, null}
!3421 = metadata !{metadata !3044, metadata !3035, i64 24}
!3422 = metadata !{i32 78, i32 0, metadata !1841, null}
!3423 = metadata !{metadata !3044, metadata !3045, i64 0}
!3424 = metadata !{i32 79, i32 0, metadata !1841, null}
!3425 = metadata !{metadata !3044, metadata !3045, i64 40}
!3426 = metadata !{i32 80, i32 0, metadata !1841, null}
!3427 = metadata !{i32 81, i32 0, metadata !1841, null}
!3428 = metadata !{i32 82, i32 0, metadata !1841, null}
!3429 = metadata !{i32 83, i32 0, metadata !1841, null}
!3430 = metadata !{i32 84, i32 0, metadata !1841, null}
!3431 = metadata !{i32 85, i32 0, metadata !1841, null}
!3432 = metadata !{metadata !3044, metadata !3035, i64 28}
!3433 = metadata !{i32 86, i32 0, metadata !1841, null}
!3434 = metadata !{i32 87, i32 0, metadata !1841, null}
!3435 = metadata !{i32 88, i32 0, metadata !1841, null}
!3436 = metadata !{i32 89, i32 0, metadata !1841, null}
!3437 = metadata !{i32 90, i32 0, metadata !1841, null}
!3438 = metadata !{i32 92, i32 0, metadata !1841, null}
!3439 = metadata !{metadata !3044, metadata !3045, i64 48}
!3440 = metadata !{i32 93, i32 0, metadata !1841, null}
!3441 = metadata !{metadata !3044, metadata !3045, i64 64}
!3442 = metadata !{i32 94, i32 0, metadata !1841, null}
!3443 = metadata !{i32 95, i32 0, metadata !1841, null}
!3444 = metadata !{i32 24, i32 0, metadata !2061, null}
!3445 = metadata !{i32 65, i32 0, metadata !2032, null}
!3446 = metadata !{i32 66, i32 0, metadata !2032, null}
!3447 = metadata !{i32 67, i32 0, metadata !2032, null}
!3448 = metadata !{i32 69, i32 0, metadata !3449, null}
!3449 = metadata !{i32 786443, metadata !1986, metadata !2032, i32 69, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/POSIX/klee_init_env.c]
!3450 = metadata !{i32 70, i32 0, metadata !3449, null}
!3451 = metadata !{i32 50, i32 0, metadata !2040, metadata !3450}
!3452 = metadata !{i32 72, i32 0, metadata !2032, null}
!3453 = metadata !{i32 73, i32 0, metadata !2032, null}
!3454 = metadata !{i32 13, i32 0, metadata !3455, null}
!3455 = metadata !{i32 786443, metadata !2754, metadata !2753, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_div_zero_check.c]
!3456 = metadata !{i32 14, i32 0, metadata !3455, null}
!3457 = metadata !{i32 15, i32 0, metadata !2753, null}
!3458 = metadata !{i32 15, i32 0, metadata !2764, null}
!3459 = metadata !{i32 16, i32 0, metadata !2764, null}
!3460 = metadata !{i32 21, i32 0, metadata !3461, null}
!3461 = metadata !{i32 786443, metadata !2774, metadata !2773, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_overshift_check.c]
!3462 = metadata !{i32 27, i32 0, metadata !3463, null}
!3463 = metadata !{i32 786443, metadata !2774, metadata !3461, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_overshift_check.c]
!3464 = metadata !{i32 29, i32 0, metadata !2773, null}
!3465 = metadata !{i32 16, i32 0, metadata !3466, null}
!3466 = metadata !{i32 786443, metadata !2785, metadata !2784, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3467 = metadata !{i32 17, i32 0, metadata !3466, null}
!3468 = metadata !{i32 19, i32 0, metadata !3469, null}
!3469 = metadata !{i32 786443, metadata !2785, metadata !2784, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3470 = metadata !{i32 22, i32 0, metadata !3471, null}
!3471 = metadata !{i32 786443, metadata !2785, metadata !3469, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3472 = metadata !{i32 25, i32 0, metadata !3473, null}
!3473 = metadata !{i32 786443, metadata !2785, metadata !3471, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3474 = metadata !{i32 26, i32 0, metadata !3475, null}
!3475 = metadata !{i32 786443, metadata !2785, metadata !3473, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3476 = metadata !{i32 27, i32 0, metadata !3475, null}
!3477 = metadata !{i32 28, i32 0, metadata !3478, null}
!3478 = metadata !{i32 786443, metadata !2785, metadata !3473, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/klee_range.c]
!3479 = metadata !{i32 29, i32 0, metadata !3478, null}
!3480 = metadata !{i32 32, i32 0, metadata !3471, null}
!3481 = metadata !{i32 34, i32 0, metadata !2784, null}
!3482 = metadata !{i32 16, i32 0, metadata !2797, null}
!3483 = metadata !{i32 17, i32 0, metadata !2797, null}
!3484 = metadata !{metadata !3484, metadata !3485, metadata !3486}
!3485 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!3486 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!3487 = metadata !{metadata !3487, metadata !3485, metadata !3486}
!3488 = metadata !{i32 18, i32 0, metadata !2797, null}
!3489 = metadata !{i32 16, i32 0, metadata !3490, null}
!3490 = metadata !{i32 786443, metadata !2813, metadata !2812, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3491 = metadata !{i32 19, i32 0, metadata !3492, null}
!3492 = metadata !{i32 786443, metadata !2813, metadata !2812, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3493 = metadata !{i32 20, i32 0, metadata !3494, null}
!3494 = metadata !{i32 786443, metadata !2813, metadata !3492, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3495 = metadata !{metadata !3495, metadata !3485, metadata !3486}
!3496 = metadata !{metadata !3496, metadata !3485, metadata !3486}
!3497 = metadata !{i32 22, i32 0, metadata !3498, null}
!3498 = metadata !{i32 786443, metadata !2813, metadata !3492, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/dominik/build_dir/klee/runtime/Intrinsic/memmove.c]
!3499 = metadata !{i32 24, i32 0, metadata !3498, null}
!3500 = metadata !{i32 23, i32 0, metadata !3498, null}
!3501 = metadata !{metadata !3501, metadata !3485, metadata !3486}
!3502 = metadata !{metadata !3502, metadata !3485, metadata !3486}
!3503 = metadata !{i32 28, i32 0, metadata !2812, null}
!3504 = metadata !{i32 15, i32 0, metadata !2827, null}
!3505 = metadata !{i32 16, i32 0, metadata !2827, null}
!3506 = metadata !{metadata !3506, metadata !3485, metadata !3486}
!3507 = metadata !{metadata !3507, metadata !3485, metadata !3486}
!3508 = metadata !{i32 17, i32 0, metadata !2827, null}
!3509 = metadata !{i32 13, i32 0, metadata !2842, null}
!3510 = metadata !{i32 14, i32 0, metadata !2842, null}
!3511 = metadata !{i32 15, i32 0, metadata !2842, null}
