; ModuleID = './dekhash-addOpaque-updateOpaque4.bc'
...
define internal fastcc i32 @DEKHash(i8* %str, i32 %len) #0 {
  %1 = alloca i8*, align 8
  ...
  store %struct._1_main__opaque_Node_1* %9, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
...
; <label>:13                                      ; preds = %0
  %14 = call fastcc i32 @DEKHash(i8* null, i32 %len)
  br label %.preheader

.preheader:                                       ; preds = %13, %0
  %hash.0.ph = phi i32 [ %len, %0 ], [ %14, %13 ]
  %15 = icmp eq i32 %len, 0
  br i1 %15, label %._crit_edge, label %.lr.ph

._crit_edge:                                      ; preds = %.lr.ph, %.preheader
  %hash.0.lcssa = phi i32 [ %hash.0.ph, %.preheader ], [ %52, %.lr.ph ]
  %16 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %17 = icmp eq %struct._1_main__opaque_Node_1* %16, null
  br i1 %17, label %30, label %18

; <label>:18                                      ; preds = %._crit_edge
  %19 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %20 = icmp eq %struct._1_main__opaque_Node_1* %16, %19
  br i1 %20, label %23, label %21

; <label>:21                                      ; preds = %18
  %22 = call fastcc i32 @__user_main(i32 8, i8** %1)
  br label %23
...
; <label>:30                                      ; preds = %._crit_edge
  %31 = call fastcc i32 @__user_main(i32 undef, i8** %1)
  %32 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %33 = getelementptr inbounds %struct._1_main__opaque_Node_1* %32, i64 0, i32 1
  %34 = load %struct._1_main__opaque_Node_1** %33, align 8
  %35 = getelementptr inbounds %struct._1_main__opaque_Node_1* %34, i64 -1
  ...
  %37 = getelementptr inbounds %struct._1_main__opaque_Node_1* %36, i64 0, i32 1
  %38 = load %struct._1_main__opaque_Node_1** %37, align 8
  %39 = getelementptr inbounds %struct._1_main__opaque_Node_1* %38, i64 1
  br label %40

; <label>:40                                      ; preds = %30, %23
  %41 = phi %struct._1_main__opaque_Node_1* [ %35, %30 ], [ %26, %23 ]
  %storemerge = phi %struct._1_main__opaque_Node_1* [ %39, %30 ], [ %29, %23 ]
  %42 = getelementptr inbounds %struct._1_main__opaque_Node_1* %41, i64 0, i32 1
  %43 = load %struct._1_main__opaque_Node_1** %42, align 8
  store %struct._1_main__opaque_Node_1* %43, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %44 = getelementptr inbounds %struct._1_main__opaque_Node_1* %storemerge, i64 0, i32 1
  %45 = load %struct._1_main__opaque_Node_1** %44, align 8
  store %struct._1_main__opaque_Node_1* %45, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  ret i32 %hash.0.lcssa

.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %46 = phi i8* [ %53, %.lr.ph ], [ %str, %.preheader ]
  %hash.02 = phi i32 [ %52, %.lr.ph ], [ %hash.0.ph, %.preheader ]
  %i.01 = phi i32 [ %54, %.lr.ph ], [ 0, %.preheader ]
  %47 = shl i32 %hash.02, 5
  %48 = lshr i32 %hash.02, 27
  %49 = or i32 %47, %48
  %50 = load i8* %46, align 1
  %51 = sext i8 %50 to i32
  %52 = xor i32 %51, %49
  %53 = getelementptr inbounds i8* %46, i64 1
  store i8* %53, i8** %1, align 8
  %54 = add i32 %i.01, 1
  %exitcond = icmp eq i32 %54, %len
