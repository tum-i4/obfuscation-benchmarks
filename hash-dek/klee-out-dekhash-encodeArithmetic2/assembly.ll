; ModuleID = './dekhash-encodeArithmetic2.bc'
...
; <label>:443                                     ; preds = %465, %strlen.exit
  %hash.0.i = phi i32 [ %441, %strlen.exit ], [ %486, %465 ]
  %i.0.i = phi i32 [ 0, %strlen.exit ], [ %503, %465 ]
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %487, %465 ]
  ...
  %459 = sub i32 1, %i.0.i
  %460 = add i32 %459, %444
  %461 = add i32 %460, %.neg1.i
  %462 = add i32 %461, %453
  %463 = add i32 %462, %458
  %464 = icmp slt i32 %463, 0
  br i1 %464, label %465, label %DEKHash.exit

; <label>:465                                     ; preds = %443
  %466 = shl i32 %hash.0.i, 5
  %467 = lshr i32 %hash.0.i, 27
  %468 = or i32 %466, %467
  %469 = load i8* %.0.i, align 1
  %470 = sext i8 %469 to i32
  %471 = xor i32 %470, -1
  %472 = and i32 %468, %471
  %473 = xor i32 %466, 2147483647
  %.neg10.i = sub i32 -2, %466
  %474 = sub i32 %.neg10.i, %473
  %475 = and i32 %474, %468
  %476 = shl i32 %475, 1
  %477 = sub i32 %476, %468
  %478 = xor i32 %477, -1
  %479 = load i8* %.0.i, align 1
  ...
  %485 = add i32 %484, %472
  %486 = add i32 %485, %483
  %487 = getelementptr inbounds i8* %.0.i, i64 1
  %488 = or i32 %i.0.i, 1
  %489 = add i32 %i.0.i, 2
  %490 = or i32 %i.0.i, -2
  %491 = xor i32 %490, 1
  ...
  %499 = sub i32 %498, %490
  %500 = xor i32 %496, %499
  %501 = xor i32 %496, 2147483647
  %502 = and i32 %499, %501
  %sum26.i = shl i32 %502, 1
  %503 = sub i32 %500, %sum26.i
  br label %443

DEKHash.exit:                                     ; preds = %443
  %504 = icmp eq i32 %hash.0.i, -566008905
  br i1 %504, label %505, label %506

; <label>:505                                     ; preds = %DEKHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %507

; <label>:506                                     ; preds = %DEKHash.exit
