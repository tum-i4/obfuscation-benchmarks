; ModuleID = './dekhash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i, label %DEKHash.exit

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %455, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %459, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %454, %.lr.ph.i ], [ %441, %strlen.exit ]
  %447 = shl i32 %hash.01.i, 5
  %448 = lshr i32 %hash.01.i, 27
  %449 = or i32 %447, %448
  %450 = load i8* %.03.i, align 1
  %451 = sext i8 %450 to i32
  %452 = or i32 %449, %451
  %453 = and i32 %451, %449
  %454 = sub i32 %452, %453
  %455 = getelementptr inbounds i8* %.03.i, i64 1
  %456 = shl i32 %i.02.i, 1
  %457 = or i32 %456, 2
  %458 = xor i32 %i.02.i, 1
  %459 = sub i32 %457, %458
  %460 = xor i32 %459, -2147483648
  %461 = and i32 %460, %441
  %462 = xor i32 %459, %442
  %463 = sub i32 %459, %441
  %464 = and i32 %463, %462
  ...
  br i1 %466, label %.lr.ph.i, label %DEKHash.exit

DEKHash.exit:                                     ; preds = %.lr.ph.i, %strlen.exit
  %hash.0.lcssa.i = phi i32 [ %441, %strlen.exit ], [ %454, %.lr.ph.i ]
  %467 = icmp eq i32 %hash.0.lcssa.i, -566008905
