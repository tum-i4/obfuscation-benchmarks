...
.outer.outer.i:                                   ; preds = %.split8.i, %strlen.exit
  %i.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %451, %.split8.i ]
  %hash.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %449, %.split8.i ]
  %_1_DEKHash_next.0.ph.ph.i = phi i64 [ 5, %strlen.exit ], [ 3, %.split8.i ]
  %.0.ph.ph.i = phi i8* [ %433, %strlen.exit ], [ %450, %.split8.i ]
  br label %.outer.i

.outer.i:                                         ; preds = %.outer.i, %.outer.outer.i
  %i.0.ph.i = phi i32 [ %i.0.ph.ph.i, %.outer.outer.i ], [ 0, %.outer.i ]
  %hash.0.ph.i = phi i32 [ %hash.0.ph.ph.i, %.outer.outer.i ], [ %441, %.outer.i ]
  %_1_DEKHash_next.0.ph.i = phi i64 [ %_1_DEKHash_next.0.ph.ph.i, %.outer.outer.i ], [ 3, %.outer.i ]
  %442 = icmp eq i64 %_1_DEKHash_next.0.ph.i, 5
...
.outer1..outer1.split_crit_edge.i:                ; preds = %.outer1..outer1.split_crit_edge.i, %.outer1..outer1.split_crit_edge.lr.ph.i
  %_1_DEKHash_next.0.ph214.i = phi i64 [ %_1_DEKHash_next.0.ph.i, %.outer1..outer1.split_crit_edge.lr.ph.i ], [ %..i, %.outer1..outer1.split_crit_edge.i ]
  switch i64 %_1_DEKHash_next.0.ph214.i, label %infloop.i [
    i64 3, label %.outer1..outer1.split_crit_edge.i
    i64 1, label %.split8.i
    i64 0, label %DEKHash.exit
  ]

.split8.i:                                        ; preds = %.outer1..outer1.split_crit_edge.i
  %444 = shl i32 %hash.0.ph.i, 5
  %445 = lshr i32 %hash.0.ph.i, 27
  %446 = or i32 %444, %445
  %447 = load i8* %.0.ph.ph.i, align 1
  %448 = sext i8 %447 to i32
  %449 = xor i32 %448, %446
  %450 = getelementptr inbounds i8* %.0.ph.ph.i, i64 1
  %451 = add i32 %i.0.ph.i, 1
  br label %.outer.outer.i

infloop.i:                                        ; preds = %.outer1..outer1.split_crit_edge.i, %infloop.i
  br label %infloop.i

DEKHash.exit:                                     ; preds = %.outer1..outer1.split_crit_edge.i
  %452 = icmp eq i32 %hash.0.ph.i, -566008905
  br i1 %452, label %453, label %454

; <label>:453                                     ; preds = %DEKHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %455

; <label>:454                                     ; preds = %DEKHash.exit
