...
%"union._2_DEKHash_$node" = type { i8* }
...
@"_2_DEKHash_$array" = internal unnamed_addr constant [1 x [9088 x i8]] [[9088 x i8] c"\94\08\00\00\00\00\00\00\00\94\00\00\00\00\00\00\00\00{[\00\00\00\00\00\00\00\00\15\8C\10\00\00\00\12\94\00\01\00\00\00\00\00\00\94\00\00\00\00\00\00\00\00{\94\08\00\0
@"_1_DEKHash_$array" = internal global [1 x [171 x i8]] [[171 x i8] c"U\0C\00\00\00\BF\01\00\00\00\07\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00U\10\00\00\00\07\BF\01\00\00\00\07\84\D6\0E\00\00\00:\04\00\00\00:e\00\00\0
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_DEKHash_$locals.i" = alloca [308 x i8], align 16
  %"_2_DEKHash_$stack.i" = alloca [1 x [32 x %"union._2_DEKHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [308 x i8]* %"_2_DEKHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_DEKHash_$node"]]* %"_2_DEKHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_DEKHash_$node"]]* %"_2_DEKHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %719, %711, %702, %696, %689, %680, %677, %669, %651, %643, %636, %630, %622, %620, %617, %605, %597, %591, %585, %577, %571, %564, %562, %543, %535, %527, %521, %513, %504, %496, %494, %487, %4
  %"_2_DEKHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [9088 x i8]]* @"_2_DEKHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_DEKHash_$pc.0.0.i", %.backedge.i ], [ %720, %719 ], [ %712, %711 ], [ %703, %702 ], [ %697, %696 ], [ %690
  %"_2_DEKHash_$sp.0.0.i" = phi %"union._2_DEKHash_$node"* [ %448, %strlen.exit ], [ %"_2_DEKHash_$sp.0.0.i", %.backedge.i ], [ %723, %719 ], [ %718, %711 ], [ %706, %702 ], [ %"_2_DEKHash_$sp.0.0.i", %696 ], [ %"_2_DEKHash_$sp.0.0.i", %689 ], [ %661, %6
  %449 = load i8* %"_2_DEKHash_$pc.0.0.i", align 1
  %450 = zext i8 %449 to i32
  switch i32 %450, label %.backedge.i [
    i32 216, label %DEKHash.exit
    i32 68, label %451
    i32 253, label %462
    i32 23, label %470
    i32 251, label %479
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
...
; <label>:455                                     ; preds = %451
  %456 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %456, align 8
  br label %459

; <label>:457                                     ; preds = %451
  %458 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %458, align 8
  br label %459

; <label>:459                                     ; preds = %457, %455, %451
  %460 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1
  %461 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:462                                     ; preds = %.backedge.i
  %463 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %464 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %465 = bitcast %"union._2_DEKHash_$node"* %464 to i8*
  %466 = load i8* %465, align 1
  %467 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %468 = load i8** %467, align 8
  store i8 %466, i8* %468, align 1
  %469 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:470                                     ; preds = %.backedge.i
  %471 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %472 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %473 = load i32* %472, align 4
  %474 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %475 = bitcast %"union._2_DEKHash_$node"* %474 to i32*
...
; <label>:479                                     ; preds = %.backedge.i
  %480 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %481 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %482 = load i8** %481, align 8
  %483 = bitcast i8* %482 to i8**
  %484 = load i8** %483, align 8
  store i8* %484, i8** %481, align 8
  br label %.backedge.i

; <label>:485                                     ; preds = %.backedge.i
  %486 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:487                                     ; preds = %.backedge.i
  %488 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %489 = bitcast i8* %488 to i32*
  %490 = load i32* %489, align 4
  %491 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1
  %492 = bitcast %"union._2_DEKHash_$node"* %491 to i32*
  store i32 %490, i32* %492, align 4
  %493 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:494                                     ; preds = %.backedge.i
  %495 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:496                                     ; preds = %.backedge.i
  %497 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %498 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %499 = load i32* %498, align 4
  %500 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %501 = bitcast %"union._2_DEKHash_$node"* %500 to i32*
  %502 = load i32* %501, align 4
  %503 = lshr i32 %499, %502
  store i32 %503, i32* %501, align 4
  br label %.backedge.i

; <label>:504                                     ; preds = %.backedge.i
  %505 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %506 = bitcast i8* %505 to i32*
  %507 = load i32* %506, align 4
  %508 = sext i32 %507 to i64
  %509 = getelementptr inbounds [308 x i8]* %"_2_DEKHash_$locals.i", i64 0, i64 %508
  %510 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1, i32 0
  store i8* %509, i8** %510, align 8
  %511 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1
  %512 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:513                                     ; preds = %.backedge.i
  %514 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %515 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %516 = load i8** %515, align 8
  %517 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1, i32 0
  %518 = load i8** %517, align 8
  %519 = bitcast i8* %518 to i8**
  store i8* %516, i8** %519, align 8
  %520 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:521                                     ; preds = %.backedge.i
  %522 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %523 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %524 = load i8** %523, align 8
  %525 = load i8* %524, align 1
  %526 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i8*
  store i8 %525, i8* %526, align 1
  br label %.backedge.i

; <label>:527                                     ; preds = %.backedge.i
  %528 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %529 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %530 = bitcast %"union._2_DEKHash_$node"* %529 to i32*
  %531 = load i32* %530, align 4
  %532 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
...
; <label>:535                                     ; preds = %.backedge.i
  %536 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %537 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i64*
  %538 = load i64* %537, align 8
  %539 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1, i32 0
  %540 = load i8** %539, align 8
  %541 = bitcast i8* %540 to i64*
  store i64 %538, i64* %541, align 8
  %542 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:543                                     ; preds = %.backedge.i
  %544 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %545 = bitcast i8* %544 to i8**
  %546 = load i8** %545, align 8
  %547 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1, i32 0
  store i8* %546, i8** %547, align 8
  %548 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1
  %549 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:550                                     ; preds = %.backedge.i
  %551 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %552 = load i32* %551, align 4
  %553 = icmp eq i32 %552, 0
  br i1 %553, label %560, label %554

; <label>:554                                     ; preds = %550
  %555 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %556 = bitcast i8* %555 to i32*
  %557 = load i32* %556, align 4
  %558 = sext i32 %557 to i64
  %.sum9.i = add i64 %558, 1
  %559 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 %.sum9.i
  br label %562

; <label>:560                                     ; preds = %550
  %561 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 5
  br label %562

; <label>:562                                     ; preds = %560, %554
  %"_2_DEKHash_$pc.0.1.i" = phi i8* [ %561, %560 ], [ %559, %554 ]
  %563 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:564                                     ; preds = %.backedge.i
  %565 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %566 = bitcast i8* %565 to i32*
  %567 = load i32* %566, align 4
  %568 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1
  %569 = bitcast %"union._2_DEKHash_$node"* %568 to i32*
  store i32 %567, i32* %569, align 4
  %570 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:571                                     ; preds = %.backedge.i
  %572 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %573 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %574 = load i8** %573, align 8
  %575 = bitcast i8* %574 to i64*
  %576 = load i64* %575, align 8
  %.c4.i = inttoptr i64 %576 to i8*
  store i8* %.c4.i, i8** %573, align 8
  br label %.backedge.i

; <label>:577                                     ; preds = %.backedge.i
  %578 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %579 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %580 = load i32* %579, align 4
  %581 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %582 = bitcast %"union._2_DEKHash_$node"* %581 to i32*
  %583 = load i32* %582, align 4
  %584 = add i32 %583, %580
  store i32 %584, i32* %582, align 4
  br label %.backedge.i

; <label>:585                                     ; preds = %.backedge.i
  %586 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %587 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i8*
  %588 = load i8* %587, align 1
  %589 = sext i8 %588 to i32
  %590 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  store i32 %589, i32* %590, align 4
  br label %.backedge.i

; <label>:591                                     ; preds = %.backedge.i
  %592 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %593 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %594 = load i32* %593, align 4
  %595 = sext i32 %594 to i64
  %596 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %.c3.i = inttoptr i64 %595 to i8*
  store i8* %.c3.i, i8** %596, align 8
  br label %.backedge.i

; <label>:597                                     ; preds = %.backedge.i
  %598 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %599 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %600 = bitcast %"union._2_DEKHash_$node"* %599 to i32*
  %601 = load i32* %600, align 4
  %602 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
...
; <label>:605                                     ; preds = %.backedge.i
  %606 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %607 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %608 = load i8** %607, align 8
  %609 = load i8* %608, align 1
  %610 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i8*
  store i8 %609, i8* %610, align 1
  br label %.backedge.i

; <label>:611                                     ; preds = %.backedge.i
  %612 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %613 = bitcast i8* %612 to i32*
  %614 = load i32* %613, align 4
  %cond.i = icmp eq i32 %614, 0
  br i1 %cond.i, label %615, label %617

; <label>:615                                     ; preds = %611
  %616 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [171 x i8]]* @"_1_DEKHash_$array", i64 0, i64 0, i64 0), i8** %616, align 8
  br label %617

; <label>:617                                     ; preds = %615, %611
  %618 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1
  %619 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:620                                     ; preds = %.backedge.i
  %621 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:622                                     ; preds = %.backedge.i
  %623 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %624 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %625 = load i32* %624, align 4
  %626 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1, i32 0
  %627 = load i8** %626, align 8
  %628 = bitcast i8* %627 to i32*
  store i32 %625, i32* %628, align 4
  %629 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:630                                     ; preds = %.backedge.i
  %631 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %632 = bitcast i8* %631 to i32*
  %633 = load i32* %632, align 4
  %634 = sext i32 %633 to i64
  %.sum2.i = add i64 %634, 1
  %635 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 %.sum2.i
  br label %.backedge.i

; <label>:636                                     ; preds = %.backedge.i
  %637 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %638 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %639 = load i8** %638, align 8
  %640 = bitcast i8* %639 to i32*
  %641 = load i32* %640, align 4
  %642 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  store i32 %641, i32* %642, align 4
  br label %.backedge.i

; <label>:643                                     ; preds = %.backedge.i
  %644 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %645 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %646 = load i32* %645, align 4
  %647 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1, i32 0
  %648 = load i8** %647, align 8
  %649 = bitcast i8* %648 to i32*
  store i32 %646, i32* %649, align 4
  %650 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:651                                     ; preds = %.backedge.i
  %652 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %653 = bitcast i8* %652 to i64*
  %654 = load i64* %653, align 8
  %655 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1, i32 0
  %.c1.i = inttoptr i64 %654 to i8*
  store i8* %.c1.i, i8** %655, align 8
  %656 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 1
  %657 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:658                                     ; preds = %.backedge.i
  %659 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %660 = load i32* %659, align 4
  %661 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %662 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 5
  %663 = bitcast i8* %662 to i32*
  %664 = load i32* %663, align 4
  %665 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 9
  %666 = bitcast i8* %665 to i32*
  %667 = load i32* %666, align 4
  %668 = icmp slt i32 %660, %664
  br i1 %668, label %669, label %672

; <label>:669                                     ; preds = %658
  %670 = sext i32 %667 to i64
  %.sum8.i = add i64 %670, 1
  %671 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:672                                     ; preds = %658
  %673 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %674 = bitcast i8* %673 to i32*
  %675 = load i32* %674, align 4
  %676 = icmp sgt i32 %660, %675
  br i1 %676, label %677, label %680

; <label>:677                                     ; preds = %672
  %678 = sext i32 %667 to i64
  %.sum7.i = add i64 %678, 1
  %679 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:680                                     ; preds = %672
  %681 = sub nsw i32 %660, %664
  %682 = shl nsw i32 %681, 2
  %683 = sext i32 %682 to i64
  %.sum5.i = add i64 %683, 13
  %684 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 %.sum5.i
  %685 = bitcast i8* %684 to i32*
  %686 = load i32* %685, align 4
  %687 = sext i32 %686 to i64
  %.sum6.i = add i64 %687, 1
  %688 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 %.sum6.i
  br label %.backedge.i

; <label>:689                                     ; preds = %.backedge.i
  %690 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %691 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %692 = load i8** %691, align 8
  %693 = bitcast i8* %692 to i32*
  %694 = load i32* %693, align 4
  %695 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  store i32 %694, i32* %695, align 4
  br label %.backedge.i

; <label>:696                                     ; preds = %.backedge.i
  %697 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %698 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i8*
  %699 = load i8* %698, align 1
  %700 = zext i8 %699 to i32
  %701 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  store i32 %700, i32* %701, align 4
  br label %.backedge.i

; <label>:702                                     ; preds = %.backedge.i
  %703 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %704 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i64*
  %705 = load i64* %704, align 8
  %706 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %707 = bitcast %"union._2_DEKHash_$node"* %706 to i64*
  %708 = load i64* %707, align 8
  %709 = mul i64 %708, %705
  %710 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1, i32 0
  %.c.i = inttoptr i64 %709 to i8*
  store i8* %.c.i, i8** %710, align 8
  br label %.backedge.i

; <label>:711                                     ; preds = %.backedge.i
  %712 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %713 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1, i32 0
  %714 = load i8** %713, align 8
  %715 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i64*
  %716 = load i64* %715, align 8
  %717 = getelementptr i8* %714, i64 %716
  store i8* %717, i8** %713, align 8
  %718 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:719                                     ; preds = %.backedge.i
  %720 = getelementptr inbounds i8* %"_2_DEKHash_$pc.0.0.i", i64 1
  %721 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 0, i32 0
  %722 = load i8** %721, align 8
  %723 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1
  %724 = bitcast %"union._2_DEKHash_$node"* %723 to i32*
  %725 = load i32* %724, align 4
  %726 = sext i32 %725 to i64
  %727 = getelementptr i8* %722, i64 %726
  %728 = getelementptr inbounds %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %727, i8** %728, align 8
  br label %.backedge.i

DEKHash.exit:                                     ; preds = %.backedge.i
  %729 = bitcast %"union._2_DEKHash_$node"* %"_2_DEKHash_$sp.0.0.i" to i32*
  %730 = load i32* %729, align 4
  %731 = icmp eq i32 %730, -566008905
  br i1 %731, label %732, label %733

; <label>:732                                     ; preds = %DEKHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %734

; <label>:733                                     ; preds = %DEKHash.exit
