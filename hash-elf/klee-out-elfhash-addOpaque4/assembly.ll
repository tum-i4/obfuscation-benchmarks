; ModuleID = './elfhash-addOpaque4.bc'
...
__str_to_int.exit19.i:                            ; preds = %59
  ...
  %70 = call fastcc i8* @__get_sym_str(i32 %67, i8* %1) #7, !dbg !2899
...
__str_to_int.exit45.i:                            ; preds = %145
  ...
  %155 = call i32 @klee_range(i32 %116, i32 %154, i8* getelementptr inbounds ([7 x i8]* @.str840, i64 0, i64 0)) #7, !dbg !2939
  %156 = icmp sgt i32 %155, 0, !dbg !2940
  br i1 %156, label %.lr.ph.i21, label %__streq.exit.thread.backedge.i, !dbg !2940

.lr.ph.i21:                                       ; preds = %__str_to_int.exit45.i
  %157 = sext i32 %23 to i64
  br label %158, !dbg !2940

; <label>:158                                     ; preds = %__add_arg.exit46.i, %.lr.ph.i21
  %indvars.iv.i = phi i64 [ %157, %.lr.ph.i21 ], [ %indvars.iv.next.i, %__add_arg.exit46.i ]
  %i.0151.i = phi i32 [ 0, %.lr.ph.i21 ], [ %169, %__add_arg.exit46.i ]
  %sym_arg_num.1150.i = phi i32 [ %sym_arg_num.0294.i, %.lr.ph.i21 ], [ %166, %__add_arg.exit46.i ]
  %159 = phi i32 [ %23, %.lr.ph.i21 ], [ %168, %__add_arg.exit46.i ]
  %160 = add i32 %sym_arg_num.1150.i, 48, !dbg !2942
  %161 = trunc i32 %160 to i8, !dbg !2942
  store i8 %161, i8* %20, align 1, !dbg !2942, !tbaa !2861
  %162 = call fastcc i8* @__get_sym_str(i32 %153, i8* %1) #7, !dbg !2944
...
__streq.exit.thread._crit_edge.i:                 ; preds = %__streq.exit.thread.backedge.i, %__streq.exit.thread.preheader.i
  ...
  %329 = call noalias i8* @malloc(i64 %328) #7, !dbg !3020
  %330 = bitcast i8* %329 to i8**, !dbg !3020
  call void @klee_mark_global(i8* %329) #7, !dbg !3021
...
__get_sym_file.exit.thread.i.i.i:                 ; preds = %340, %344, %__streq.exit.thread._crit_edge.i
  %357 = call i64 @klee_get_valuel(i64 ptrtoint ([2 x i8]* @.str80 to i64)) #7, !dbg !3052
  ...
  call void @klee_assume(i64 %360) #7, !dbg !3055
...
__concretize_string.exit.i.i.i:                   ; preds = %370, %367
  %380 = call i64 (i64, ...)* @syscall(i64 4, i8* getelementptr inbounds ([2 x i8]* @.str80, i64 0, i64 0), %struct.stat64.647* %s.i.i) #7, !dbg !3054
...
; <label>:383                                     ; preds = %__concretize_string.exit.i.i.i
  %384 = call i32 @klee_get_errno() #7, !dbg !3076
...
__fd_stat.exit.i.i:                               ; preds = %383, %__concretize_string.exit.i.i.i, %354
  ...
  %387 = call noalias i8* @malloc(i64 %386) #7, !dbg !3079
...
.lr.ph.preheader.i.i:                             ; preds = %__fd_stat.exit.i.i
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %388, i32 %sym_file_len.0.lcssa.i, i8* %335, %struct.stat64.647* %s.i.i) #7, !dbg !3084
...
._crit_edge2.i.i:                                 ; preds = %.lr.ph.preheader.i.i, %._crit_edge2.i.i
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %392, i32 %sym_file_len.0.lcssa.i, i8* %335, %struct.stat64.647* %s.i.i) #7, !dbg !3084
...
; <label>:394                                     ; preds = %._crit_edge.i.i
  %395 = call noalias i8* @malloc(i64 24) #7, !dbg !3087
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %396, i32 %sym_file_len.0.lcssa.i, i8* getelementptr inbounds ([6 x i8]* @.str110, i64 0, i64 0), %struct.stat64.647* %s.i.i) #7, !dbg !3090
...
; <label>:422                                     ; preds = %420
  %423 = call noalias i8* @malloc(i64 24) #7, !dbg !3119
  ...
  call fastcc void @__create_new_dfile(%struct.exe_disk_file_t* %424, i32 1024, i8* getelementptr inbounds ([7 x i8]* @.str716, i64 0, i64 0), %struct.stat64.647* %s.i.i) #7, !dbg !3122
...
; <label>:427                                     ; preds = %426, %422
  ...
  call void @klee_make_symbolic(i8* %428, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str817, i64 0, i64 0)) #7, !dbg !3133
  ...
  call void @klee_assume(i64 %431) #7, !dbg !3136
...
rand.exit:                                        ; preds = %427, %441
  ...
  %445 = tail call i8* @malloc(i64 16) #7
...
; <label>:463                                     ; preds = %463, %538
  %p.0.i = phi i8* [ %542, %538 ], [ %466, %463 ]
...
strlen.exit:                                      ; preds = %463
  ...
  %468 = ptrtoint i8* %542 to i64, !dbg !3156
  %469 = sub i64 %467, %468, !dbg !3156
  %470 = trunc i64 %469 to i32
  %471 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %472 = icmp eq %struct._1_main__opaque_Node_1* %471, %539
  br i1 %472, label %.lr.ph.lr.ph.i, label %.preheader.i

.lr.ph.lr.ph.i:                                   ; preds = %strlen.exit
  %473 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %474 = icmp eq %struct._1_main__opaque_Node_1* %473, %539
  %475 = icmp eq %struct._1_main__opaque_Node_1* %473, null
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.outer.i, %.lr.ph.lr.ph.i
  %.0.ph15.i = phi i8* [ %542, %.lr.ph.lr.ph.i ], [ %504, %.outer.i ]
  %i.0.ph14.i = phi i32 [ 0, %.lr.ph.lr.ph.i ], [ %505, %.outer.i ]
  %hash.0.ph13.i = phi i32 [ 0, %.lr.ph.lr.ph.i ], [ %503, %.outer.i ]
  %476 = icmp ult i32 %i.0.ph14.i, %470
  br i1 %474, label %.lr.ph.split.us.split.us.i.preheader, label %.lr.ph.split..lr.ph.split.split_crit_edge.i

.lr.ph.split.us.split.us.i.preheader:             ; preds = %.lr.ph.i
  br i1 %476, label %.lr.ph, label %ELFHash.exit

.lr.ph:                                           ; preds = %.lr.ph.split.us.split.us.i.preheader
  %477 = load i8* %.0.ph15.i, align 1
  %478 = sext i8 %477 to i32
  br i1 %475, label %.lr.ph.split.us, label %.lr.ph..lr.ph.split_crit_edge

.lr.ph.split.us:                                  ; preds = %.lr.ph, %.lr.ph.split.us.split.us.i.us
  %hash.07.us.us.i5.us = phi i32 [ %486, %.lr.ph.split.us.split.us.i.us ], [ %hash.0.ph13.i, %.lr.ph ]
  %i.08.us.us.i4.us = phi i32 [ %488, %.lr.ph.split.us.split.us.i.us ], [ %i.0.ph14.i, %.lr.ph ]
  %479 = shl i32 %hash.07.us.us.i5.us, 4
  %480 = add i32 %478, %479
  %481 = and i32 %480, -268435456
  %482 = icmp eq i32 %481, 0
  br i1 %482, label %.lr.ph.split.us.split.us.i.us, label %483

; <label>:483                                     ; preds = %.lr.ph.split.us
  %484 = lshr exact i32 %481, 24
  %485 = xor i32 %484, %480
  br label %.lr.ph.split.us.split.us.i.us

.lr.ph.split.us.split.us.i.us:                    ; preds = %.lr.ph.split.us, %483
  %hash.1.us.us.i.us = phi i32 [ %480, %.lr.ph.split.us ], [ %485, %483 ]
  %486 = shl i32 %hash.1.us.us.i.us, 7
  %487 = add i32 %i.08.us.us.i4.us, 1
  %488 = lshr i32 %487, %i.08.us.us.i4.us
  %489 = icmp ult i32 %488, %470
  br i1 %489, label %.lr.ph.split.us, label %ELFHash.exit

.lr.ph..lr.ph.split_crit_edge:                    ; preds = %.lr.ph
  %490 = shl i32 %hash.0.ph13.i, 4
  %491 = add i32 %478, %490
  %492 = and i32 %491, -268435456
  %493 = icmp eq i32 %492, 0
  br i1 %493, label %.outer.i, label %494

; <label>:494                                     ; preds = %.lr.ph..lr.ph.split_crit_edge
  %495 = lshr exact i32 %492, 24
  %496 = xor i32 %495, %491
  br label %.outer.i

.preheader.i:                                     ; preds = %strlen.exit, %.outer.i, %497, %.preheader.i
  br label %.preheader.i

.lr.ph.split..lr.ph.split.split_crit_edge.i:      ; preds = %.lr.ph.i
  br i1 %476, label %497, label %ELFHash.exit

; <label>:497                                     ; preds = %.lr.ph.split..lr.ph.split.split_crit_edge.i
  %498 = shl i32 %hash.0.ph13.i, 4
  %499 = load i8* %.0.ph15.i, align 1
  %500 = sext i8 %499 to i32
  %501 = add i32 %500, %498
  br i1 %475, label %.preheader.i, label %.outer.i

.outer.i:                                         ; preds = %.lr.ph..lr.ph.split_crit_edge, %494, %497
  %hash.1.lcssa.i = phi i32 [ %501, %497 ], [ %491, %.lr.ph..lr.ph.split_crit_edge ], [ %496, %494 ]
  %.lcssa.i = phi i32 [ %501, %497 ], [ %491, %.lr.ph..lr.ph.split_crit_edge ], [ %491, %494 ]
  %.not.i = or i32 %.lcssa.i, 268435455
  %502 = xor i32 %.not.i, -268435456
  %503 = and i32 %502, %hash.1.lcssa.i
  %504 = getelementptr inbounds i8* %.0.ph15.i, i64 1
  %505 = add i32 %i.0.ph14.i, 1
  br i1 %474, label %.lr.ph.i, label %.preheader.i

ELFHash.exit:                                     ; preds = %.lr.ph.split..lr.ph.split.split_crit_edge.i, %.lr.ph.split.us.split.us.i.preheader, %.lr.ph.split.us.split.us.i.us
  %hash.0.lcssa3.i = phi i32 [ %486, %.lr.ph.split.us.split.us.i.us ], [ %hash.0.ph13.i, %.lr.ph.split.us.split.us.i.preheader ], [ %hash.0.ph13.i, %.lr.ph.split..lr.ph.split.split_crit_edge.i ]
  %506 = icmp eq i32 %hash.0.lcssa3.i, 184139465
  br i1 %506, label %507, label %508

; <label>:507                                     ; preds = %ELFHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %509

; <label>:508                                     ; preds = %ELFHash.exit
...
; <label>:510                                     ; preds = %460, %452, %rand.exit
  %511 = load i32* %444, align 4, !dbg !3143
  %512 = load i32* %443, align 4, !dbg !3143
  %513 = add nsw i32 %512, %511, !dbg !3143
  store i32 %513, i32* %443, align 4, !dbg !3143
  %514 = lshr i32 %513, 1, !dbg !3144
  %515 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %516 = icmp ult i32* %515, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %517 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %516, label %518, label %rand.exit.1, !dbg !3146

; <label>:518                                     ; preds = %510
  %519 = icmp ult i32* %517, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %519, i32* %517, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %510, %518
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %510 ], [ %515, %518 ]
  %rptr.0.i.i.i.1 = phi i32* [ %517, %510 ], [ %..i.i.i.1, %518 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %520 = tail call i8* @malloc(i64 16) #7
  %521 = bitcast i8* %520 to %struct._1_main__opaque_Node_1*
  %522 = icmp eq i8* %520, null
  br i1 %522, label %538, label %523

; <label>:523                                     ; preds = %rand.exit.1
  %524 = bitcast i8* %520 to i32*
  store i32 %514, i32* %524, align 4
  %525 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %526 = icmp eq %struct._1_main__opaque_Node_1* %525, null
  br i1 %526, label %535, label %527

; <label>:527                                     ; preds = %523
  %528 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %529 = getelementptr inbounds %struct._1_main__opaque_Node_1* %528, i64 0, i32 1
  %530 = load %struct._1_main__opaque_Node_1** %529, align 8
  %531 = getelementptr inbounds i8* %520, i64 8
  %532 = bitcast i8* %531 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %530, %struct._1_main__opaque_Node_1** %532, align 8
  %533 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %534 = getelementptr inbounds %struct._1_main__opaque_Node_1* %533, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %521, %struct._1_main__opaque_Node_1** %534, align 8
  br label %538

; <label>:535                                     ; preds = %523
  %536 = getelementptr inbounds i8* %520, i64 8
  %537 = bitcast i8* %536 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %521, %struct._1_main__opaque_Node_1** %537, align 8
  store %struct._1_main__opaque_Node_1* %521, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %538

; <label>:538                                     ; preds = %535, %527, %rand.exit.1
  %539 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %539, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %540 = getelementptr inbounds i8* %329, i64 8
