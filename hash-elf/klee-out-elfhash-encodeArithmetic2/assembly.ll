; ModuleID = './elfhash-encodeArithmetic2.bc'
...
; <label>:442                                     ; preds = %494, %strlen.exit
  %hash.0.i = phi i32 [ 0, %strlen.exit ], [ %503, %494 ]
  %i.0.i = phi i32 [ 0, %strlen.exit ], [ %513, %494 ]
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %504, %494 ]
  %443 = or i32 %i.0.i, %441
  %444 = and i32 %i.0.i, %441
  %445 = sub i32 %443, %444
  %446 = sub i32 %i.0.i, %441
  %447 = or i32 %445, %446
  %448 = add i32 %i.0.i, -1
  %449 = sub i32 %448, %443
  %450 = sub i32 %444, %443
  ...
  br i1 %458, label %459, label %ELFHash.exit

; <label>:459                                     ; preds = %442
  %460 = shl i32 %hash.0.i, 4
  %461 = load i8* %.0.i, align 1
  %462 = sext i8 %461 to i32
  %.demorgan.i = and i32 %462, %460
  %463 = xor i32 %.demorgan.i, -1
  %464 = xor i32 %460, -1
  %465 = or i32 %462, %464
  %466 = sub i32 %465, %464
  %.neg5.i = add i32 %466, 1
  %467 = or i32 %460, 1
  %468 = add i32 %467, %462
  %469 = add i32 %468, %463
  %470 = add i32 %469, %.neg5.i
  %471 = add i32 %469, %466
  %472 = or i32 %471, 268435455
  %473 = sub i32 -268435455, %470
  %474 = add i32 %473, %472
  %475 = xor i32 %474, %471
  %476 = and i32 %474, %471
  %477 = shl i32 %476, 1
...
; <label>:494                                     ; preds = %481, %459
  %hash.1.i = phi i32 [ %493, %481 ], [ %471, %459 ]
  %.demorgan1.i = and i32 %hash.1.i, %479
  %495 = xor i32 %.demorgan1.i, -1
  %496 = add i32 %478, 2
  %497 = add i32 %496, %hash.1.i
  %498 = add i32 %497, %495
  %499 = sub i32 -2, %478
  %500 = and i32 %498, %499
  %501 = xor i32 %498, -1
  %502 = and i32 %479, %501
  %503 = sub i32 %500, %502
  %504 = getelementptr inbounds i8* %.0.i, i64 1
  %505 = xor i32 %i.0.i, -2
  %506 = shl i32 %i.0.i, 1
  %507 = and i32 %506, -4
  %508 = xor i32 %507, -4
...
ELFHash.exit:                                     ; preds = %442
  %514 = icmp eq i32 %hash.0.i, 184139465
  br i1 %514, label %515, label %516

; <label>:515                                     ; preds = %ELFHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %517

; <label>:516                                     ; preds = %ELFHash.exit
