; ModuleID = './elfhash-addOpaque-updateOpaque4.bc'
...
; <label>:464                                     ; preds = %464, %562
  %p.0.i = phi i8* [ %566, %562 ], [ %467, %464 ]
...
strlen.exit:                                      ; preds = %464
  ...
  %469 = ptrtoint i8* %566 to i64, !dbg !3156
  ...
  %476 = getelementptr inbounds %struct._1_main__opaque_Node_1* %563, i64 0, i32 1
  ...
  br i1 %478, label %525, label %.lr.ph.i3

.lr.ph.i3:                                        ; preds = %strlen.exit, %..lr.ph.i3_crit_edge
  %479 = phi i8* [ %524, %..lr.ph.i3_crit_edge ], [ %566, %strlen.exit ]
  %480 = phi %struct._1_main__opaque_Node_1* [ %.pre, %..lr.ph.i3_crit_edge ], [ %475, %strlen.exit ]
  %i.07.i = phi i32 [ %phitmp, %..lr.ph.i3_crit_edge ], [ 1, %strlen.exit ]
  %hash.06.i = phi i32 [ %523, %..lr.ph.i3_crit_edge ], [ 0, %strlen.exit ]
  %x.05.i = phi i32 [ %x.13.i, %..lr.ph.i3_crit_edge ], [ 0, %strlen.exit ]
  %481 = icmp eq %struct._1_main__opaque_Node_1* %480, null
  br i1 %481, label %497, label %482

; <label>:482                                     ; preds = %.lr.ph.i3
  %483 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %484 = icmp eq %struct._1_main__opaque_Node_1* %483, null
  br i1 %484, label %485, label %488

; <label>:485                                     ; preds = %482
  %486 = and i32 %x.05.i, -268435456
  call void @klee_div_zero_check(i64 5) #7
  %487 = udiv i32 %486, 5
  br label %503
...
; <label>:488                                     ; preds = %482
  ...
  br i1 %490, label %.thread.i, label %491

; <label>:491                                     ; preds = %488
  %492 = shl i32 %hash.06.i, 4
  %493 = load i8* %479, align 1
  %494 = sext i8 %493 to i32
  %495 = add i32 %494, %492
  %496 = and i32 %495, -268435456
  br label %503

; <label>:497                                     ; preds = %.lr.ph.i3
  %498 = shl i32 %hash.06.i, 4
  %499 = load i8* %479, align 1
  %500 = sext i8 %499 to i32
  %501 = add i32 %500, %498
  %int_cast_to_i641.i = zext i32 %hash.06.i to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641.i) #7
  %502 = udiv i32 %501, %hash.06.i
  br label %.thread.i

; <label>:503                                     ; preds = %491, %485
  %x.1.i = phi i32 [ %487, %485 ], [ %496, %491 ]
  %hash.1.i = phi i32 [ %x.05.i, %485 ], [ %495, %491 ]
  %504 = icmp eq i32 %x.1.i, 0
  br i1 %504, label %521, label %.thread.i

.thread.i:                                        ; preds = %503, %497, %488
  %hash.14.i = phi i32 [ %hash.1.i, %503 ], [ %502, %497 ], [ 4, %488 ]
  %x.12.i = phi i32 [ %x.1.i, %503 ], [ 4, %497 ], [ 4, %488 ]
  ...
  %511 = getelementptr inbounds %struct._1_main__opaque_Node_1* %507, i64 0, i32 1
  %512 = load %struct._1_main__opaque_Node_1** %511, align 8
  %513 = getelementptr inbounds %struct._1_main__opaque_Node_1* %510, i64 0, i32 1
  %514 = load %struct._1_main__opaque_Node_1** %513, align 8
  %515 = getelementptr inbounds %struct._1_main__opaque_Node_1* %512, i64 0, i32 1
  %516 = load %struct._1_main__opaque_Node_1** %515, align 8
  store %struct._1_main__opaque_Node_1* %516, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %517 = getelementptr inbounds %struct._1_main__opaque_Node_1* %514, i64 0, i32 1
  %518 = load %struct._1_main__opaque_Node_1** %517, align 8
  store %struct._1_main__opaque_Node_1* %518, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %519 = lshr i32 %x.12.i, 24
  %520 = xor i32 %519, %hash.14.i
  br label %521

; <label>:521                                     ; preds = %.thread.i, %503
  %x.13.i = phi i32 [ %x.12.i, %.thread.i ], [ 0, %503 ]
  %hash.2.i = phi i32 [ %520, %.thread.i ], [ %hash.1.i, %503 ]
  %522 = xor i32 %x.13.i, -1
  %523 = and i32 %hash.2.i, %522
  %524 = getelementptr inbounds i8* %479, i64 1
  store i8* %524, i8** %1, align 8
  %exitcond.i = icmp eq i32 %i.07.i, %471
  br i1 %exitcond.i, label %._crit_edge.i, label %..lr.ph.i3_crit_edge

..lr.ph.i3_crit_edge:                             ; preds = %521
  %.pre = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %phitmp = add i32 %i.07.i, 1
  br label %.lr.ph.i3
...
; <label>:525                                     ; preds = %._crit_edge.i, %strlen.exit
  %526 = phi %struct._1_main__opaque_Node_1* [ %.pre.i, %._crit_edge.i ], [ %477, %strlen.exit ]
  %hash.0.lcssa.i = phi i32 [ %523, %._crit_edge.i ], [ 0, %strlen.exit ]
  %527 = icmp eq %struct._1_main__opaque_Node_1* %526, null
  br i1 %527, label %528, label %ELFHash.exit

; <label>:528                                     ; preds = %525
  %529 = call fastcc i32 @__user_main(i32 3, i8** %1) #7
  br label %ELFHash.exit

ELFHash.exit:                                     ; preds = %525, %528
  %530 = icmp eq i32 %hash.0.lcssa.i, 184139465
  br i1 %530, label %531, label %532

; <label>:531                                     ; preds = %ELFHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %533

; <label>:532                                     ; preds = %ELFHash.exit
...
; <label>:534                                     ; preds = %461, %453, %rand.exit
  %535 = load i32* %445, align 4, !dbg !3143
  %536 = load i32* %444, align 4, !dbg !3143
  %537 = add nsw i32 %536, %535, !dbg !3143
  store i32 %537, i32* %444, align 4, !dbg !3143
  %538 = lshr i32 %537, 1, !dbg !3144
  %539 = getelementptr inbounds i32* %444, i64 1, !dbg !3145
  %540 = icmp ult i32* %539, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %541 = getelementptr inbounds i32* %445, i64 1, !dbg !3148
  br i1 %540, label %542, label %rand.exit.1, !dbg !3146

; <label>:542                                     ; preds = %534
  %543 = icmp ult i32* %541, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %543, i32* %541, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %534, %542
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %534 ], [ %539, %542 ]
  %rptr.0.i.i.i.1 = phi i32* [ %541, %534 ], [ %..i.i.i.1, %542 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %544 = tail call i8* @malloc(i64 16) #7
  %545 = bitcast i8* %544 to %struct._1_main__opaque_Node_1*
  %546 = icmp eq i8* %544, null
  br i1 %546, label %562, label %547

; <label>:547                                     ; preds = %rand.exit.1
  %548 = bitcast i8* %544 to i32*
  store i32 %538, i32* %548, align 4
  %549 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %550 = icmp eq %struct._1_main__opaque_Node_1* %549, null
...
; <label>:551                                     ; preds = %547
  ...
  %554 = load %struct._1_main__opaque_Node_1** %553, align 8
  %555 = getelementptr inbounds i8* %544, i64 8
  %556 = bitcast i8* %555 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %554, %struct._1_main__opaque_Node_1** %556, align 8
  %557 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %558 = getelementptr inbounds %struct._1_main__opaque_Node_1* %557, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %545, %struct._1_main__opaque_Node_1** %558, align 8
  br label %562

; <label>:559                                     ; preds = %547
  %560 = getelementptr inbounds i8* %544, i64 8
  %561 = bitcast i8* %560 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %545, %struct._1_main__opaque_Node_1** %561, align 8
  store %struct._1_main__opaque_Node_1* %545, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %562

; <label>:562                                     ; preds = %559, %551, %rand.exit.1
  %563 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %563, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %564 = getelementptr inbounds i8* %330, i64 8
