; ModuleID = './elfhash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i, label %ELFHash.exit.thread

.lr.ph.i:                                         ; preds = %strlen.exit, %463
  %.03.i = phi i8* [ %466, %463 ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %467, %463 ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %465, %463 ], [ 0, %strlen.exit ]
  %447 = shl i32 %hash.01.i, 4
  %448 = load i8* %.03.i, align 1
  %449 = sext i8 %448 to i32
  %450 = or i32 %449, %447
  %451 = and i32 %449, %447
  %452 = add i32 %450, %451
  %453 = or i32 %452, -268435456
  %454 = xor i32 %453, 268435455
  %455 = add i32 %452, 1
  %456 = add i32 %455, %454
  %457 = icmp eq i32 %456, 0
  br i1 %457, label %463, label %458

; <label>:458                                     ; preds = %.lr.ph.i
  %459 = lshr i32 %456, 24
  %460 = or i32 %459, %452
  %461 = and i32 %459, %452
  %462 = sub i32 %460, %461
...
; <label>:463                                     ; preds = %458, %.lr.ph.i
  %hash.1.i = phi i32 [ %462, %458 ], [ %452, %.lr.ph.i ]
  %464 = or i32 %hash.1.i, %456
  %465 = sub i32 %464, %456
  %466 = getelementptr inbounds i8* %.03.i, i64 1
  %467 = add i32 %i.02.i, 1
  %468 = add i32 %i.02.i, -2147483647
  %469 = and i32 %468, %441
  %470 = xor i32 %467, %442
  %471 = sub i32 %467, %441
  %472 = and i32 %471, %470
  ...
  br i1 %474, label %.lr.ph.i, label %ELFHash.exit

ELFHash.exit:                                     ; preds = %463
  %475 = icmp eq i32 %465, 184139465
  br i1 %475, label %476, label %ELFHash.exit.thread

; <label>:476                                     ; preds = %ELFHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %477

ELFHash.exit.thread:                              ; preds = %strlen.exit, %ELFHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %477

; <label>:477                                     ; preds = %ELFHash.exit.thread, %476
  ret i32 0
}
