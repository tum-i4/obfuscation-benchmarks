; ModuleID = './elfhash-addOpaque-updateOpaque1.bc'
...
define internal fastcc i32 @ELFHash(i8* nocapture readonly %str, i32 %len) #2 {
  %1 = icmp eq i32 %len, 0
  br i1 %1, label %._crit_edge, label %.lr.ph

._crit_edge:                                      ; preds = %21, %0
  %hash.0.lcssa = phi i32 [ 0, %0 ], [ %23, %21 ]
  %x.0.lcssa = phi i32 [ 0, %0 ], [ %10, %21 ]
...
; <label>:4                                       ; preds = %._crit_edge
  %5 = tail call fastcc i32 @ELFHash(i8* null, i32 %x.0.lcssa)
  ret i32 %hash.0.lcssa

.lr.ph:                                           ; preds = %0, %21
  %.03 = phi i8* [ %24, %21 ], [ %str, %0 ]
  %hash.02 = phi i32 [ %23, %21 ], [ 0, %0 ]
  %i.01 = phi i32 [ %25, %21 ], [ 0, %0 ]
  %6 = shl i32 %hash.02, 4
  %7 = load i8* %.03, align 1
  %8 = sext i8 %7 to i32
  %9 = add i32 %8, %6
...
; <label>:12                                      ; preds = %.lr.ph
  ...
  store %struct._1_main__opaque_Node_1* %18, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %19 = lshr exact i32 %10, 24
  %20 = xor i32 %19, %9
  br label %21

; <label>:21                                      ; preds = %.lr.ph, %12
  %hash.1 = phi i32 [ %20, %12 ], [ %9, %.lr.ph ]
  %.not = or i32 %9, 268435455
  %22 = xor i32 %.not, -268435456
  %23 = and i32 %hash.1, %22
  %24 = getelementptr inbounds i8* %.03, i64 1
  %25 = add i32 %i.01, 1
  %exitcond = icmp eq i32 %25, %len
