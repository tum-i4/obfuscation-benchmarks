...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %ELFHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %452
  %.03.i = phi i8* [ %455, %452 ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %456, %452 ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %454, %452 ], [ 0, %strlen.exit ]
  %443 = shl i32 %hash.01.i, 4
  %444 = load i8* %.03.i, align 1
...
; <label>:449                                     ; preds = %.lr.ph.i
  %450 = lshr exact i32 %447, 24
  %451 = xor i32 %450, %446
  br label %452

; <label>:452                                     ; preds = %449, %.lr.ph.i
  %hash.1.i = phi i32 [ %451, %449 ], [ %446, %.lr.ph.i ]
  %.not.i = or i32 %446, 268435455
  %453 = xor i32 %.not.i, -268435456
  %454 = and i32 %hash.1.i, %453
  %455 = getelementptr inbounds i8* %.03.i, i64 1
  %456 = add i32 %i.02.i, 1
  %exitcond.i = icmp eq i32 %456, %441
  br i1 %exitcond.i, label %ELFHash.exit, label %.lr.ph.i

ELFHash.exit:                                     ; preds = %452
  %457 = icmp eq i32 %454, 184139465
  br i1 %457, label %458, label %ELFHash.exit.thread
...
; <label>:459                                     ; preds = %ELFHash.exit.thread, %458
  ret i32 0
}
