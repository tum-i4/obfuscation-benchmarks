...
.outer.outer.i:                                   ; preds = %.split27.i, %strlen.exit
  %i.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %455, %.split27.i ]
  %x.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %x.0.ph363.i, %.split27.i ]
  %hash.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %453, %.split27.i ]
  %_1_ELFHash_next.0.ph.ph.i = phi i64 [ 8, %strlen.exit ], [ 6, %.split27.i ]
  %.0.ph.ph.i = phi i8* [ %433, %strlen.exit ], [ %454, %.split27.i ]
  br label %.outer.i

.outer.i:                                         ; preds = %.outer.i, %.outer.outer.i
  %i.0.ph.i = phi i32 [ %i.0.ph.ph.i, %.outer.outer.i ], [ 0, %.outer.i ]
  %x.0.ph.i = phi i32 [ %x.0.ph.ph.i, %.outer.outer.i ], [ 0, %.outer.i ]
  %hash.0.ph.i = phi i32 [ %hash.0.ph.ph.i, %.outer.outer.i ], [ 0, %.outer.i ]
  %_1_ELFHash_next.0.ph.i = phi i64 [ %_1_ELFHash_next.0.ph.ph.i, %.outer.outer.i ], [ 6, %.outer.i ]
  %442 = icmp eq i64 %_1_ELFHash_next.0.ph.i, 8
  br i1 %442, label %.outer.i, label %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.lr.ph.i

.outer11..outer11.split_crit_edge.lr.ph.lr.ph.lr.ph.i: ; preds = %.outer.i
  %443 = icmp ult i32 %i.0.ph.i, %441
  %..i = select i1 %443, i64 4, i64 0
  br label %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.i

.outer11..outer11.split_crit_edge.lr.ph.lr.ph.i:  ; preds = %.split18.i, %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.lr.ph.i
  %_1_ELFHash_next.0.ph565.i = phi i64 [ %_1_ELFHash_next.0.ph.i, %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.lr.ph.i ], [ 3, %.split18.i ]
  %hash.0.ph464.i = phi i32 [ %hash.0.ph.i, %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.lr.ph.i ], [ %449, %.split18.i ]
  %x.0.ph363.i = phi i32 [ %x.0.ph.i, %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.lr.ph.i ], [ %450, %.split18.i ]
  %444 = icmp eq i32 %x.0.ph363.i, 0
  %.1.i = select i1 %444, i64 1, i64 2
  %445 = lshr i32 %x.0.ph363.i, 24
  br label %.outer11..outer11.split_crit_edge.lr.ph.i

.outer11..outer11.split_crit_edge.lr.ph.i:        ; preds = %.split24.i, %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.i
  %_1_ELFHash_next.0.ph950.i = phi i64 [ %_1_ELFHash_next.0.ph565.i, %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.i ], [ 1, %.split24.i ]
  %hash.0.ph848.i = phi i32 [ %hash.0.ph464.i, %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.i ], [ %451, %.split24.i ]
  br label %.outer11..outer11.split_crit_edge.i

.outer11..outer11.split_crit_edge.i:              ; preds = %.split21.i, %.outer11..outer11.split_crit_edge.i, %.outer11..outer11.split_crit_edge.lr.ph.i
  %_1_ELFHash_next.0.ph1233.i = phi i64 [ %_1_ELFHash_next.0.ph950.i, %.outer11..outer11.split_crit_edge.lr.ph.i ], [ %.1.i, %.split21.i ], [ %..i, %.outer11..outer11.split_crit_edge.i ]
  switch i64 %_1_ELFHash_next.0.ph1233.i, label %infloop.i [
    i64 6, label %.outer11..outer11.split_crit_edge.i
    i64 4, label %.split18.i
    i64 3, label %.split21.i
    i64 2, label %.split24.i
    i64 1, label %.split27.i
    i64 0, label %ELFHash.exit
  ]

.split18.i:                                       ; preds = %.outer11..outer11.split_crit_edge.i
  %446 = shl i32 %hash.0.ph848.i, 4
  %447 = load i8* %.0.ph.ph.i, align 1
  %448 = sext i8 %447 to i32
  %449 = add i32 %448, %446
  %450 = and i32 %449, -268435456
  br label %.outer11..outer11.split_crit_edge.lr.ph.lr.ph.i

.split21.i:                                       ; preds = %.outer11..outer11.split_crit_edge.i
  br label %.outer11..outer11.split_crit_edge.i

.split24.i:                                       ; preds = %.outer11..outer11.split_crit_edge.i
  %451 = xor i32 %hash.0.ph848.i, %445
  br label %.outer11..outer11.split_crit_edge.lr.ph.i

.split27.i:                                       ; preds = %.outer11..outer11.split_crit_edge.i
  %452 = xor i32 %x.0.ph363.i, -1
  %453 = and i32 %hash.0.ph848.i, %452
  %454 = getelementptr inbounds i8* %.0.ph.ph.i, i64 1
  %455 = add i32 %i.0.ph.i, 1
  br label %.outer.outer.i

infloop.i:                                        ; preds = %.outer11..outer11.split_crit_edge.i, %infloop.i
  br label %infloop.i

ELFHash.exit:                                     ; preds = %.outer11..outer11.split_crit_edge.i
  %456 = icmp eq i32 %hash.0.ph848.i, 184139465
  br i1 %456, label %457, label %458

; <label>:457                                     ; preds = %ELFHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %459

; <label>:458                                     ; preds = %ELFHash.exit
