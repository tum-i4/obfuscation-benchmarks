...
.backedge.i:                                      ; preds = %480, %479, %474, %473, %470, %469, %468, %466, %465, %464, %458, %457, %456, %454, %453, %452, %451, %450, %449, %448, %447, %446, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  %_1_ELFHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_ELFHash_next.0.i, %.backedge.i ], [ %_1_ELFHash_next.0.i, %480 ], [ 6, %479 ], [ %_1_ELFHash_next.0.i, %474 ], [ 1, %473 ], [ %_1_ELFHash_next.0.i, %470 ], [ 1, %469 ], [ 2, %468 ], [ %_1_EL
  %i.0.i = phi i32 [ undef, %strlen.exit ], [ %i.0.i, %.backedge.i ], [ %i.0.i, %480 ], [ %i.0.i, %479 ], [ %478, %474 ], [ %i.0.i, %473 ], [ %i.0.i, %470 ], [ %i.0.i, %469 ], [ %i.0.i, %468 ], [ %i.0.i, %465 ], [ %i.0.i, %464 ], [ %i.0.i, %458 ], [ %i.0
  %x.0.i = phi i32 [ undef, %strlen.exit ], [ %x.0.i, %.backedge.i ], [ %x.0.i, %480 ], [ %x.0.i, %479 ], [ %x.0.i, %474 ], [ %x.0.i, %473 ], [ %x.0.i, %470 ], [ %x.0.i, %469 ], [ %x.0.i, %468 ], [ %x.0.i, %465 ], [ %x.0.i, %464 ], [ %463, %458 ], [ %x.0
  %hash.0.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.i, %.backedge.i ], [ %hash.0.i, %480 ], [ %hash.0.i, %479 ], [ %476, %474 ], [ %hash.0.i, %473 ], [ %472, %470 ], [ %hash.0.i, %469 ], [ %hash.0.i, %468 ], [ %hash.0.i, %465 ], [ %hash.0.i, %464 ],
  %_2_ELFHash_next.0.i = phi i64 [ 28, %strlen.exit ], [ %_2_ELFHash_next.0.i, %.backedge.i ], [ 2, %480 ], [ 26, %479 ], [ 5, %474 ], [ 26, %473 ], [ 8, %470 ], [ 26, %469 ], [ 26, %468 ], [ 13, %465 ], [ 26, %464 ], [ 16, %458 ], [ 26, %457 ], [ 26, %4
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %.0.i, %.backedge.i ], [ %.0.i, %480 ], [ %.0.i, %479 ], [ %477, %474 ], [ %.0.i, %473 ], [ %.0.i, %470 ], [ %.0.i, %469 ], [ %.0.i, %468 ], [ %.0.i, %465 ], [ %.0.i, %464 ], [ %.0.i, %458 ], [ %.0.i, %457 ], [
  switch i64 %_2_ELFHash_next.0.i, label %.backedge.i [
    i64 28, label %442
    i64 26, label %443
    i64 25, label %451
    i64 24, label %452
...
; <label>:443                                     ; preds = %.backedge.i
  switch i64 %_1_ELFHash_next.0.i, label %450 [
...
; <label>:466                                     ; preds = %.backedge.i
  %467 = icmp eq i32 %x.0.i, 0
  %.1.i = select i1 %467, i64 11, i64 12
  br label %.backedge.i
...
; <label>:470                                     ; preds = %.backedge.i
  %471 = lshr i32 %x.0.i, 24
  %472 = xor i32 %hash.0.i, %471
  br label %.backedge.i
...
; <label>:474                                     ; preds = %.backedge.i
  %475 = xor i32 %x.0.i, -1
  %476 = and i32 %hash.0.i, %475
  %477 = getelementptr inbounds i8* %.0.i, i64 1
  %478 = add i32 %i.0.i, 1
  br label %.backedge.i

; <label>:479                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:480                                     ; preds = %.backedge.i
  br label %.backedge.i

ELFHash.exit:                                     ; preds = %.backedge.i
  %481 = icmp eq i32 %hash.0.i, 184139465
  br i1 %481, label %482, label %483

; <label>:482                                     ; preds = %ELFHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %484

; <label>:483                                     ; preds = %ELFHash.exit
