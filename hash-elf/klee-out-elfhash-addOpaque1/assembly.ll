; ModuleID = './elfhash-addOpaque1.bc'
...
; <label>:463                                     ; preds = %463, %519
  %p.0.i = phi i8* [ %523, %519 ], [ %466, %463 ]
...
.lr.ph.i:                                         ; preds = %strlen.exit
  ...
  %474 = icmp eq %struct._1_main__opaque_Node_1* %473, %520
  %475 = icmp eq i32 %470, 0
  br i1 %474, label %.lr.ph.split.us.i.preheader, label %.lr.ph..lr.ph.split_crit_edge.i

.lr.ph.split.us.i.preheader:                      ; preds = %.lr.ph.i
  br i1 %475, label %ELFHash.exit.thread, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph.split.us.i
  %hash.02.us.i4 = phi i32 [ %486, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %i.03.us.i3 = phi i32 [ %488, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %.04.us.i2 = phi i8* [ %487, %.lr.ph.split.us.i ], [ %523, %.lr.ph.split.us.i.preheader ]
  %476 = shl i32 %hash.02.us.i4, 4
  %477 = load i8* %.04.us.i2, align 1
  %478 = sext i8 %477 to i32
  %479 = add i32 %478, %476
  %480 = and i32 %479, -268435456
  %481 = icmp eq i32 %480, 0
  br i1 %481, label %.lr.ph.split.us.i, label %482

; <label>:482                                     ; preds = %.lr.ph
  %483 = lshr exact i32 %480, 24
  %484 = xor i32 %483, %479
  br label %.lr.ph.split.us.i

.lr.ph.split.us.i:                                ; preds = %482, %.lr.ph
  %hash.1.us.i = phi i32 [ %484, %482 ], [ %479, %.lr.ph ]
  %.not.us.i = or i32 %479, 268435455
  %485 = xor i32 %.not.us.i, -268435456
  %486 = and i32 %hash.1.us.i, %485
  %487 = getelementptr inbounds i8* %.04.us.i2, i64 1
  %488 = add i32 %i.03.us.i3, 1
  %exitcond = icmp eq i32 %488, %470
  br i1 %exitcond, label %.lr.ph.split.us.i.ELFHash.exit_crit_edge, label %.lr.ph

.preheader.i:                                     ; preds = %.lr.ph..lr.ph.split_crit_edge.i, %strlen.exit, %.preheader.i
  br label %.preheader.i

.lr.ph..lr.ph.split_crit_edge.i:                  ; preds = %.lr.ph.i
  br i1 %475, label %ELFHash.exit.thread, label %.preheader.i

.lr.ph.split.us.i.ELFHash.exit_crit_edge:         ; preds = %.lr.ph.split.us.i
  %phitmp = icmp eq i32 %486, 184139465
  br i1 %phitmp, label %489, label %ELFHash.exit.thread

; <label>:489                                     ; preds = %.lr.ph.split.us.i.ELFHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %490

ELFHash.exit.thread:                              ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph..lr.ph.split_crit_edge.i, %.lr.ph.split.us.i.ELFHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %490

; <label>:490                                     ; preds = %ELFHash.exit.thread, %489
  ret i32 0

; <label>:491                                     ; preds = %460, %452, %rand.exit
  %492 = load i32* %444, align 4, !dbg !3143
  %493 = load i32* %443, align 4, !dbg !3143
  %494 = add nsw i32 %493, %492, !dbg !3143
  store i32 %494, i32* %443, align 4, !dbg !3143
  %495 = lshr i32 %494, 1, !dbg !3144
  %496 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %497 = icmp ult i32* %496, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %498 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %497, label %499, label %rand.exit.1, !dbg !3146

; <label>:499                                     ; preds = %491
  %500 = icmp ult i32* %498, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %500, i32* %498, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %491, %499
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %491 ], [ %496, %499 ]
  %rptr.0.i.i.i.1 = phi i32* [ %498, %491 ], [ %..i.i.i.1, %499 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %501 = tail call i8* @malloc(i64 16) #7
  %502 = bitcast i8* %501 to %struct._1_main__opaque_Node_1*
  %503 = icmp eq i8* %501, null
  br i1 %503, label %519, label %504

; <label>:504                                     ; preds = %rand.exit.1
  %505 = bitcast i8* %501 to i32*
  store i32 %495, i32* %505, align 4
  %506 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %507 = icmp eq %struct._1_main__opaque_Node_1* %506, null
  br i1 %507, label %516, label %508

; <label>:508                                     ; preds = %504
  %509 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  ...
  %512 = getelementptr inbounds i8* %501, i64 8
  %513 = bitcast i8* %512 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %511, %struct._1_main__opaque_Node_1** %513, align 8
  %514 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %515 = getelementptr inbounds %struct._1_main__opaque_Node_1* %514, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %502, %struct._1_main__opaque_Node_1** %515, align 8
  br label %519

; <label>:516                                     ; preds = %504
  %517 = getelementptr inbounds i8* %501, i64 8
  %518 = bitcast i8* %517 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %502, %struct._1_main__opaque_Node_1** %518, align 8
  store %struct._1_main__opaque_Node_1* %502, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %519

; <label>:519                                     ; preds = %516, %508, %rand.exit.1
  %520 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %520, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %521 = getelementptr inbounds i8* %329, i64 8
  %522 = bitcast i8* %521 to i8**
  %523 = load i8** %522, align 8
