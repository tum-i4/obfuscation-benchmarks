...
{ 
  ...
  while (1) {
    ...
    if ((i < len) >= randomVars_BogusReturn38) {
      {  /* __blockattribute__(__ATOMIC__)*/ 
      ...
      if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
        while (((_1_main__opaque_list1_1 != (struct _1_main__opaque_Node_1 *)0UL) > randomVars_BogusReturn38) >= randomVars_BogusReturn38) {
    ...
    if (x != 0U) {
      ...
      if (_1_main__opaque_list1_1 != _1_main__opaque_list2_1) {
        __asm__  volatile   (".byte 0x24,0x5a,0xfb,0xcb,0x85":);
      } else {
        {  /* __blockattribute__(__ATOMIC__)*/ 
        _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
        _1_main__opaque_list2_1 = _1_main__opaque_list2_1->next;
      ...
      if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
        __asm__  volatile   (".byte 0x74,0x88,0xd2,0x66,0xb5,0xa0,0x8d,0xf7":);
      } else {
        {  /* __blockattribute__(__ATOMIC__)*/ 
        _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
        _1_main__opaque_list2_1 = _1_main__opaque_list2_1->next;
      ...
      if (_1_main__opaque_list1_1 != _1_main__opaque_list2_1) {
        __asm__  volatile   (".byte 0x30,0xc0,0xe8,0x82,0x31,0x0,0x0":);
      } else {
        {  /* __blockattribute__(__ATOMIC__)*/ 
        _1_main__opaque_list1_1 = _1_main__opaque_list1_1->next;
        _1_main__opaque_list2_1 = _1_main__opaque_list2_1->next;
      ...
      if (_1_main__opaque_list2_1 == (struct _1_main__opaque_Node_1 *)0UL) {
        if (_1_main__opaque_list1_1 == (struct _1_main__opaque_Node_1 *)0UL) {
          ...
          randomVars_BogusReturn38 = main(1, & str);
        }
      } else {
