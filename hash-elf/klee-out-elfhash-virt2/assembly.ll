...
%"union._2_ELFHash_$node" = type { i8* }
...
@"_2_ELFHash_$array" = internal unnamed_addr constant [1 x [11180 x i8]] [[11180 x i8] c"\CF\00\00\00\00\00\00\00\00\0E\08\00\00\00\00\00\00\00\0E\00\00\00\00\00\00\00\00Q\1E\0E\00\01\00\00\00\00\00\00\0E\00\00\00\00\00\00\00\00Q\1E\81\18\00\00\006\CF\00
@"_1_ELFHash_$array" = internal global [1 x [274 x i8]] [[274 x i8] c"U\0C\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\14\00\00\00\07\F0<\0E\00\00
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_ELFHash_$locals.i" = alloca [312 x i8], align 16
  %"_2_ELFHash_$stack.i" = alloca [1 x [32 x %"union._2_ELFHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [312 x i8]* %"_2_ELFHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_ELFHash_$node"]]* %"_2_ELFHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_ELFHash_$node"]]* %"_2_ELFHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %777, %771, %765, %759, %750, %742, %735, %729, %720, %712, %706, %697, %691, %684, %676, %673, %661, %653, %645, %636, %629, %622, %620, %614, %607, %605, %599, %590, %588, %580, %573, %564, %5
  %"_2_ELFHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [11180 x i8]]* @"_2_ELFHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_ELFHash_$pc.0.0.i", %.backedge.i ], [ %778, %777 ], [ %772, %771 ], [ %766, %765 ], [ %760, %759 ], [ %75
  %"_2_ELFHash_$sp.0.0.i" = phi %"union._2_ELFHash_$node"* [ %448, %strlen.exit ], [ %"_2_ELFHash_$sp.0.0.i", %.backedge.i ], [ %"_2_ELFHash_$sp.0.0.i", %777 ], [ %"_2_ELFHash_$sp.0.0.i", %771 ], [ %"_2_ELFHash_$sp.0.0.i", %765 ], [ %"_2_ELFHash_$sp.0.0.
  %449 = load i8* %"_2_ELFHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %453 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %454 = load i32* %453, align 4
  %455 = sext i32 %454 to i64
  %456 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %.c7.i = inttoptr i64 %455 to i8*
  store i8* %.c7.i, i8** %456, align 8
  br label %.backedge.i

; <label>:457                                     ; preds = %.backedge.i
  %458 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %459 = bitcast i8* %458 to i32*
  %460 = load i32* %459, align 4
  %461 = sext i32 %460 to i64
  %462 = getelementptr inbounds [312 x i8]* %"_2_ELFHash_$locals.i", i64 0, i64 %461
  %463 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1, i32 0
  store i8* %462, i8** %463, align 8
  %464 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1
  %465 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:466                                     ; preds = %.backedge.i
  %467 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %468 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i8*
  %469 = load i8* %468, align 1
  %470 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  %471 = load i8** %470, align 8
  store i8 %469, i8* %471, align 1
  %472 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:473                                     ; preds = %.backedge.i
  %474 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %475 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %476 = load i32* %475, align 4
  %477 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %478 = bitcast %"union._2_ELFHash_$node"* %477 to i32*
...
; <label>:481                                     ; preds = %.backedge.i
  %482 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %483 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %484 = load i32* %483, align 4
  %485 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %486 = bitcast i8* %482 to i32*
  %487 = load i32* %486, align 4
  %488 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 9
  %489 = bitcast i8* %488 to i32*
  %490 = load i32* %489, align 4
  %491 = icmp slt i32 %484, %487
  br i1 %491, label %492, label %495

; <label>:492                                     ; preds = %481
  %493 = sext i32 %490 to i64
  %.sum12.i = add i64 %493, 1
  %494 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 %.sum12.i
  br label %.backedge.i

; <label>:495                                     ; preds = %481
  %496 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 5
  %497 = bitcast i8* %496 to i32*
  %498 = load i32* %497, align 4
  %499 = icmp sgt i32 %484, %498
  br i1 %499, label %500, label %503

; <label>:500                                     ; preds = %495
  %501 = sext i32 %490 to i64
  %.sum11.i = add i64 %501, 1
  %502 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 %.sum11.i
  br label %.backedge.i

; <label>:503                                     ; preds = %495
  %504 = sub nsw i32 %484, %487
  %505 = shl nsw i32 %504, 2
  %506 = sext i32 %505 to i64
  %.sum9.i = add i64 %506, 13
  %507 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 %.sum9.i
  %508 = bitcast i8* %507 to i32*
  %509 = load i32* %508, align 4
  %510 = sext i32 %509 to i64
  %.sum10.i = add i64 %510, 1
  %511 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 %.sum10.i
  br label %.backedge.i

; <label>:512                                     ; preds = %.backedge.i
  %513 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %514 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %515 = bitcast %"union._2_ELFHash_$node"* %514 to i32*
  %516 = load i32* %515, align 4
  %517 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %518 = load i8** %517, align 8
  %519 = bitcast i8* %518 to i32*
  store i32 %516, i32* %519, align 4
  %520 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:521                                     ; preds = %.backedge.i
  %522 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %523 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %524 = bitcast %"union._2_ELFHash_$node"* %523 to i32*
  %525 = load i32* %524, align 4
  %526 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %527 = load i32* %526, align 4
  %528 = xor i32 %527, %525
  store i32 %528, i32* %524, align 4
  br label %.backedge.i

; <label>:529                                     ; preds = %.backedge.i
  %530 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %531 = load i32* %530, align 4
  %532 = icmp eq i32 %531, 0
  br i1 %532, label %539, label %533

; <label>:533                                     ; preds = %529
  %534 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %535 = bitcast i8* %534 to i32*
  %536 = load i32* %535, align 4
  %537 = sext i32 %536 to i64
  %.sum8.i = add i64 %537, 1
  %538 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 %.sum8.i
  br label %541

; <label>:539                                     ; preds = %529
  %540 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 5
  br label %541

; <label>:541                                     ; preds = %539, %533
  %"_2_ELFHash_$pc.0.1.i" = phi i8* [ %540, %539 ], [ %538, %533 ]
  %542 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:543                                     ; preds = %.backedge.i
  %544 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %545 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %546 = load i8** %545, align 8
  %547 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %548 = bitcast %"union._2_ELFHash_$node"* %547 to i32*
  %549 = load i32* %548, align 4
  %550 = sext i32 %549 to i64
  %551 = getelementptr i8* %546, i64 %550
  %552 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %551, i8** %552, align 8
  br label %.backedge.i

; <label>:553                                     ; preds = %.backedge.i
  %554 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
...
; <label>:557                                     ; preds = %553
  %558 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %558, align 8
  br label %561

; <label>:559                                     ; preds = %553
  %560 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %560, align 8
  br label %561

; <label>:561                                     ; preds = %559, %557, %553
  %562 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1
  %563 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:564                                     ; preds = %.backedge.i
  %565 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %566 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %567 = bitcast %"union._2_ELFHash_$node"* %566 to i32*
  %568 = load i32* %567, align 4
  %569 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
...
; <label>:573                                     ; preds = %.backedge.i
  %574 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %575 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %576 = load i8** %575, align 8
  %577 = bitcast i8* %576 to i32*
  %578 = load i32* %577, align 4
  %579 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  store i32 %578, i32* %579, align 4
  br label %.backedge.i

; <label>:580                                     ; preds = %.backedge.i
  %581 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %582 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i64*
  %583 = load i64* %582, align 8
  %584 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  %585 = load i8** %584, align 8
  %586 = bitcast i8* %585 to i64*
  store i64 %583, i64* %586, align 8
  %587 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:588                                     ; preds = %.backedge.i
  %589 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:590                                     ; preds = %.backedge.i
  %591 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %592 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i64*
  %593 = load i64* %592, align 8
  %594 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %595 = bitcast %"union._2_ELFHash_$node"* %594 to i64*
  %596 = load i64* %595, align 8
  %597 = mul i64 %596, %593
  %598 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  %.c5.i = inttoptr i64 %597 to i8*
  store i8* %.c5.i, i8** %598, align 8
  br label %.backedge.i

; <label>:599                                     ; preds = %.backedge.i
  %600 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %601 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %602 = load i8** %601, align 8
  %603 = bitcast i8* %602 to i8**
  %604 = load i8** %603, align 8
  store i8* %604, i8** %601, align 8
  br label %.backedge.i

; <label>:605                                     ; preds = %.backedge.i
  %606 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:607                                     ; preds = %.backedge.i
  %608 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %609 = bitcast i8* %608 to i8**
  %610 = load i8** %609, align 8
  %611 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1, i32 0
  store i8* %610, i8** %611, align 8
  %612 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1
  %613 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:614                                     ; preds = %.backedge.i
  %615 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %616 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %617 = load i8** %616, align 8
  %618 = load i8* %617, align 1
  %619 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i8*
  store i8 %618, i8* %619, align 1
  br label %.backedge.i

; <label>:620                                     ; preds = %.backedge.i
  %621 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:622                                     ; preds = %.backedge.i
  %623 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %624 = bitcast i8* %623 to i32*
  %625 = load i32* %624, align 4
  %626 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1
  %627 = bitcast %"union._2_ELFHash_$node"* %626 to i32*
  store i32 %625, i32* %627, align 4
  %628 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:629                                     ; preds = %.backedge.i
  %630 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %631 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %632 = load i8** %631, align 8
  %633 = bitcast i8* %632 to i32*
  %634 = load i32* %633, align 4
  %635 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  store i32 %634, i32* %635, align 4
  br label %.backedge.i

; <label>:636                                     ; preds = %.backedge.i
  %637 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %638 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %639 = bitcast %"union._2_ELFHash_$node"* %638 to i64*
  %640 = load i64* %639, align 8
  %641 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i64*
  %642 = load i64* %641, align 8
  %643 = and i64 %642, %640
  %644 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  %.c4.i = inttoptr i64 %643 to i8*
  store i8* %.c4.i, i8** %644, align 8
  br label %.backedge.i

; <label>:645                                     ; preds = %.backedge.i
  %646 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %647 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  %648 = load i8** %647, align 8
  %649 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %650 = load i8** %649, align 8
  %651 = bitcast i8* %650 to i8**
  store i8* %648, i8** %651, align 8
  %652 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:653                                     ; preds = %.backedge.i
  %654 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %655 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i64*
  %656 = load i64* %655, align 8
  %657 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  %658 = load i8** %657, align 8
  %659 = bitcast i8* %658 to i64*
  store i64 %656, i64* %659, align 8
  %660 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:661                                     ; preds = %.backedge.i
  %662 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %663 = bitcast i8* %662 to i32*
  %664 = load i32* %663, align 4
  %665 = sext i32 %664 to i64
  %.sum.i = add i64 %665, 1
  %666 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:667                                     ; preds = %.backedge.i
  %668 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %669 = bitcast i8* %668 to i32*
  %670 = load i32* %669, align 4
  %cond.i = icmp eq i32 %670, 0
  br i1 %cond.i, label %671, label %673

; <label>:671                                     ; preds = %667
  %672 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [274 x i8]]* @"_1_ELFHash_$array", i64 0, i64 0, i64 0), i8** %672, align 8
  br label %673

; <label>:673                                     ; preds = %671, %667
  %674 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1
  %675 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:676                                     ; preds = %.backedge.i
  %677 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %678 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %679 = load i32* %678, align 4
  %680 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %681 = bitcast %"union._2_ELFHash_$node"* %680 to i32*
  %682 = load i32* %681, align 4
  %683 = add i32 %682, %679
  store i32 %683, i32* %681, align 4
  br label %.backedge.i

; <label>:684                                     ; preds = %.backedge.i
  %685 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %686 = bitcast i8* %685 to i64*
  %687 = load i64* %686, align 8
  %688 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1, i32 0
  %.c3.i = inttoptr i64 %687 to i8*
  store i8* %.c3.i, i8** %688, align 8
  %689 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1
  %690 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:691                                     ; preds = %.backedge.i
  %692 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %693 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i8*
  %694 = load i8* %693, align 1
  %695 = zext i8 %694 to i32
  %696 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  store i32 %695, i32* %696, align 4
  br label %.backedge.i

; <label>:697                                     ; preds = %.backedge.i
  %698 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %699 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %700 = load i8** %699, align 8
  %701 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %702 = bitcast %"union._2_ELFHash_$node"* %701 to i64*
  %703 = load i64* %702, align 8
  %704 = getelementptr i8* %700, i64 %703
  %705 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %704, i8** %705, align 8
  br label %.backedge.i

; <label>:706                                     ; preds = %.backedge.i
  %707 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %708 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %709 = load i8** %708, align 8
  %710 = bitcast i8* %709 to i64*
  %711 = load i64* %710, align 8
  %.c2.i = inttoptr i64 %711 to i8*
  store i8* %.c2.i, i8** %708, align 8
  br label %.backedge.i

; <label>:712                                     ; preds = %.backedge.i
  %713 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %714 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %715 = load i32* %714, align 4
  %716 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %717 = bitcast %"union._2_ELFHash_$node"* %716 to i32*
  %718 = load i32* %717, align 4
  %719 = shl i32 %715, %718
  store i32 %719, i32* %717, align 4
  br label %.backedge.i

; <label>:720                                     ; preds = %.backedge.i
  %721 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %722 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %723 = bitcast %"union._2_ELFHash_$node"* %722 to i32*
  %724 = load i32* %723, align 4
  %725 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %726 = load i8** %725, align 8
  %727 = bitcast i8* %726 to i32*
  store i32 %724, i32* %727, align 4
  %728 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:729                                     ; preds = %.backedge.i
  %730 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %731 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %732 = load i8** %731, align 8
  %733 = bitcast i8* %732 to i64*
  %734 = load i64* %733, align 8
  %.c1.i = inttoptr i64 %734 to i8*
  store i8* %.c1.i, i8** %731, align 8
  br label %.backedge.i

; <label>:735                                     ; preds = %.backedge.i
  %736 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %737 = bitcast i8* %736 to i32*
  %738 = load i32* %737, align 4
  %739 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 1
  %740 = bitcast %"union._2_ELFHash_$node"* %739 to i32*
  store i32 %738, i32* %740, align 4
  %741 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:742                                     ; preds = %.backedge.i
  %743 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %744 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %745 = bitcast %"union._2_ELFHash_$node"* %744 to i32*
  %746 = load i32* %745, align 4
  %747 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %748 = load i32* %747, align 4
  %749 = and i32 %748, %746
  store i32 %749, i32* %745, align 4
  br label %.backedge.i

; <label>:750                                     ; preds = %.backedge.i
  %751 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %752 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %753 = load i32* %752, align 4
  %754 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 -1
  %755 = bitcast %"union._2_ELFHash_$node"* %754 to i32*
  %756 = load i32* %755, align 4
  %757 = icmp ult i32 %753, %756
  %758 = zext i1 %757 to i32
  store i32 %758, i32* %755, align 4
  br label %.backedge.i

; <label>:759                                     ; preds = %.backedge.i
  %760 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %761 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i8*
  %762 = load i8* %761, align 1
  %763 = sext i8 %762 to i32
  %764 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  store i32 %763, i32* %764, align 4
  br label %.backedge.i

; <label>:765                                     ; preds = %.backedge.i
  %766 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %767 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %768 = load i32* %767, align 4
  %769 = zext i32 %768 to i64
  %770 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %.c.i = inttoptr i64 %769 to i8*
  store i8* %.c.i, i8** %770, align 8
  br label %.backedge.i

; <label>:771                                     ; preds = %.backedge.i
  %772 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %773 = getelementptr inbounds %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i", i64 0, i32 0
  %774 = load i8** %773, align 8
  %775 = load i8* %774, align 1
  %776 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i8*
  store i8 %775, i8* %776, align 1
  br label %.backedge.i

; <label>:777                                     ; preds = %.backedge.i
  %778 = getelementptr inbounds i8* %"_2_ELFHash_$pc.0.0.i", i64 1
  %779 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i64*
  %780 = load i64* %779, align 8
  %781 = trunc i64 %780 to i32
  %782 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  store i32 %781, i32* %782, align 4
  br label %.backedge.i

ELFHash.exit:                                     ; preds = %.backedge.i
  %783 = bitcast %"union._2_ELFHash_$node"* %"_2_ELFHash_$sp.0.0.i" to i32*
  %784 = load i32* %783, align 4
  %785 = icmp eq i32 %784, 184139465
  br i1 %785, label %786, label %787

; <label>:786                                     ; preds = %ELFHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %788

; <label>:787                                     ; preds = %ELFHash.exit
