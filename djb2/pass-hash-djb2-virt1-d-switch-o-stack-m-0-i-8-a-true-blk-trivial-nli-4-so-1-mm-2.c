...
{ 
  ...
  while (1) {
    ...
    switch (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL ? *(_4_main_$pc[0]) : *(_4_main_$pc[0]) | 2) {
    ...
    if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) > argc) {
      ...
      while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) <= _4_main_$select) {
        if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main__alwaysOne) {
          (_4_main_$sp[0] + 0)->_unsigned_long = ((unsigned long )(_4_main_$sp[0] + 0)->_int / 7) % c;
        } else {
    ...
    if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
      if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
        ...
        if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < i7) {
          (_4_main_$sp[0] + 0)->_int = (int )(_4_main_$sp[0] + 0)->_unsigned_long / i7 ^ 9;
        } else {
      ...
      while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) < argc) {
        if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) != _4_main__alwaysOne) {
          if (((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) >= argc) > r8) {
            ...
            while (1) {
              if ((((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) < r8) <= r8) > _4_main__alwaysOne) {
        ...
        if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) < argc) {
          ...
          while ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) != _4_main_$select) {
            if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) >= r8) {
              (_4_main_$sp[0] + -1)->_unsigned_long = ((_4_main_$sp[0] + -1)->_unsigned_long * (_4_main_$sp[0] + 0)->_unsigned_long << c) << 2;
              _4_main_$sp[0] = ((_4_main_$sp[0] + -1) - 1) - -1;
            } else {
              (_4_main_$sp[0] + -1)->_unsigned_long = c;
              _4_main_$sp[0] = (_4_main_$sp[0] + -1) + 1;
        ...
        while ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < i7) {
          if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) != r8) {
            while (((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) == argc) <= argc) {
              while (1) {
                if ((((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) >= argc) > i7) != i7) {
          ...
          if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) != _4_main_$select) {
            (_4_main_$sp[0] + 0)->_unsigned_long = 2UL * c;
          } else {
        ...
        if (((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) != r8) == _4_main__alwaysOne) {
          if (((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) < _4_main_$select) > _4_main_$select) {
            if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) != _4_main_$select) < _4_main__alwaysOne) {
              (_4_main_$sp[0] + 0)->_unsigned_long = 4UL - 1;
            } else {
            ...
            while (1) {
              ...
              (_4_main_$sp[0] + 0)->_unsigned_long = (*((unsigned long *)(_4_main_$sp[0] + 0)->_void_star) / c | hash) * 6;
            }
          }
        } else {
          while (1) {
            ...
            while (1) {
              if (((((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) >= argc) > i7) != i7) < r8) {
                return (r8 / 4 << i7);
              } else {
    ...
    if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == argc) {
      ...
      while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) == argc) {
        ...
        while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) <= argc) {
          if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main_$select) {
            (_4_main_$sp[0] + 0)->_unsigned_long = 2UL ^ hash;
          } else {
          ...
          if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
            if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
              ...
              if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) > i7) {
                (_4_main_$sp[0] + -1)->_unsigned_long = (((_4_main_$sp[0] + 0)->_unsigned_long & (_4_main_$sp[0] + -1)->_unsigned_long) - 2) & hash;
                _4_main_$sp[0] = ((_4_main_$sp[0] + -1) + 1) - 1;
              } else {
                (_4_main_$sp[0] + -1)->_unsigned_long = 6UL;
                _4_main_$sp[0] = (_4_main_$sp[0] + -1) - -1;
    ...
    if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
      ...
      if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) >= r8) {
        (_4_main_$sp[0] + 0)->_unsigned_long = ((unsigned long )(_4_main_$sp[0] + 0)->_unsigned_char ^ 1) << hash;
      } else {
