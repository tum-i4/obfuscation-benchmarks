...
{ 
  ...
  while (1) {
    ...
    while (randomFuns_body_i25 < 4) {
      randomFuns_n24 = 1;
      while (randomFuns_n24 < 1905681) {
        _4_main__alwaysOne ++;
        randomFuns_n24 += 5810;
      }
      _4_main__alwaysOne -= 328;
      randomFuns_body_i25 ++;
    }
    ...
    if (_4_main_$currentOp == _4_main__load_unsigned_char$left_STA_0$result_STA_0) {
      ...
      if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
        ...
        if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) < r8) {
          ...
          (_4_main_$sp[0] + 0)->_unsigned_char = *((unsigned char *)(_4_main_$sp[0] + 0)->_void_star) / 9;
        }
      } else
            ...
            if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) < argc) {
              while (1) {
                ...
                while (1) {
                  ...
                  (_4_main_$sp[0] + -1)->_unsigned_long = (((_4_main_$sp[0] + 0)->_unsigned_long + (_4_main_$sp[0] + -1)->_unsigned_long) % 6) % 2;
                  _4_main_$sp[0] = ((_4_main_$sp[0] + -1) - 1) - -1;
                }
              }
            } else
          ...
          if (((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) < argc) <= r8) {
            ...
            while (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < _4_main_$select) >= _4_main__alwaysOne) {
              while (1) {
                ...
                (_4_main_$sp[0] + -1)->_unsigned_long = c % c | 1;
            ...
            while (1) {
              ...
              while (1) {
                ...
                (_4_main_$sp[0] + -1)->_unsigned_long = (((_4_main_$sp[0] + 0)->_unsigned_long + (_4_main_$sp[0] + -1)->_unsigned_long) % 6) % 2 - c;
                _4_main_$sp[0] = (((_4_main_$sp[0] + -1) - 1) - -1) + -1;
              }
            }
          }
          ...
          if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) < i7) {
            while (1) {
              ...
              while (1) {
                ...
                (_4_main_$sp[0] + -1)->_unsigned_long = ((_4_main_$sp[0] + 0)->_unsigned_long + (_4_main_$sp[0] + -1)->_unsigned_long) % 6 << c;
                _4_main_$sp[0] = ((_4_main_$sp[0] + -1) - 1) + 1;
              }
            }
          } else {
        ...
        if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
          ...
          if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) <= argc) {
            while (1) {
              ...
              (_4_main_$sp[0] + -1)->_unsigned_long = (((_4_main_$sp[0] + -1)->_unsigned_long << (_4_main_$sp[0] + 0)->_int) & hash) * 8;
              _4_main_$sp[0] = ((_4_main_$sp[0] + -1) - -1) - -1;
            }
          } else {
            while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) != argc) {
        ...
        if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < r8) {
          ...
          while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) == argc) {
            while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) == _4_main_$select) {
              while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) <= r8) {
                if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) != _4_main__alwaysOne) {
                  (_4_main_$sp[0] + 1)->_unsigned_long = (*((unsigned long *)_4_main_$pc[0]) ^ 1) + 9;
                  _4_main_$sp[0] = ((_4_main_$sp[0] + 1) - 1) - -1;
                  _4_main_$pc[0] += 8;
                } else {
    ...
    if (_4_main_$currentOp == _4_main__Ne_unsigned_long_unsigned_long2int$left_STA_0$result_STA_0$right_STA_1) {
      ...
      if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) >= _4_main__alwaysOne) {
        while (1) {
          ...
          (_4_main_$sp[0] + -1)->_int = ((_4_main_$sp[0] + 0)->_unsigned_long != (_4_main_$sp[0] + -1)->_unsigned_long) * argc + 10;
          _4_main_$sp[0] = ((_4_main_$sp[0] + -1) + 1) - 1;
        }
      } else {
        {
