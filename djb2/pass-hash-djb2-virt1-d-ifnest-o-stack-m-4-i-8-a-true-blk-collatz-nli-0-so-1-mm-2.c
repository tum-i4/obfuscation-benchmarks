...
{ 
  ...
  while (1) {
    _4_main_$currentOp = *(_4_main_$pc[0]) * ((unsigned char )(_3_main__opaque_list1_1 == _3_main__opaque_list2_1) - (unsigned char )(_3_main__opaque_list2_1 == (struct _3_main__opaque_Node_1 *)0UL));
            ...
            if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
              ...
              if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > argc) {
                while (1) {
                  ...
                  (_4_main_$sp[0] + -1)->_int = (((_4_main_$sp[0] + 0)->_int + (_4_main_$sp[0] + -1)->_int) + 10) >> 10;
        ...
        if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
          if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
            ...
            while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) > argc) {
              ...
              if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > argc) {
                if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) <= argc) < argc) {
                  (_4_main_$sp[0] + -1)->_int = _4_main_$select >> 6;
                  _4_main_$sp[0] = ((_4_main_$sp[0] + -1) + 1) + 1;
                } else {
                  (_4_main_$sp[0] + -1)->_int = 3 & 6;
                  _4_main_$sp[0] = (((_4_main_$sp[0] + -1) + -1) + 1) + 1;
        ...
        while (1) {
          ...
          while (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < _4_main_$select) == _4_main_$select) {
            while (1) {
              ...
              while (1) {
                {
                while (((((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) <= argc) > argc) != _4_main_$select) != r8) {
        ...
        if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
          ...
          if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) <= argc) {
            if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) != argc) != argc) {
              ...
              while (1) {
                ...
                (_4_main_$sp[0] + 1)->_int = 5 & _4_main_$select;
                _4_main_$sp[0] = (((_4_main_$sp[0] + 1) + -1) - 1) + -1;
                _4_main_$pc[0] += 4;
              }
            }
          ...
          if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < r8) {
            while (1) {
              ...
              (_4_main_$sp[0] + 1)->_int = (*((int *)_4_main_$pc[0]) | i7) + argc;
              _4_main_$sp[0] = ((_4_main_$sp[0] + 1) + -1) - -1;
              _4_main_$pc[0] += 4;
            }
          } else
          ...
          if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == i7) {
            while (1) {
              ...
              while (1) {
                ...
                (_4_main_$sp[0] + -1)->_unsigned_long = ((_4_main_$sp[0] + 0)->_unsigned_long * (_4_main_$sp[0] + -1)->_unsigned_long << 8) | hash;
                _4_main_$sp[0] = ((_4_main_$sp[0] + -1) - 1) - 1;
              }
            }
          } else {
