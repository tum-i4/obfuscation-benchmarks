...
{ 
  ...
  while (1) {
    ...
    switch (_3_main__opaque_list1_1 == _3_main__opaque_list2_1 ? *(_4_main_$pc[0]) : (unsigned char)4) {
          ...
          if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
            ...
            if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) >= _4_main__alwaysOne) {
              if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > i7) <= r8) {
                (_4_main_$sp[0] + 0)->_unsigned_long = 2UL / 9;
              } else {
    ...
    if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
      if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
        if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
          ...
          if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > i7) {
            *((unsigned long *)(_4_main_$sp[0] + 0)->_void_star) = ((_4_main_$sp[0] + -1)->_unsigned_long >> 1) + 6;
      ...
      while ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) >= _4_main__alwaysOne) {
        ...
        if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) > argc) {
          if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > i7) >= argc) {
            ...
            *((unsigned long *)(_4_main_$sp[0] + 0)->_void_star) = (((_4_main_$sp[0] + -1)->_unsigned_long >> 1) + 6) | hash;
    ...
    if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
      if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
        ...
        if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < argc) {
          ...
          while ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) < _4_main__alwaysOne) {
            (_4_main_$sp[0] + -1)->_int = ((_4_main_$sp[0] + 0)->_unsigned_long != (_4_main_$sp[0] + -1)->_unsigned_long) | 8;
            _4_main_$sp[0] = (_4_main_$sp[0] + -1) - -1;
          }
        }
      } else {
    ...
    if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
      if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
        ...
        if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) < _4_main__alwaysOne) {
          ...
          while ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) < r8) {
            if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) != i7) {
              (_4_main_$sp[0] + 0)->_unsigned_char = *((unsigned char *)(_4_main_$sp[0] + 0)->_void_star) % 9 + 2;
            } else {
      ...
      if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) == r8) {
        while (((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) < _4_main__alwaysOne) > r8) {
          if ((((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) != _4_main_$select) <= argc) < r8) {
            ...
            while (1) {
              if ((((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) > _4_main_$select) > argc) > _4_main__alwaysOne) {

              } else {
                return (8);
              }
              (_4_main_$sp[0] + 0)->_unsigned_char = (unsigned char)5 ^ (unsigned char)4;
            }
          }
        }
      } else
            ...
            while (1) {
              ...
              while (1) {
                ...
                while (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) != argc) <= r8) {
                  while (1) {
                    if (((*((int *)_4_main_$pc[0]) == _4_main__alwaysOne) <= _4_main__alwaysOne) > argc) {
                      return (argc);
                    } else {
