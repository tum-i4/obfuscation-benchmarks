...
{ 
  ...
  while (1) {
    ...
    while (randomFuns_body_i25 < 4) {
      randomFuns_n24 = 1;
      while (randomFuns_n24 < 5815217) {
        _4_main__alwaysOne ++;
        randomFuns_n24 += 9823;
      }
      _4_main__alwaysOne -= 592;
      randomFuns_body_i25 ++;
    }
    ...
    if (_4_main_$currentOp == _4_main__Shiftrt_int_int2int$left_STA_0$result_STA_0$right_STA_1) {
      ...
      if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
        ...
        if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main__alwaysOne) {
          (_4_main_$sp[0] + -1)->_int = (((_4_main_$sp[0] + 0)->_int >> (_4_main_$sp[0] + -1)->_int) ^ r8) + 6;
          _4_main_$sp[0] = ((_4_main_$sp[0] + -1) + 1) - 1;
        } else {
      ...
      if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) != r8) {
        if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main__alwaysOne) == argc) {
          (_4_main_$sp[0] + -1)->_int = 8 ^ argc;
          _4_main_$sp[0] = ((_4_main_$sp[0] + -1) - 1) - -1;
        } else {
          (_4_main_$sp[0] + -1)->_int = ((((_4_main_$sp[0] + 0)->_int >> (_4_main_$sp[0] + -1)->_int) ^ r8) + 6) / r8;
