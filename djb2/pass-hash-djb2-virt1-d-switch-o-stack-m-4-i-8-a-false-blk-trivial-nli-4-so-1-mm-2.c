        ...
        if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
          if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
            ...
            if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main_$select) {
              *((int *)(_4_main_$sp[0] + 0)->_void_star) = ((_4_main_$sp[0] + -1)->_int % 10) / _4_main__alwaysOne;
          ...
          if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > _4_main__alwaysOne) {
            while (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main_$select) != _4_main__alwaysOne) {
              *((int *)(_4_main_$sp[0] + 0)->_void_star) = ((_4_main_$sp[0] + -1)->_int % 10) / _4_main__alwaysOne ^ 2;
        ...
        while ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) == argc) {
          if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > argc) {
            if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) > _4_main__alwaysOne) < r8) {
              ...
              while (1) {
                while ((((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main_$select) != _4_main__alwaysOne) > i7) {

                }
                *((int *)(_4_main_$sp[0] + 0)->_void_star) = (((_4_main_$sp[0] + -1)->_int % 10) / _4_main__alwaysOne ^ 2) ^ argc;
    ...
    if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
      if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
        if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
          ...
          if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) > _4_main_$select) {
            (_4_main_$sp[0] + 0)->_unsigned_long = hash >> c;
          } else {
        ...
        while ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) <= i7) {
          if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) == i7) {
            if (((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) > _4_main_$select) > r8) {
              (_4_main_$sp[0] + 0)->_unsigned_long = c / 1;
            } else {
              (_4_main_$sp[0] + 0)->_unsigned_long = c;
            }
          } else {
      ...
      if (_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) {
        if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
          ...
          while ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) > r8) {
            ...
            if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) == _4_main__alwaysOne) {
              return (((_4_main_$sp[0] + 0)->_int & _4_main_$select) << _4_main_$select);
            } else {
    ...
    if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) != _4_main__alwaysOne) {
      while (1) {
        ...
        if (((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) <= i7) > r8) {
          {
          while ((*((int *)_4_main_$pc[0]) <= argc) <= _4_main__alwaysOne) {
