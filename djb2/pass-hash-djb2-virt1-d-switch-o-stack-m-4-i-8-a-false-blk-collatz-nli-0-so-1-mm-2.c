...
{ 
  ...
  while (1) {
    ...
    if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
      ...
      (_4_main_$sp[0] + 0)->_unsigned_char = *((unsigned char *)(_4_main_$sp[0] + 0)->_void_star) | (unsigned char)8;
    }
    break;
    ...
    if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) != r8) {
      if (((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) > _4_main_$select) > r8) {
        ...
        while (1) {
          ...
          (_4_main_$sp[0] + -1)->_void_star = ((((_4_main_$sp[0] + -1)->_void_star + (_4_main_$sp[0] + 0)->_unsigned_long) - 1) - -1) - 1;
          _4_main_$sp[0] = (((_4_main_$sp[0] + -1) - 1) - -1) + 1;
        }
      }
    } else {
