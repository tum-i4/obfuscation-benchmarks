...
{ 
  ...
  while (1) {
    ...
    while (randomFuns_body_i25 < 4) {
      randomFuns_n24 = 1;
      while (randomFuns_n24 < 1448673) {
        _4_main__alwaysOne ++;
        randomFuns_n24 += 2663;
      }
      _4_main__alwaysOne -= 544;
      randomFuns_body_i25 ++;
    }
    ...
    if (_4_main_$currentOp == _4_main__convert_int2unsigned_long$left_STA_0$result_STA_0) {
      ...
      if (_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) {
        ...
        if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) <= r8) {
          (_4_main_$sp[0] + 0)->_unsigned_long = ((unsigned long )(_4_main_$sp[0] + 0)->_int >> 8) + 10;
        } else {
      ...
      if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) <= r8) {
        ...
        while (((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) <= r8) == argc) {
          (_4_main_$sp[0] + 0)->_unsigned_long = (((unsigned long )(_4_main_$sp[0] + 0)->_int >> 8) + 10) % 2;
        }
        }
      } else
      if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) <= r8) {
        (_4_main_$sp[0] + 0)->_unsigned_long = ((unsigned long )(_4_main_$sp[0] + 0)->_int >> 8) >> hash;
      } else {
