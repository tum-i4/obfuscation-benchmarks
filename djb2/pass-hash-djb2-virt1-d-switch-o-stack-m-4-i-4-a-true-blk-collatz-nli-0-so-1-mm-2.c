...
{ 
  ...
  while (1) {
    ...
    if ((_3_main__opaque_list1_1 != (struct _3_main__opaque_Node_1 *)0UL) <= argc) {
      (_4_main_$sp[0] + 0)->_unsigned_long = (*((unsigned long *)(_4_main_$sp[0] + 0)->_void_star) & 4) >> 5;
    } else {
    ...
    if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
      ...
      if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) >= argc) {
        (_4_main_$sp[0] + 0)->_unsigned_long = 2UL / 1;
      } else {
    ...
    if ((_3_main__opaque_list2_1 != (struct _3_main__opaque_Node_1 *)0UL) != i7) {
      ...
      while (((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) >= argc) > i7) {
        (_4_main_$sp[0] + 0)->_unsigned_long = (2UL / 1) / 4;
      }
      }
    } else
    ...
    *((int *)(_4_main_$sp[0] + 0)->_void_star) = (_4_main_$sp[0] + -1)->_int;
    ...
    if (_3_main__opaque_list1_1 == _3_main__opaque_list2_1) {
      ...
      if ((_3_main__opaque_list1_1 == _3_main__opaque_list2_1) == i7) {
        (_4_main_$sp[0] + -1)->_unsigned_long = (((_4_main_$sp[0] + 0)->_unsigned_long + (_4_main_$sp[0] + -1)->_unsigned_long) >> hash) + 9;
        _4_main_$sp[0] = ((_4_main_$sp[0] + -1) - -1) + 1;
      } else {
