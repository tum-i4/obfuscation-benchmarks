...
%"union._2_BKDRHash_$node" = type { i8* }
...
@"_1_BKDRHash_$array" = internal global [1 x [169 x i8]] [[169 x i8] c"U\0C\00\00\00\EF\83\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\14\00\00\00\07l<\0E\00\00\
@"_2_BKDRHash_$array" = internal unnamed_addr constant [1 x [8280 x i8]] [[8280 x i8] c"\A3\00\00\00\00\00\00\00\00,\08\00\00\00\00\00\00\00,\00\00\00\00\00\00\00\00\8B\DB|\10\00\00\00\87\A3\00\00\00\00\00\00\00\00,\08\00\00\00\00\00\00\00,\00\00\00\00\0
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_BKDRHash_$locals.i" = alloca [312 x i8], align 16
  %"_2_BKDRHash_$stack.i" = alloca [1 x [32 x %"union._2_BKDRHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [312 x i8]* %"_2_BKDRHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_BKDRHash_$node"]]* %"_2_BKDRHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_BKDRHash_$node"]]* %"_2_BKDRHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %709, %707, %697, %691, %689, %680, %677, %669, %655, %640, %631, %628, %613, %611, %590, %582, %574, %567, %558, %551, %549, %540, %534, %528, %522, %516, %510, %503, %495, %487, %480, %471, %4
  %"_2_BKDRHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [8280 x i8]]* @"_2_BKDRHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_BKDRHash_$pc.0.0.i", %.backedge.i ], [ %710, %709 ], [ %708, %707 ], [ %698, %697 ], [ %692, %691 ], [ %
  %"_2_BKDRHash_$sp.0.0.i" = phi %"union._2_BKDRHash_$node"* [ %448, %strlen.exit ], [ %"_2_BKDRHash_$sp.0.0.i", %.backedge.i ], [ %"_2_BKDRHash_$sp.0.0.i", %709 ], [ %"_2_BKDRHash_$sp.0.0.i", %707 ], [ %701, %697 ], [ %"_2_BKDRHash_$sp.0.0.i", %691 ], [
  %449 = load i8* %"_2_BKDRHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %453 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %454 = load i8** %453, align 8
  %455 = bitcast i8* %454 to i32*
  %456 = load i32* %455, align 4
  %457 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  store i32 %456, i32* %457, align 4
  br label %.backedge.i

; <label>:458                                     ; preds = %.backedge.i
  %459 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %460 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %461 = load i8** %460, align 8
  %462 = load i8* %461, align 1
  %463 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i8*
  store i8 %462, i8* %463, align 1
  br label %.backedge.i

; <label>:464                                     ; preds = %.backedge.i
  %465 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %466 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %467 = load i8** %466, align 8
  %468 = bitcast i8* %467 to i32*
  %469 = load i32* %468, align 4
  %470 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  store i32 %469, i32* %470, align 4
  br label %.backedge.i

; <label>:471                                     ; preds = %.backedge.i
  %472 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %473 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %474 = bitcast %"union._2_BKDRHash_$node"* %473 to i32*
  %475 = load i32* %474, align 4
  %476 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %477 = load i8** %476, align 8
  %478 = bitcast i8* %477 to i32*
  store i32 %475, i32* %478, align 4
  %479 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:480                                     ; preds = %.backedge.i
  %481 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %482 = bitcast i8* %481 to i8**
  %483 = load i8** %482, align 8
  %484 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* %483, i8** %484, align 8
  %485 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1
  %486 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:487                                     ; preds = %.backedge.i
  %488 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %489 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  %490 = load i32* %489, align 4
  %491 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %492 = bitcast %"union._2_BKDRHash_$node"* %491 to i32*
...
; <label>:495                                     ; preds = %.backedge.i
  %496 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %497 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i64*
  %498 = load i64* %497, align 8
  %499 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  %500 = load i8** %499, align 8
  %501 = bitcast i8* %500 to i64*
  store i64 %498, i64* %501, align 8
  %502 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:503                                     ; preds = %.backedge.i
  %504 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %505 = bitcast i8* %504 to i32*
  %506 = load i32* %505, align 4
  %507 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1
  %508 = bitcast %"union._2_BKDRHash_$node"* %507 to i32*
  store i32 %506, i32* %508, align 4
  %509 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:510                                     ; preds = %.backedge.i
  %511 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %512 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %513 = load i8** %512, align 8
...
; <label>:516                                     ; preds = %.backedge.i
  %517 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %518 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  %519 = load i32* %518, align 4
  %520 = sext i32 %519 to i64
  %521 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %.c4.i = inttoptr i64 %520 to i8*
  store i8* %.c4.i, i8** %521, align 8
  br label %.backedge.i

; <label>:522                                     ; preds = %.backedge.i
  %523 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %524 = bitcast i8* %523 to i32*
  %525 = load i32* %524, align 4
  %526 = sext i32 %525 to i64
  %.sum3.i = add i64 %526, 1
  %527 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 %.sum3.i
  br label %.backedge.i

; <label>:528                                     ; preds = %.backedge.i
  %529 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %530 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %531 = load i8** %530, align 8
  %532 = bitcast i8* %531 to i64*
  %533 = load i64* %532, align 8
  %.c2.i = inttoptr i64 %533 to i8*
  store i8* %.c2.i, i8** %530, align 8
  br label %.backedge.i

; <label>:534                                     ; preds = %.backedge.i
  %535 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %536 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i8*
  %537 = load i8* %536, align 1
  %538 = zext i8 %537 to i32
  %539 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  store i32 %538, i32* %539, align 4
  br label %.backedge.i

; <label>:540                                     ; preds = %.backedge.i
  %541 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %542 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %543 = bitcast %"union._2_BKDRHash_$node"* %542 to i32*
  %544 = load i32* %543, align 4
  %545 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %546 = load i8** %545, align 8
  %547 = bitcast i8* %546 to i32*
  store i32 %544, i32* %547, align 4
  %548 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:549                                     ; preds = %.backedge.i
  %550 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:551                                     ; preds = %.backedge.i
  %552 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %553 = bitcast i8* %552 to i32*
  %554 = load i32* %553, align 4
  %555 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1
  %556 = bitcast %"union._2_BKDRHash_$node"* %555 to i32*
  store i32 %554, i32* %556, align 4
  %557 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:558                                     ; preds = %.backedge.i
  %559 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %560 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %561 = load i8** %560, align 8
  %562 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %563 = bitcast %"union._2_BKDRHash_$node"* %562 to i64*
  %564 = load i64* %563, align 8
  %565 = getelementptr i8* %561, i64 %564
  %566 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %565, i8** %566, align 8
  br label %.backedge.i

; <label>:567                                     ; preds = %.backedge.i
  %568 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %569 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i8*
  %570 = load i8* %569, align 1
  %571 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  %572 = load i8** %571, align 8
  store i8 %570, i8* %572, align 1
  %573 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:574                                     ; preds = %.backedge.i
  %575 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %576 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %577 = load i8** %576, align 8
  %578 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  %579 = load i8** %578, align 8
  %580 = bitcast i8* %579 to i8**
  store i8* %577, i8** %580, align 8
  %581 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:582                                     ; preds = %.backedge.i
  %583 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %584 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %585 = bitcast %"union._2_BKDRHash_$node"* %584 to i32*
  %586 = load i32* %585, align 4
  %587 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
...
; <label>:590                                     ; preds = %.backedge.i
  %591 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %592 = bitcast i8* %591 to i32*
  %593 = load i32* %592, align 4
  %594 = sext i32 %593 to i64
  %595 = getelementptr inbounds [312 x i8]* %"_2_BKDRHash_$locals.i", i64 0, i64 %594
  %596 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* %595, i8** %596, align 8
  %597 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1
  %598 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:599                                     ; preds = %.backedge.i
  %600 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  %601 = load i32* %600, align 4
  %602 = icmp eq i32 %601, 0
  br i1 %602, label %609, label %603

; <label>:603                                     ; preds = %599
  %604 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %605 = bitcast i8* %604 to i32*
  %606 = load i32* %605, align 4
  %607 = sext i32 %606 to i64
  %.sum9.i = add i64 %607, 1
  %608 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 %.sum9.i
  br label %611

; <label>:609                                     ; preds = %599
  %610 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 5
  br label %611

; <label>:611                                     ; preds = %609, %603
  %"_2_BKDRHash_$pc.0.1.i" = phi i8* [ %610, %609 ], [ %608, %603 ]
  %612 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:613                                     ; preds = %.backedge.i
  %614 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %615 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  %616 = load i32* %615, align 4
  %617 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %618 = bitcast %"union._2_BKDRHash_$node"* %617 to i32*
...
; <label>:622                                     ; preds = %.backedge.i
  %623 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %624 = bitcast i8* %623 to i32*
  %625 = load i32* %624, align 4
  %cond.i = icmp eq i32 %625, 0
  br i1 %cond.i, label %626, label %628

; <label>:626                                     ; preds = %622
  %627 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [169 x i8]]* @"_1_BKDRHash_$array", i64 0, i64 0, i64 0), i8** %627, align 8
  br label %628

; <label>:628                                     ; preds = %626, %622
  %629 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1
  %630 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:631                                     ; preds = %.backedge.i
  %632 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %633 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i64*
  %634 = load i64* %633, align 8
  %635 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %636 = bitcast %"union._2_BKDRHash_$node"* %635 to i64*
  %637 = load i64* %636, align 8
  %638 = mul i64 %637, %634
  %639 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  %.c1.i = inttoptr i64 %638 to i8*
  store i8* %.c1.i, i8** %639, align 8
  br label %.backedge.i

; <label>:640                                     ; preds = %.backedge.i
  %641 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %642 = bitcast i8* %641 to i64*
  %643 = load i64* %642, align 8
  %644 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1, i32 0
  %.c.i = inttoptr i64 %643 to i8*
  store i8* %.c.i, i8** %644, align 8
  %645 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1
  %646 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:647                                     ; preds = %.backedge.i
  %648 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
...
; <label>:651                                     ; preds = %647
  %652 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %652, align 8
  br label %655

; <label>:653                                     ; preds = %647
  %654 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %654, align 8
  br label %655

; <label>:655                                     ; preds = %653, %651, %647
  %656 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 1
  %657 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:658                                     ; preds = %.backedge.i
  %659 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %660 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  %661 = load i32* %660, align 4
  %662 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %663 = bitcast i8* %659 to i32*
  %664 = load i32* %663, align 4
  %665 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 5
  %666 = bitcast i8* %665 to i32*
  %667 = load i32* %666, align 4
  %668 = icmp slt i32 %661, %664
  br i1 %668, label %669, label %672

; <label>:669                                     ; preds = %658
  %670 = sext i32 %667 to i64
  %.sum8.i = add i64 %670, 1
  %671 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:672                                     ; preds = %658
  %673 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 9
  %674 = bitcast i8* %673 to i32*
  %675 = load i32* %674, align 4
  %676 = icmp sgt i32 %661, %675
  br i1 %676, label %677, label %680

; <label>:677                                     ; preds = %672
  %678 = sext i32 %667 to i64
  %.sum7.i = add i64 %678, 1
  %679 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:680                                     ; preds = %672
  %681 = sub nsw i32 %661, %664
  %682 = shl nsw i32 %681, 2
  %683 = sext i32 %682 to i64
  %.sum5.i = add i64 %683, 13
  %684 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 %.sum5.i
  %685 = bitcast i8* %684 to i32*
  %686 = load i32* %685, align 4
  %687 = sext i32 %686 to i64
  %.sum6.i = add i64 %687, 1
  %688 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 %.sum6.i
  br label %.backedge.i

; <label>:689                                     ; preds = %.backedge.i
  %690 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:691                                     ; preds = %.backedge.i
  %692 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %693 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %694 = load i8** %693, align 8
  %695 = load i8* %694, align 1
  %696 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i8*
  store i8 %695, i8* %696, align 1
  br label %.backedge.i

; <label>:697                                     ; preds = %.backedge.i
  %698 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %699 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %700 = load i8** %699, align 8
  %701 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1
  %702 = bitcast %"union._2_BKDRHash_$node"* %701 to i32*
  %703 = load i32* %702, align 4
  %704 = sext i32 %703 to i64
  %705 = getelementptr i8* %700, i64 %704
  %706 = getelementptr inbounds %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %705, i8** %706, align 8
  br label %.backedge.i

; <label>:707                                     ; preds = %.backedge.i
  %708 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:709                                     ; preds = %.backedge.i
  %710 = getelementptr inbounds i8* %"_2_BKDRHash_$pc.0.0.i", i64 1
  %711 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i8*
  %712 = load i8* %711, align 1
  %713 = sext i8 %712 to i32
  %714 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  store i32 %713, i32* %714, align 4
  br label %.backedge.i

BKDRHash.exit:                                    ; preds = %.backedge.i
  %715 = bitcast %"union._2_BKDRHash_$node"* %"_2_BKDRHash_$sp.0.0.i" to i32*
  %716 = load i32* %715, align 4
  %717 = icmp eq i32 %716, -1114471758
  br i1 %717, label %718, label %719

; <label>:718                                     ; preds = %BKDRHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %720

; <label>:719                                     ; preds = %BKDRHash.exit
