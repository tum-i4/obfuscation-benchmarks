...
%"union._1_BKDRHash_$node" = type { i8* }
...
@"_1_BKDRHash_$array" = internal unnamed_addr constant [1 x [169 x i8]] [[169 x i8] c"U\0C\00\00\00\EF\83\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1FU\14\00\00\00\EF\00\00\00\00\1F:\04\00\00\00\BF\01\00\00\00\07U\14\00\00\00
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_BKDRHash_$locals.i" = alloca [24 x i8], align 16
  %"_1_BKDRHash_$stack.i" = alloca [1 x [32 x %"union._1_BKDRHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [24 x i8]* %"_1_BKDRHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_BKDRHash_$node"]]* %"_1_BKDRHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_BKDRHash_$node"]]* %"_1_BKDRHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %597, %591, %584, %578, %569, %561, %553, %544, %538, %536, %528, %522, %513, %506, %497, %489, %487, %468, %462, %459, %.backedge.i, %strlen.exit
  %"_1_BKDRHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [169 x i8]]* @"_1_BKDRHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_BKDRHash_$pc.0.0.i", %.backedge.i ], [ %603, %597 ], [ %592, %591 ], [ %585, %584 ], [ %579, %578 ], [ %5
  %"_1_BKDRHash_$sp.0.0.i" = phi %"union._1_BKDRHash_$node"* [ %448, %strlen.exit ], [ %"_1_BKDRHash_$sp.0.0.i", %.backedge.i ], [ %601, %597 ], [ %"_1_BKDRHash_$sp.0.0.i", %591 ], [ %"_1_BKDRHash_$sp.0.0.i", %584 ], [ %"_1_BKDRHash_$sp.0.0.i", %578 ], [
  %449 = load i8* %"_1_BKDRHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
...
; <label>:455                                     ; preds = %451
  %456 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %456, align 8
  br label %459

; <label>:457                                     ; preds = %451
  %458 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %458, align 8
  br label %459

; <label>:459                                     ; preds = %457, %455, %451
  %460 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1
  %461 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:462                                     ; preds = %.backedge.i
  %463 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %464 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i8*
  %465 = load i8* %464, align 1
  %466 = sext i8 %465 to i32
  %467 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  store i32 %466, i32* %467, align 4
  br label %.backedge.i

; <label>:468                                     ; preds = %.backedge.i
  %469 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %470 = bitcast i8* %469 to i64*
  %471 = load i64* %470, align 8
  %472 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1, i32 0
  %.c2.i = inttoptr i64 %471 to i8*
  store i8* %.c2.i, i8** %472, align 8
  %473 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1
  %474 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:475                                     ; preds = %.backedge.i
  %476 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  %477 = load i32* %476, align 4
  %478 = icmp eq i32 %477, 0
  br i1 %478, label %485, label %479

; <label>:479                                     ; preds = %475
  %480 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %481 = bitcast i8* %480 to i32*
  %482 = load i32* %481, align 4
  %483 = sext i32 %482 to i64
  %.sum3.i = add i64 %483, 1
  %484 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 %.sum3.i
  br label %487

; <label>:485                                     ; preds = %475
  %486 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 5
  br label %487

; <label>:487                                     ; preds = %485, %479
  %"_1_BKDRHash_$pc.0.1.i" = phi i8* [ %486, %485 ], [ %484, %479 ]
  %488 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:489                                     ; preds = %.backedge.i
  %490 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %491 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  %492 = load i32* %491, align 4
  %493 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  %494 = load i8** %493, align 8
  %495 = bitcast i8* %494 to i32*
  store i32 %492, i32* %495, align 4
  %496 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:497                                     ; preds = %.backedge.i
  %498 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %499 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %500 = load i8** %499, align 8
  %501 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1
  %502 = bitcast %"union._1_BKDRHash_$node"* %501 to i64*
  %503 = load i64* %502, align 8
  %504 = getelementptr i8* %500, i64 %503
  %505 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %504, i8** %505, align 8
  br label %.backedge.i

; <label>:506                                     ; preds = %.backedge.i
  %507 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %508 = bitcast i8* %507 to i32*
  %509 = load i32* %508, align 4
  %510 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1
  %511 = bitcast %"union._1_BKDRHash_$node"* %510 to i32*
  store i32 %509, i32* %511, align 4
  %512 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:513                                     ; preds = %.backedge.i
  %514 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %515 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  %516 = load i32* %515, align 4
  %517 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1
  %518 = bitcast %"union._1_BKDRHash_$node"* %517 to i32*
...
; <label>:522                                     ; preds = %.backedge.i
  %523 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %524 = bitcast i8* %523 to i32*
  %525 = load i32* %524, align 4
  %526 = sext i32 %525 to i64
  %.sum.i = add i64 %526, 1
  %527 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:528                                     ; preds = %.backedge.i
  %529 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %530 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1
  %531 = bitcast %"union._1_BKDRHash_$node"* %530 to i32*
  %532 = load i32* %531, align 4
  %533 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
...
; <label>:536                                     ; preds = %.backedge.i
  %537 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:538                                     ; preds = %.backedge.i
  %539 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %540 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  %541 = load i32* %540, align 4
  %542 = sext i32 %541 to i64
  %543 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %.c1.i = inttoptr i64 %542 to i8*
  store i8* %.c1.i, i8** %543, align 8
  br label %.backedge.i

; <label>:544                                     ; preds = %.backedge.i
  %545 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %546 = bitcast i8* %545 to i32*
  %547 = load i32* %546, align 4
  %548 = sext i32 %547 to i64
  %549 = getelementptr inbounds [24 x i8]* %"_1_BKDRHash_$locals.i", i64 0, i64 %548
  %550 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1, i32 0
  store i8* %549, i8** %550, align 8
  %551 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1
  %552 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:553                                     ; preds = %.backedge.i
  %554 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %555 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  %556 = load i32* %555, align 4
  %557 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1
  %558 = bitcast %"union._1_BKDRHash_$node"* %557 to i32*
...
; <label>:561                                     ; preds = %.backedge.i
  %562 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %563 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  %564 = load i8** %563, align 8
  %565 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %566 = load i8** %565, align 8
  %567 = bitcast i8* %566 to i8**
  store i8* %564, i8** %567, align 8
  %568 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:569                                     ; preds = %.backedge.i
  %570 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %571 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i64*
  %572 = load i64* %571, align 8
  %573 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1
  %574 = bitcast %"union._1_BKDRHash_$node"* %573 to i64*
  %575 = load i64* %574, align 8
  %576 = mul i64 %575, %572
  %577 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 -1, i32 0
  %.c.i = inttoptr i64 %576 to i8*
  store i8* %.c.i, i8** %577, align 8
  br label %.backedge.i

; <label>:578                                     ; preds = %.backedge.i
  %579 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %580 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %581 = load i8** %580, align 8
  %582 = bitcast i8* %581 to i8**
  %583 = load i8** %582, align 8
  store i8* %583, i8** %580, align 8
  br label %.backedge.i

; <label>:584                                     ; preds = %.backedge.i
  %585 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %586 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %587 = load i8** %586, align 8
  %588 = bitcast i8* %587 to i32*
  %589 = load i32* %588, align 4
  %590 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  store i32 %589, i32* %590, align 4
  br label %.backedge.i

; <label>:591                                     ; preds = %.backedge.i
  %592 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %593 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 0, i32 0
  %594 = load i8** %593, align 8
  %595 = load i8* %594, align 1
  %596 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i8*
  store i8 %595, i8* %596, align 1
  br label %.backedge.i

; <label>:597                                     ; preds = %.backedge.i
  %598 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 1
  %599 = bitcast i8* %598 to i32*
  %600 = load i32* %599, align 4
  %601 = getelementptr inbounds %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i", i64 1
  %602 = bitcast %"union._1_BKDRHash_$node"* %601 to i32*
  store i32 %600, i32* %602, align 4
  %603 = getelementptr inbounds i8* %"_1_BKDRHash_$pc.0.0.i", i64 5
  br label %.backedge.i

BKDRHash.exit:                                    ; preds = %.backedge.i
  %604 = bitcast %"union._1_BKDRHash_$node"* %"_1_BKDRHash_$sp.0.0.i" to i32*
  %605 = load i32* %604, align 4
  %606 = icmp eq i32 %605, -1114471758
  br i1 %606, label %607, label %608

; <label>:607                                     ; preds = %BKDRHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %609

; <label>:608                                     ; preds = %BKDRHash.exit
