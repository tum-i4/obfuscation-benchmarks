; ModuleID = './bkdrhash-addOpaque1.bc'
...
; <label>:463                                     ; preds = %463, %512
  %p.0.i = phi i8* [ %516, %512 ], [ %466, %463 ]
...
.lr.ph.i:                                         ; preds = %strlen.exit
  ...
  %474 = icmp eq %struct._1_main__opaque_Node_1* %473, %513
  %475 = icmp eq i32 %470, 0
  br i1 %474, label %.lr.ph.split.us.i.preheader, label %.lr.ph..lr.ph.split_crit_edge.i

.lr.ph.split.us.i.preheader:                      ; preds = %.lr.ph.i
  br i1 %475, label %BKDRHash.exit.thread, label %.lr.ph.split.us.i

.lr.ph.split.us.i:                                ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph.split.us.i
  %hash.02.us.i4 = phi i32 [ %479, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %i.03.us.i3 = phi i32 [ %481, %.lr.ph.split.us.i ], [ 0, %.lr.ph.split.us.i.preheader ]
  %.04.us.i2 = phi i8* [ %480, %.lr.ph.split.us.i ], [ %516, %.lr.ph.split.us.i.preheader ]
  %476 = mul i32 %hash.02.us.i4, 131
  %477 = load i8* %.04.us.i2, align 1
  %478 = sext i8 %477 to i32
  %479 = add i32 %478, %476
  %480 = getelementptr inbounds i8* %.04.us.i2, i64 1
  %481 = add i32 %i.03.us.i3, 1
  %exitcond = icmp eq i32 %481, %470
  br i1 %exitcond, label %.lr.ph.split.us.i.BKDRHash.exit_crit_edge, label %.lr.ph.split.us.i

.preheader.i:                                     ; preds = %.lr.ph..lr.ph.split_crit_edge.i, %strlen.exit, %.preheader.i
  br label %.preheader.i

.lr.ph..lr.ph.split_crit_edge.i:                  ; preds = %.lr.ph.i
  br i1 %475, label %BKDRHash.exit.thread, label %.preheader.i

.lr.ph.split.us.i.BKDRHash.exit_crit_edge:        ; preds = %.lr.ph.split.us.i
  %phitmp = icmp eq i32 %479, -1114471758
  br i1 %phitmp, label %482, label %BKDRHash.exit.thread

; <label>:482                                     ; preds = %.lr.ph.split.us.i.BKDRHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %483

BKDRHash.exit.thread:                             ; preds = %.lr.ph.split.us.i.preheader, %.lr.ph..lr.ph.split_crit_edge.i, %.lr.ph.split.us.i.BKDRHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %483

; <label>:483                                     ; preds = %BKDRHash.exit.thread, %482
  ret i32 0

; <label>:484                                     ; preds = %460, %452, %rand.exit
  %485 = load i32* %444, align 4, !dbg !3143
  %486 = load i32* %443, align 4, !dbg !3143
  %487 = add nsw i32 %486, %485, !dbg !3143
  store i32 %487, i32* %443, align 4, !dbg !3143
  %488 = lshr i32 %487, 1, !dbg !3144
  %489 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %490 = icmp ult i32* %489, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %491 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %490, label %492, label %rand.exit.1, !dbg !3146

; <label>:492                                     ; preds = %484
  %493 = icmp ult i32* %491, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %493, i32* %491, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %484, %492
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %484 ], [ %489, %492 ]
  %rptr.0.i.i.i.1 = phi i32* [ %491, %484 ], [ %..i.i.i.1, %492 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %494 = tail call i8* @malloc(i64 16) #7
  %495 = bitcast i8* %494 to %struct._1_main__opaque_Node_1*
  %496 = icmp eq i8* %494, null
  br i1 %496, label %512, label %497

; <label>:497                                     ; preds = %rand.exit.1
  %498 = bitcast i8* %494 to i32*
  store i32 %488, i32* %498, align 4
  %499 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %500 = icmp eq %struct._1_main__opaque_Node_1* %499, null
  br i1 %500, label %509, label %501

; <label>:501                                     ; preds = %497
  %502 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %503 = getelementptr inbounds %struct._1_main__opaque_Node_1* %502, i64 0, i32 1
  %504 = load %struct._1_main__opaque_Node_1** %503, align 8
  %505 = getelementptr inbounds i8* %494, i64 8
  %506 = bitcast i8* %505 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %504, %struct._1_main__opaque_Node_1** %506, align 8
  %507 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %508 = getelementptr inbounds %struct._1_main__opaque_Node_1* %507, i64 0, i32 1
  store %struct._1_main__opaque_Node_1* %495, %struct._1_main__opaque_Node_1** %508, align 8
  br label %512

; <label>:509                                     ; preds = %497
  %510 = getelementptr inbounds i8* %494, i64 8
  %511 = bitcast i8* %510 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %495, %struct._1_main__opaque_Node_1** %511, align 8
  store %struct._1_main__opaque_Node_1* %495, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %512

; <label>:512                                     ; preds = %509, %501, %rand.exit.1
  ...
  %514 = getelementptr inbounds i8* %329, i64 8
  %515 = bitcast i8* %514 to i8**
  %516 = load i8** %515, align 8
