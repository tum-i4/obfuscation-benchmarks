...
.backedge.i:                                      ; preds = %463, %462, %461, %460, %459, %458, %457, %456, %449, %448, %447, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  ...
  %_1_BKDRHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_BKDRHash_next.0.i, %.backedge.i ], [ %_1_BKDRHash_next.0.i, %463 ], [ %_1_BKDRHash_next.0.i, %462 ], [ %_1_BKDRHash_next.0.i, %461 ], [ %_1_BKDRHash_next.0.i, %460 ], [ 5, %458 ], [ %_1_BKD
  %_2_BKDRHash_next.0.i = phi i64 [ 2, %strlen.exit ], [ %_2_BKDRHash_next.0.i, %.backedge.i ], [ 0, %463 ], [ 17, %462 ], [ 14, %461 ], [ 9, %460 ], [ 0, %458 ], [ 5, %457 ], [ 0, %456 ], [ 8, %449 ], [ 0, %448 ], [ 0, %447 ], [ 13, %444 ], [ 0, %443 ],
  ...
  switch i64 %_2_BKDRHash_next.0.i, label %.backedge.i [
    i64 17, label %442
    i64 16, label %443
    i64 14, label %444
    i64 13, label %445
...
; <label>:459                                     ; preds = %.backedge.i
  switch i64 %_1_BKDRHash_next.0.i, label %463 [
...
BKDRHash.exit:                                    ; preds = %.backedge.i
  %464 = icmp eq i32 %hash.0.i, -1114471758
  br i1 %464, label %465, label %466

; <label>:465                                     ; preds = %BKDRHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %467

; <label>:466                                     ; preds = %BKDRHash.exit
