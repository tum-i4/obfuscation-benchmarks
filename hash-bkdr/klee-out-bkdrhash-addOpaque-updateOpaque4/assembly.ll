; ModuleID = './bkdrhash-addOpaque-updateOpaque4.bc'
...
; <label>:479                                     ; preds = %strlen.exit
  call void @klee_div_zero_check(i64 0) #7
...
; <label>:480                                     ; preds = %479, %strlen.exit
  ...
  %seed.0.i = phi i32 [ 0, %479 ], [ 131, %strlen.exit ]
...
; <label>:495                                     ; preds = %493
  ...
  br i1 %497, label %.BKDRHash.exit_crit_edge, label %498

.BKDRHash.exit_crit_edge:                         ; preds = %495
  %.pre12 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %BKDRHash.exit
...
BKDRHash.exit:                                    ; preds = %.BKDRHash.exit_crit_edge, %502, %506
  %519 = phi %struct._1_main__opaque_Node_1* [ %.pre12, %.BKDRHash.exit_crit_edge ], [ %505, %502 ], [ %511, %506 ]
  %520 = phi %struct._1_main__opaque_Node_1* [ %.pre11, %.BKDRHash.exit_crit_edge ], [ %501, %502 ], [ %507, %506 ]
  ...
  %525 = icmp eq i32 %hash.1.i, -1114471758
  br i1 %525, label %526, label %527

; <label>:526                                     ; preds = %BKDRHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %528

; <label>:527                                     ; preds = %BKDRHash.exit
