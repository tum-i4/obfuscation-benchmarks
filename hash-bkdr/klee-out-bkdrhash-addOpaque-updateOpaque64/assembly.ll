; ModuleID = './bkdrhash-addOpaque-updateOpaque64.bc'
...
; <label>:163                                     ; preds = %151
  %164 = call fastcc i32 @BKDRHash(i8* null, i32 0)
...
; <label>:194                                     ; preds = %185
  %195 = call fastcc i32 @BKDRHash(i8* null, i32 %hash.034)
...
; <label>:397                                     ; preds = %395
  %398 = call fastcc i32 @BKDRHash(i8* null, i32 %hash.034)
...
.preheader18:                                     ; preds = %419, %.preheader18
  %431 = call fastcc i32 @BKDRHash(i8* inttoptr (i64 6 to i8*), i32 9)
...
; <label>:464                                     ; preds = %.thread12
  %465 = call fastcc i32 @BKDRHash(i8* null, i32 %hash.034)
...
!3157 = metadata !{i32 3505}
!3158 = metadata !{i32 6984}
!3159 = metadata !{i32 7828}
!3160 = metadata !{i32 8796}
!3161 = metadata !{i32 12320}
!3162 = metadata !{i32 17411}
!3163 = metadata !{i32 19608}
!3164 = metadata !{i32 25546}
!3165 = metadata !{i32 25865}
!3166 = metadata !{i32 26194}
