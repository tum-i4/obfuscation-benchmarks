...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %BKDRHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %447, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %448, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %446, %.lr.ph.i ], [ 0, %strlen.exit ]
  %443 = mul i32 %hash.01.i, 131
  %444 = load i8* %.03.i, align 1
  %445 = sext i8 %444 to i32
  %446 = add i32 %445, %443
  %447 = getelementptr inbounds i8* %.03.i, i64 1
  %448 = add i32 %i.02.i, 1
  %exitcond.i = icmp eq i32 %448, %441
  br i1 %exitcond.i, label %BKDRHash.exit, label %.lr.ph.i

BKDRHash.exit:                                    ; preds = %.lr.ph.i
  %449 = icmp eq i32 %446, -1114471758
  br i1 %449, label %450, label %BKDRHash.exit.thread

; <label>:450                                     ; preds = %BKDRHash.exit
...
; <label>:451                                     ; preds = %BKDRHash.exit.thread, %450
  ret i32 0
}
