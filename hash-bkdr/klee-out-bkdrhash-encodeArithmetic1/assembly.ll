; ModuleID = './bkdrhash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i, label %BKDRHash.exit.thread

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %459, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %463, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %458, %.lr.ph.i ], [ 0, %strlen.exit ]
  %447 = and i32 %hash.01.i, 131
  %448 = or i32 %hash.01.i, 131
  %449 = mul i32 %447, %448
  %450 = and i32 %hash.01.i, -132
  %451 = xor i32 %447, 131
  %452 = mul i32 %451, %450
  %453 = add i32 %452, %449
  ...
  %457 = and i32 %453, %455
  %458 = add i32 %457, %456
  %459 = getelementptr inbounds i8* %.03.i, i64 1
  %460 = shl i32 %i.02.i, 1
  %461 = or i32 %460, 2
  %462 = xor i32 %i.02.i, 1
  %463 = sub i32 %461, %462
  %464 = xor i32 %463, -2147483648
  %465 = and i32 %464, %441
  %466 = xor i32 %463, %442
  %467 = sub i32 %463, %441
  %468 = and i32 %467, %466
  ...
  br i1 %470, label %.lr.ph.i, label %BKDRHash.exit

BKDRHash.exit:                                    ; preds = %.lr.ph.i
  %471 = icmp eq i32 %458, -1114471758
  br i1 %471, label %472, label %BKDRHash.exit.thread

; <label>:472                                     ; preds = %BKDRHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %473

BKDRHash.exit.thread:                             ; preds = %strlen.exit, %BKDRHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %473

; <label>:473                                     ; preds = %BKDRHash.exit.thread, %472
  ret i32 0
}
