; ModuleID = './bkdrhash-addOpaque4.bc'
...
.outer..outer.split_crit_edge:                    ; preds = %.outer..outer.split_crit_edge.lr.ph, %.outer
  ...
  br i1 %48, label %.outer.split.split.us, label %BKDRHash.exit
...
thread-pre-split:                                 ; preds = %.outer, %.split, %51
  ...
  br i1 %53, label %BKDRHash.exit, label %thread-pre-split.thread-pre-split.split_crit_edge
