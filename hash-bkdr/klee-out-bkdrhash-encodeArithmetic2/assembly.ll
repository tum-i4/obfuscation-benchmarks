; ModuleID = './bkdrhash-encodeArithmetic2.bc'
...
; <label>:442                                     ; preds = %463, %strlen.exit
  %hash.0.i = phi i32 [ 0, %strlen.exit ], [ %517, %463 ]
  %i.0.i = phi i32 [ 0, %strlen.exit ], [ %531, %463 ]
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %518, %463 ]
  %443 = or i32 %i.0.i, %441
  %444 = and i32 %i.0.i, %441
  %445 = sub i32 %443, %444
  %446 = xor i32 %i.0.i, %441
  %447 = xor i32 %i.0.i, 2147483647
  %448 = and i32 %447, %441
  %449 = shl i32 %448, 1
  %450 = sub i32 %446, %449
  %451 = or i32 %450, %445
  ...
  br i1 %462, label %463, label %BKDRHash.exit

; <label>:463                                     ; preds = %442
  %464 = or i32 %hash.0.i, 131
  %465 = xor i32 %464, -132
  %466 = xor i32 %hash.0.i, -1
  %467 = sub i32 %465, %466
  %468 = and i32 %467, %464
  %469 = or i32 %hash.0.i, %467
  %470 = or i32 %469, 131
  %471 = mul i32 %468, %470
  %hash.0.not.i = and i32 %hash.0.i, -132
  %472 = xor i32 %hash.0.not.i, -132
  %473 = and i32 %467, %472
  %474 = xor i32 %467, -1
  %475 = and i32 %464, %474
  %476 = mul i32 %473, %475
  %477 = add i32 %471, %476
  %478 = add i32 %464, -131
  %479 = sub i32 %464, %hash.0.i
  %480 = and i32 %478, %479
  %481 = or i32 %478, %479
  %482 = mul i32 %480, %481
  %.neg8.i = add i32 %hash.0.i, -1
  %483 = sub i32 %.neg8.i, %464
  %484 = and i32 %478, %483
  %485 = sub i32 130, %464
  %486 = and i32 %485, %479
  %487 = mul i32 %484, %486
  ...
  %493 = add i32 %489, %490
  %.demorgan.i = and i32 %492, %493
  %494 = xor i32 %.demorgan.i, -1
  %495 = add i32 %hash.0.i, 132
  %496 = or i32 %hash.0.i, -132
  %497 = xor i32 %496, 131
  %498 = add i32 %495, %497
  %499 = and i32 %467, %498
  %500 = or i32 %467, %498
  ...
  %509 = add i32 %507, %508
  %510 = xor i32 %509, -1
  %511 = load i8* %.0.i, align 1
  %512 = sext i8 %511 to i32
  %513 = or i32 %512, %510
  %514 = sub i32 %513, %510
  %.neg30.i = add i32 %514, 1
  %515 = add i32 %493, %492
  %516 = add i32 %515, %494
  %517 = add i32 %516, %.neg30.i
  %518 = getelementptr inbounds i8* %.0.i, i64 1
  %519 = add i32 %i.0.i, 2
  %520 = or i32 %i.0.i, 2147483646
  %521 = xor i32 %520, 1
  %522 = add i32 %519, %521
  %523 = shl i32 %522, 1
  %524 = or i32 %i.0.i, 1
...
BKDRHash.exit:                                    ; preds = %442
  %532 = icmp eq i32 %hash.0.i, -1114471758
  br i1 %532, label %533, label %534

; <label>:533                                     ; preds = %BKDRHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %535

; <label>:534                                     ; preds = %BKDRHash.exit
