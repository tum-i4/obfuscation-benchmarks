; ModuleID = './bkdrhash-addOpaque-updateOpaque1.bc'
...
define internal fastcc i32 @BKDRHash(i8* nocapture readonly %str, i32 %len) #2 {
  %1 = icmp eq i32 %len, 0
...
; <label>:10                                      ; preds = %.lr.ph
  %11 = tail call fastcc i32 @BKDRHash(i8* null, i32 %hash.02)
  br label %12

; <label>:12                                      ; preds = %.lr.ph, %10
  %.1 = phi i32 [ %.014, %.lr.ph ], [ %11, %10 ]
  %13 = mul i32 %hash.02, 131
