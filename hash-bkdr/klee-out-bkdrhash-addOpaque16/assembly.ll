; ModuleID = './bkdrhash-addOpaque16.bc'
...
; <label>:10                                      ; preds = %5, %8
  call void asm sideeffect ".byte 0xfd,0xff,0xff,0xc6,0x5", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3157
  br label %.preheader

; <label>:11                                      ; preds = %0
  %12 = icmp eq %struct._1_main__opaque_Node_1* %2, null
  %13 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %14 = icmp ne %struct._1_main__opaque_Node_1* %13, null
  %or.cond = and i1 %12, %14
  br i1 %or.cond, label %15, label %.preheader

; <label>:15                                      ; preds = %11
  %16 = call fastcc i32 @BKDRHash(i8* null, i32 0)
  br label %.preheader

.preheader:                                       ; preds = %15, %11, %10
  %seed.0.ph = phi i32 [ 131, %10 ], [ 131, %11 ], [ %16, %15 ]
  ...
  br i1 %19, label %.outer..outer.split_crit_edge.lr.ph, label %.split

.outer..outer.split_crit_edge.lr.ph:              ; preds = %.preheader
  %20 = icmp ne i32 %len, 0
  br label %.outer..outer.split_crit_edge

.outer..outer.split_crit_edge:                    ; preds = %.outer..outer.split_crit_edge.lr.ph, %.outer.backedge
  %21 = phi i8* [ %str, %.outer..outer.split_crit_edge.lr.ph ], [ %40, %.outer.backedge ]
  %.in = phi %struct._1_main__opaque_Node_1* [ %17, %.outer..outer.split_crit_edge.lr.ph ], [ %41, %.outer.backedge ]
  %22 = phi i1 [ %20, %.outer..outer.split_crit_edge.lr.ph ], [ %44, %.outer.backedge ]
  %hash.0.ph39 = phi i32 [ 0, %.outer..outer.split_crit_edge.lr.ph ], [ %hash.0.ph.be, %.outer.backedge ]
  %i.0.ph35 = phi i32 [ 0, %.outer..outer.split_crit_edge.lr.ph ], [ %i.0.ph.be, %.outer.backedge ]
  br i1 %22, label %.outer.split.split.us, label %.outer.split..outer.split.split_crit_edge

.outer.split..outer.split.split_crit_edge:        ; preds = %.outer..outer.split_crit_edge
  %23 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %24 = icmp eq %struct._1_main__opaque_Node_1* %23, null
  %seed.0.hash.0 = select i1 %24, i32 %seed.0.ph, i32 %hash.0.ph39
  ret i32 %seed.0.hash.0

.outer.split.split.us:                            ; preds = %.outer..outer.split_crit_edge
  %25 = icmp eq %struct._1_main__opaque_Node_1* %.in, null
  br i1 %25, label %.outer.split.split.us.split.us, label %.us-lcssa7.us
...
.split:                                           ; preds = %.outer.backedge, %.preheader
  %26 = phi %struct._1_main__opaque_Node_1* [ %18, %.preheader ], [ %42, %.outer.backedge ]
  %27 = icmp eq %struct._1_main__opaque_Node_1* %26, null
  br i1 %27, label %28, label %thread-pre-split

; <label>:28                                      ; preds = %.split
  %29 = call fastcc i32 @__user_main(i32 6, i8** %1)
  br label %thread-pre-split

thread-pre-split:                                 ; preds = %28, %.split, %.us-lcssa.us
  %.pr = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %30 = icmp eq %struct._1_main__opaque_Node_1* %.pr, null
  br i1 %30, label %.us-lcssa.us, label %thread-pre-split.split.thread-pre-split.split.split_crit_edge

.us-lcssa.us:                                     ; preds = %thread-pre-split
  call void asm sideeffect ".byte 0x99,0x35,0xbd,0xe6,0x15,0xec,0xb6", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3158
  br label %thread-pre-split

thread-pre-split.split.thread-pre-split.split.split_crit_edge: ; preds = %thread-pre-split, %thread-pre-split.split.thread-pre-split.split.split_crit_edge
  br label %thread-pre-split.split.thread-pre-split.split.split_crit_edge

.us-lcssa7.us:                                    ; preds = %.outer.split.split.us
...
; <label>:33                                      ; preds = %.us-lcssa7.us
  %34 = mul i32 %seed.0.ph, %hash.0.ph39
  %35 = load i8* %21, align 1
  %36 = sext i8 %35 to i32
  %37 = add i32 %36, %34
  %38 = getelementptr inbounds i8* %21, i64 1
  store i8* %38, i8** %1, align 8
  %39 = add i32 %i.0.ph35, 1
  br label %.outer.backedge

.outer.backedge:                                  ; preds = %33, %45
  %40 = phi i8* [ %38, %33 ], [ %21, %45 ]
  %i.0.ph.be = phi i32 [ %39, %33 ], [ %47, %45 ]
  %hash.0.ph.be = phi i32 [ %37, %33 ], [ 7, %45 ]
  ...
  %44 = icmp ult i32 %i.0.ph.be, %len
  br i1 %43, label %.outer..outer.split_crit_edge, label %.split

; <label>:45                                      ; preds = %.us-lcssa7.us
  %46 = add i32 %i.0.ph35, 1
...
!3157 = metadata !{i32 3490}
!3158 = metadata !{i32 4105}
