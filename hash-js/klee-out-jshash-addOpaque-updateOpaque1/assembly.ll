; ModuleID = './jshash-addOpaque-updateOpaque1.bc'
...
; <label>:47                                      ; preds = %47, %.lr.ph
  %48 = phi i8* [ %.pre, %.lr.ph ], [ %56, %47 ]
  %i.0.i3 = phi i32 [ 0, %.lr.ph ], [ %57, %47 ]
  %hash.0.i2 = phi i32 [ 1315423911, %.lr.ph ], [ %55, %47 ]
  %49 = shl i32 %hash.0.i2, 5
  %50 = load i8* %48, align 1
  %51 = sext i8 %50 to i32
  %52 = lshr i32 %hash.0.i2, 2
  %53 = add i32 %52, %49
  %54 = add i32 %53, %51
  %55 = xor i32 %54, %hash.0.i2
  %56 = getelementptr inbounds i8* %48, i64 1
  store i8* %56, i8** %1, align 8
  %57 = add i32 %i.0.i3, 1
  %exitcond = icmp eq i32 %57, %40
  br i1 %exitcond, label %.JSHash.exit_crit_edge, label %47

.JSHash.exit_crit_edge:                           ; preds = %47
  %phitmp = icmp eq i32 %55, 302766813
  %58 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  ...
  %61 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %62 = getelementptr inbounds %struct._1_main__opaque_Node_1* %61, i64 0, i32 1
  %63 = load %struct._1_main__opaque_Node_1** %62, align 8
  store %struct._1_main__opaque_Node_1* %63, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br i1 %phitmp, label %64, label %71

; <label>:64                                      ; preds = %.JSHash.exit_crit_edge
...
.critedge:                                        ; preds = %.preheader
  ...
  %68 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %69 = getelementptr inbounds %struct._1_main__opaque_Node_1* %68, i64 0, i32 1
  %70 = load %struct._1_main__opaque_Node_1** %69, align 8
  store %struct._1_main__opaque_Node_1* %70, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %71

; <label>:71                                      ; preds = %.critedge, %.JSHash.exit_crit_edge
