...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %442, label %JSHash.exit.thread, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %strlen.exit, %.lr.ph.i
  %.03.i = phi i8* [ %450, %.lr.ph.i ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %451, %.lr.ph.i ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %449, %.lr.ph.i ], [ 1315423911, %strlen.exit ]
  %443 = shl i32 %hash.01.i, 5
  %444 = load i8* %.03.i, align 1
  %445 = sext i8 %444 to i32
  %446 = lshr i32 %hash.01.i, 2
  %447 = add i32 %446, %443
  %448 = add i32 %447, %445
  %449 = xor i32 %448, %hash.01.i
  %450 = getelementptr inbounds i8* %.03.i, i64 1
  %451 = add i32 %i.02.i, 1
  %exitcond.i = icmp eq i32 %451, %441
  br i1 %exitcond.i, label %JSHash.exit, label %.lr.ph.i

JSHash.exit:                                      ; preds = %.lr.ph.i
  %452 = icmp eq i32 %449, 302766813
  br i1 %452, label %453, label %JSHash.exit.thread

; <label>:453                                     ; preds = %JSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %454

JSHash.exit.thread:                               ; preds = %strlen.exit, %JSHash.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %454

; <label>:454                                     ; preds = %JSHash.exit.thread, %453
  ret i32 0
}
