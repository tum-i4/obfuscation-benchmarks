...
define internal fastcc i32 @JSHash(i8* nocapture readonly %str, i32 %len) #2 {
...
; <label>:7                                       ; preds = %4
  %8 = tail call fastcc i32 @JSHash(i8* null, i32 undef)
  br label %10
...
.split.us:                                        ; preds = %10, %15
  %i.0.us = phi i32 [ %24, %15 ], [ 0, %10 ]
  %hash.0.us = phi i32 [ %22, %15 ], [ 1315423911, %10 ]
  %.01.us = phi i8* [ %23, %15 ], [ %str, %10 ]
  %14 = icmp ult i32 %i.0.us, %.02
  br i1 %14, label %15, label %.us-lcssa.us

; <label>:15                                      ; preds = %.split.us
  %16 = shl i32 %hash.0.us, 5
  %17 = load i8* %.01.us, align 1
  %18 = sext i8 %17 to i32
  %19 = lshr i32 %hash.0.us, 2
  %20 = add i32 %19, %16
  %21 = add i32 %20, %18
  %22 = xor i32 %21, %hash.0.us
  %23 = getelementptr inbounds i8* %.01.us, i64 1
  %24 = add i32 %i.0.us, 1
  br label %.split.us

.preheader:                                       ; preds = %10, %.loopexit.split
  %i.0 = phi i32 [ %26, %.loopexit.split ], [ 0, %10 ]
  %25 = icmp ult i32 %i.0, %.02
  br i1 %25, label %.preheader..preheader.split_crit_edge, label %.loopexit.split
