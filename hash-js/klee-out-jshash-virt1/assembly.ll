...
@"_1_JSHash_$array" = internal unnamed_addr constant [1 x [177 x i8]] [[177 x i8] c"U\0C\00\00\00\EF\A7\C6gN\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00U\10\00\00\00\07\BF\01\00\00\00\07\84\D6\0E\00\00\00:\04\00\00\00:l\
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_1_JSHash_$locals.i" = alloca [20 x i8], align 16
  %"_1_JSHash_$stack.i" = alloca [1 x [32 x %"union._1_JSHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [20 x i8]* %"_1_JSHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._1_JSHash_$node"]]* %"_1_JSHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._1_JSHash_$node"]]* %"_1_JSHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %613, %605, %597, %588, %585, %569, %562, %556, %554, %535, %526, %519, %513, %507, %505, %499, %493, %485, %476, %468, %460, %451, %.backedge.i, %strlen.exit
  %"_1_JSHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [177 x i8]]* @"_1_JSHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_1_JSHash_$pc.0.0.i", %.backedge.i ], [ %614, %613 ], [ %606, %605 ], [ %598, %597 ], [ %589, %588 ], [ %587, %5
  %"_1_JSHash_$sp.0.0.i" = phi %"union._1_JSHash_$node"* [ %448, %strlen.exit ], [ %"_1_JSHash_$sp.0.0.i", %.backedge.i ], [ %"_1_JSHash_$sp.0.0.i", %613 ], [ %609, %605 ], [ %601, %597 ], [ %590, %588 ], [ %586, %585 ], [ %576, %569 ], [ %566, %562 ], [
  %449 = load i8* %"_1_JSHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %453 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i64*
  %454 = load i64* %453, align 8
  %455 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  %456 = bitcast %"union._1_JSHash_$node"* %455 to i64*
  %457 = load i64* %456, align 8
  %458 = mul i64 %457, %454
  %459 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1, i32 0
  %.c2.i = inttoptr i64 %458 to i8*
  store i8* %.c2.i, i8** %459, align 8
  br label %.backedge.i

; <label>:460                                     ; preds = %.backedge.i
  %461 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %462 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  %463 = load i32* %462, align 4
  %464 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  %465 = bitcast %"union._1_JSHash_$node"* %464 to i32*
...
; <label>:468                                     ; preds = %.backedge.i
  %469 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %470 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  %471 = bitcast %"union._1_JSHash_$node"* %470 to i32*
  %472 = load i32* %471, align 4
  %473 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
...
; <label>:476                                     ; preds = %.backedge.i
  %477 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %478 = bitcast i8* %477 to i32*
  %479 = load i32* %478, align 4
  %480 = sext i32 %479 to i64
  %481 = getelementptr inbounds [20 x i8]* %"_1_JSHash_$locals.i", i64 0, i64 %480
  %482 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %481, i8** %482, align 8
  %483 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1
  %484 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:485                                     ; preds = %.backedge.i
  %486 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %487 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1, i32 0
  %488 = load i8** %487, align 8
  %489 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 0, i32 0
  %490 = load i8** %489, align 8
  %491 = bitcast i8* %490 to i8**
  store i8* %488, i8** %491, align 8
  %492 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:493                                     ; preds = %.backedge.i
  %494 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %495 = bitcast i8* %494 to i32*
  %496 = load i32* %495, align 4
  %497 = sext i32 %496 to i64
  %.sum.i = add i64 %497, 1
  %498 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:499                                     ; preds = %.backedge.i
  %500 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %501 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 0, i32 0
  %502 = load i8** %501, align 8
...
; <label>:505                                     ; preds = %.backedge.i
  %506 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:507                                     ; preds = %.backedge.i
  %508 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %509 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i8*
  %510 = load i8* %509, align 1
  %511 = sext i8 %510 to i32
  %512 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  store i32 %511, i32* %512, align 4
  br label %.backedge.i

; <label>:513                                     ; preds = %.backedge.i
  %514 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %515 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  %516 = load i32* %515, align 4
  %517 = sext i32 %516 to i64
  %518 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 0, i32 0
  %.c1.i = inttoptr i64 %517 to i8*
  store i8* %.c1.i, i8** %518, align 8
  br label %.backedge.i

; <label>:519                                     ; preds = %.backedge.i
  %520 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %521 = bitcast i8* %520 to i64*
  %522 = load i64* %521, align 8
  %523 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1, i32 0
  %.c.i = inttoptr i64 %522 to i8*
  store i8* %.c.i, i8** %523, align 8
  %524 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1
  %525 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:526                                     ; preds = %.backedge.i
  %527 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %528 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 0, i32 0
  %529 = load i8** %528, align 8
  %530 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  %531 = bitcast %"union._1_JSHash_$node"* %530 to i64*
  %532 = load i64* %531, align 8
  %533 = getelementptr i8* %529, i64 %532
  %534 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %533, i8** %534, align 8
  br label %.backedge.i

; <label>:535                                     ; preds = %.backedge.i
  %536 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %537 = bitcast i8* %536 to i32*
  %538 = load i32* %537, align 4
  %539 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1
  %540 = bitcast %"union._1_JSHash_$node"* %539 to i32*
  store i32 %538, i32* %540, align 4
  %541 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:542                                     ; preds = %.backedge.i
  %543 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  %544 = load i32* %543, align 4
  %545 = icmp eq i32 %544, 0
  br i1 %545, label %552, label %546

; <label>:546                                     ; preds = %542
  %547 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %548 = bitcast i8* %547 to i32*
  %549 = load i32* %548, align 4
  %550 = sext i32 %549 to i64
  %.sum3.i = add i64 %550, 1
  %551 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 %.sum3.i
  br label %554

; <label>:552                                     ; preds = %542
  %553 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 5
  br label %554

; <label>:554                                     ; preds = %552, %546
  %"_1_JSHash_$pc.0.1.i" = phi i8* [ %553, %552 ], [ %551, %546 ]
  %555 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:556                                     ; preds = %.backedge.i
  %557 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %558 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 0, i32 0
  %559 = load i8** %558, align 8
  %560 = load i8* %559, align 1
  %561 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i8*
  store i8 %560, i8* %561, align 1
  br label %.backedge.i

; <label>:562                                     ; preds = %.backedge.i
  %563 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %564 = bitcast i8* %563 to i32*
  %565 = load i32* %564, align 4
  %566 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1
  %567 = bitcast %"union._1_JSHash_$node"* %566 to i32*
  store i32 %565, i32* %567, align 4
  %568 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:569                                     ; preds = %.backedge.i
  %570 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %571 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  %572 = load i32* %571, align 4
  %573 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1, i32 0
  %574 = load i8** %573, align 8
  %575 = bitcast i8* %574 to i32*
  store i32 %572, i32* %575, align 4
  %576 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:577                                     ; preds = %.backedge.i
  %578 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %579 = bitcast i8* %578 to i32*
  %580 = load i32* %579, align 4
  switch i32 %580, label %585 [
    i32 1, label %581
    i32 0, label %583
  ]

; <label>:581                                     ; preds = %577
  %582 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %582, align 8
  br label %585

; <label>:583                                     ; preds = %577
  %584 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %584, align 8
  br label %585

; <label>:585                                     ; preds = %583, %581, %577
  %586 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 1
  %587 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:588                                     ; preds = %.backedge.i
  %589 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %590 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  %591 = bitcast %"union._1_JSHash_$node"* %590 to i32*
  %592 = load i32* %591, align 4
  %593 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
...
; <label>:597                                     ; preds = %.backedge.i
  %598 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %599 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  %600 = load i32* %599, align 4
  %601 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  %602 = bitcast %"union._1_JSHash_$node"* %601 to i32*
...
; <label>:605                                     ; preds = %.backedge.i
  %606 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %607 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  %608 = load i32* %607, align 4
  %609 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 -1
  %610 = bitcast %"union._1_JSHash_$node"* %609 to i32*
...
; <label>:613                                     ; preds = %.backedge.i
  %614 = getelementptr inbounds i8* %"_1_JSHash_$pc.0.0.i", i64 1
  %615 = getelementptr inbounds %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i", i64 0, i32 0
  %616 = load i8** %615, align 8
  %617 = bitcast i8* %616 to i32*
  %618 = load i32* %617, align 4
  %619 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  store i32 %618, i32* %619, align 4
  br label %.backedge.i

JSHash.exit:                                      ; preds = %.backedge.i
  %620 = bitcast %"union._1_JSHash_$node"* %"_1_JSHash_$sp.0.0.i" to i32*
  %621 = load i32* %620, align 4
  %622 = icmp eq i32 %621, 302766813
  br i1 %622, label %623, label %624

; <label>:623                                     ; preds = %JSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %625

; <label>:624                                     ; preds = %JSHash.exit
