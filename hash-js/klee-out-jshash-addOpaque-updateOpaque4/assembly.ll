; ModuleID = './jshash-addOpaque-updateOpaque4.bc'
...
; <label>:13                                      ; preds = %0
  %14 = call fastcc i32 @JSHash(i8* null, i32 %len)
  br label %.preheader

.preheader:                                       ; preds = %0, %13
  %.0.ph = phi i32 [ %14, %13 ], [ %len, %0 ]
  %15 = icmp eq i32 %.0.ph, 0
  br i1 %15, label %.split, label %.outer..outer.split_crit_edge.preheader

.outer..outer.split_crit_edge.preheader:          ; preds = %.preheader
  %.in = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %16 = icmp eq %struct._1_main__opaque_Node_1* %.in, null
  br label %.outer..outer.split_crit_edge

.outer..outer.split_crit_edge:                    ; preds = %.outer..outer.split_crit_edge.preheader, %.outer
  %17 = phi i8* [ %52, %.outer ], [ %str, %.outer..outer.split_crit_edge.preheader ]
  %hash.0.ph8 = phi i32 [ %51, %.outer ], [ 1315423911, %.outer..outer.split_crit_edge.preheader ]
  %i.0.ph7 = phi i32 [ %53, %.outer ], [ 0, %.outer..outer.split_crit_edge.preheader ]
  br i1 %16, label %.outer.split.split.us, label %.outer

.outer.split.split.us:                            ; preds = %.outer..outer.split_crit_edge, %.outer.split.split.us
  br label %.outer.split.split.us

.split:                                           ; preds = %.outer, %.preheader
  %hash.0.ph.lcssa = phi i32 [ 1315423911, %.preheader ], [ %51, %.outer ]
...
; <label>:20                                      ; preds = %.split
  ...
  %22 = icmp eq %struct._1_main__opaque_Node_1* %18, %21
  br i1 %22, label %25, label %23

; <label>:23                                      ; preds = %20
  %24 = call fastcc i32 @__user_main(i32 3, i8** %1)
  br label %25

; <label>:25                                      ; preds = %20, %23
  %26 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %27 = getelementptr inbounds %struct._1_main__opaque_Node_1* %26, i64 0, i32 1
  ...
  %30 = getelementptr inbounds %struct._1_main__opaque_Node_1* %29, i64 0, i32 1
  %31 = load %struct._1_main__opaque_Node_1** %30, align 8
  br label %39

; <label>:32                                      ; preds = %.split
  %33 = load %struct._1_main__opaque_Node_1** inttoptr (i64 8 to %struct._1_main__opaque_Node_1**), align 8
...
; <label>:39                                      ; preds = %32, %25
  %40 = phi %struct._1_main__opaque_Node_1* [ %34, %32 ], [ %28, %25 ]
  %storemerge = phi %struct._1_main__opaque_Node_1* [ %38, %32 ], [ %31, %25 ]
  ...
  %43 = getelementptr inbounds %struct._1_main__opaque_Node_1* %storemerge, i64 0, i32 1
  ...
  ret i32 %hash.0.ph.lcssa

.outer:                                           ; preds = %.outer..outer.split_crit_edge
  %45 = shl i32 %hash.0.ph8, 5
  %46 = load i8* %17, align 1
  %47 = sext i8 %46 to i32
  %48 = lshr i32 %hash.0.ph8, 2
  %49 = add i32 %48, %45
  %50 = add i32 %49, %47
  %51 = xor i32 %50, %hash.0.ph8
  %52 = getelementptr inbounds i8* %17, i64 1
  store i8* %52, i8** %1, align 8
  %53 = add i32 %i.0.ph7, 1
  %54 = icmp ult i32 %53, %.0.ph
  br i1 %54, label %.outer..outer.split_crit_edge, label %.split
}
