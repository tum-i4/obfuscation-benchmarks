...
; <label>:463                                     ; preds = %463, %515
  %p.0.i = phi i8* [ %519, %515 ], [ %466, %463 ]
...
.split.us.i:                                      ; preds = %.split.us.i.preheader, %.split.us.i
  %.0.us.i4 = phi i8* [ %481, %.split.us.i ], [ %519, %.split.us.i.preheader ]
  %i.0.us.i3 = phi i32 [ %482, %.split.us.i ], [ 0, %.split.us.i.preheader ]
  %hash.0.us.i2 = phi i32 [ %480, %.split.us.i ], [ 1315423911, %.split.us.i.preheader ]
  %474 = shl i32 %hash.0.us.i2, 5
  %475 = load i8* %.0.us.i4, align 1
  %476 = sext i8 %475 to i32
  %477 = lshr i32 %hash.0.us.i2, 2
  %478 = add i32 %477, %474
  %479 = add i32 %478, %476
  %480 = xor i32 %479, %hash.0.us.i2
  %481 = getelementptr inbounds i8* %.0.us.i4, i64 1
  %482 = add i32 %i.0.us.i3, 1
  %exitcond = icmp eq i32 %482, %470
  br i1 %exitcond, label %.split.us.i.JSHash.exit_crit_edge, label %.split.us.i

.preheader.i:                                     ; preds = %strlen.exit, %.preheader.i
  %i.0.i = phi i32 [ %484, %.preheader.i ], [ 0, %strlen.exit ]
  %483 = icmp ult i32 %i.0.i, %470
  %484 = add i32 %i.0.i, 1
  br i1 %483, label %.preheader..preheader.split_crit_edge.i, label %.preheader.i
...
.split.us.i.JSHash.exit_crit_edge:                ; preds = %.split.us.i
  %phitmp = icmp eq i32 %480, 302766813
  br i1 %phitmp, label %485, label %.critedge

; <label>:485                                     ; preds = %.split.us.i.JSHash.exit_crit_edge
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str107, i64 0, i64 0))
  br label %486

.critedge:                                        ; preds = %.split.us.i.preheader, %.split.us.i.JSHash.exit_crit_edge
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([30 x i8]* @str, i64 0, i64 0))
  br label %486

; <label>:486                                     ; preds = %.critedge, %485
  ret i32 0

; <label>:487                                     ; preds = %460, %452, %rand.exit
  %488 = load i32* %444, align 4, !dbg !3143
  %489 = load i32* %443, align 4, !dbg !3143
  %490 = add nsw i32 %489, %488, !dbg !3143
  store i32 %490, i32* %443, align 4, !dbg !3143
  %491 = lshr i32 %490, 1, !dbg !3144
  %492 = getelementptr inbounds i32* %443, i64 1, !dbg !3145
  %493 = icmp ult i32* %492, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3146
  %494 = getelementptr inbounds i32* %444, i64 1, !dbg !3148
  br i1 %493, label %495, label %rand.exit.1, !dbg !3146

; <label>:495                                     ; preds = %487
  %496 = icmp ult i32* %494, getelementptr inbounds ([32 x i32]* @randtbl, i64 1, i64 0), !dbg !3150
  %..i.i.i.1 = select i1 %496, i32* %494, i32* getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), !dbg !3150
  br label %rand.exit.1, !dbg !3150

rand.exit.1:                                      ; preds = %487, %495
  %fptr.0.i.i.i.1 = phi i32* [ getelementptr inbounds ([32 x i32]* @randtbl, i64 0, i64 1), %487 ], [ %492, %495 ]
  %rptr.0.i.i.i.1 = phi i32* [ %494, %487 ], [ %..i.i.i.1, %495 ]
  store i32* %fptr.0.i.i.i.1, i32** @unsafe_state.0, align 8, !dbg !3152
  store i32* %rptr.0.i.i.i.1, i32** @unsafe_state.1, align 8, !dbg !3153
  %497 = tail call i8* @malloc(i64 16) #7
  %498 = bitcast i8* %497 to %struct._1_main__opaque_Node_1*
  %499 = icmp eq i8* %497, null
  br i1 %499, label %515, label %500

; <label>:500                                     ; preds = %rand.exit.1
  %501 = bitcast i8* %497 to i32*
  store i32 %491, i32* %501, align 4
  %502 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %503 = icmp eq %struct._1_main__opaque_Node_1* %502, null
...
; <label>:504                                     ; preds = %500
  ...
  %508 = getelementptr inbounds i8* %497, i64 8
  %509 = bitcast i8* %508 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %507, %struct._1_main__opaque_Node_1** %509, align 8
  ...
  store %struct._1_main__opaque_Node_1* %498, %struct._1_main__opaque_Node_1** %511, align 8
  br label %515

; <label>:512                                     ; preds = %500
  %513 = getelementptr inbounds i8* %497, i64 8
  %514 = bitcast i8* %513 to %struct._1_main__opaque_Node_1**
  store %struct._1_main__opaque_Node_1* %498, %struct._1_main__opaque_Node_1** %514, align 8
  store %struct._1_main__opaque_Node_1* %498, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %515

; <label>:515                                     ; preds = %512, %504, %rand.exit.1
  ...
  %517 = getelementptr inbounds i8* %329, i64 8
