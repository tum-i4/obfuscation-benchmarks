; ModuleID = './jshash-addOpaque-updateOpaque64.bc'
...
define internal fastcc i32 @JSHash(i8* %str, i32 %len) #0 {
  %1 = alloca i8*, align 8
...
; <label>:17                                      ; preds = %0
  %18 = call fastcc i32 @JSHash(i8* null, i32 undef)
  %.pre35 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %.pre36 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %19

; <label>:19                                      ; preds = %0, %17
  %20 = phi %struct._1_main__opaque_Node_1* [ %15, %0 ], [ %.pre36, %17 ]
  %21 = phi %struct._1_main__opaque_Node_1* [ %13, %0 ], [ %.pre35, %17 ]
...
; <label>:71                                      ; preds = %39
  %72 = call fastcc i32 @JSHash(i8* null, i32 %len)
  %.pre38 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %.pre39 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %73

; <label>:73                                      ; preds = %39, %71
  %74 = phi %struct._1_main__opaque_Node_1* [ %.pre39, %71 ], [ %67, %39 ]
  %75 = phi %struct._1_main__opaque_Node_1* [ %.pre38, %71 ], [ %67, %39 ]
  ...
  br i1 %84, label %85, label %.preheader15
...
.outer:                                           ; preds = %414, %.preheader15
  %112 = phi i8* [ %str, %.preheader15 ], [ %422, %414 ]
  %113 = phi %struct._1_main__opaque_Node_1* [ %110, %.preheader15 ], [ %412, %414 ]
  %114 = phi %struct._1_main__opaque_Node_1* [ %108, %.preheader15 ], [ %410, %414 ]
  %i.0.ph16 = phi i32 [ 0, %.preheader15 ], [ %423, %414 ]
  %hash.0.ph17 = phi i32 [ 1315423911, %.preheader15 ], [ %421, %414 ]
  %115 = icmp ult i32 %i.0.ph16, %.01
  br label %116

; <label>:116                                     ; preds = %.outer, %398
  %_1_main__opaque_list1_1.promoted27 = phi %struct._1_main__opaque_Node_1* [ null, %398 ], [ %114, %.outer ]
  %_1_main__opaque_list2_1.promoted28 = phi %struct._1_main__opaque_Node_1* [ %412, %398 ], [ %113, %.outer ]
  %hash.0 = phi i32 [ %hash.6, %398 ], [ %hash.0.ph17, %.outer ]
  %117 = icmp eq %struct._1_main__opaque_Node_1* %_1_main__opaque_list1_1.promoted27, null
...
; <label>:118                                     ; preds = %116
  %119 = getelementptr inbounds %struct._1_main__opaque_Node_1* %_1_main__opaque_list1_1.promoted27, i64 0, i32 1
  ...
  %121 = getelementptr inbounds %struct._1_main__opaque_Node_1* %_1_main__opaque_list2_1.promoted28, i64 0, i32 1
...
; <label>:128                                     ; preds = %118
  %129 = call fastcc i32 @JSHash(i8* null, i32 %i.0.ph16)
  %.pre41 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %130

; <label>:130                                     ; preds = %118, %128
  %131 = phi %struct._1_main__opaque_Node_1* [ %.pre41, %128 ], [ %124, %118 ]
...
; <label>:137                                     ; preds = %133
  %138 = call fastcc i32 @JSHash(i8* null, i32 %i.0.ph16)
...
; <label>:159                                     ; preds = %130, %157, %145, %158
  ...
  br i1 %166, label %167, label %.thread69
...
; <label>:176                                     ; preds = %.thread69
  %177 = call fastcc i32 @JSHash(i8* null, i32 %.01)
  ...
  %.phi.trans.insert63 = getelementptr inbounds %struct._1_main__opaque_Node_1* %.pre62, i64 0, i32 1
  %.pre64 = load %struct._1_main__opaque_Node_1** %.phi.trans.insert63, align 8
  %phitmp68 = icmp eq %struct._1_main__opaque_Node_1* %.pr7.pre, null
  br i1 %phitmp68, label %178, label %._crit_edge65

._crit_edge65:                                    ; preds = %176
  %.pre66 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %184

; <label>:178                                     ; preds = %176
  %179 = getelementptr inbounds %struct._1_main__opaque_Node_1* %.pre64, i64 -1
...
; <label>:184                                     ; preds = %._crit_edge65, %.thread
  %185 = phi %struct._1_main__opaque_Node_1* [ %172, %.thread ], [ %.pre66, %._crit_edge65 ]
  %186 = phi %struct._1_main__opaque_Node_1* [ %175, %.thread ], [ %.pre64, %._crit_edge65 ]
  %hash.48 = phi i32 [ %hash.3, %.thread ], [ %177, %._crit_edge65 ]
...
; <label>:215                                     ; preds = %212
  ...
  br i1 %216, label %.preheader13, label %217
...
; <label>:226                                     ; preds = %.preheader13
  %227 = call fastcc i32 @JSHash(i8* null, i32 %hash.5)
  %.pre24 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %228

; <label>:228                                     ; preds = %.preheader13, %226
  %229 = phi %struct._1_main__opaque_Node_1* [ %224, %.preheader13 ], [ %.pre24, %226 ]
...
; <label>:274                                     ; preds = %271, %272, %269, %268
  ...
  br i1 %phitmp, label %._crit_edge, label %.thread26

._crit_edge:                                      ; preds = %274
  %.pre = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %.pre46 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %275

.thread26:                                        ; preds = %274
  %.pre55 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %.phi.trans.insert = getelementptr inbounds %struct._1_main__opaque_Node_1* %.pre55, i64 0, i32 1
  %.pre56 = load %struct._1_main__opaque_Node_1** %.phi.trans.insert, align 8
  %.pre57 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %.phi.trans.insert58 = getelementptr inbounds %struct._1_main__opaque_Node_1* %.pre57, i64 0, i32 1
  %.pre59 = load %struct._1_main__opaque_Node_1** %.phi.trans.insert58, align 8
  store %struct._1_main__opaque_Node_1* %.pre56, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  store %struct._1_main__opaque_Node_1* %.pre59, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %275

; <label>:275                                     ; preds = %._crit_edge, %.thread26
  %276 = phi %struct._1_main__opaque_Node_1* [ %.pre46, %._crit_edge ], [ %.pre56, %.thread26 ]
  %277 = phi %struct._1_main__opaque_Node_1* [ %.pre, %._crit_edge ], [ %.pre59, %.thread26 ]
...
; <label>:302                                     ; preds = %291, %297, %301
  %303 = phi %struct._1_main__opaque_Node_1* [ %299, %297 ], [ %.pre47, %301 ], [ %292, %291 ]
  %304 = phi %struct._1_main__opaque_Node_1* [ %300, %297 ], [ %.pre25, %301 ], [ %293, %291 ]
...
; <label>:313                                     ; preds = %302
  ...
  %.pre49 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %314

; <label>:314                                     ; preds = %313, %306
  %315 = phi %struct._1_main__opaque_Node_1* [ %.pre49, %313 ], [ %312, %306 ]
  %316 = phi %struct._1_main__opaque_Node_1* [ %.pre48, %313 ], [ %309, %306 ]
...
; <label>:322                                     ; preds = %314
  ...
  %.pre50 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
...
; <label>:328                                     ; preds = %323, %322
  %329 = phi %struct._1_main__opaque_Node_1* [ %327, %323 ], [ %.pre51, %322 ]
  %330 = phi %struct._1_main__opaque_Node_1* [ %325, %323 ], [ %.pre50, %322 ]
...
; <label>:340                                     ; preds = %328
  ...
  %.pre52 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %.pre53 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %341

; <label>:341                                     ; preds = %340, %336
  %342 = phi %struct._1_main__opaque_Node_1* [ %.pre53, %340 ], [ %339, %336 ]
  %343 = phi %struct._1_main__opaque_Node_1* [ %.pre52, %340 ], [ %338, %336 ]
...
; <label>:383                                     ; preds = %373
  ...
  %.pre43 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %384

; <label>:384                                     ; preds = %383, %379
  %385 = phi %struct._1_main__opaque_Node_1* [ %.pre43, %383 ], [ %382, %379 ]
  %386 = phi %struct._1_main__opaque_Node_1* [ %.pre42, %383 ], [ %381, %379 ]
...
; <label>:396                                     ; preds = %384
  %397 = call fastcc i32 @JSHash(i8* null, i32 %i.0.ph16)
  %.pre44 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %.pre45 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %398

; <label>:398                                     ; preds = %384, %396
  %399 = phi %struct._1_main__opaque_Node_1* [ %.pre45, %396 ], [ %394, %384 ]
  %400 = phi %struct._1_main__opaque_Node_1* [ %.pre44, %396 ], [ %392, %384 ]
...
; <label>:414                                     ; preds = %398
  %415 = shl i32 %hash.6, 5
  %416 = load i8* %112, align 1
  %417 = sext i8 %416 to i32
  %418 = lshr i32 %hash.6, 2
  %419 = add i32 %418, %415
  %420 = add i32 %419, %417
  %421 = xor i32 %420, %hash.6
  %422 = getelementptr inbounds i8* %112, i64 1
  store i8* %422, i8** %1, align 8
  %423 = add i32 %i.0.ph16, 1
  br label %.outer

; <label>:424                                     ; preds = %341, %369
  %425 = phi %struct._1_main__opaque_Node_1* [ %372, %369 ], [ %367, %341 ]
  %426 = phi %struct._1_main__opaque_Node_1* [ %371, %369 ], [ %365, %341 ]
  %427 = getelementptr inbounds %struct._1_main__opaque_Node_1* %426, i64 0, i32 1
  %428 = load %struct._1_main__opaque_Node_1** %427, align 8
  %429 = getelementptr inbounds %struct._1_main__opaque_Node_1* %425, i64 0, i32 1
  %430 = load %struct._1_main__opaque_Node_1** %429, align 8
  %431 = getelementptr inbounds %struct._1_main__opaque_Node_1* %428, i64 0, i32 1
  %432 = load %struct._1_main__opaque_Node_1** %431, align 8
  %433 = getelementptr inbounds %struct._1_main__opaque_Node_1* %430, i64 0, i32 1
  %434 = load %struct._1_main__opaque_Node_1** %433, align 8
  %435 = getelementptr inbounds %struct._1_main__opaque_Node_1* %432, i64 0, i32 1
  %436 = load %struct._1_main__opaque_Node_1** %435, align 8
  %437 = getelementptr inbounds %struct._1_main__opaque_Node_1* %434, i64 0, i32 1
  %438 = load %struct._1_main__opaque_Node_1** %437, align 8
  %439 = getelementptr inbounds %struct._1_main__opaque_Node_1* %436, i64 0, i32 1
  %440 = load %struct._1_main__opaque_Node_1** %439, align 8
  %441 = getelementptr inbounds %struct._1_main__opaque_Node_1* %438, i64 0, i32 1
  %442 = load %struct._1_main__opaque_Node_1** %441, align 8
  %443 = getelementptr inbounds %struct._1_main__opaque_Node_1* %440, i64 0, i32 1
  %444 = load %struct._1_main__opaque_Node_1** %443, align 8
  %445 = getelementptr inbounds %struct._1_main__opaque_Node_1* %442, i64 0, i32 1
  %446 = load %struct._1_main__opaque_Node_1** %445, align 8
  %447 = getelementptr inbounds %struct._1_main__opaque_Node_1* %444, i64 0, i32 1
  %448 = load %struct._1_main__opaque_Node_1** %447, align 8
  %449 = getelementptr inbounds %struct._1_main__opaque_Node_1* %446, i64 0, i32 1
  %450 = load %struct._1_main__opaque_Node_1** %449, align 8
  %451 = getelementptr inbounds %struct._1_main__opaque_Node_1* %448, i64 0, i32 1
  %452 = load %struct._1_main__opaque_Node_1** %451, align 8
  store %struct._1_main__opaque_Node_1* %452, %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %453 = getelementptr inbounds %struct._1_main__opaque_Node_1* %450, i64 0, i32 1
  %454 = load %struct._1_main__opaque_Node_1** %453, align 8
  store %struct._1_main__opaque_Node_1* %454, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  ret i32 %hash.5
}
...
strlen.exit:                                      ; preds = %463
  ...
  %471 = tail call fastcc i32 @JSHash(i8* %508, i32 %470)
  %472 = icmp eq i32 %471, 302766813
...
!2857 = metadata !{i32 3878}
!2858 = metadata !{i32 3946}
!2859 = metadata !{i32 15072}
!2860 = metadata !{i32 15203}
!2861 = metadata !{i32 15407}
!2862 = metadata !{i32 23598}
!2863 = metadata !{i32 24149}
!2864 = metadata !{i32 24479}
!2865 = metadata !{i32 25283}
!2866 = metadata !{i32 27351}
