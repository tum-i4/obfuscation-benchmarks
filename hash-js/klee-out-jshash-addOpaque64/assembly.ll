; ModuleID = './jshash-addOpaque64.bc'
...
define internal fastcc i32 @JSHash(i8* %str, i32 %len) #2 {
  %1 = alloca i8*, align 8
...
; <label>:4                                       ; preds = %0
  %5 = call fastcc i32 @JSHash(i8* null, i32 undef)
  br label %6
...
; <label>:13                                      ; preds = %10
  %14 = call fastcc i32 @JSHash(i8* null, i32 %i.0)
  br label %20
...
.backedge:                                        ; preds = %62, %.thread.thread, %20
  %24 = phi i8* [ %str, %20 ], [ %63, %62 ], [ %71, %.thread.thread ]
  %i.1 = phi i32 [ %.i.0, %20 ], [ 6, %62 ], [ %72, %.thread.thread ]
  %hash.0 = phi i32 [ 1315423911, %20 ], [ 5, %62 ], [ %70, %.thread.thread ]
...
; <label>:39                                      ; preds = %35
  ...
  br i1 %40, label %thread-pre-split, label %.preheader35

.preheader35:                                     ; preds = %39
  %41 = icmp ult i32 %i.1, %.08
  br i1 %41, label %.preheader35..preheader35.split_crit_edge, label %.split

.preheader35..preheader35.split_crit_edge:        ; preds = %.preheader35, %.preheader35..preheader35.split_crit_edge
  br label %.preheader35..preheader35.split_crit_edge

.split:                                           ; preds = %.preheader35
...
; <label>:54                                      ; preds = %.backedge
  ...
  br i1 %55, label %thread-pre-split, label %73
...
.thread.thread:                                   ; preds = %.split, %.thread
  %64 = shl i32 %hash.0, 5
  %65 = load i8* %24, align 1
  %66 = sext i8 %65 to i32
  %67 = lshr i32 %hash.0, 2
  %68 = add i32 %67, %64
  %69 = add i32 %68, %66
  %70 = xor i32 %69, %hash.0
  %71 = getelementptr inbounds i8* %24, i64 1
...
; <label>:73                                      ; preds = %54
  ...
  %75 = icmp eq %struct._1_main__opaque_Node_1* %74, null
  br i1 %75, label %76, label %.thread14

; <label>:76                                      ; preds = %73
  %77 = call fastcc i32 @__user_main(i32 0, i8** %1)
  %.pr9 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %78 = icmp eq %struct._1_main__opaque_Node_1* %.pr9, null
  br i1 %78, label %.thread10, label %.thread14

.thread10:                                        ; preds = %76
  %79 = call fastcc i32 @JSHash(i8* null, i32 %i.1)
  %.pr13.pr = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %80 = icmp eq %struct._1_main__opaque_Node_1* %.pr13.pr, null
  br i1 %80, label %.thread20, label %.thread14
...
.thread20:                                        ; preds = %.thread10
  ...
  br i1 %82, label %206, label %208

.thread14:                                        ; preds = %73, %76, %.thread10
  %hash.116 = phi i32 [ %79, %.thread10 ], [ %hash.0, %76 ], [ %hash.0, %73 ]
  ...
  br i1 %85, label %86, label %.loopexit32

; <label>:86                                      ; preds = %.thread14
...
; <label>:90                                      ; preds = %86
  %91 = icmp eq %struct._1_main__opaque_Node_1* %89, null
  %92 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br i1 %91, label %.preheader27, label %102

.preheader27:                                     ; preds = %90
...
; <label>:95                                      ; preds = %.preheader27
  %96 = call fastcc i32 @JSHash(i8* null, i32 %.08)
  br label %.lr.phthread-pre-split

.lr.phthread-pre-split:                           ; preds = %101, %95
  %.pr56 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.phthread-pre-split, %.preheader27
  %97 = phi %struct._1_main__opaque_Node_1* [ %.pr56, %.lr.phthread-pre-split ], [ %92, %.preheader27 ]
  %98 = icmp eq %struct._1_main__opaque_Node_1* %97, null
  br i1 %98, label %99, label %101

; <label>:99                                      ; preds = %.lr.ph
  %100 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %101

; <label>:101                                     ; preds = %.lr.ph, %99
  call void asm sideeffect ".byte 0x39,0x47,0x20,0x7f,0x1a,0x7d,0x7,0xb8", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3159
  br label %.lr.phthread-pre-split

; <label>:102                                     ; preds = %90
  %103 = icmp eq %struct._1_main__opaque_Node_1* %92, null
...
; <label>:107                                     ; preds = %104
  ...
  br label %.preheader30thread-pre-split
...
; <label>:114                                     ; preds = %111
  %115 = or i32 %hash.116, %i.1
  %116 = call fastcc i32 @JSHash(i8* inttoptr (i64 9 to i8*), i32 %115)
  br label %119

; <label>:117                                     ; preds = %111
  %118 = call fastcc i32 @JSHash(i8* null, i32 %hash.116)
  br label %119

; <label>:119                                     ; preds = %108, %114, %117
  %120 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %121 = icmp eq %struct._1_main__opaque_Node_1* %120, null
  br i1 %121, label %122, label %thread-pre-split18

; <label>:122                                     ; preds = %119
  call void asm sideeffect ".byte 0x0,0x0,0x48,0x8d", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3161
  br label %.preheader30thread-pre-split

.preheader30thread-pre-split:                     ; preds = %.critedge, %107, %122
  %.pr57 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %phitmp = icmp eq %struct._1_main__opaque_Node_1* %.pr57, null
  br i1 %phitmp, label %.critedge, label %123

; <label>:123                                     ; preds = %.preheader30thread-pre-split
  %124 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %125 = icmp eq %struct._1_main__opaque_Node_1* %124, null
...
; <label>:130                                     ; preds = %127
  %131 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
...
; <label>:134                                     ; preds = %130
  %135 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %136 = icmp eq %struct._1_main__opaque_Node_1* %135, null
...
; <label>:148                                     ; preds = %145
  ...
  %150 = icmp eq %struct._1_main__opaque_Node_1* %149, null
...
.critedge:                                        ; preds = %102, %148, %126, %133, %153, %151, %152, %137, %127, %.preheader30thread-pre-split
  %154 = call fastcc i32 @__user_main(i32 3, i8** %1)
  br label %.preheader30thread-pre-split

; <label>:155                                     ; preds = %86
  %156 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %157 = icmp eq %struct._1_main__opaque_Node_1* %89, %156
  br i1 %157, label %160, label %158

; <label>:158                                     ; preds = %155
  %159 = call fastcc i32 @JSHash(i8* null, i32 %i.1)
  br label %160

; <label>:160                                     ; preds = %155, %158
  %hash.2 = phi i32 [ %hash.116, %155 ], [ %159, %158 ]
...
; <label>:163                                     ; preds = %160
  ...
  br i1 %165, label %thread-pre-split18, label %.preheader31

.preheader31:                                     ; preds = %163
  %166 = getelementptr inbounds i8** %1, i64 -1
  br label %167

; <label>:167                                     ; preds = %.preheader31, %185
  ...
  %170 = icmp eq %struct._1_main__opaque_Node_1* %168, %169
  br i1 %170, label %171, label %179

; <label>:171                                     ; preds = %167
  %172 = icmp ne %struct._1_main__opaque_Node_1* %168, null
  %173 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %174 = icmp ne %struct._1_main__opaque_Node_1* %173, null
  %or.cond7 = and i1 %172, %174
  br i1 %or.cond7, label %175, label %185

; <label>:175                                     ; preds = %171
  %176 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %177 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %178 = icmp eq %struct._1_main__opaque_Node_1* %176, %177
  br i1 %178, label %.loopexit32, label %185

; <label>:179                                     ; preds = %167
  %180 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %181 = icmp eq %struct._1_main__opaque_Node_1* %168, %180
...
; <label>:184                                     ; preds = %179, %182
  call void asm sideeffect ".byte 0xe1,0x52,0x1c,0x3a,0x62", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3168
  br label %185

; <label>:185                                     ; preds = %175, %171, %184
  %186 = call fastcc i32 @__user_main(i32 0, i8** %166)
  br label %167
...
; <label>:190                                     ; preds = %187
  ...
  %192 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %193 = icmp eq %struct._1_main__opaque_Node_1* %191, %192
...
; <label>:196                                     ; preds = %187, %194, %190
  ...
  br i1 %199, label %thread-pre-split18, label %200

; <label>:200                                     ; preds = %196
  call void asm sideeffect ".byte 0x39,0x57,0x48,0x7f", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3169
  br label %thread-pre-split18

thread-pre-split18:                               ; preds = %196, %119, %200, %163
  %hash.3.ph = phi i32 [ %hash.2, %163 ], [ %hash.2, %200 ], [ %hash.116, %119 ], [ %hash.2, %196 ]
...
.loopexit32:                                      ; preds = %175, %thread-pre-split18, %.thread14
  %201 = phi %struct._1_main__opaque_Node_1* [ %.pr23, %thread-pre-split18 ], [ %84, %.thread14 ], [ %176, %175 ]
  %202 = phi %struct._1_main__opaque_Node_1* [ %.pr19, %thread-pre-split18 ], [ %83, %.thread14 ], [ %176, %175 ]
  %hash.3 = phi i32 [ %hash.3.ph, %thread-pre-split18 ], [ %hash.116, %.thread14 ], [ %hash.2, %175 ]
  %203 = icmp eq %struct._1_main__opaque_Node_1* %202, null
  %204 = icmp eq %struct._1_main__opaque_Node_1* %201, null
  br i1 %203, label %205, label %209

; <label>:205                                     ; preds = %.loopexit32
  br i1 %204, label %206, label %208

; <label>:206                                     ; preds = %.thread20, %205
  %207 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %208

; <label>:208                                     ; preds = %.thread20, %205, %206
  call void asm sideeffect ".byte 0x81,0xe7,0xed,0xfb,0xff,0x41", "~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !3170
  br label %.loopexit

; <label>:209                                     ; preds = %.loopexit32
...
; <label>:216                                     ; preds = %213
  %217 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %.loopexit
...
.loopexit:                                        ; preds = %.split, %138, %216, %213, %218, %210, %208
  %.0 = phi i32 [ undef, %208 ], [ undef, %210 ], [ undef, %218 ], [ %hash.3, %213 ], [ %hash.3, %216 ], [ %hash.116, %138 ], [ %i.1, %.split ]
  ret i32 %.0
}
...
!3157 = metadata !{i32 3612}
!3158 = metadata !{i32 5150}
!3159 = metadata !{i32 8303}
!3160 = metadata !{i32 8890}
!3161 = metadata !{i32 9381}
!3162 = metadata !{i32 9739}
!3163 = metadata !{i32 10004}
!3164 = metadata !{i32 10187}
!3165 = metadata !{i32 10923}
!3166 = metadata !{i32 11235}
!3167 = metadata !{i32 11365}
!3168 = metadata !{i32 12710}
!3169 = metadata !{i32 13948}
!3170 = metadata !{i32 14308}
!3171 = metadata !{i32 14756}
