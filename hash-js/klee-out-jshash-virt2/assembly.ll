...
@"_2_JSHash_$array" = internal unnamed_addr constant [1 x [9088 x i8]] [[9088 x i8] c"%\00\01\00\00\00\00\00\00%\00\00\00\00\00\00\00\00/%\08\00\00\00\00\00\00\00%\00\00\00\00\00\00\00\00/7\00\00\00\00\00\00\00\00CCh\18\00\00\00\06%\08\00\00\00\00\00\00\
@"_1_JSHash_$array" = internal global [1 x [177 x i8]] [[177 x i8] c"U\0C\00\00\00\EF\A7\C6gN\1FU\10\00\00\00\EF\00\00\00\00\1FU\10\00\00\00\EF\00\00\00\00\1F:\04\00\00\00U\10\00\00\00\07\BF\01\00\00\00\07\84\D6\0E\00\00\00:\04\00\00\00:l\00\00\00U\0C\00
...
define internal fastcc i32 @__user_main(i32 %argc, i8** nocapture readonly %argv) #0 {
  ...
  %"_2_JSHash_$locals.i" = alloca [308 x i8], align 16
  %"_2_JSHash_$stack.i" = alloca [1 x [32 x %"union._2_JSHash_$node"]], align 16
...
strlen.exit:                                      ; preds = %436
  ...
  %446 = getelementptr inbounds [308 x i8]* %"_2_JSHash_$locals.i", i64 0, i64 0
  %447 = bitcast [1 x [32 x %"union._2_JSHash_$node"]]* %"_2_JSHash_$stack.i" to i8*
  store i8* %435, i8** %1, align 8
  store i32 %443, i32* %2, align 4
  %448 = getelementptr inbounds [1 x [32 x %"union._2_JSHash_$node"]]* %"_2_JSHash_$stack.i", i64 0, i64 0, i64 0
  br label %.backedge.i

.backedge.i:                                      ; preds = %724, %718, %709, %702, %694, %687, %680, %678, %670, %660, %654, %648, %646, %639, %631, %623, %616, %610, %604, %595, %589, %581, %572, %570, %561, %553, %550, %534, %532, %511, %508, %500, %4
  %"_2_JSHash_$pc.0.0.i" = phi i8* [ getelementptr inbounds ([1 x [9088 x i8]]* @"_2_JSHash_$array", i64 0, i64 0, i64 0), %strlen.exit ], [ %"_2_JSHash_$pc.0.0.i", %.backedge.i ], [ %725, %724 ], [ %723, %718 ], [ %710, %709 ], [ %708, %702 ], [ %695, %
  %"_2_JSHash_$sp.0.0.i" = phi %"union._2_JSHash_$node"* [ %448, %strlen.exit ], [ %"_2_JSHash_$sp.0.0.i", %.backedge.i ], [ %"_2_JSHash_$sp.0.0.i", %724 ], [ %"_2_JSHash_$sp.0.0.i", %718 ], [ %713, %709 ], [ %707, %702 ], [ %701, %694 ], [ %691, %687 ],
  %449 = load i8* %"_2_JSHash_$pc.0.0.i", align 1
...
; <label>:451                                     ; preds = %.backedge.i
  %452 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %453 = bitcast i8* %452 to i64*
  %454 = load i64* %453, align 8
  %455 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1, i32 0
  %.c4.i = inttoptr i64 %454 to i8*
  store i8* %.c4.i, i8** %455, align 8
  %456 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1
  %457 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:458                                     ; preds = %.backedge.i
  %459 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %460 = bitcast i8* %459 to i32*
  %461 = load i32* %460, align 4
  %cond.i = icmp eq i32 %461, 0
  br i1 %cond.i, label %462, label %464

; <label>:462                                     ; preds = %458
  %463 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* getelementptr inbounds ([1 x [177 x i8]]* @"_1_JSHash_$array", i64 0, i64 0, i64 0), i8** %463, align 8
  br label %464

; <label>:464                                     ; preds = %462, %458
  %465 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1
  %466 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:467                                     ; preds = %.backedge.i
  %468 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %469 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %470 = load i8** %469, align 8
  %471 = bitcast i8* %470 to i32*
  %472 = load i32* %471, align 4
  %473 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  store i32 %472, i32* %473, align 4
  br label %.backedge.i

; <label>:474                                     ; preds = %.backedge.i
  %475 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %476 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %477 = bitcast %"union._2_JSHash_$node"* %476 to i32*
  %478 = load i32* %477, align 4
  %479 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %480 = load i8** %479, align 8
  %481 = bitcast i8* %480 to i32*
  store i32 %478, i32* %481, align 4
  %482 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:483                                     ; preds = %.backedge.i
  %484 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %485 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
...
; <label>:489                                     ; preds = %.backedge.i
  %490 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %491 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  %492 = load i32* %491, align 4
  %493 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %494 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 9
  %495 = bitcast i8* %494 to i32*
  %496 = load i32* %495, align 4
  %497 = bitcast i8* %490 to i32*
  %498 = load i32* %497, align 4
  %499 = icmp slt i32 %492, %496
  br i1 %499, label %500, label %503

; <label>:500                                     ; preds = %489
  %501 = sext i32 %498 to i64
  %.sum9.i = add i64 %501, 1
  %502 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 %.sum9.i
  br label %.backedge.i

; <label>:503                                     ; preds = %489
  %504 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 5
  %505 = bitcast i8* %504 to i32*
  %506 = load i32* %505, align 4
  %507 = icmp sgt i32 %492, %506
  br i1 %507, label %508, label %511

; <label>:508                                     ; preds = %503
  %509 = sext i32 %498 to i64
  %.sum8.i = add i64 %509, 1
  %510 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 %.sum8.i
  br label %.backedge.i

; <label>:511                                     ; preds = %503
  %512 = sub nsw i32 %492, %496
  %513 = shl nsw i32 %512, 2
  %514 = sext i32 %513 to i64
  %.sum6.i = add i64 %514, 13
  %515 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 %.sum6.i
  %516 = bitcast i8* %515 to i32*
  %517 = load i32* %516, align 4
  %518 = sext i32 %517 to i64
  %.sum7.i = add i64 %518, 1
  %519 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 %.sum7.i
  br label %.backedge.i

; <label>:520                                     ; preds = %.backedge.i
  %521 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  %522 = load i32* %521, align 4
  %523 = icmp eq i32 %522, 0
  br i1 %523, label %530, label %524

; <label>:524                                     ; preds = %520
  %525 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %526 = bitcast i8* %525 to i32*
  %527 = load i32* %526, align 4
  %528 = sext i32 %527 to i64
  %.sum5.i = add i64 %528, 1
  %529 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 %.sum5.i
  br label %532

; <label>:530                                     ; preds = %520
  %531 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 5
  br label %532

; <label>:532                                     ; preds = %530, %524
  %"_2_JSHash_$pc.0.1.i" = phi i8* [ %531, %530 ], [ %529, %524 ]
  %533 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:534                                     ; preds = %.backedge.i
  %535 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %536 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1, i32 0
  %537 = load i8** %536, align 8
  %538 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %539 = load i8** %538, align 8
  %540 = bitcast i8* %539 to i8**
  store i8* %537, i8** %540, align 8
  %541 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:542                                     ; preds = %.backedge.i
  %543 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
...
; <label>:546                                     ; preds = %542
  %547 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %445, i8** %547, align 8
  br label %550

; <label>:548                                     ; preds = %542
  %549 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %444, i8** %549, align 8
  br label %550

; <label>:550                                     ; preds = %548, %546, %542
  %551 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1
  %552 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:553                                     ; preds = %.backedge.i
  %554 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %555 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %556 = bitcast %"union._2_JSHash_$node"* %555 to i32*
  %557 = load i32* %556, align 4
  %558 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  %559 = load i32* %558, align 4
  %560 = lshr i32 %557, %559
  store i32 %560, i32* %556, align 4
  br label %.backedge.i

; <label>:561                                     ; preds = %.backedge.i
  %562 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %563 = bitcast i8* %562 to i32*
  %564 = load i32* %563, align 4
  %565 = sext i32 %564 to i64
  %566 = getelementptr inbounds [308 x i8]* %"_2_JSHash_$locals.i", i64 0, i64 %565
  %567 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %566, i8** %567, align 8
  %568 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1
  %569 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:570                                     ; preds = %.backedge.i
  %571 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:572                                     ; preds = %.backedge.i
  %573 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %574 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %575 = bitcast %"union._2_JSHash_$node"* %574 to i32*
  %576 = load i32* %575, align 4
  %577 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %578 = load i8** %577, align 8
  %579 = bitcast i8* %578 to i32*
  store i32 %576, i32* %579, align 4
  %580 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:581                                     ; preds = %.backedge.i
  %582 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %583 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %584 = bitcast %"union._2_JSHash_$node"* %583 to i32*
  %585 = load i32* %584, align 4
  %586 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
...
; <label>:589                                     ; preds = %.backedge.i
  %590 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %591 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %592 = load i8** %591, align 8
  %593 = load i8* %592, align 1
  %594 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i8*
  store i8 %593, i8* %594, align 1
  br label %.backedge.i

; <label>:595                                     ; preds = %.backedge.i
  %596 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %597 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %598 = bitcast %"union._2_JSHash_$node"* %597 to i32*
  %599 = load i32* %598, align 4
  %600 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
...
; <label>:604                                     ; preds = %.backedge.i
  %605 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %606 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %607 = load i8** %606, align 8
  %608 = load i8* %607, align 1
  %609 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i8*
  store i8 %608, i8* %609, align 1
  br label %.backedge.i

; <label>:610                                     ; preds = %.backedge.i
  %611 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %612 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %613 = load i8** %612, align 8
  %614 = bitcast i8* %613 to i64*
  %615 = load i64* %614, align 8
  %.c2.i = inttoptr i64 %615 to i8*
  store i8* %.c2.i, i8** %612, align 8
  br label %.backedge.i

; <label>:616                                     ; preds = %.backedge.i
  %617 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %618 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i8*
  %619 = load i8* %618, align 1
  %620 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1, i32 0
  %621 = load i8** %620, align 8
  store i8 %619, i8* %621, align 1
  %622 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:623                                     ; preds = %.backedge.i
  %624 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %625 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i64*
  %626 = load i64* %625, align 8
  %627 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1, i32 0
  %628 = load i8** %627, align 8
  %629 = bitcast i8* %628 to i64*
  store i64 %626, i64* %629, align 8
  %630 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -2
  br label %.backedge.i

; <label>:631                                     ; preds = %.backedge.i
  %632 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %633 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  %634 = load i32* %633, align 4
  %635 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %636 = bitcast %"union._2_JSHash_$node"* %635 to i32*
  %637 = load i32* %636, align 4
  %638 = xor i32 %637, %634
  store i32 %638, i32* %636, align 4
  br label %.backedge.i

; <label>:639                                     ; preds = %.backedge.i
  %640 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %641 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %642 = load i8** %641, align 8
  %643 = bitcast i8* %642 to i32*
  %644 = load i32* %643, align 4
  %645 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  store i32 %644, i32* %645, align 4
  br label %.backedge.i

; <label>:646                                     ; preds = %.backedge.i
  %647 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:648                                     ; preds = %.backedge.i
  %649 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %650 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  %651 = load i32* %650, align 4
  %652 = sext i32 %651 to i64
  %653 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %.c1.i = inttoptr i64 %652 to i8*
  store i8* %.c1.i, i8** %653, align 8
  br label %.backedge.i

; <label>:654                                     ; preds = %.backedge.i
  %655 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %656 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i8*
  %657 = load i8* %656, align 1
  %658 = sext i8 %657 to i32
  %659 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  store i32 %658, i32* %659, align 4
  br label %.backedge.i

; <label>:660                                     ; preds = %.backedge.i
  %661 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %662 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 0, i32 0
  %663 = load i8** %662, align 8
  %664 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %665 = bitcast %"union._2_JSHash_$node"* %664 to i32*
  %666 = load i32* %665, align 4
  %667 = sext i32 %666 to i64
  %668 = getelementptr i8* %663, i64 %667
  %669 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1, i32 0
  store i8* %668, i8** %669, align 8
  br label %.backedge.i

; <label>:670                                     ; preds = %.backedge.i
  %671 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %672 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %673 = bitcast %"union._2_JSHash_$node"* %672 to i32*
  %674 = load i32* %673, align 4
  %675 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  %676 = load i32* %675, align 4
  %677 = add i32 %676, %674
  store i32 %677, i32* %673, align 4
  br label %.backedge.i

; <label>:678                                     ; preds = %.backedge.i
  %679 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  br label %.backedge.i

; <label>:680                                     ; preds = %.backedge.i
  %681 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %682 = bitcast i8* %681 to i32*
  %683 = load i32* %682, align 4
  %684 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1
  %685 = bitcast %"union._2_JSHash_$node"* %684 to i32*
  store i32 %683, i32* %685, align 4
  %686 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:687                                     ; preds = %.backedge.i
  %688 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %689 = bitcast i8* %688 to i32*
  %690 = load i32* %689, align 4
  %691 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1
  %692 = bitcast %"union._2_JSHash_$node"* %691 to i32*
  store i32 %690, i32* %692, align 4
  %693 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 5
  br label %.backedge.i

; <label>:694                                     ; preds = %.backedge.i
  %695 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %696 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1, i32 0
  %697 = load i8** %696, align 8
  %698 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i64*
  %699 = load i64* %698, align 8
  %700 = getelementptr i8* %697, i64 %699
  store i8* %700, i8** %696, align 8
  %701 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  br label %.backedge.i

; <label>:702                                     ; preds = %.backedge.i
  %703 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %704 = bitcast i8* %703 to i8**
  %705 = load i8** %704, align 8
  %706 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1, i32 0
  store i8* %705, i8** %706, align 8
  %707 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 1
  %708 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 9
  br label %.backedge.i

; <label>:709                                     ; preds = %.backedge.i
  %710 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %711 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i64*
  %712 = load i64* %711, align 8
  %713 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1
  %714 = bitcast %"union._2_JSHash_$node"* %713 to i64*
  %715 = load i64* %714, align 8
  %716 = mul i64 %715, %712
  %717 = getelementptr inbounds %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i", i64 -1, i32 0
  %.c.i = inttoptr i64 %716 to i8*
  store i8* %.c.i, i8** %717, align 8
  br label %.backedge.i

; <label>:718                                     ; preds = %.backedge.i
  %719 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %720 = bitcast i8* %719 to i32*
  %721 = load i32* %720, align 4
  %722 = sext i32 %721 to i64
  %.sum.i = add i64 %722, 1
  %723 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 %.sum.i
  br label %.backedge.i

; <label>:724                                     ; preds = %.backedge.i
  %725 = getelementptr inbounds i8* %"_2_JSHash_$pc.0.0.i", i64 1
  %726 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i8*
  %727 = load i8* %726, align 1
  %728 = zext i8 %727 to i32
  %729 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  store i32 %728, i32* %729, align 4
  br label %.backedge.i

JSHash.exit:                                      ; preds = %.backedge.i
  %730 = bitcast %"union._2_JSHash_$node"* %"_2_JSHash_$sp.0.0.i" to i32*
  %731 = load i32* %730, align 4
  %732 = icmp eq i32 %731, 302766813
  br i1 %732, label %733, label %734

; <label>:733                                     ; preds = %JSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str97, i64 0, i64 0))
  br label %735

; <label>:734                                     ; preds = %JSHash.exit
