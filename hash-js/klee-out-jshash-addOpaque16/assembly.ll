; ModuleID = './jshash-addOpaque16.bc'
...
; <label>:8                                       ; preds = %5
  %9 = call fastcc i32 @JSHash(i8* null, i32 undef)
  br label %11
...
; <label>:12                                      ; preds = %11, %.loopexit4.split
  %13 = phi i8* [ %38, %.loopexit4.split ], [ %str, %11 ]
  %i.0 = phi i32 [ %39, %.loopexit4.split ], [ 0, %11 ]
  %hash.0 = phi i32 [ %37, %.loopexit4.split ], [ 1315423911, %11 ]
...
; <label>:29                                      ; preds = %12
  ...
  br i1 %30, label %.loopexit4.split, label %40

.loopexit4.split:                                 ; preds = %.preheader3, %17, %29, %28, %20
  %31 = shl i32 %hash.0, 5
  %32 = load i8* %13, align 1
  %33 = sext i8 %32 to i32
  %34 = lshr i32 %hash.0, 2
  %35 = add i32 %34, %31
  %36 = add i32 %35, %33
  %37 = xor i32 %36, %hash.0
  %38 = getelementptr inbounds i8* %13, i64 1
  store i8* %38, i8** %1, align 8
  %39 = add i32 %i.0, 1
  br label %12

; <label>:40                                      ; preds = %29
  %41 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
...
; <label>:43                                      ; preds = %40
  ...
  %46 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %47 = icmp eq %struct._1_main__opaque_Node_1* %44, %46
...
; <label>:49                                      ; preds = %.lr.ph, %49
  %50 = call fastcc i32 @__user_main(i32 0, i8** %48)
...
; <label>:55                                      ; preds = %54
  %56 = call fastcc i32 @__user_main(i32 3, i8** %1)
  br label %.loopexit

.loopexit:                                        ; preds = %49, %.preheader, %40, %54, %55
  ret i32 %hash.0
}
