...
.outer.outer.i:                                   ; preds = %.split8.i, %strlen.exit
  %i.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %452, %.split8.i ]
  %hash.0.ph.ph.i = phi i32 [ undef, %strlen.exit ], [ %450, %.split8.i ]
  %_1_JSHash_next.0.ph.ph.i = phi i64 [ 5, %strlen.exit ], [ 3, %.split8.i ]
  %.0.ph.ph.i = phi i8* [ %433, %strlen.exit ], [ %451, %.split8.i ]
  br label %.outer.i

.outer.i:                                         ; preds = %.outer.i, %.outer.outer.i
  %i.0.ph.i = phi i32 [ %i.0.ph.ph.i, %.outer.outer.i ], [ 0, %.outer.i ]
  %hash.0.ph.i = phi i32 [ %hash.0.ph.ph.i, %.outer.outer.i ], [ 1315423911, %.outer.i ]
  %_1_JSHash_next.0.ph.i = phi i64 [ %_1_JSHash_next.0.ph.ph.i, %.outer.outer.i ], [ 3, %.outer.i ]
  %442 = icmp eq i64 %_1_JSHash_next.0.ph.i, 5
...
.outer1..outer1.split_crit_edge.i:                ; preds = %.outer1..outer1.split_crit_edge.i, %.outer1..outer1.split_crit_edge.lr.ph.i
  %_1_JSHash_next.0.ph214.i = phi i64 [ %_1_JSHash_next.0.ph.i, %.outer1..outer1.split_crit_edge.lr.ph.i ], [ %..i, %.outer1..outer1.split_crit_edge.i ]
  switch i64 %_1_JSHash_next.0.ph214.i, label %infloop.i [
    i64 3, label %.outer1..outer1.split_crit_edge.i
    i64 1, label %.split8.i
    i64 0, label %JSHash.exit
  ]

.split8.i:                                        ; preds = %.outer1..outer1.split_crit_edge.i
  %444 = shl i32 %hash.0.ph.i, 5
  %445 = load i8* %.0.ph.ph.i, align 1
  %446 = sext i8 %445 to i32
  %447 = lshr i32 %hash.0.ph.i, 2
  %448 = add i32 %447, %444
  %449 = add i32 %448, %446
  %450 = xor i32 %449, %hash.0.ph.i
  %451 = getelementptr inbounds i8* %.0.ph.ph.i, i64 1
  %452 = add i32 %i.0.ph.i, 1
  br label %.outer.outer.i

infloop.i:                                        ; preds = %.outer1..outer1.split_crit_edge.i, %infloop.i
  br label %infloop.i

JSHash.exit:                                      ; preds = %.outer1..outer1.split_crit_edge.i
  %453 = icmp eq i32 %hash.0.ph.i, 302766813
  br i1 %453, label %454, label %455

; <label>:454                                     ; preds = %JSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %456

; <label>:455                                     ; preds = %JSHash.exit
