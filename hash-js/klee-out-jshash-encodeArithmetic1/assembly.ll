; ModuleID = './jshash-encodeArithmetic1.bc'
...
strlen.exit:                                      ; preds = %434
  ...
  br i1 %446, label %.lr.ph.i2, label %JSHash.exit.thread

.lr.ph.i2:                                        ; preds = %strlen.exit, %.lr.ph.i2
  %.03.i = phi i8* [ %480, %.lr.ph.i2 ], [ %433, %strlen.exit ]
  %i.02.i = phi i32 [ %483, %.lr.ph.i2 ], [ 0, %strlen.exit ]
  %hash.01.i = phi i32 [ %479, %.lr.ph.i2 ], [ 1315423911, %strlen.exit ]
  ...
  %461 = xor i32 %460, %453
  %462 = sub i32 %455, %461
  %463 = or i32 %462, %hash.01.i
  %464 = load i8* %.03.i, align 1
  ...
  %476 = xor i32 %475, %453
  %477 = sub i32 %470, %476
  %478 = and i32 %477, %hash.01.i
  %479 = sub i32 %463, %478
  %480 = getelementptr inbounds i8* %.03.i, i64 1
  %481 = or i32 %i.02.i, 1
  %482 = and i32 %i.02.i, 1
  %483 = add i32 %481, %482
  %484 = xor i32 %483, -2147483648
  %485 = and i32 %484, %441
  %486 = xor i32 %442, %483
  %487 = sub i32 %483, %441
  %488 = and i32 %487, %486
  ...
  br i1 %490, label %.lr.ph.i2, label %JSHash.exit

JSHash.exit:                                      ; preds = %.lr.ph.i2
  %491 = icmp eq i32 %479, 302766813
  br i1 %491, label %492, label %JSHash.exit.thread

; <label>:492                                     ; preds = %JSHash.exit
...
; <label>:493                                     ; preds = %JSHash.exit.thread, %492
  ret i32 0
}
