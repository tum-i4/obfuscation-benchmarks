...
.backedge.i:                                      ; preds = %466, %465, %464, %463, %462, %461, %460, %459, %449, %448, %447, %445, %444, %443, %442, %.backedge.i, %strlen.exit
  %_1_JSHash_next.0.i = phi i64 [ undef, %strlen.exit ], [ %_1_JSHash_next.0.i, %.backedge.i ], [ %_1_JSHash_next.0.i, %466 ], [ %_1_JSHash_next.0.i, %465 ], [ %_1_JSHash_next.0.i, %464 ], [ %_1_JSHash_next.0.i, %463 ], [ 5, %461 ], [ %_1_JSHash_next.0.i
  %i.0.i = phi i32 [ undef, %strlen.exit ], [ %i.0.i, %.backedge.i ], [ %i.0.i, %466 ], [ %i.0.i, %465 ], [ %i.0.i, %464 ], [ %i.0.i, %463 ], [ %i.0.i, %461 ], [ %i.0.i, %460 ], [ %i.0.i, %459 ], [ %458, %449 ], [ %i.0.i, %448 ], [ %i.0.i, %447 ], [ %i.0
  %hash.0.i = phi i32 [ undef, %strlen.exit ], [ %hash.0.i, %.backedge.i ], [ %hash.0.i, %466 ], [ %hash.0.i, %465 ], [ %hash.0.i, %464 ], [ %hash.0.i, %463 ], [ %hash.0.i, %461 ], [ %hash.0.i, %460 ], [ %hash.0.i, %459 ], [ %456, %449 ], [ %hash.0.i, %4
  %_2_JSHash_next.0.i = phi i64 [ 2, %strlen.exit ], [ %_2_JSHash_next.0.i, %.backedge.i ], [ 0, %466 ], [ 17, %465 ], [ 14, %464 ], [ 9, %463 ], [ 0, %461 ], [ 5, %460 ], [ 0, %459 ], [ 8, %449 ], [ 0, %448 ], [ 0, %447 ], [ 13, %444 ], [ 0, %443 ], [ 1
  %.0.i = phi i8* [ %433, %strlen.exit ], [ %.0.i, %.backedge.i ], [ %.0.i, %466 ], [ %.0.i, %465 ], [ %.0.i, %464 ], [ %.0.i, %463 ], [ %.0.i, %461 ], [ %.0.i, %460 ], [ %.0.i, %459 ], [ %457, %449 ], [ %.0.i, %448 ], [ %.0.i, %447 ], [ %.0.i, %444 ], [
  switch i64 %_2_JSHash_next.0.i, label %.backedge.i [
    i64 17, label %442
    i64 16, label %443
    i64 14, label %444
    i64 13, label %445
...
; <label>:449                                     ; preds = %.backedge.i
  %450 = shl i32 %hash.0.i, 5
  %451 = load i8* %.0.i, align 1
  %452 = sext i8 %451 to i32
  %453 = lshr i32 %hash.0.i, 2
  %454 = add i32 %453, %450
  %455 = add i32 %454, %452
  %456 = xor i32 %455, %hash.0.i
  %457 = getelementptr inbounds i8* %.0.i, i64 1
  %458 = add i32 %i.0.i, 1
  br label %.backedge.i
...
; <label>:461                                     ; preds = %.backedge.i
  br label %.backedge.i

; <label>:462                                     ; preds = %.backedge.i
  switch i64 %_1_JSHash_next.0.i, label %466 [
...
JSHash.exit:                                      ; preds = %.backedge.i
  %467 = icmp eq i32 %hash.0.i, 302766813
  br i1 %467, label %468, label %469

; <label>:468                                     ; preds = %JSHash.exit
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @str96, i64 0, i64 0))
  br label %470

; <label>:469                                     ; preds = %JSHash.exit
