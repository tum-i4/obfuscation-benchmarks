; ModuleID = './jshash-addOpaque-updateOpaque16.bc'
...
; <label>:5                                       ; preds = %0
  %6 = call fastcc i32 @JSHash(i8* null, i32 undef)
  br label %7
...
; <label>:21                                      ; preds = %7, %19
  ...
  %22 = phi %struct._1_main__opaque_Node_1* [ %15, %7 ], [ %.pre15, %19 ]
  %23 = icmp eq %struct._1_main__opaque_Node_1* %22, null
  br i1 %23, label %.preheader12.preheader, label %39

.preheader12.preheader:                           ; preds = %21
  %.pre19 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  br label %.preheader12

.preheader12:                                     ; preds = %.preheader12.preheader, %.loopexit11.split
  %24 = phi %struct._1_main__opaque_Node_1* [ %34, %.loopexit11.split ], [ %.pre19, %.preheader12.preheader ]
  %25 = phi %struct._1_main__opaque_Node_1* [ %38, %.loopexit11.split ], [ %.pre, %.preheader12.preheader ]
  %26 = icmp eq %struct._1_main__opaque_Node_1* %24, %25
  br i1 %26, label %28, label %.preheader10

.preheader10:                                     ; preds = %.preheader12
  %27 = icmp eq %struct._1_main__opaque_Node_1* %25, null
  br i1 %27, label %.loopexit11.split, label %.preheader10..preheader10.split_crit_edge

.preheader10..preheader10.split_crit_edge:        ; preds = %.preheader10, %.preheader10..preheader10.split_crit_edge
  br label %.preheader10..preheader10.split_crit_edge

; <label>:28                                      ; preds = %.preheader12
  %29 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  %30 = icmp eq %struct._1_main__opaque_Node_1* %29, null
  br i1 %30, label %.loopexit11.split, label %.loopexit13.loopexit

.loopexit11.split:                                ; preds = %.preheader10, %28
...
.loopexit13.loopexit:                             ; preds = %28
  %.pre17 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list1_1, align 8
  %.pre18 = load %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %.loopexit13

.loopexit13:                                      ; preds = %.loopexit13.loopexit, %42, %52
  %61 = phi %struct._1_main__opaque_Node_1* [ %.pre18, %.loopexit13.loopexit ], [ %47, %42 ], [ %60, %52 ]
  %62 = phi %struct._1_main__opaque_Node_1* [ %.pre17, %.loopexit13.loopexit ], [ %44, %42 ], [ %56, %52 ]
...
.preheader:                                       ; preds = %72, %.loopexit13
  %76 = phi %struct._1_main__opaque_Node_1* [ %75, %72 ], [ %70, %.loopexit13 ]
  %77 = phi %struct._1_main__opaque_Node_1* [ %74, %72 ], [ %68, %.loopexit13 ]
...
._crit_edge.loopexit:                             ; preds = %.lr.ph
  ...
  store %struct._1_main__opaque_Node_1* %133, %struct._1_main__opaque_Node_1** @_1_main__opaque_list2_1, align 8
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  %87 = phi %struct._1_main__opaque_Node_1* [ %83, %.preheader ], [ %131, %._crit_edge.loopexit ]
  %88 = phi %struct._1_main__opaque_Node_1* [ %85, %.preheader ], [ %133, %._crit_edge.loopexit ]
  %hash.0.lcssa = phi i32 [ 1315423911, %.preheader ], [ %123, %._crit_edge.loopexit ]
...
; <label>:94                                      ; preds = %._crit_edge, %90
  ...
  br i1 %113, label %162, label %134

.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %114 = phi i8* [ %124, %.lr.ph ], [ %str, %.preheader ]
  %115 = phi %struct._1_main__opaque_Node_1* [ %133, %.lr.ph ], [ %85, %.preheader ]
  %116 = phi %struct._1_main__opaque_Node_1* [ %131, %.lr.ph ], [ %83, %.preheader ]
  %hash.09 = phi i32 [ %123, %.lr.ph ], [ 1315423911, %.preheader ]
  %i.08 = phi i32 [ %125, %.lr.ph ], [ 0, %.preheader ]
  %117 = shl i32 %hash.09, 5
  %118 = load i8* %114, align 1
  %119 = sext i8 %118 to i32
  %120 = lshr i32 %hash.09, 2
  %121 = add i32 %120, %117
  %122 = add i32 %121, %119
  %123 = xor i32 %122, %hash.09
  %124 = getelementptr inbounds i8* %114, i64 1
  store i8* %124, i8** %1, align 8
  %125 = add i32 %i.08, 1
  %126 = getelementptr inbounds %struct._1_main__opaque_Node_1* %116, i64 0, i32 1
  %127 = load %struct._1_main__opaque_Node_1** %126, align 8
  %128 = getelementptr inbounds %struct._1_main__opaque_Node_1* %115, i64 0, i32 1
  %129 = load %struct._1_main__opaque_Node_1** %128, align 8
  %130 = getelementptr inbounds %struct._1_main__opaque_Node_1* %127, i64 0, i32 1
  %131 = load %struct._1_main__opaque_Node_1** %130, align 8
  %132 = getelementptr inbounds %struct._1_main__opaque_Node_1* %129, i64 0, i32 1
  %133 = load %struct._1_main__opaque_Node_1** %132, align 8
  %exitcond = icmp eq i32 %125, %.06
  br i1 %exitcond, label %._crit_edge.loopexit, label %.lr.ph

; <label>:134                                     ; preds = %94
  %135 = icmp ne %struct._1_main__opaque_Node_1* %110, %112
  %136 = icmp ne %struct._1_main__opaque_Node_1* %112, null
  %or.cond5 = or i1 %135, %136
  br i1 %or.cond5, label %139, label %137

; <label>:137                                     ; preds = %134
  %138 = call fastcc i32 @JSHash(i8* null, i32 %.06)
...
; <label>:139                                     ; preds = %134, %137
  %.pr7 = phi %struct._1_main__opaque_Node_1* [ %110, %134 ], [ %.pr7.pr, %137 ]
  %140 = phi %struct._1_main__opaque_Node_1* [ %112, %134 ], [ %.pr, %137 ]
  %hash.1 = phi i32 [ %hash.0.lcssa, %134 ], [ %138, %137 ]
  %141 = icmp eq %struct._1_main__opaque_Node_1* %140, null
  %142 = icmp eq %struct._1_main__opaque_Node_1* %.pr7, null
  br i1 %141, label %thread-pre-split.preheader, label %143

thread-pre-split.preheader:                       ; preds = %139
  br i1 %142, label %thread-pre-split, label %.loopexit.split

thread-pre-split:                                 ; preds = %thread-pre-split.preheader, %thread-pre-split
  br label %thread-pre-split

; <label>:143                                     ; preds = %139
  br i1 %142, label %144, label %.loopexit.split

; <label>:144                                     ; preds = %143
  %145 = call fastcc i32 @__user_main(i32 0, i8** %1)
  br label %.loopexit.split

.loopexit.split:                                  ; preds = %thread-pre-split.preheader, %143, %144
  ...
  %150 = getelementptr inbounds %struct._1_main__opaque_Node_1* %149, i64 0, i32 1
  %151 = load %struct._1_main__opaque_Node_1** %150, align 8
  %152 = getelementptr inbounds %struct._1_main__opaque_Node_1* %148, i64 0, i32 1
...
; <label>:157                                     ; preds = %.loopexit.split
  %158 = getelementptr inbounds %struct._1_main__opaque_Node_1* %153, i64 0, i32 1
  ...
  %160 = getelementptr inbounds %struct._1_main__opaque_Node_1* %155, i64 0, i32 1
...
; <label>:162                                     ; preds = %157, %.loopexit.split, %94
  %.0 = phi i32 [ %hash.0.lcssa, %94 ], [ %hash.1, %.loopexit.split ], [ %hash.1, %157 ]
  ret i32 %.0
}
